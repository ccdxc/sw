...
type ESClient interface {
	...
	// by `from`.
	Search(ctx context.Context, index, iType string, query interface{}, aggregation interface{}, from, size int32, sortByField string, sortAsc bool) (*es.SearchResult, error)
