...
type ESClient interface {
	...
	// by `from`.
	Search(ctx context.Context, index, iType string, query es.Query, aggregation es.Aggregation, from, size int32, sortByField string, sortAsc bool) (*es.SearchResult, error)
