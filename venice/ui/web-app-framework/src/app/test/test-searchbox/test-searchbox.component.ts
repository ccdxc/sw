...
@Component({
  selector: 'app-test-searchbox',
  templateUrl: './test-searchbox.component.html',
  styleUrls: ['./test-searchbox.component.css']
})
export class TestSearchboxComponent implements OnInit {
  ...
  filterCountrySingle(event) {
    ...
    this.filteredCountriesSingle = this.filterCountry(query, this.countriesJSON);
