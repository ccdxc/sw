...
@Component({
  selector: 'app-test-uniquerepeater',
  templateUrl: './test-uniquerepeater.component.html',
  styleUrls: ['./test-uniquerepeater.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class TestUniqueRepeaterComponent implements OnInit {
  data: RepeaterData[] = [];
  output: any;
