...
export class Metricsv1Service extends AbstractService {
 ...
 generates a RPC call Query */
  public GetQuery():Observable<{body: IMetrics_queryQueryResponse | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/metrics/v1/metrics';
    return this.invokeAJAXGetCall(url, 'GetQuery') as Observable<{body: IMetrics_queryQueryResponse | Error, statusCode: number}>;
  }
