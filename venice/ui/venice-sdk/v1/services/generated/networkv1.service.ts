...
export class Networkv1Service extends AbstractService {
  ...
  */
  ...
  public ListLbPolicy_1(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkLbPolicyList | IApiStatus | Error, statusCode: number}> {
  ...
  public AddLbPolicy_1(body: INetworkLbPolicy, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/lb-policy';
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
    }
  ...
  /** Get LbPolicy object */
  public GetLbPolicy_1(O_Name, queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
  ...
  public DeleteLbPolicy_1(O_Name, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/lb-policy/{O.Name}';
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  public UpdateLbPolicy_1(O_Name, body: INetworkLbPolicy, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/lb-policy/{O.Name}';
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  public AddNetwork_1(body: INetworkNetwork, stagingID: string = ""):Observable<{body: INetworkNetwork | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/networks';
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
    }
  ...
  public UpdateNetwork_1(O_Name, body: INetworkNetwork, stagingID: string = ""):Observable<{body: INetworkNetwork | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/networks/{O.Name}';
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  public ListService_1(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkServiceList | IApiStatus | Error, statusCode: number}> {
  ...
  public AddService_1(body: INetworkService, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/services';
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
    }
  ...
  /** Get Service object */
  public GetService_1(O_Name, queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
  ...
  public DeleteService_1(O_Name, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/services/{O.Name}';
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  public UpdateService_1(O_Name, body: INetworkService, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/services/{O.Name}';
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  /** List LbPolicy objects */
  public ListLbPolicy(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkLbPolicyList | IApiStatus | Error, statusCode: number}> {
  ...
  /** Create LbPolicy object */
  public AddLbPolicy(body: INetworkLbPolicy, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/lb-policy';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  /** Get LbPolicy object */
  public GetLbPolicy(O_Name, queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
  ...
  /** Delete LbPolicy object */
  public DeleteLbPolicy(O_Name, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/lb-policy/{O.Name}';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
  ...
  /** Update LbPolicy object */
  public UpdateLbPolicy(O_Name, body: INetworkLbPolicy, stagingID: string = ""):Observable<{body: INetworkLbPolicy | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/lb-policy/{O.Name}';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
  ...
  /** Create Network object */
  public AddNetwork(body: INetworkNetwork, stagingID: string = ""):Observable<{body: INetworkNetwork | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/networks';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  /** Update Network object */
  public UpdateNetwork(O_Name, body: INetworkNetwork, stagingID: string = ""):Observable<{body: INetworkNetwork | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/networks/{O.Name}';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
  ...
  /** List Service objects */
  public ListService(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkServiceList | IApiStatus | Error, statusCode: number}> {
  ...
  /** Create Service object */
  public AddService(body: INetworkService, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/services';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    if (stagingID != null && stagingID.length != 0) {
      url = url.replace('configs', 'staging/' + stagingID);
  ...
  /** Get Service object */
  public GetService(O_Name, queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
  ...
  /** Delete Service object */
  public DeleteService(O_Name, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/services/{O.Name}';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
  ...
  /** Update Service object */
  public UpdateService(O_Name, body: INetworkService, stagingID: string = ""):Observable<{body: INetworkService | IApiStatus | Error, statusCode: number}> {
    let url = this['baseUrlAndPort'] + '/configs/network/v1/tenant/{O.Tenant}/services/{O.Name}';
    url = url.replace('{O.Tenant}', this['O_Tenant']);
    url = url.replace('{O.Name}', O_Name);
    if (stagingID != null && stagingID.length != 0) {
  ...
  public WatchLbPolicy_1(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkAutoMsgLbPolicyWatchHelper | IApiStatus | Error, statusCode: number}> {
  ...
  public WatchService_1(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkAutoMsgServiceWatchHelper | IApiStatus | Error, statusCode: number}> {
  ...
  /** Watch LbPolicy objects. Supports WebSockets or HTTP long poll */
  public WatchLbPolicy(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkAutoMsgLbPolicyWatchHelper | IApiStatus | Error, statusCode: number}> {
  ...
  /** Watch Service objects. Supports WebSockets or HTTP long poll */
  public WatchService(queryParam: any = null, stagingID: string = ""):Observable<{body: INetworkAutoMsgServiceWatchHelper | IApiStatus | Error, statusCode: number}> {
