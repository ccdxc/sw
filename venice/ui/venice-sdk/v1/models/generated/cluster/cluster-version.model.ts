...
import { ClusterVersionSpec, IClusterVersionSpec } from './cluster-version-spec.model';
import { ClusterVersionStatus, IClusterVersionStatus } from './cluster-version-status.model';

export interface IClusterVersion {
    'kind'?: string;
    'api-version'?: string;
    'meta'?: IApiObjectMeta;
    'spec'?: IClusterVersionSpec;
    'status'?: IClusterVersionStatus;
    '_ui'?: any;
}


export class ClusterVersion extends BaseModel implements IClusterVersion {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return ClusterVersion.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return ClusterVersion.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (ClusterVersion.propInfo[prop] != null &&
                        ClusterVersion.propInfo[prop].default != null);
    }
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        } else if (fillDefaults && ClusterVersion.hasDefaultValue('kind')) {
            this['kind'] = ClusterVersion.propInfo['kind'].default;
        } else {
            this['kind'] = null
        }
        if (values && values['api-version'] != null) {
            this['api-version'] = values['api-version'];
        } else if (fillDefaults && ClusterVersion.hasDefaultValue('api-version')) {
            this['api-version'] = ClusterVersion.propInfo['api-version'].default;
        } else {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), ClusterVersion.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), ClusterVersion.propInfo['api-version']),
                'meta': CustomFormGroup(this['meta'].$formGroup, ClusterVersion.propInfo['meta'].required),
                'spec': CustomFormGroup(this['spec'].$formGroup, ClusterVersion.propInfo['spec'].required),
                'status': CustomFormGroup(this['status'].$formGroup, ClusterVersion.propInfo['status'].required),
            });
