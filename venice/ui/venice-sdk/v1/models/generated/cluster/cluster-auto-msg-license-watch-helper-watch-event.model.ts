...
import { ClusterLicense, IClusterLicense } from './cluster-license.model';
...
export class ClusterAutoMsgLicenseWatchHelperWatchEvent extends BaseModel implements IClusterAutoMsgLicenseWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo[prop] != null &&
                        ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    constructor(values?: any, setDefaults:boolean = true) {
        super();
        this['object'] = new ClusterLicense();
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, ClusterAutoMsgLicenseWatchHelperWatchEvent.propInfo['object'].required),
            });
