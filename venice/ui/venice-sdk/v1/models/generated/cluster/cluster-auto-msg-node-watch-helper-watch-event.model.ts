    ...
    */
    public static hasDefaultValue(prop) {
        return (ClusterAutoMsgNodeWatchHelperWatchEvent.propInfo[prop] != null &&
                        ...
                        ClusterAutoMsgNodeWatchHelperWatchEvent.propInfo[prop].default != '');
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), ClusterAutoMsgNodeWatchHelperWatchEvent.propInfo['type'].description),
