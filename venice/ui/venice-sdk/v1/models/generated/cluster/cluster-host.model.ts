...
export class ClusterHost extends BaseModel implements IClusterHost {
    ...
    public static propInfo: { [prop in keyof IClusterHost]: PropInfoItem } = {
        'kind': {
            required: false,
            type: 'string'
        },
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), ClusterHost.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), ClusterHost.propInfo['api-version']),
                'meta': CustomFormGroup(this['meta'].$formGroup, ClusterHost.propInfo['meta'].required),
                'spec': CustomFormGroup(this['spec'].$formGroup, ClusterHost.propInfo['spec'].required),
                'status': CustomFormGroup(this['status'].$formGroup, ClusterHost.propInfo['status'].required),
            });
