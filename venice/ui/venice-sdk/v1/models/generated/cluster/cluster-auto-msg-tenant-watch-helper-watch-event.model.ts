...
export class ClusterAutoMsgTenantWatchHelperWatchEvent extends BaseModel implements IClusterAutoMsgTenantWatchHelperWatchEvent {
    ...
    public static propInfo: { [prop in keyof IClusterAutoMsgTenantWatchHelperWatchEvent]: PropInfoItem } = {
        'type': {
            required: false,
            type: 'string'
        },
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return ClusterAutoMsgTenantWatchHelperWatchEvent.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), ClusterAutoMsgTenantWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, ClusterAutoMsgTenantWatchHelperWatchEvent.propInfo['object'].required),
            });
