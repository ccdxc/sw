...
export class RolloutAutoMsgRolloutWatchHelperWatchEvent extends BaseModel implements IRolloutAutoMsgRolloutWatchHelperWatchEvent {
    ...
    public static propInfo: { [prop in keyof IRolloutAutoMsgRolloutWatchHelperWatchEvent]: PropInfoItem } = {
        'type': {
            required: false,
            type: 'string'
        },
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), RolloutAutoMsgRolloutWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, RolloutAutoMsgRolloutWatchHelperWatchEvent.propInfo['object'].required),
            });
