    ...
    */
    public static hasDefaultValue(prop) {
        return (ObjstoreObjectList.propInfo[prop] != null &&
                        ...
                        ObjstoreObjectList.propInfo[prop].default != '');
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), ObjstoreObjectList.propInfo['kind'].description),
                'api-version': CustomFormControl(new FormControl(this['api-version']), ObjstoreObjectList.propInfo['api-version'].description),
