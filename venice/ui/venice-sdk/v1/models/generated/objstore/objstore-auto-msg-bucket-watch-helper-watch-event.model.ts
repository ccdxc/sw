...
export class ObjstoreAutoMsgBucketWatchHelperWatchEvent extends BaseModel implements IObjstoreAutoMsgBucketWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo[prop] != null &&
                        ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, ObjstoreAutoMsgBucketWatchHelperWatchEvent.propInfo['object'].required),
            });
