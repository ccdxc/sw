...
export class ObjstoreAutoMsgObjectWatchHelperWatchEvent extends BaseModel implements IObjstoreAutoMsgObjectWatchHelperWatchEvent {
    ...
    public static propInfo: { [prop in keyof IObjstoreAutoMsgObjectWatchHelperWatchEvent]: PropInfoItem } = {
        'type': {
            required: false,
            type: 'string'
        },
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), ObjstoreAutoMsgObjectWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, ObjstoreAutoMsgObjectWatchHelperWatchEvent.propInfo['object'].required),
            });
