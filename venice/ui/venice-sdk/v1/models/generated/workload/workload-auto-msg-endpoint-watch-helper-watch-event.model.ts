...
export class WorkloadAutoMsgEndpointWatchHelperWatchEvent extends BaseModel implements IWorkloadAutoMsgEndpointWatchHelperWatchEvent {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return WorkloadAutoMsgEndpointWatchHelperWatchEvent.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), WorkloadAutoMsgEndpointWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, WorkloadAutoMsgEndpointWatchHelperWatchEvent.propInfo['object'].required),
            });
