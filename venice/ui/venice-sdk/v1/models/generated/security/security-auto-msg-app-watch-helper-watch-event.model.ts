...
export class SecurityAutoMsgAppWatchHelperWatchEvent extends BaseModel implements ISecurityAutoMsgAppWatchHelperWatchEvent {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return SecurityAutoMsgAppWatchHelperWatchEvent.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), SecurityAutoMsgAppWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, SecurityAutoMsgAppWatchHelperWatchEvent.propInfo['object'].required),
            });
