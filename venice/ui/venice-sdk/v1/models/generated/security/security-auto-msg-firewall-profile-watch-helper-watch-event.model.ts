    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), SecurityAutoMsgFirewallProfileWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, SecurityAutoMsgFirewallProfileWatchHelperWatchEvent.propInfo['object'].required),
            });
