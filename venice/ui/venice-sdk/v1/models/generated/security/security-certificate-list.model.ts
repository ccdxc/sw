...
export class SecurityCertificateList extends BaseModel implements ISecurityCertificateList {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return SecurityCertificateList.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), SecurityCertificateList.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), SecurityCertificateList.propInfo['api-version']),
                'list-meta': CustomFormGroup(this['list-meta'].$formGroup, SecurityCertificateList.propInfo['list-meta'].required),
                'items': new FormArray([]),
            });
