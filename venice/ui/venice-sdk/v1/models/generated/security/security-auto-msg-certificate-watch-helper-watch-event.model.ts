...
export class SecurityAutoMsgCertificateWatchHelperWatchEvent extends BaseModel implements ISecurityAutoMsgCertificateWatchHelperWatchEvent {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return SecurityAutoMsgCertificateWatchHelperWatchEvent.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), SecurityAutoMsgCertificateWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, SecurityAutoMsgCertificateWatchHelperWatchEvent.propInfo['object'].required),
            });
