...
export class StagingBufferList extends BaseModel implements IStagingBufferList {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return StagingBufferList.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), StagingBufferList.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), StagingBufferList.propInfo['api-version']),
                'list-meta': CustomFormGroup(this['list-meta'].$formGroup, StagingBufferList.propInfo['list-meta'].required),
                'items': new FormArray([]),
            });
