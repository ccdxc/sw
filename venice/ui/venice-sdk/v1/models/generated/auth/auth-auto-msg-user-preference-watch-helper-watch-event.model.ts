...
export class AuthAutoMsgUserPreferenceWatchHelperWatchEvent extends BaseModel implements IAuthAutoMsgUserPreferenceWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo[prop] != null &&
                        AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    constructor(values?: any, setDefaults:boolean = true) {
        super();
        this['object'] = new AuthUserPreference();
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, AuthAutoMsgUserPreferenceWatchHelperWatchEvent.propInfo['object'].required),
            });
