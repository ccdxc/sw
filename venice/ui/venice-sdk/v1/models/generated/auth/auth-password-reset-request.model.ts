...
export class AuthPasswordResetRequest extends BaseModel implements IAuthPasswordResetRequest {
    ...
    public static propInfo: { [prop in keyof IAuthPasswordResetRequest]: PropInfoItem } = {
        'kind': {
            required: false,
            type: 'string'
        },
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), AuthPasswordResetRequest.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), AuthPasswordResetRequest.propInfo['api-version']),
                'meta': CustomFormGroup(this['meta'].$formGroup, AuthPasswordResetRequest.propInfo['meta'].required),
            });
