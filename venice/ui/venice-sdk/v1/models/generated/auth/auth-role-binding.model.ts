...
export class AuthRoleBinding extends BaseModel implements IAuthRoleBinding {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return AuthRoleBinding.propInfo;
    }
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        } else if (fillDefaults && AuthRoleBinding.hasDefaultValue('api-version')) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), AuthRoleBinding.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), AuthRoleBinding.propInfo['api-version']),
                'meta': CustomFormGroup(this['meta'].$formGroup, AuthRoleBinding.propInfo['meta'].required),
                'spec': CustomFormGroup(this['spec'].$formGroup, AuthRoleBinding.propInfo['spec'].required),
                'status': CustomFormGroup(this['status'].$formGroup, AuthRoleBinding.propInfo['status'].required),
            });
