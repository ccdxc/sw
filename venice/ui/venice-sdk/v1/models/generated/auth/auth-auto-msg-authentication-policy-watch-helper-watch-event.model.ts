    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), AuthAutoMsgAuthenticationPolicyWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, AuthAutoMsgAuthenticationPolicyWatchHelperWatchEvent.propInfo['object'].required),
            });
