...
export enum DiagnosticsModuleSpec_log_level {
    'info' = "info",
    'warn' = "warn",
    'error' = "error",
    'debug' = "debug",
...
export enum DiagnosticsModuleStatus_category {
    'venice' = "venice",
    'naples' = "naples",
}
...
export class AllEnums {
    ...
    DiagnosticsModuleSpec_log_level = DiagnosticsModuleSpec_log_level;
    DiagnosticsModuleStatus_category = DiagnosticsModuleStatus_category;
