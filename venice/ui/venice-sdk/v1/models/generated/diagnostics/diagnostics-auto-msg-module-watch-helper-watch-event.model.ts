...
export class DiagnosticsAutoMsgModuleWatchHelperWatchEvent extends BaseModel implements IDiagnosticsAutoMsgModuleWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo[prop] != null &&
                        DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    constructor(values?: any, setDefaults:boolean = true) {
        super();
        this['object'] = new DiagnosticsModule();
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, DiagnosticsAutoMsgModuleWatchHelperWatchEvent.propInfo['object'].required),
            });
