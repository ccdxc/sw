    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'packet-size': CustomFormControl(new FormControl(this['packet-size'], [minValueValidator(64), maxValueValidator(2048), ]), MonitoringMirrorSessionSpec.propInfo['packet-size']),
