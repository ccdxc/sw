...
export class MonitoringAutoMsgAlertWatchHelperWatchEvent extends BaseModel implements IMonitoringAutoMsgAlertWatchHelperWatchEvent {
    ...
    public static propInfo: { [prop in keyof IMonitoringAutoMsgAlertWatchHelperWatchEvent]: PropInfoItem } = {
        'type': {
            required: false,
            type: 'string'
        },
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return MonitoringAutoMsgAlertWatchHelperWatchEvent.propInfo;
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), MonitoringAutoMsgAlertWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, MonitoringAutoMsgAlertWatchHelperWatchEvent.propInfo['object'].required),
            });
