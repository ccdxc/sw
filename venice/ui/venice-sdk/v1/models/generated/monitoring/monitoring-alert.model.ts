...
export class MonitoringAlert extends BaseModel implements IMonitoringAlert {
    ...
    public static propInfo: { [prop in keyof IMonitoringAlert]: PropInfoItem } = {
        'kind': {
            required: false,
            type: 'string'
        },
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), MonitoringAlert.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), MonitoringAlert.propInfo['api-version']),
                'meta': CustomFormGroup(this['meta'].$formGroup, MonitoringAlert.propInfo['meta'].required),
                'spec': CustomFormGroup(this['spec'].$formGroup, MonitoringAlert.propInfo['spec'].required),
                'status': CustomFormGroup(this['status'].$formGroup, MonitoringAlert.propInfo['status'].required),
            });
