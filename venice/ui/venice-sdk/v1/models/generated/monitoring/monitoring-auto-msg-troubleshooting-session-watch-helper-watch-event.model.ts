    ...
    */
    public static hasDefaultValue(prop) {
        return (MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo[prop] != null &&
                        ...
                        MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo[prop].default != '');
    }
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo['type'].description),
