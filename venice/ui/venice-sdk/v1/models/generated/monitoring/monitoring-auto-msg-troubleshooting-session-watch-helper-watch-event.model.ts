...
export class MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent extends BaseModel implements IMonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent {
    ...
    */
    public static hasDefaultEnumValue(prop) {
        return (MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.enumProperties[prop] != null &&
                        MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.enumProperties[prop].default != null &&
                        MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.enumProperties[prop].default != '');
    }
