...
export class MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent extends BaseModel implements IMonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo[prop] != null &&
                        MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, MonitoringAutoMsgTroubleshootingSessionWatchHelperWatchEvent.propInfo['object'].required),
            });
