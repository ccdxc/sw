...
export class MonitoringStatsPolicyList extends BaseModel implements IMonitoringStatsPolicyList {
    ...
    */
    setValues(values: any): void {
        ...
        } else if (MonitoringStatsPolicyList.hasDefaultValue('kind')) {
            this['kind'] = MonitoringStatsPolicyList.propInfo['kind'].default;
        }
        if (values && values['api-version'] != null) {
            this['api-version'] = values['api-version'];
        } else if (MonitoringStatsPolicyList.hasDefaultValue('api-version')) {
            this['api-version'] = MonitoringStatsPolicyList.propInfo['api-version'].default;
        }
        if (values && values['resource-version'] != null) {
            this['resource-version'] = values['resource-version'];
        } else if (MonitoringStatsPolicyList.hasDefaultValue('resource-version')) {
            this['resource-version'] = MonitoringStatsPolicyList.propInfo['resource-version'].default;
        }
        if (values) {
