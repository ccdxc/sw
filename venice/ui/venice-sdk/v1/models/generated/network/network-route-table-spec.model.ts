...
export class NetworkRouteTableSpec extends BaseModel implements INetworkRouteTableSpec {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return NetworkRouteTableSpec.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return NetworkRouteTableSpec.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (NetworkRouteTableSpec.propInfo[prop] != null &&
                        NetworkRouteTableSpec.propInfo[prop].default != null);
    }
