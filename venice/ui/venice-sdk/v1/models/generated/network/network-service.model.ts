...
export class NetworkService extends BaseModel implements INetworkService {
    ...
    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return NetworkService.propInfo;
    }
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        } else if (fillDefaults && NetworkService.hasDefaultValue('kind')) {
        ...
        } else if (fillDefaults && NetworkService.hasDefaultValue('api-version')) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'kind': CustomFormControl(new FormControl(this['kind']), NetworkService.propInfo['kind']),
                'api-version': CustomFormControl(new FormControl(this['api-version']), NetworkService.propInfo['api-version']),
                'meta': CustomFormGroup(this['meta'].$formGroup, NetworkService.propInfo['meta'].required),
                'spec': CustomFormGroup(this['spec'].$formGroup, NetworkService.propInfo['spec'].required),
                'status': CustomFormGroup(this['status'].$formGroup, NetworkService.propInfo['status'].required),
            });
