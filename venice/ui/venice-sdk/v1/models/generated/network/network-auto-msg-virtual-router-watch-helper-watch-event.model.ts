...
export class NetworkAutoMsgVirtualRouterWatchHelperWatchEvent extends BaseModel implements INetworkAutoMsgVirtualRouterWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo[prop] != null &&
                        NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    constructor(values?: any, setDefaults:boolean = true) {
        super();
        this['object'] = new NetworkVirtualRouter();
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, NetworkAutoMsgVirtualRouterWatchHelperWatchEvent.propInfo['object'].required),
            });
