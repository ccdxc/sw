...
export class NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent extends BaseModel implements INetworkAutoMsgIPAMPolicyWatchHelperWatchEvent {
    ...
    public getPropInfo(propName: string): PropInfoItem {
        return NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo[propName];
    }

    public getPropInfoConfig(): { [key:string]:PropInfoItem } {
        return NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo;
    }
    ...
    */
    public static hasDefaultValue(prop) {
        return (NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo[prop] != null &&
                        NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo[prop].default != null);
    }
    ...
    */
    constructor(values?: any, setDefaults:boolean = true) {
        super();
        this['object'] = new NetworkIPAMPolicy();
    ...
    */
    setValues(values: any, fillDefaults = true): void {
        ...
        if (values && values['type'] != null) {
            ...
            this['type'] = NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo['type'].default;
        } else {
            this['type'] = null
        }
        if (values) {
    ...
    protected getFormGroup(): FormGroup {
        if (!this._formGroup) {
            this._formGroup = new FormGroup({
                'type': CustomFormControl(new FormControl(this['type']), NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo['type']),
                'object': CustomFormGroup(this['object'].$formGroup, NetworkAutoMsgIPAMPolicyWatchHelperWatchEvent.propInfo['object'].required),
            });
