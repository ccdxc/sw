...
type DatabaseReq struct {
	...
	ShardID         uint64 `protobuf:"varint,3,opt,name=ShardID" json:"ShardID,omitempty"`
	Database        string `protobuf:"bytes,4,opt,name=Database" json:"Database,omitempty"`
	RetentionPeriod uint64 `protobuf:"varint,5,opt,name=RetentionPeriod" json:"RetentionPeriod,omitempty"`
}
...
type DataNodeClient interface {
	...
	ExecuteAggQuery(ctx context.Context, in *QueryReq, opts ...grpc.CallOption) (*QueryResp, error)
	// key-value messages
...
func (c *dataNodeClient) ExecuteAggQuery(ctx context.Context, in *QueryReq, opts ...grpc.CallOption) (*QueryResp, error) {
	out := new(QueryResp)
	err := grpc.Invoke(ctx, "/tproto.DataNode/ExecuteAggQuery", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DataNodeServer interface {
	...
	ExecuteAggQuery(context.Context, *QueryReq) (*QueryResp, error)
	// key-value messages
...
func _DataNode_ExecuteAggQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataNodeServer).ExecuteAggQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tproto.DataNode/ExecuteAggQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataNodeServer).ExecuteAggQuery(ctx, req.(*QueryReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DataNode_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExecuteAggQuery",
			Handler:    _DataNode_ExecuteAggQuery_Handler,
		},
		{
			MethodName: "ReadReq",
...
var fileDescriptor0 = []byte{
	...
	,
}
