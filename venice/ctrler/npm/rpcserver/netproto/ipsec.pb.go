...
type IPSecSAEncryptSpec struct {
	...
	TepNS string `protobuf:"bytes,9,opt,name=TepNS,proto3" json:"tep-namespace,omitempty"`
}
...
func (m *IPSecSAEncryptSpec) GetTepNS() string {
	if m != nil {
		return m.TepNS
	}
	return ""
...
type IPSecSADecryptSpec struct {
	...
	// SPI information
	SPI uint32 `protobuf:"varint,11,opt,name=SPI,proto3" json:"spi,omitempty"`
	// TepNS holds the namespace that holds outer IP for the tunnel
	TepNS string `protobuf:"bytes,12,opt,name=TepNS,proto3" json:"tep-namespace,omitempty"`
}
...
func (m *IPSecSADecryptSpec) GetTepNS() string {
	if m != nil {
		return m.TepNS
	}
	return ""
...
func (m *IPSecSAEncryptSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TepNS) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(len(m.TepNS)))
		i += copy(dAtA[i:], m.TepNS)
	}
	return i, nil
}
...
func (m *IPSecSAEncryptSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TepNS", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TepNS = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipIpsec(dAtA[iNdEx:])
...
var fileDescriptorIpsec = []byte{
	...
	,
}
