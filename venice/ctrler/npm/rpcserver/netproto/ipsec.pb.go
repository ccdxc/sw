...
type IPSecSAEncryptSpec struct {
	// Name of the IPSec SA Encrypt Request
...
func (m *IPSecSAEncryptSpec) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
type IPSecSADecryptSpec struct {
	// Name of the IPSec SA Decrypt Request
	Name string `protobuf:"bytes,1,opt,name=Name,proto3" json:"name, omitempty"`
	// SA Decrypt protocol
	Protocol string `protobuf:"bytes,2,opt,name=Protocol,proto3" json:"protocol,omitempty"`
...
func (m *IPSecSADecryptSpec) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *IPSecSAEncryptSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(len(m.Name)))
...
var fileDescriptorIpsec = []byte{
	...
	,
}
