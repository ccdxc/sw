...
import monitoring2 "github.com/pensando/sw/api/generated/monitoring"
...
type FwlogPolicySpec struct {
	...
	// fwlog exports
	Exports []*monitoring2.FwlogExport `protobuf:"bytes,2,rep,name=Exports" json:"exports,omitempty"`
}
...
func (m *FwlogPolicySpec) GetExports() []*monitoring2.FwlogExport {
	if m != nil {
		return m.Exports
	}
	return nil
...
type FlowExportPolicySpec struct {
	Targets []monitoring2.FlowExportTarget `protobuf:"bytes,1,rep,name=Targets" json:"targets,omitempty"`
}
...
func (m *FlowExportPolicySpec) GetTargets() []monitoring2.FlowExportTarget {
	if m != nil {
		return m.Targets
	}
	return nil
...
func (m *FwlogPolicySpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Exports = append(m.Exports, &monitoring2.FwlogExport{})
...
func (m *FlowExportPolicySpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Targets = append(m.Targets, monitoring2.FlowExportTarget{})
