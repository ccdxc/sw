...
type CertMgrBundle struct {
	...
	CaTrustChain []*certapi.Certificate `protobuf:"bytes,2,rep,name=caTrustChain" json:"caTrustChain,omitempty"`
	TrustRoots   []*certapi.Certificate `protobuf:"bytes,3,rep,name=trustRoots" json:"trustRoots,omitempty"`
}
...
func (m *CertMgrBundle) GetCaTrustChain() []*certapi.Certificate {
	if m != nil {
...
func (m *CertMgrBundle) GetTrustRoots() []*certapi.Certificate {
	if m != nil {
		return m.TrustRoots
	}
	return nil
...
func (m *CertMgrBundle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.CaTrustChain = append(m.CaTrustChain, &certapi.Certificate{})
		...
		case 3:
			...
			m.TrustRoots = append(m.TrustRoots, &certapi.Certificate{})
...
var fileDescriptorCluster = []byte{
	...
	,
}
