...
const (
	...
	ModuleSpec_Job ModuleSpec_ModuleType = 4
)
...
type ModuleSpec_Submodule struct {
	...
	LivenessProbe *ModuleSpec_Submodule_Probe `protobuf:"bytes,8,opt,name=LivenessProbe" json:"LivenessProbe,omitempty"`
}
...
func (m *ModuleSpec_Submodule) GetLivenessProbe() *ModuleSpec_Submodule_Probe {
	if m != nil {
...
type ModuleSpec_Submodule_TCPSocketAction struct {
	// Port on the Host to probe.
	Port string `protobuf:"bytes,1,opt,name=Port,proto3" json:"Port,omitempty"`
}

func (m *ModuleSpec_Submodule_TCPSocketAction) Reset()         { *m = ModuleSpec_Submodule_TCPSocketAction{} }
func (m *ModuleSpec_Submodule_TCPSocketAction) String() string { return proto.CompactTextString(m) }
func (*ModuleSpec_Submodule_TCPSocketAction) ProtoMessage()    {}
func (*ModuleSpec_Submodule_TCPSocketAction) Descriptor() ([]byte, []int) {
	return fileDescriptorModule, []int{0, 0, 2}
}

func (m *ModuleSpec_Submodule_TCPSocketAction) GetPort() string {
	if m != nil {
		return m.Port
	}
	return ""
...
type ModuleSpec_Submodule_Handler struct {
	...
	TCPProbe *ModuleSpec_Submodule_TCPSocketAction `protobuf:"bytes,3,opt,name=TCPProbe" json:"TCPProbe,omitempty"`
}
...
func (m *ModuleSpec_Submodule_Handler) GetTCPProbe() *ModuleSpec_Submodule_TCPSocketAction {
	if m != nil {
		return m.TCPProbe
	}
	return nil
...
func (*ModuleSpec_Submodule_Probe) Descriptor() ([]byte, []int) {
	return fileDescriptorModule, []int{0, 0, 5}
}
...
func init() {
	...
	proto.RegisterType((*ModuleSpec_Submodule_TCPSocketAction)(nil), "types.ModuleSpec.Submodule.TCPSocketAction")
...
func (m *ModuleSpec_Submodule) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LivenessProbe != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintModule(dAtA, i, uint64(m.LivenessProbe.Size()))
...
func (m *ModuleSpec_Submodule_TCPSocketAction) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ModuleSpec_Submodule_TCPSocketAction) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Port) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintModule(dAtA, i, uint64(len(m.Port)))
...
func (m *ModuleSpec_Submodule_Handler) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TCPProbe != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintModule(dAtA, i, uint64(m.TCPProbe.Size()))
		n5, err := m.TCPProbe.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *ModuleSpec_Submodule_Probe) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Handler != nil {
		...
		n6, err := m.Handler.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *ModuleSpec_Submodule_TCPSocketAction) Size() (n int) {
	var l int
	_ = l
	l = len(m.Port)
	if l > 0 {
...
func (m *ModuleSpec_Submodule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.LivenessProbe == nil {
				m.LivenessProbe = &ModuleSpec_Submodule_Probe{}
			}
...
func (m *ModuleSpec_Submodule_TCPSocketAction) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ModuleSpec_Submodule_Handler) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TCPProbe", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TCPProbe == nil {
				m.TCPProbe = &ModuleSpec_Submodule_TCPSocketAction{}
			}
			if err := m.TCPProbe.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorModule = []byte{
	...
	,
}
