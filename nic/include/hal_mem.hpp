...
typedef enum hal_slab_e {
    ...
    HAL_SLAB_PI_MAX                          = 119,  // NOTE: MUST be last PI slab id
    ...
    HAL_SLAB_PD_MAX                          = 1045,   // NOTE: MUST be last PD slab id
    HAL_SLAB_RSVD                            = 1046,   // all non-delay delete slabs can use this
    HAL_SLAB_MAX                             = 1047,
