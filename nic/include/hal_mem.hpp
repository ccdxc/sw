...
typedef enum hal_slab_e {
    ...
    HAL_SLAB_PI_MAX                      = 61,  // NOTE: MUST be last PI slab id

    // PD Slabs
    HAL_SLAB_PD_MIN                      = 62,
    HAL_SLAB_VRF_PD = HAL_SLAB_PD_MIN,
    HAL_SLAB_L2SEG_PD                    = 63,
    HAL_SLAB_MC_ENTRY_PD                 = 64,
    HAL_SLAB_LIF_PD                      = 65,
    HAL_SLAB_UPLINKIF_PD                 = 66,
    HAL_SLAB_UPLINKPC_PD                 = 67,
    HAL_SLAB_ENICIF_PD                   = 68,
    HAL_SLAB_IF_L2SEG_PD                 = 69,
    HAL_SLAB_TUNNELIF_PD                 = 70,
    HAL_SLAB_CPUIF_PD                    = 71,
    HAL_SLAB_DOS_POLICY_PD               = 72,
    HAL_SLAB_SECURITY_PROFILE_PD         = 73,
    HAL_SLAB_EP_PD                       = 74,
    HAL_SLAB_EP_IP_ENTRY_PD              = 75,
    HAL_SLAB_SESSION_PD                  = 76,
    HAL_SLAB_TLSCB_PD                    = 77,
    HAL_SLAB_TCPCB_PD                    = 78,
    HAL_SLAB_QOS_CLASS_PD                = 79,
    HAL_SLAB_ACL_PD                      = 80,
    HAL_SLAB_WRING_PD                    = 81,
    HAL_SLAB_IPSECCB_PD                  = 82,
    HAL_SLAB_IPSECCB_DECRYPT_PD          = 83,
    HAL_SLAB_L4LB_PD                     = 84,
    HAL_SLAB_RW_PD                       = 85,
    HAL_SLAB_TUNNEL_RW_PD                = 86,
    HAL_SLAB_CPUCB_PD                    = 87,
    HAL_SLAB_CPUPKT_PD                   = 88,
    HAL_SLAB_RAWRCB_PD                   = 89,
    HAL_SLAB_RAWCCB_PD                   = 90,
    HAL_SLAB_PROXYRCB_PD                 = 91,
    HAL_SLAB_PROXYCCB_PD                 = 92,
    HAL_SLAB_CPUPKT_QINST_INFO_PD        = 93,
    HAL_SLAB_DIRECTMAP_ENTRY             = 94,
    HAL_SLAB_DIRECTMAP_DATA              = 95,
    HAL_SLAB_PORT_PD                     = 96,
    HAL_SLAB_COPP_PD                     = 97,
    HAL_SLAB_PD_MAX                      = 98,   // NOTE: MUST be last PD slab id
    HAL_SLAB_RSVD                        = 99,  // all non-delay delete slabs can use this
    HAL_SLAB_MAX                         = 100,
