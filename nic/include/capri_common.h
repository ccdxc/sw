...
#define CAPRI_SEM_IPSEC_RNMDR_ALLOC_ADDR          (CAPRI_MEM_SEMA_START + 8 * 20)
#define CAPRI_SEM_IPSEC_RNMDR_FREE_ADDR           (CAPRI_MEM_SEMA_START + 8 * 21)
#define CAPRI_SEM_IPSEC_RNMPR_ALLOC_ADDR          (CAPRI_MEM_SEMA_START + 8 * 22)
#define CAPRI_SEM_IPSEC_RNMPR_FREE_ADDR           (CAPRI_MEM_SEMA_START + 8 * 23)
#define CAPRI_SEM_IPSEC_TNMDR_ALLOC_ADDR          (CAPRI_MEM_SEMA_START + 8 * 24)
#define CAPRI_SEM_IPSEC_TNMDR_FREE_ADDR           (CAPRI_MEM_SEMA_START + 8 * 25)
#define CAPRI_SEM_IPSEC_TNMPR_ALLOC_ADDR          (CAPRI_MEM_SEMA_START + 8 * 26)
#define CAPRI_SEM_IPSEC_TNMPR_FREE_ADDR           (CAPRI_MEM_SEMA_START + 8 * 27)
