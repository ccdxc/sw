...
struct phv_                             p;
struct s4_tbl_k                         k;
struct s4_tbl_session_round2_session0_d d;
 ...
 */
#define SESSION_ROUND2_EXEC_e(_expiry_bit, _next_tbl, _next_round,              \
...
_inner_label2:;                                                                 \
    ...
    SESSION_EXPIRY_CHECK_KIVEC4_e(_expiry_bit)                                  \

    
%%
    .param          session_round3_session0
    .param          session_round3_session1
    .param          session_round3_session2
    .param          session_round3_session3
    .param          session_summarize
     SESSION_METRICS_PARAMS()
    .align

session_round2_session0:
    //CLEAR_TABLE0
    SESSION_KIVEC_AGE_TMO_PROPAGATE(5, 4)  
    SESSION_ROUND2_EXEC_e(round2_session0, 0, SESSION_ROUND3,
                          session_round3_session0, _session0_label0,
                          _session0_label1, _session0_label2,
                          SESSION_NO_MORE_SESSION0_ALT())

    .align

session_round2_session1:
    CLEAR_TABLE1
    SESSION_ROUND2_EXEC_e(round2_session1, 1, SESSION_ROUND3,
                          session_round3_session1, _session1_label0,
...
session_round2_session2:
    CLEAR_TABLE2
    SESSION_ROUND2_EXEC_e(round2_session2, 2, SESSION_ROUND3,
                          session_round3_session2, _session2_label0,
                          _session2_label1, _session2_label2,
                          SESSION_NO_MORE_SESSION1_2_ALT())
                                  
    .align

session_round2_session3:
    //CLEAR_TABLE3
    SESSION_ROUND2_EXEC_e(round2_session3, 3, SESSION_ROUND3,
                          session_round3_session3, _session3_label0,
