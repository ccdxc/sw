...
req_tx_sqwqe_base_sge_process:
    ...
    // sge_p[0]
    add            r1, r0, (TXWQE_SGE_OFFSET_BITS - (1 << LOG_SIZEOF_SGE_T_BITS))
...
sge_loop:
    ...
    sub            r1, (TXWQE_SGE_OFFSET_BITS - (1 << LOG_SIZEOF_SGE_T_BITS)), r1
    srl            r1, r1, LOG_SIZEOF_SGE_T_BITS
    seq            c1, r1, d.base.num_sges
    ...
    add            r6, K_CURRENT_SGE_ID, d.base.num_sges // Branch Delay Slot
    ...
    phvwr     CAPRI_PHV_FIELD(SQCB_WRITE_BACK_P, first), 1
...
sge_recirc:
    ...
    phvwrpair CAPRI_PHV_FIELD(WQE_TO_SGE_P, in_progress), CAPRI_KEY_FIELD(IN_P, in_progress), \
              CAPRI_PHV_FIELD(WQE_TO_SGE_P, ah_handle), d.ud_send.ah_handle
