...
req_tx_sqlkey_process:
     ...
     sll          r1, k.args.key_id, LOG_SIZEOF_KEY_ENTRY_T_BITS

     // r2 = lkey_p->acc_trl
     tblrdp       r2, r1, offsetof(KEY_ENTRY_T, acc_ctrl), sizeof(KEY_ENTRY_T.acc_ctrl)
     ...
     add          r4, k.args.log_page_size, LOG_HBM_NUM_PT_ENTRIES_PER_CACHELINE
...
pt_unaligned_access:
     ...
     add          r4, k.args.log_page_size, r0
     srlv.c1      r2, r2, r4
...
pt_aligned_access:
     ...
     CAPRI_SET_FIELD(r7, INFO_OUT_T, log_page_size, k.args.log_page_size)

     CAPRI_GET_TABLE_I_K(req_tx_phv_t, r2, r7)
     CAPRI_NEXT_TABLE_I_READ(r7, CAPRI_TABLE_LOCK_DIS, CAPRI_TABLE_SIZE_512_BITS, req_tx_sqptseg_process, r3)
