...
resp_tx_rqcb1_dcqcn_rate_process:
    ...
    CAPRI_NEXT_TABLE0_READ_PC(CAPRI_TABLE_LOCK_EN, CAPRI_TABLE_SIZE_0_BITS, resp_tx_dcqcn_rate_process, DCQCN_CB_ADDR)
    nop.e
    nop

timer_event:
    // Load dcqcn_cb MPU only. HBM addr will be loaded from stage 3 to update timer params.
    CAPRI_NEXT_TABLE0_READ_PC(CAPRI_TABLE_LOCK_EN, CAPRI_TABLE_SIZE_0_BITS, resp_tx_dcqcn_timer_process, DCQCN_CB_ADDR)
