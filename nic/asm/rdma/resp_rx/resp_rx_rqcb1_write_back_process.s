...
resp_rx_rqcb1_write_back_process:
    ...
    bcf             [!c1], recirc
    crestore        [c3, c2], k.{args.incr_nxt_to_go_token_id...args.incr_c_index}, 0x3
    # c3 - incr_nxt_to_go_token_id, c2 - incr_c_index    
    tbladd.c3       d.nxt_to_go_token_id, 1
    tblmincri.c2    PROXY_RQ_C_INDEX, d.log_num_wqes, 1
    bbeq            k.global.flags.resp_rx._only, 1, skip_updates_for_only
    tblwr           d.in_progress, k.args.in_progress   //BD Slot

    // updates for multi-packet case
    tblwr       d.{current_sge_offset...current_sge_id}, k.{args.current_sge_offset...args.current_sge_id}
    crestore    [c3, c2], k.{args.update_wqe_ptr...args.update_num_sges}, 0x3
    #c3 - update_wqe_ptr
    #c2 - update_num_sges
    tblwr.c3    d.curr_wqe_ptr, k.args.curr_wqe_ptr;
    tblwr.c2    d.num_sges, k.args.num_sges
...
skip_updates_for_only:
    ...
    bbeq            k.global.flags.resp_rx._inv_rkey, 0, inv_rkey_mpu_only
    KT_BASE_ADDR_GET(KT_BASE_ADDR, TMP)
    add             TMP, r0, k.to_stage.s3.wb1.inv_r_key
