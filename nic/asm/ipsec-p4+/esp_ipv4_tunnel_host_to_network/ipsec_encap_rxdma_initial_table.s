...
ipsec_encap_rxdma_initial_table:
    ...
    phvwr p.ipsec_to_stage2_tail_desc_addr, d.tail_desc_addr
    ...
    phvwr p.ipsec_global_lif, k.p4_intr_global_lif
    phvwr p.ipsec_global_qtype, k.p4_rxdma_intr_qtype
    phvwr p.ipsec_global_qid, k.p4_rxdma_intr_qid
    phvwr p.ipsec_globa_frame_size, k.p4_intr_frame_size

    phvwri p.p42p4plus_hdr_table0_valid, 1
    phvwr p.common_te0_phv_table0_pc, allocate_input_desc_semaphore
    phvwri p.common_te0_phv_table0_raw_table_size, 4
    phvwri p.common_te0_phv_table0_lock_en, 0
    phvwri p.common_te0_phv_table0_addr, INDESC_SEMAPHORE_ADDR

    phvwri p.p42p4plus_hdr_table1_valid, 1
    phvwr p.common_te0_phv_table1_pc, allocate_output_desc_semaphore
    phvwri p.common_te0_phv_table1_raw_table_size, 4
    phvwr p.common_te0_phv_table1_lock_en, 0
    phvwr p.common_te0_phv_table1_addr, OUTDESC_SEMAPHORE_ADDR
  
    phvwri p.p42p4plus_hdr_table2_valid, 1
    phvwr p.common_te0_phv_table2_pc, allocate_input_page_semaphore
    phvwri p.common_te0_phv_table2_raw_table_size, 4
    phvwri p.common_te0_phv_table2_lock_en, 0
    phvwri p.common_te0_phv_table2_addr, INPAGE_SEMAPHORE_ADDR

    phvwri p.p42p4plus_hdr_table2_valid, 1
    phvwr p.common_te0_phv_table2_pc, allocate_output_page_semaphore
    phvwri p.common_te0_phv_table2_raw_table_size, 4
    phvwri p.common_te0_phv_table2_lock_en, 0
    phvwri p.common_te0_phv_table2_addr, OUTPAGE_SEMAPHORE_ADDR
    nop.e
