...
#define D(field)    d.{u.read_tx_virtq_avail_d.##field}
...
%%
    ...
    .param      virtio_tx_check_reqs_start

virtio_tx_read_virtq_avail_start:

    /* FIXME: Assumes little-endian for now */
    phvwr       p.to_s2_tx_virtq_avail_idx, D(idx).hx
...
virtio_tx_read_virtq_avail_done:
