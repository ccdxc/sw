...
eth_tx_interrupt:
  ...
  // DMA Interrupt
  DMA_CMD_PTR(_r_ptr, _r_flit, _r_index, r7)
  DMA_HBM_PHV2MEM(_r_ptr, c0, k.eth_tx_t0_s2s_intr_assert_addr, CAPRI_PHV_START_OFFSET(eth_tx_t0_s2s_intr_assert_data), CAPRI_PHV_END_OFFSET(eth_tx_t0_s2s_intr_assert_data), r7)
  DMA_CMD_NEXT(_r_flit, _r_index, c7)
