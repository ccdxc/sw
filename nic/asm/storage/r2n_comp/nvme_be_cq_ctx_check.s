...
%%
   .param	nvme_be_cq_entry_pop_start

nvme_be_cq_ctx_check_start:
   ...
   LOAD_TABLE_CBASE_IDX(d.base_addr, d.c_ndx, NVME_BE_CQ_ENTRY_SIZE, 
                        NVME_BE_CQ_ENTRY_SIZE, nvme_be_cq_entry_pop_start)
exit:
   nop.e
   nop
