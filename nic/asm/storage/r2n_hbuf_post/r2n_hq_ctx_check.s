...
%%
   .param	r2n_hq_entry_pop_start

r2n_hq_ctx_check_start:
   ...
   LOAD_TABLE_CBASE_IDX(d.base_addr, d.c_ndx, R2N_RX_BUF_POST_ENTRY_SIZE, 
                        R2N_RX_BUF_POST_ENTRY_SIZE, r2n_hq_entry_pop_start)
exit:
   nop.e
   nop
