...
#define RAWR_RNMDPR_RING_SHIFT              ASIC_CPU_RX_DPR_RING_SHIFT
#define RAWR_RNMDPR_PAGE_OFFSET             ASIC_CPU_RX_DPR_PAGE_OFFSET
#define RAWR_RNMDPR_PAGE_SIZE               ASIC_CPU_RX_DPR_OBJ_TOTAL_SIZE
