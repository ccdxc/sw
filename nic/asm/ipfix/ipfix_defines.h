...
#define IPFIX_STATS_NUM_EXPORTED_BYTES_OFFSET   0
#define IPFIX_STATS_NUM_EXPORTED_PACKET_OFFSET  8
#define IPFIX_STATS_NUM_RECORDS_NONIP_OFFSET    16
#define IPFIX_STATS_NUM_RECORDS_IPV4_OFFSET     24
#define IPFIX_STATS_NUM_RECORDS_IPV6_OFFSET     32
