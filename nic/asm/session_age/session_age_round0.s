...
struct phv_                             p;
struct s2_tbl_k                         k;
struct s2_tbl_age_round0_session0_d     d;
 ...
 */
#define AGE_EXPIRY_CHECK_KIVEC2_e(_expiry_bit)                                  \
    AGE_EXPIRY_CHECK_ALL_LKUP_TYPES_e(_expiry_bit,                              \
                                      AGE_KIVEC2_ICMP_AGE_MS,                   \
                                      AGE_KIVEC2_UDP_AGE_MS,                    \
                                      AGE_KIVEC2_TCP_AGE_MS,                    \
                                      AGE_KIVEC2_OTHER_AGE_MS)                  \
 ...
 */
#define AGE_SESSION_ROUND0_EXEC_e(_expiry_bit, _next_tbl, _next_round,          \
...
_inner_label2:;                                                                 \
    ...
    AGE_EXPIRY_CHECK_KIVEC2_e(_expiry_bit)                                      \


%%
    .param          age_round1_session0
    .param          age_round1_session1
    .param          age_round1_session2
    .param          age_round1_session3
    .param          age_summarize
     AGE_METRICS_PARAMS()
    .align
...
age_round0_session0:
    //CLEAR_TABLE0
    AGE_KIVEC_MAX_AGE_MS_PROPAGATE(3, 2)  
    AGE_SESSION_ROUND0_EXEC_e(round0_session0, 0, AGE_SESSION_ROUND1,
                              age_round1_session0, _session0_label0,
...
age_round0_session1:
    CLEAR_TABLE1
    AGE_SESSION_ROUND0_EXEC_e(round0_session1, 1, AGE_SESSION_ROUND1,
                              age_round1_session1,  _session1_label0,
...
age_round0_session2:
    CLEAR_TABLE2
    AGE_SESSION_ROUND0_EXEC_e(round0_session2, 2, AGE_SESSION_ROUND1,
                              age_round1_session2, _session2_label0,
...
age_round0_session3:
    //CLEAR_TABLE3
    AGE_SESSION_ROUND0_EXEC_e(round0_session3, 3, AGE_SESSION_ROUND1,
                              age_round1_session3, _session3_label0,
