hdr_transpositions:
    ...
    crestore        [c7-c1], d.hdr_transpositions_d.hdr3_bits[6:0], 0x3F
...
hdr_transpositions_layer1:
    ...
    phvwr.c5        p.ethernet_1_srcAddr, d.hdr_transpositions_d.ethernet_src
    phvwr.c6        p.ethernet_1_dstAddr, d.hdr_transpositions_d.ethernet_dst
    phvwr.c7        p.ethernet_1_etherType, d.hdr_transpositions_d.ethernet_type
    ...
    phvwrpair.c1    p.ctag_1_vid, d.hdr_transpositions_d.ctag, \
                        p.ctag_1_etherType, d.hdr_transpositions_d.ethernet_type
    phvwr.c2        p.ipv4_1_srcAddr, d.hdr_transpositions_d.ip_src
    phvwr.c3        p.ipv4_1_dstAddr, d.hdr_transpositions_d.ip_dst
    phvwr.c4        p.ipv4_1_diffserv, d.hdr_transpositions_d.ip_dscp
    phvwr.c5        p.ipv4_1_protocol, d.hdr_transpositions_d.ip_proto
    phvwr.c6        p.ipv4_1_ttl, d.hdr_transpositions_d.ip_ttl
    phvwr.c7        p.ipv6_1_srcAddr, d.hdr_transpositions_d.ip_src
    crestore        [c7-c1], d.hdr_transpositions_d.hdr1_bits[20:14], 0x3F
    phvwr.c1        p.ipv6_1_dstAddr, d.hdr_transpositions_d.ip_dst
    phvwr.c2        p.ipv6_1_trafficClass, d.hdr_transpositions_d.ip_dscp
    phvwr.c3        p.ipv6_1_nextHdr, d.hdr_transpositions_d.ip_proto
    jr              r7
    phvwr.c4        p.ipv6_1_hopLimit, d.hdr_transpositions_d.ip_ttl
...
hdr_transpositions_layer2:
    ...
    phvwr.c5        p.ethernet_2_srcAddr, d.hdr_transpositions_d.ethernet_src
    phvwr.c6        p.ethernet_2_dstAddr, d.hdr_transpositions_d.ethernet_dst
    phvwr.c7        p.ethernet_2_etherType, d.hdr_transpositions_d.ethernet_type
    ...
    phvwrpair.c1    p.ctag_2_vid, d.hdr_transpositions_d.ctag, \
                        p.ctag_2_etherType, d.hdr_transpositions_d.ethernet_type
    phvwr.c2        p.ipv4_2_srcAddr, d.hdr_transpositions_d.ip_src
    phvwr.c3        p.ipv4_2_dstAddr, d.hdr_transpositions_d.ip_dst
    phvwr.c4        p.ipv4_2_diffserv, d.hdr_transpositions_d.ip_dscp
    phvwr.c5        p.ipv4_2_protocol, d.hdr_transpositions_d.ip_proto
    phvwr.c6        p.ipv4_2_ttl, d.hdr_transpositions_d.ip_ttl
    phvwr.c7        p.ipv6_2_srcAddr, d.hdr_transpositions_d.ip_src
    crestore        [c7-c1], d.hdr_transpositions_d.hdr2_bits[20:14], 0x3F
    phvwr.c1        p.ipv6_2_dstAddr, d.hdr_transpositions_d.ip_dst
    phvwr.c2        p.ipv6_2_trafficClass, d.hdr_transpositions_d.ip_dscp
    phvwr.c3        p.ipv6_2_nextHdr, d.hdr_transpositions_d.ip_proto
    jr              r7
    phvwr.c4        p.ipv6_2_hopLimit, d.hdr_transpositions_d.ip_ttl
...
hdr_transpositions_layer3:
    ...
    phvwr.c5        p.ethernet_3_srcAddr, d.hdr_transpositions_d.ethernet_src
    phvwr.c6        p.ethernet_3_dstAddr, d.hdr_transpositions_d.ethernet_dst
    phvwr.c7        p.ethernet_3_etherType, d.hdr_transpositions_d.ethernet_type
    ...
    phvwrpair.c1    p.ctag_3_vid, d.hdr_transpositions_d.ctag, \
                        p.ctag_3_etherType, d.hdr_transpositions_d.ethernet_type
    phvwr.c2        p.ipv4_3_srcAddr, d.hdr_transpositions_d.ip_src
    phvwr.c3        p.ipv4_3_dstAddr, d.hdr_transpositions_d.ip_dst
    phvwr.c4        p.ipv4_3_diffserv, d.hdr_transpositions_d.ip_dscp
    phvwr.c5        p.ipv4_3_protocol, d.hdr_transpositions_d.ip_proto
    phvwr.c6        p.ipv4_3_ttl, d.hdr_transpositions_d.ip_ttl
    phvwr.c7        p.ipv6_3_srcAddr, d.hdr_transpositions_d.ip_src
    crestore        [c7-c1], d.hdr_transpositions_d.hdr3_bits[20:14], 0x3F
    phvwr.c1        p.ipv6_3_dstAddr, d.hdr_transpositions_d.ip_dst
    phvwr.c2        p.ipv6_3_trafficClass, d.hdr_transpositions_d.ip_dscp
    phvwr.c3        p.ipv6_3_nextHdr, d.hdr_transpositions_d.ip_proto
    jr              r7
    phvwr.c4        p.ipv6_3_hopLimit, d.hdr_transpositions_d.ip_ttl
