...
tx_hdr_transpositions_layer1:
    bcf             [!c1&!c2&!c3&!c4&!c5&!c6&!c7], tx_hdr_transpositions_layer1_next
...
tx_hdr_transpositions_layer1_next:
    ...
    bbeq            k.ipv4_1_valid, TRUE, tx_hdr_transpositions_layer1_ipv4
    bbeq            k.ipv6_1_valid, TRUE, tx_hdr_transpositions_layer1_ipv6
    nop
    nop.e
    nop

tx_hdr_transpositions_layer1_ipv4:
...
tx_hdr_transpositions_layer1_ipv6:
    phvwr.c2        p.ipv6_1_srcAddr, d.tx_hdr_transpositions_d.ip_src
    phvwr.c3        p.ipv6_1_dstAddr, d.tx_hdr_transpositions_d.ip_dst
    phvwr.c4        p.ipv6_1_trafficClass, d.tx_hdr_transpositions_d.ip_dscp
    phvwr.c5        p.ipv6_1_nextHdr, d.tx_hdr_transpositions_d.ip_proto
    jr              r7
    phvwr.c6        p.ipv6_1_hopLimit, d.tx_hdr_transpositions_d.ip_ttl
