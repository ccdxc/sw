...
rx_key1:
    nop.!c1.e
    seq         c1, d.rx_key1_d.match_fields[MATCH_ETHERNET_DST_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ethernet_dst_1, k.ethernet_1_dstAddr
    seq         c1, d.rx_key1_d.match_fields[MATCH_ETHERNET_SRC_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ethernet_src_1, k.ethernet_1_srcAddr
    seq         c1, d.rx_key1_d.match_fields[MATCH_ETHERNET_TYPE_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ethernet_type_1, k.ethernet_1_etherType
    seq         c1, d.rx_key1_d.match_fields[MATCH_CUSTOMER_VLAN_ID_BIT_POS], 1
...
rx_key1_ipv4:
    seq         c1, d.rx_key1_d.match_fields[MATCH_IP_SRC_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_src_1, k.ipv4_1_srcAddr
    seq         c1, d.rx_key1_d.match_fields[MATCH_IP_DST_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_dst_1, k.ipv4_1_dstAddr
    seq         c1, d.rx_key1_d.match_fields[MATCH_IP_DSCP_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_dscp_1, k.ipv4_1_diffserv
    seq         c1, d.rx_key1_d.match_fields[MATCH_IP_PROTO_BIT_POS], 1
