...
rx_key2:
    nop.!c1.e
    seq         c1, d.rx_key2_d.match_fields[MATCH_ETHERNET_DST_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ethernet_dst_2, k.ethernet_2_dstAddr
    seq         c1, d.rx_key2_d.match_fields[MATCH_ETHERNET_SRC_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ethernet_src_2, k.ethernet_2_srcAddr
    seq         c1, d.rx_key2_d.match_fields[MATCH_ETHERNET_TYPE_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ethernet_type_2, k.ethernet_2_etherType
    seq         c1, d.rx_key2_d.match_fields[MATCH_CUSTOMER_VLAN_ID_BIT_POS], 1
...
rx_key2_ipv4:
    seq         c1, d.rx_key2_d.match_fields[MATCH_IP_SRC_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_src_2, k.ipv4_2_srcAddr
    seq         c1, d.rx_key2_d.match_fields[MATCH_IP_DST_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_dst_2, k.ipv4_2_dstAddr
    seq         c1, d.rx_key2_d.match_fields[MATCH_IP_DSCP_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_dscp_2, k.ipv4_2_diffserv
    seq         c1, d.rx_key2_d.match_fields[MATCH_IP_PROTO_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_proto_2, k.ipv4_2_protocol
    seq.e       c1, d.rx_key2_d.match_fields[MATCH_IP_TTL_BIT_POS], 1
...
rx_key2_ipv6:
    ...
    seq         c1, d.rx_key2_d.match_fields[MATCH_IP_DST_BIT_POS], 1
    phvwr.c1    p.flow_lkp_metadata_ip_dst_2[127:40], k.ipv6_2_dstAddr_sbit0_ebit87
    phvwr.c1    p.flow_lkp_metadata_ip_dst_2[39:0], k.ipv6_2_dstAddr_sbit88_ebit127
    seq         c1, d.rx_key2_d.match_fields[MATCH_IP_DSCP_BIT_POS], 1
