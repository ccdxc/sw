...
nacl_permit:
  ...
  seq         c5, d.u.nacl_permit_d.ingress_mirror_en, 1
  seq         c6, d.u.nacl_permit_d.egress_mirror_en, 1
  ...
  phvwr.c5    p.capri_intrinsic_tm_span_session, d.u.nacl_permit_d.ingress_mirror_session_id
  phvwr.e     p.copp_metadata_policer_index, d.u.nacl_permit_d.policer_index
  phvwr.c6    p.control_metadata_egress_mirror_session_id, d.u.nacl_permit_d.egress_mirror_session_id
