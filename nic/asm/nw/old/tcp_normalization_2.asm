...
// Please jump to line 144 - below code is deprecated.
smeqb  c1 k.ipv4_flags,IP_FLAGS_RSVD_MASK, 0x0
bcf c1 ip_res_action
nop
ip_res_action: 
    smeqb  c2 k.ip_res_action, 1, 0x0
    smeqb  c3 k.ip_res_action, 2, 0x0
   .csbegin
   cswitch[c3,c2]
   nop
   .cscase 0
   ...
   nop
   .cscase 2
   phvwr.e control_ipv4_normalization_cpu_reason,IP_NORMALIZATION_REASON_RSVD
   nop
   .cscase 3
   ...
   .csend 
ip_df_action_begin:
smeqb c1 k.ipv4_flags,IP_FLAGS_DF_MASK, 0x0
bcf c1 ip_df_action
nop
ip_df_action:
    smeqb  c2 k.ip_df_action, 1, 0x0
    smeqb  c3 k.ip_df_action, 2, 0x0
   .csbegin
   cswitch[c3,c2]
   nop
   .cscase 0
   b ipv4_options_drop_begin
   nop
   .cscase 1
   phvwr.e control_ip_normalization_drop,TRUE
   nop
   .cscase 2
   phvwr.e control_ipv4_normalization_cpu_reason,IP_NORMALIZATION_REASON_DF
   nop
   .cscase 3
   add r2,r0,k[ipv4_flags]
   andi r2,r2,5
   ...
   nop
   .csend 
ipv4_options_drop_begin:
add r2,r0,k[ipv4_hlen]
bgti r2,20, ipv4_options_drop:
nop
ipv4_options_drop:
    smeqb  c2 k.ip_df_action, 1, 0x0
    smeqb  c3 k.ip_df_action, 2, 0x0
...
// Actual code begins below - please ignore the code above.
