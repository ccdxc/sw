...
validate_tunneled_packet2_ipv6:
  ...
  or          r2, k.inner_ipv6_srcAddr_sbit32_ebit63, \
                  k.inner_ipv6_srcAddr_sbit0_ebit31, 32
  or          r3, k.inner_ipv6_srcAddr_sbit104_ebit127, \
                  k.inner_ipv6_srcAddr_sbit64_ebit103, 40
  seq         c2, r2, r0
  seq         c3, r3, r1
  andcf       c2, [c3]
