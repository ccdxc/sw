...
encap_inner_ipv6_udp_rewrite:
  phvwr       p.{inner_ipv6_version...inner_ipv6_flowLabel}, k.{ipv6_version...ipv6_flowLabel_sbit4_ebit19}
  phvwr       p.{inner_ipv6_payloadLen}, k.{ipv6_payloadLen}
  phvwr       p.{inner_ipv6_nextHdr...inner_ipv6_dstAddr}, k.{ipv6_nextHdr...ipv6_dstAddr}
  phvwr       p.{inner_udp_srcPort...inner_udp_checksum}, k.{udp_srcPort...udp_checksum}
