...
dma_cmd_ring_tcp_tx_doorbell:
    ...
    bcf         [c1], tcp_serq_produce
    phvwri      p.dma_cmd5_dma_cmd_addr, CAPRI_DOORBELL_ADDR(0,
                    DB_IDX_UPD_PIDX_INC, DB_SCHED_UPD_SET, 0, LIF_TCP)
    /* data will be in r3 */
    CAPRI_RING_DOORBELL_DATA(0, k.common_phv_fid, TCP_SCHED_RING_PENDING, 0)
...
tcp_serq_produce:
    ...
    nop
ring_doorbell:
    phvwri      p.dma_cmd6_dma_cmd_addr, CAPRI_DOORBELL_ADDR(0,
                    DB_IDX_UPD_PIDX_INC, DB_SCHED_UPD_SET, 0, LIF_TLS)
    /* data will be in r3 */
    CAPRI_RING_DOORBELL_DATA(0, k.common_phv_fid, 0, k.to_s6_xrq_pidx)
    phvwr       p.{db_data_pid...db_data_index}, r3.dx
    phvwri      p.dma_cmd6_dma_cmd_phv_start_addr, TCP_PHV_DB_DATA_START
    phvwri      p.dma_cmd6_dma_cmd_phv_end_addr, TCP_PHV_DB_DATA_END
