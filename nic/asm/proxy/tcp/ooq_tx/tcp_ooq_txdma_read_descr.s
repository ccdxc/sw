...
struct s2_t0_ooq_tcp_tx_read_descr_d d;

%%
    .align
tcp_ooq_txdma_read_descr:
    CAPRI_CLEAR_TABLE_VALID(0)
    CAPRI_OPERAND_DEBUG(k.common_te0_phv_table_addr)
    CAPRI_OPERAND_DEBUG(d.{A0}.dx)
    CAPRI_OPERAND_DEBUG(d.{O0}.wx)
    CAPRI_OPERAND_DEBUG(d.{L0}.wx)
...
tcp_ooq_txdma_dma_cmds:
    ...
    sub             r1, k.common_te0_phv_table_addr, \
                        (NIC_DESC_ENTRY_0_OFFSET - NIC_DESC_ENTRY_OOO_TCP_HDR_OFFSET)
