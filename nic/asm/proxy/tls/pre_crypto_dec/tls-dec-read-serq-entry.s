...
table_read_rx_serq_dec: 
	CAPRI_NEXT_TABLE0_READ(k.tls_global_phv_fid, TABLE_LOCK_EN, tls_dec_rx_serq_process,
...
table_read_TNMDR_ALLOC_IDX:
	...
	CAPRI_NEXT_IDX1_READ(TABLE_LOCK_DIS, tls_dec_alloc_tnmdr_process,
	                    r3, TABLE_SIZE_16_BITS)

table_read_TNMPR_ALLOC_IDX:
	addi 	r3, r0, TNMPR_ALLOC_IDX
	CAPRI_NEXT_IDX2_READ(TABLE_LOCK_DIS, tls_dec_alloc_tnmpr_process,
	                    r3, TABLE_SIZE_16_BITS)
