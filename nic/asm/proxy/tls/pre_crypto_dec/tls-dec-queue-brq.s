...
dma_cmd_dec_data_len:
    ...
    phvwri      p.dma_cmd1_dma_cmd_phv_start_addr, CAPRI_PHV_START_OFFSET(to_s6_cur_tls_data_len)
	phvwri		p.dma_cmd1_dma_cmd_phv_end_addr, CAPRI_PHV_END_OFFSET(to_s6_cur_tls_data_len)
...
dma_cmd_dec_odesc:
    ...
    phvwri      p.dma_cmd2_dma_cmd_phv_start_addr, CAPRI_PHV_START_OFFSET(odesc_A0)
	phvwri		p.dma_cmd2_dma_cmd_phv_end_addr, CAPRI_PHV_END_OFFSET(odesc_next_pkt)
...
dma_cmd_iv:
    ...
    phvwri      p.dma_cmd3_dma_cmd_phv_start_addr, CAPRI_PHV_START_OFFSET(crypto_iv_salt)
    phvwri      p.dma_cmd3_dma_cmd_phv_end_addr, CAPRI_PHV_END_OFFSET(crypto_iv_explicit_iv)
...
dma_cmd_idesc:
    ...
    phvwri      p.dma_cmd5_dma_cmd_phv_start_addr, CAPRI_PHV_START_OFFSET(idesc_A0)
	phvwri		p.dma_cmd5_dma_cmd_phv_end_addr, CAPRI_PHV_END_OFFSET(idesc_next_pkt)
...
dma_cmd_output_list_addr:
    ...
    phvwri      p.dma_cmd6_dma_cmd_phv_start_addr, CAPRI_PHV_START_OFFSET(odesc_dma_src_odesc)
	phvwri		p.dma_cmd6_dma_cmd_phv_end_addr, CAPRI_PHV_END_OFFSET(odesc_dma_src_odesc)
