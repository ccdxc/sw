...
#define NIC_BRQ_ENTRY_SIZE                   64
#define NIC_BRQ_ENTRY_SIZE_SHIFT             6          /* for 64B */
...
#define BARCO_SYM_CMD_CORE_HASH 1
#define BARCO_SYM_CMD_CORE_CHACHA 2
#define BARCO_SYM_CMD_CORE_AES_CBC 3

#define BARCO_SYM_CMD_KEYSIZE_AES128 0
#define BARCO_SYM_CMD_KEYSIZE_AES256 1

#define BARCO_SYM_CMD_MODE_GCM 0
#define BARCO_SYM_CMD_MODE_CCM 1
#define BARCO_SYM_CMD_MODE_CBC 2

#define BARCO_SYM_CMD_HASH_SHA256 0
#define BARCO_SYM_CMD_HASH_SHA1 1
#define BARCO_SYM_CMD_HASH_SHA384 2

#define BARCO_SYM_CMD_OP_ENCRYPT 0
#define BARCO_SYM_CMD_OP_DECRYPT 1
#define BARCO_SYM_CMD_OP_ENCRYPT_AEAD 2
#define BARCO_SYM_CMD_OP_DECRYPT_AEAD 3
#define BARCO_SYM_CMD_OP_HASH 4
#define BARCO_SYM_CMD_OP_HMAC 5
