...
rx_key2_ipv4:
    phvwr.c1    p.flow_lkp_metadata_ip_src_2, \
                    k.{ipv4_2_srcAddr_sbit0_ebit7...ipv4_2_srcAddr_sbit16_ebit31}
...
rx_key2_ipv6:
    phvwr.c1    p.flow_lkp_metadata_ip_src_2[127:72], \
                    k.{ipv6_2_srcAddr_sbit0_ebit15...ipv6_2_srcAddr_sbit48_ebit55}
    phvwr.c1    p.flow_lkp_metadata_ip_src_2[71:0], \
                    k.{ipv6_2_srcAddr_sbit56_ebit127}
