...
#ifndef __SVC_BATCH_HPP__
#define __SVC_BATCH_HPP__
...
public:
    Status BatchStart(ServerContext *context,
                      const tpc::BatchSpec *spec,
                      tpc::BatchStatus *status) override;
    Status BatchCommit(ServerContext *context,
                       const Empty *spec,
                       Empty *status) override;
    Status BatchAbort(ServerContext *context,
                      const Empty *spec,
                      Empty *status) override;
};

#endif    // __SVC_BATCH_HPP__
