...
var typesMapNetwork = map[string]*api.Struct{
	...
	"netproto.Network": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"eg-v4-sec-policies":  api.CLIInfo{Path: "Spec.EgV4SecurityPolicies", Skip: false, Insert: "", Help: ""},
			"eg-v6-sec-policies":  api.CLIInfo{Path: "Spec.EgV6SecurityPolicies", Skip: false, Insert: "", Help: ""},
			"generation-id":       api.CLIInfo{Path: "GenerationID", Skip: false, Insert: "", Help: ""},
			"ing-v4-sec-policies": api.CLIInfo{Path: "Spec.IngV4SecurityPolicies", Skip: false, Insert: "", Help: ""},
			"ing-v6-sec-policies": api.CLIInfo{Path: "Spec.IngV6SecurityPolicies", Skip: false, Insert: "", Help: ""},
	...
	"netproto.NetworkSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"IngV4SecurityPolicies": api.Field{Name: "IngV4SecurityPolicies", CLITag: api.CLIInfo{ID: "ing-v4-sec-policies", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "ing-v4-sec-policies", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"EgV4SecurityPolicies": api.Field{Name: "EgV4SecurityPolicies", CLITag: api.CLIInfo{ID: "eg-v4-sec-policies", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "eg-v4-sec-policies", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"IngV6SecurityPolicies": api.Field{Name: "IngV6SecurityPolicies", CLITag: api.CLIInfo{ID: "ing-v6-sec-policies", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "ing-v6-sec-policies", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"EgV6SecurityPolicies": api.Field{Name: "EgV6SecurityPolicies", CLITag: api.CLIInfo{ID: "eg-v6-sec-policies", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "eg-v6-sec-policies", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
