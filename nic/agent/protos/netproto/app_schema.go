...
var typesMapApp = map[string]*api.Struct{
	...
	"netproto.App": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"program-id":                  api.CLIInfo{Path: "Spec.ALG.MSRPC[].ProgramID", Skip: false, Insert: "", Help: ""},
			"program-id-timeout":          api.CLIInfo{Path: "Spec.ALG.MSRPC[].ProgramIDTimeout", Skip: false, Insert: "", Help: ""},
