...
func (cl *AgentClient) SecurityGroupList() ([]netproto.SecurityGroup, error) {
...
func (cl *AgentClient) SecurityGroupCreate(postData netproto.SecurityGroup) error {
	var resp Response
...
func (cl *AgentClient) SecurityGroupUpdate(putData netproto.SecurityGroup) error {
	var resp Response
...
func (cl *AgentClient) SecurityGroupDelete(deleteData netproto.SecurityGroup) error {
	var resp Response
