...
type NetworkSecurityPolicy struct {
	...
	NetworkSecurityPolicy *netproto5.NetworkSecurityPolicy `protobuf:"bytes,3,opt,name=NetworkSecurityPolicy" json:"NetworkSecurityPolicy,omitempty"`
}
...
func (*NetworkSecurityPolicy) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (m *NetworkSecurityPolicy) GetNetworkSecurityPolicy() *netproto5.NetworkSecurityPolicy {
	if m != nil {
...
func init() { proto.RegisterFile("delphi/sgpolicy.proto", fileDescriptor4) }
