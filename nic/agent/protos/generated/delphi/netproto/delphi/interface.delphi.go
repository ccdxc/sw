...
type Interface struct {
	...
	Interface *netproto7.Interface `protobuf:"bytes,3,opt,name=Interface" json:"Interface,omitempty"`
}
...
func (*Interface) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (m *Interface) GetInterface() *netproto7.Interface {
	if m != nil {
		return m.Interface
	}
	return nil
...
func init() { proto.RegisterFile("delphi/interface.proto", fileDescriptor6) }
