...
type Interface struct {
	...
	Interface *netproto8.Interface `protobuf:"bytes,3,opt,name=Interface" json:"Interface,omitempty"`
}
...
func (*Interface) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (m *Interface) GetInterface() *netproto8.Interface {
	if m != nil {
		return m.Interface
	}
	return nil
...
func init() { proto.RegisterFile("delphi/interface.proto", fileDescriptor7) }
