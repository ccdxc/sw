...
func (ms *MbusServer) ListRoutingConfigs(ctx context.Context, filterFn func(memdb.Object) bool) ([]*netproto.RoutingConfig, error) {
	var objlist []*netproto.RoutingConfig

	// walk all objects
	objs := ms.memDB.ListObjects("RoutingConfig", filterFn)
	for _, oo := range objs {
...
func (eh *RoutingConfigTopic) ListRoutingConfigs(ctx context.Context, objsel *api.ListWatchOptions) (*netproto.RoutingConfigList, error) {
	...
	if eh.statusReactor != nil {
		filterFn = eh.statusReactor.GetWatchFilter("RoutingConfig", objsel)
	}

	// walk all objects
	objs := eh.server.memDB.ListObjects("RoutingConfig", filterFn)
...
func (eh *RoutingConfigTopic) WatchRoutingConfigs(watchOptions *api.ListWatchOptions, stream netproto.RoutingConfigApiV1_WatchRoutingConfigsServer) error {
	...
	if eh.statusReactor != nil {
		watcher.Filter = eh.statusReactor.GetWatchFilter("RoutingConfig", watchOptions)
	} else {
