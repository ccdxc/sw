...
type FWEvent struct {
	...
	IflowBytes      uint64           `protobuf:"varint,30,opt,name=iflow_bytes,json=iflowBytes,proto3" json:"iflow_bytes,omitempty"`
	RflowBytes      uint64           `protobuf:"varint,31,opt,name=rflow_bytes,json=rflowBytes,proto3" json:"rflow_bytes,omitempty"`
...
func (m *FWEvent) GetIflowBytes() uint64 {
	if m != nil {
		return m.IflowBytes
	}
	return 0
...
func (m *FWEvent) GetRflowBytes() uint64 {
	if m != nil {
		return m.RflowBytes
	}
	return 0
...
func (m *FWEvent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IflowBytes != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintFwlog(dAtA, i, uint64(m.IflowBytes))
	}
	if m.RflowBytes != 0 {
		dAtA[i] = 0xf8
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintFwlog(dAtA, i, uint64(m.RflowBytes))
	}
	if m.AppId != 0 {
		dAtA[i] = 0x80
		i++
...
func (m *FWEvent) Size() (n int) {
	...
	if m.IflowBytes != 0 {
		n += 2 + sovFwlog(uint64(m.IflowBytes))
	}
	if m.RflowBytes != 0 {
		n += 2 + sovFwlog(uint64(m.RflowBytes))
	}
	if m.AppId != 0 {
...
var fileDescriptorFwlog = []byte{
	...
	,
}
