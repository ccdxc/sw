...
type FlowLog struct {
	...
	SrcNATIP *IPAddress `protobuf:"bytes,6,opt,name=SrcNATIP" json:"SrcNATIP,omitempty"`
	// source NAT port, if any
	SrcNATPort uint32 `protobuf:"varint,7,opt,name=SrcNATPort,proto3" json:"SrcNATPort,omitempty"`
	// NAT-ed destination IP after the rewrite, if any
	DstNATIP *IPAddress `protobuf:"bytes,8,opt,name=DstNATIP" json:"DstNATIP,omitempty"`
	...
	IflowBytes uint64 `protobuf:"varint,12,opt,name=IflowBytes,proto3" json:"IflowBytes,omitempty"`
	// initator flow packet count
	IflowPackets uint64 `protobuf:"varint,13,opt,name=IflowPackets,proto3" json:"IflowPackets,omitempty"`
	// responder flow octet count
	RflowBytes uint64 `protobuf:"varint,14,opt,name=RflowBytes,proto3" json:"RflowBytes,omitempty"`
	// responder flow packet count
	RflowPackets uint64 `protobuf:"varint,15,opt,name=RflowPackets,proto3" json:"RflowPackets,omitempty"`
}
...
var fileDescriptorOper = []byte{
	...
	,
}
