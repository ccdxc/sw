...
type PortSpec struct {
	...
	AdminState PortAdminState `protobuf:"varint,2,opt,name=AdminState,proto3,enum=pds.PortAdminState" json:"AdminState,omitempty" meta:mandatory`
	// port speed
	Speed PortSpeed `protobuf:"varint,3,opt,name=Speed,proto3,enum=pds.PortSpeed" json:"Speed,omitempty"`
	// FEC type
	FECType PortFecType `protobuf:"varint,4,opt,name=FECType,proto3,enum=pds.PortFecType" json:"FECType,omitempty"`
	// enable/disable auto negotiation feature
	AutoNegEn bool `protobuf:"varint,5,opt,name=AutoNegEn,proto3" json:"AutoNegEn,omitempty"`
	// link debounce timeout in msec (default = 0 ms)
	DeBounceTimeout uint32 `protobuf:"varint,6,opt,name=DeBounceTimeout,proto3" json:"DeBounceTimeout,omitempty"`
	// MTU size in bytes
	Mtu uint32 `protobuf:"varint,7,opt,name=Mtu,proto3" json:"Mtu,omitempty"`
	// Pause type (pfc or link level)
	PauseType PortPauseType `protobuf:"varint,8,opt,name=PauseType,proto3,enum=pds.PortPauseType" json:"PauseType,omitempty"`
	// Port loopback mode - MAC/PHY
	LoopbackMode PortLoopBackMode `protobuf:"varint,9,opt,name=LoopbackMode,proto3,enum=pds.PortLoopBackMode" json:"LoopbackMode,omitempty"`
	// Number of lanes for port
	NumLanes uint32 `protobuf:"varint,10,opt,name=NumLanes,proto3" json:"NumLanes,omitempty"`
}
...
type PortStatus struct {
	LinkStatus *PortLinkStatus `protobuf:"bytes,1,opt,name=LinkStatus" json:"LinkStatus,omitempty"`
	XcvrStatus *PortXcvrStatus `protobuf:"bytes,2,opt,name=XcvrStatus" json:"XcvrStatus,omitempty"`
}
...
func (m *PortGetRequest) GetId() []uint32 {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *PortSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintPort(dAtA, i, uint64(m.Id))
	}
	if m.AdminState != 0 {
		dAtA[i] = 0x10
		i++
...
var fileDescriptorPort = []byte{
	...
	,
}
