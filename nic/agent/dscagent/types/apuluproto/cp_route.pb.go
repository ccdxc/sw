...
type CPRouteRedistStatus struct {
	...
	AddrFilter *IPAddress `protobuf:"bytes,4,opt,name=AddrFilter" json:"AddrFilter,omitempty"`
}
...
type CPRouteRedistKeyHandle struct {
	Key *CPRouteRedistKey `protobuf:"bytes,1,opt,name=Key" json:"Key,omitempty"`
}
...
type CPRouteRedistGetRequest struct {
	Request []*CPRouteRedistKeyHandle `protobuf:"bytes,1,rep,name=Request" json:"Request,omitempty"`
}
...
type CPRouteRedist struct {
	Status *CPRouteRedistStatus `protobuf:"bytes,1,opt,name=Status" json:"Status,omitempty"`
}
...
type CPRouteRedistGetResponse struct {
	ApiStatus ApiStatus        `protobuf:"varint,1,opt,name=ApiStatus,proto3,enum=types.ApiStatus" json:"ApiStatus,omitempty"`
	Response  []*CPRouteRedist `protobuf:"bytes,2,rep,name=Response" json:"Response,omitempty"`
}
