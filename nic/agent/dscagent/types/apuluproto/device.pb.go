...
type DeviceStatus struct {
	...
	// Chip Type
	ChipType string `protobuf:"bytes,11,opt,name=ChipType,proto3" json:"ChipType,omitempty"`
	// Hardware Revision
...
func (m *DeviceStatus) GetChipType() string {
	if m != nil {
		return m.ChipType
	}
	return ""
...
func (m *DeviceStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ChipType) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintDevice(dAtA, i, uint64(len(m.ChipType)))
...
var fileDescriptorDevice = []byte{
	...
	,
}
