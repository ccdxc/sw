...
type SecurityProfileSpec struct {
	// Namespaces the security profile is attached to
	AttachNamespaces []string `protobuf:"bytes,1,rep,name=AttachNamespaces" json:"attach-namespaces,omitempty"`
...
func (m *SecurityProfileSpec) GetAttachNamespaces() []string {
	if m != nil {
		return m.AttachNamespaces
	}
	return nil
}
...
func (m *SecurityProfileSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AttachNamespaces) > 0 {
		for _, s := range m.AttachNamespaces {
			dAtA[i] = 0xa
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *SecurityProfileSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AttachNamespaces", wireType)
			}
			...
			m.AttachNamespaces = append(m.AttachNamespaces, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
var fileDescriptorSecprofile = []byte{
	...
	,
}
