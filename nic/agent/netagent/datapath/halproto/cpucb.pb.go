...
type CpuCbSpec struct {
	...
	AscqFreeRequests  uint64          `protobuf:"varint,8,opt,name=ascq_free_requests,json=ascqFreeRequests,proto3" json:"ascq_free_requests,omitempty"`
}
...
func (m *CpuCbSpec) GetAscqFreeRequests() uint64 {
	if m != nil {
		return m.AscqFreeRequests
	}
	return 0
}
...
func (m *CpuCbSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AscqFreeRequests != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintCpucb(dAtA, i, uint64(m.AscqFreeRequests))
	}
	return i, nil
}
...
func (m *CpuCbSpec) Size() (n int) {
	...
	if m.AscqFreeRequests != 0 {
		n += 1 + sovCpucb(uint64(m.AscqFreeRequests))
	}
	return n
}
...
func (m *CpuCbSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AscqFreeRequests", wireType)
			}
			m.AscqFreeRequests = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCpucb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AscqFreeRequests |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorCpucb = []byte{
	...
	,
}
