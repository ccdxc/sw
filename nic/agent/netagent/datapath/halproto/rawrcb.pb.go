...
type RawrCbSpec struct {
	...
	StatPktsRedir   uint64 `protobuf:"varint,18,opt,name=stat_pkts_redir,json=statPktsRedir,proto3" json:"stat_pkts_redir,omitempty"`
	...
	StatQstateCfgErr      uint32 `protobuf:"varint,21,opt,name=stat_qstate_cfg_err,json=statQstateCfgErr,proto3" json:"stat_qstate_cfg_err,omitempty"`
	StatPktLenErr         uint32 `protobuf:"varint,22,opt,name=stat_pkt_len_err,json=statPktLenErr,proto3" json:"stat_pkt_len_err,omitempty"`
	StatRxqFull           uint32 `protobuf:"varint,23,opt,name=stat_rxq_full,json=statRxqFull,proto3" json:"stat_rxq_full,omitempty"`
	StatTxqFull           uint32 `protobuf:"varint,24,opt,name=stat_txq_full,json=statTxqFull,proto3" json:"stat_txq_full,omitempty"`
	StatDescSemAllocFull  uint32 `protobuf:"varint,25,opt,name=stat_desc_sem_alloc_full,json=statDescSemAllocFull,proto3" json:"stat_desc_sem_alloc_full,omitempty"`
	StatMpageSemAllocFull uint32 `protobuf:"varint,26,opt,name=stat_mpage_sem_alloc_full,json=statMpageSemAllocFull,proto3" json:"stat_mpage_sem_alloc_full,omitempty"`
	StatPpageSemAllocFull uint32 `protobuf:"varint,27,opt,name=stat_ppage_sem_alloc_full,json=statPpageSemAllocFull,proto3" json:"stat_ppage_sem_alloc_full,omitempty"`
	StatSemFreeFull       uint32 `protobuf:"varint,28,opt,name=stat_sem_free_full,json=statSemFreeFull,proto3" json:"stat_sem_free_full,omitempty"`
}
...
func (m *RawrCbSpec) GetRedirSpan() uint32 {
	if m != nil {
		return m.RedirSpan
	}
	return 0
...
func (m *RawrCbSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RedirSpan != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintRawrcb(dAtA, i, uint64(m.RedirSpan))
	}
...
func (m *RawrCbSpec) Size() (n int) {
	...
	if m.RedirSpan != 0 {
		n += 2 + sovRawrcb(uint64(m.RedirSpan))
	}
	if m.StatPktsRedir != 0 {
...
var fileDescriptorRawrcb = []byte{
	...
	,
}
