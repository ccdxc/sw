...
type RawrCbSpec struct {
	...
	ChainRxqBase            uint32           `protobuf:"varint,4,opt,name=chain_rxq_base,json=chainRxqBase,proto3" json:"chain_rxq_base,omitempty"`
	ChainRxqRingIndicesAddr uint32           `protobuf:"varint,5,opt,name=chain_rxq_ring_indices_addr,json=chainRxqRingIndicesAddr,proto3" json:"chain_rxq_ring_indices_addr,omitempty"`
	...
	ChainTxqBase            uint32           `protobuf:"varint,9,opt,name=chain_txq_base,json=chainTxqBase,proto3" json:"chain_txq_base,omitempty"`
	ChainTxqRingIndicesAddr uint32           `protobuf:"varint,10,opt,name=chain_txq_ring_indices_addr,json=chainTxqRingIndicesAddr,proto3" json:"chain_txq_ring_indices_addr,omitempty"`
...
var fileDescriptorRawrcb = []byte{
	...
	,
}
