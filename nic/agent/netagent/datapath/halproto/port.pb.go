...
const (
	...
	PortSpeed_PORT_SPEED_40G  PortSpeed = 3
	PortSpeed_PORT_SPEED_50G  PortSpeed = 4
	PortSpeed_PORT_SPEED_100G PortSpeed = 5
)
...
type PortInfoSpec struct {
	...
	// key_or_handle is the port number
	KeyOrHandle *PortKeyHandle `protobuf:"bytes,2,opt,name=key_or_handle,json=keyOrHandle" json:"key_or_handle,omitempty" venice:key`
	PortSpeed   PortSpeed      `protobuf:"varint,3,opt,name=port_speed,json=portSpeed,proto3,enum=port.PortSpeed" json:"port_speed,omitempty"`
	MacId       uint32         `protobuf:"varint,4,opt,name=mac_id,json=macId,proto3" json:"mac_id,omitempty" venice:immutable`
	MacCh       uint32         `protobuf:"varint,5,opt,name=mac_ch,json=macCh,proto3" json:"mac_ch,omitempty" venice:immutable`
	NumLanes    uint32         `protobuf:"varint,6,opt,name=num_lanes,json=numLanes,proto3" json:"num_lanes,omitempty" venice:immutable`
}
...
func (m *PortInfoSpec) GetPortSpeed() PortSpeed {
	if m != nil {
		return m.PortSpeed
	}
	return PortSpeed_PORT_SPEED_NONE
...
func (m *PortInfoSpec) GetMacId() uint32 {
	if m != nil {
		return m.MacId
	}
	return 0
...
func (m *PortInfoSpec) GetMacCh() uint32 {
	if m != nil {
		return m.MacCh
	}
	return 0
...
var fileDescriptorPort = []byte{
	...
	,
}
