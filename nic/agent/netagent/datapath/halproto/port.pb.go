...
type PortInfoSpec struct {
	...
	BreakoutModes uint32         `protobuf:"varint,4,opt,name=breakout_modes,json=breakoutModes,proto3" json:"breakout_modes,omitempty"`
}
...
func (m *PortInfoSpec) GetBreakoutModes() uint32 {
	if m != nil {
...
func (m *PortInfoSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BreakoutModes != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintPort(dAtA, i, uint64(m.BreakoutModes))
	}
	return i, nil
}
...
func (m *PortInfoSpec) Size() (n int) {
	...
	if m.BreakoutModes != 0 {
		n += 1 + sovPort(uint64(m.BreakoutModes))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BreakoutModes |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorPort = []byte{
	...
	,
}
