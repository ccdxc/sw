...
type RuleMatch struct {
	...
	AppMatch      []*RuleMatch_AppMatchInfo `protobuf:"bytes,9,rep,name=app_match,json=appMatch" json:"app_match,omitempty"`
}
...
func (m *RuleMatch) GetAppMatch() []*RuleMatch_AppMatchInfo {
	if m != nil {
		return m.AppMatch
	}
	return nil
...
type RuleMatch_AppMatchInfo struct {
	// Types that are valid to be assigned to App:
	//	*RuleMatch_AppMatchInfo_PortInfo
	//	*RuleMatch_AppMatchInfo_IcmpInfo
	//	*RuleMatch_AppMatchInfo_Icmpv6Info
	//	*RuleMatch_AppMatchInfo_RpcInfo
	//	*RuleMatch_AppMatchInfo_MsrpcInfo
	//	*RuleMatch_AppMatchInfo_EspInfo
	App isRuleMatch_AppMatchInfo_App `protobuf_oneof:"App"`
}

func (m *RuleMatch_AppMatchInfo) Reset()                    { *m = RuleMatch_AppMatchInfo{} }
func (m *RuleMatch_AppMatchInfo) String() string            { return proto.CompactTextString(m) }
func (*RuleMatch_AppMatchInfo) ProtoMessage()               {}
func (*RuleMatch_AppMatchInfo) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{13, 6} }

type isRuleMatch_AppMatchInfo_App interface {
	isRuleMatch_AppMatchInfo_App()
	MarshalTo([]byte) (int, error)
	Size() int
}

type RuleMatch_AppMatchInfo_PortInfo struct {
	PortInfo *RuleMatch_L4PortAppInfo `protobuf:"bytes,1,opt,name=port_info,json=portInfo,oneof"`
}
type RuleMatch_AppMatchInfo_IcmpInfo struct {
	IcmpInfo *RuleMatch_ICMPAppInfo `protobuf:"bytes,2,opt,name=icmp_info,json=icmpInfo,oneof"`
}
type RuleMatch_AppMatchInfo_Icmpv6Info struct {
	Icmpv6Info *RuleMatch_ICMPv6AppInfo `protobuf:"bytes,3,opt,name=icmpv6_info,json=icmpv6Info,oneof"`
}
type RuleMatch_AppMatchInfo_RpcInfo struct {
	RpcInfo *RuleMatch_RPCAppInfo `protobuf:"bytes,4,opt,name=rpc_info,json=rpcInfo,oneof"`
}
type RuleMatch_AppMatchInfo_MsrpcInfo struct {
	MsrpcInfo *RuleMatch_MSRPCAppInfo `protobuf:"bytes,5,opt,name=msrpc_info,json=msrpcInfo,oneof"`
}
type RuleMatch_AppMatchInfo_EspInfo struct {
	EspInfo *RuleMatch_ESPInfo `protobuf:"bytes,6,opt,name=esp_info,json=espInfo,oneof"`
}

func (*RuleMatch_AppMatchInfo_PortInfo) isRuleMatch_AppMatchInfo_App()   {}
func (*RuleMatch_AppMatchInfo_IcmpInfo) isRuleMatch_AppMatchInfo_App()   {}
func (*RuleMatch_AppMatchInfo_Icmpv6Info) isRuleMatch_AppMatchInfo_App() {}
func (*RuleMatch_AppMatchInfo_RpcInfo) isRuleMatch_AppMatchInfo_App()    {}
func (*RuleMatch_AppMatchInfo_MsrpcInfo) isRuleMatch_AppMatchInfo_App()  {}
func (*RuleMatch_AppMatchInfo_EspInfo) isRuleMatch_AppMatchInfo_App()    {}

func (m *RuleMatch_AppMatchInfo) GetApp() isRuleMatch_AppMatchInfo_App {
	if m != nil {
		return m.App
	}
	return nil
...
func (m *RuleMatch_AppMatchInfo) GetPortInfo() *RuleMatch_L4PortAppInfo {
	if x, ok := m.GetApp().(*RuleMatch_AppMatchInfo_PortInfo); ok {
		return x.PortInfo
	}
	return nil
}

func (m *RuleMatch_AppMatchInfo) GetIcmpInfo() *RuleMatch_ICMPAppInfo {
	if x, ok := m.GetApp().(*RuleMatch_AppMatchInfo_IcmpInfo); ok {
		return x.IcmpInfo
	}
	return nil
}

func (m *RuleMatch_AppMatchInfo) GetIcmpv6Info() *RuleMatch_ICMPv6AppInfo {
	if x, ok := m.GetApp().(*RuleMatch_AppMatchInfo_Icmpv6Info); ok {
		return x.Icmpv6Info
	}
	return nil
}

func (m *RuleMatch_AppMatchInfo) GetRpcInfo() *RuleMatch_RPCAppInfo {
	if x, ok := m.GetApp().(*RuleMatch_AppMatchInfo_RpcInfo); ok {
		return x.RpcInfo
	}
	return nil
}

func (m *RuleMatch_AppMatchInfo) GetMsrpcInfo() *RuleMatch_MSRPCAppInfo {
	if x, ok := m.GetApp().(*RuleMatch_AppMatchInfo_MsrpcInfo); ok {
		return x.MsrpcInfo
	}
	return nil
}

func (m *RuleMatch_AppMatchInfo) GetEspInfo() *RuleMatch_ESPInfo {
	if x, ok := m.GetApp().(*RuleMatch_AppMatchInfo_EspInfo); ok {
		return x.EspInfo
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*RuleMatch_AppMatchInfo) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RuleMatch_AppMatchInfo_OneofMarshaler, _RuleMatch_AppMatchInfo_OneofUnmarshaler, _RuleMatch_AppMatchInfo_OneofSizer, []interface{}{
		(*RuleMatch_AppMatchInfo_PortInfo)(nil),
		(*RuleMatch_AppMatchInfo_IcmpInfo)(nil),
		(*RuleMatch_AppMatchInfo_Icmpv6Info)(nil),
		(*RuleMatch_AppMatchInfo_RpcInfo)(nil),
		(*RuleMatch_AppMatchInfo_MsrpcInfo)(nil),
		(*RuleMatch_AppMatchInfo_EspInfo)(nil),
	}
}

func _RuleMatch_AppMatchInfo_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*RuleMatch_AppMatchInfo)
	// App
	switch x := m.App.(type) {
	case *RuleMatch_AppMatchInfo_PortInfo:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.PortInfo); err != nil {
			return err
		}
	case *RuleMatch_AppMatchInfo_IcmpInfo:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.IcmpInfo); err != nil {
			return err
		}
	case *RuleMatch_AppMatchInfo_Icmpv6Info:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Icmpv6Info); err != nil {
			return err
		}
	case *RuleMatch_AppMatchInfo_RpcInfo:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RpcInfo); err != nil {
			return err
		}
	case *RuleMatch_AppMatchInfo_MsrpcInfo:
		_ = b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.MsrpcInfo); err != nil {
			return err
		}
	case *RuleMatch_AppMatchInfo_EspInfo:
	...
	case nil:
	default:
		return fmt.Errorf("RuleMatch_AppMatchInfo.App has unexpected type %T", x)
	}
	return nil
}

func _RuleMatch_AppMatchInfo_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*RuleMatch_AppMatchInfo)
	switch tag {
	case 1: // App.port_info
		...
		err := b.DecodeMessage(msg)
		m.App = &RuleMatch_AppMatchInfo_PortInfo{msg}
		return true, err
	case 2: // App.icmp_info
		...
		err := b.DecodeMessage(msg)
		m.App = &RuleMatch_AppMatchInfo_IcmpInfo{msg}
		return true, err
	case 3: // App.icmpv6_info
		...
		err := b.DecodeMessage(msg)
		m.App = &RuleMatch_AppMatchInfo_Icmpv6Info{msg}
		return true, err
	case 4: // App.rpc_info
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		err := b.DecodeMessage(msg)
		m.App = &RuleMatch_AppMatchInfo_RpcInfo{msg}
		return true, err
	case 5: // App.msrpc_info
		...
		err := b.DecodeMessage(msg)
		m.App = &RuleMatch_AppMatchInfo_MsrpcInfo{msg}
		return true, err
	case 6: // App.esp_info
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		err := b.DecodeMessage(msg)
		m.App = &RuleMatch_AppMatchInfo_EspInfo{msg}
		return true, err
	default:
		return false, nil
	}
...
func _RuleMatch_AppMatchInfo_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*RuleMatch_AppMatchInfo)
	// App
	switch x := m.App.(type) {
	case *RuleMatch_AppMatchInfo_PortInfo:
...
func init() {
	...
	proto.RegisterType((*RuleMatch_AppMatchInfo)(nil), "types.RuleMatch.AppMatchInfo")
...
func (m *RuleMatch_AppMatchInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RuleMatch_AppMatchInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.App != nil {
		nn20, err := m.App.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn20
...
func (m *RuleMatch_AppMatchInfo_PortInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.PortInfo != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.PortInfo.Size()))
		n21, err := m.PortInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *RuleMatch_AppMatchInfo_IcmpInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.IcmpInfo != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.IcmpInfo.Size()))
		n22, err := m.IcmpInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *RuleMatch_AppMatchInfo_Icmpv6Info) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Icmpv6Info != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.Icmpv6Info.Size()))
		n23, err := m.Icmpv6Info.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *RuleMatch_AppMatchInfo_RpcInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RpcInfo != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.RpcInfo.Size()))
		n24, err := m.RpcInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *RuleMatch_AppMatchInfo_MsrpcInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.MsrpcInfo != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.MsrpcInfo.Size()))
		n25, err := m.MsrpcInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *RuleMatch_AppMatchInfo_EspInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.EspInfo != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.EspInfo.Size()))
		n26, err := m.EspInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *RuleMatch_AppMatchInfo) Size() (n int) {
	var l int
	_ = l
	if m.App != nil {
		n += m.App.Size()
...
func (m *RuleMatch_AppMatchInfo_PortInfo) Size() (n int) {
	var l int
	_ = l
	if m.PortInfo != nil {
		l = m.PortInfo.Size()
...
func (m *RuleMatch_AppMatchInfo_IcmpInfo) Size() (n int) {
	var l int
	_ = l
	if m.IcmpInfo != nil {
		l = m.IcmpInfo.Size()
...
func (m *RuleMatch_AppMatchInfo_Icmpv6Info) Size() (n int) {
	var l int
	_ = l
	if m.Icmpv6Info != nil {
		l = m.Icmpv6Info.Size()
...
func (m *RuleMatch_AppMatchInfo_RpcInfo) Size() (n int) {
	var l int
	_ = l
	if m.RpcInfo != nil {
		l = m.RpcInfo.Size()
...
func (m *RuleMatch_AppMatchInfo_MsrpcInfo) Size() (n int) {
	var l int
	_ = l
	if m.MsrpcInfo != nil {
		l = m.MsrpcInfo.Size()
...
func (m *RuleMatch_AppMatchInfo_EspInfo) Size() (n int) {
	var l int
	_ = l
	if m.EspInfo != nil {
		l = m.EspInfo.Size()
...
func (m *RuleMatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.AppMatch = append(m.AppMatch, &RuleMatch_AppMatchInfo{})
			if err := m.AppMatch[len(m.AppMatch)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RuleMatch_AppMatchInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AppMatchInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AppMatchInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.App = &RuleMatch_AppMatchInfo_PortInfo{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.App = &RuleMatch_AppMatchInfo_IcmpInfo{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.App = &RuleMatch_AppMatchInfo_Icmpv6Info{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.App = &RuleMatch_AppMatchInfo_RpcInfo{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.App = &RuleMatch_AppMatchInfo_MsrpcInfo{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
			...
			m.App = &RuleMatch_AppMatchInfo_EspInfo{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
var fileDescriptorTypes = []byte{
	...
	,
}
