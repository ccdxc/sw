...
type L2SegmentStatusIris struct {
...
func (m *L2SegmentStatusIris) Reset()                    { *m = L2SegmentStatusIris{} }
func (m *L2SegmentStatusIris) String() string            { return proto.CompactTextString(m) }
func (*L2SegmentStatusIris) ProtoMessage()               {}
func (*L2SegmentStatusIris) Descriptor() ([]byte, []int) { return fileDescriptorL2Segment, []int{2} }

func (m *L2SegmentStatusIris) GetHwL2SegId() uint32 {
	if m != nil {
		return m.HwL2SegId
	}
	return 0
...
func (m *L2SegmentStatusIris) GetL2SegLookupId() uint32 {
	if m != nil {
...
func (m *L2SegmentStatusIris) GetL2SegVlanIdCpu() uint32 {
	if m != nil {
...
func (m *L2SegmentStatusIris) GetInpPropCpuIdx() uint32 {
	if m != nil {
...
func (m *L2SegmentStatusIris) GetInpPropIdx() []uint32 {
	if m != nil {
		return m.InpPropIdx
	}
	return nil
...
func (m *L2SegmentStatusIris) GetInpPropIdxPrTag() []uint32 {
	if m != nil {
...
type L2SegmentStatusGFT struct {
}

func (m *L2SegmentStatusGFT) Reset()                    { *m = L2SegmentStatusGFT{} }
func (m *L2SegmentStatusGFT) String() string            { return proto.CompactTextString(m) }
func (*L2SegmentStatusGFT) ProtoMessage()               {}
func (*L2SegmentStatusGFT) Descriptor() ([]byte, []int) { return fileDescriptorL2Segment, []int{3} }
...
type L2SegmentStatus struct {
	...
	//
	// Types that are valid to be assigned to L2SegInfo:
	//	*L2SegmentStatus_IrisInfo
	//	*L2SegmentStatus_GftInfo
	L2SegInfo isL2SegmentStatus_L2SegInfo `protobuf_oneof:"l2seg_info"`
}
...
type isL2SegmentStatus_L2SegInfo interface {
	isL2SegmentStatus_L2SegInfo()
	MarshalTo([]byte) (int, error)
	Size() int
}

type L2SegmentStatus_IrisInfo struct {
	IrisInfo *L2SegmentStatusIris `protobuf:"bytes,3,opt,name=iris_info,json=irisInfo,oneof"`
}
type L2SegmentStatus_GftInfo struct {
	GftInfo *L2SegmentStatusGFT `protobuf:"bytes,4,opt,name=gft_info,json=gftInfo,oneof"`
}

func (*L2SegmentStatus_IrisInfo) isL2SegmentStatus_L2SegInfo() {}
func (*L2SegmentStatus_GftInfo) isL2SegmentStatus_L2SegInfo()  {}

func (m *L2SegmentStatus) GetL2SegInfo() isL2SegmentStatus_L2SegInfo {
	if m != nil {
		return m.L2SegInfo
	}
	return nil
...
func (m *L2SegmentStatus) GetIrisInfo() *L2SegmentStatusIris {
	if x, ok := m.GetL2SegInfo().(*L2SegmentStatus_IrisInfo); ok {
		return x.IrisInfo
	}
	return nil
}

func (m *L2SegmentStatus) GetGftInfo() *L2SegmentStatusGFT {
	if x, ok := m.GetL2SegInfo().(*L2SegmentStatus_GftInfo); ok {
		return x.GftInfo
	}
	return nil
}
...
func (*L2SegmentStatus) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _L2SegmentStatus_OneofMarshaler, _L2SegmentStatus_OneofUnmarshaler, _L2SegmentStatus_OneofSizer, []interface{}{
		(*L2SegmentStatus_IrisInfo)(nil),
		(*L2SegmentStatus_GftInfo)(nil),
	}
}
...
func _L2SegmentStatus_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// l2seg_info
	switch x := m.L2SegInfo.(type) {
	case *L2SegmentStatus_IrisInfo:
		_ = b.EncodeVarint(3<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.IrisInfo); err != nil {
			return err
		}
	case *L2SegmentStatus_GftInfo:
	...
	case nil:
	default:
		return fmt.Errorf("L2SegmentStatus.L2SegInfo has unexpected type %T", x)
	}
	return nil
}
...
func _L2SegmentStatus_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*L2SegmentStatus)
	switch tag {
	case 3: // l2seg_info.iris_info
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(L2SegmentStatusIris)
		err := b.DecodeMessage(msg)
		m.L2SegInfo = &L2SegmentStatus_IrisInfo{msg}
		return true, err
	case 4: // l2seg_info.gft_info
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(L2SegmentStatusGFT)
		err := b.DecodeMessage(msg)
		m.L2SegInfo = &L2SegmentStatus_GftInfo{msg}
		return true, err
	default:
		return false, nil
	}
...
func init() {
	...
	proto.RegisterType((*L2SegmentStatusIris)(nil), "l2segment.L2segmentStatusIris")
	proto.RegisterType((*L2SegmentStatusGFT)(nil), "l2segment.L2segmentStatusGFT")
...
func (m *L2SegmentStatusIris) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *L2SegmentStatusIris) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *L2SegmentStatusGFT) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *L2SegmentStatusGFT) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *L2SegmentStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L2SegInfo != nil {
		nn12, err := m.L2SegInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn12
...
func (m *L2SegmentStatus_IrisInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.IrisInfo != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.IrisInfo.Size()))
		n13, err := m.IrisInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *L2SegmentStatus_GftInfo) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.GftInfo != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.GftInfo.Size()))
		n14, err := m.GftInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *L2SegmentStatusIris) Size() (n int) {
	var l int
	_ = l
	if m.HwL2SegId != 0 {
...
func (m *L2SegmentStatusGFT) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *L2SegmentStatus_IrisInfo) Size() (n int) {
	var l int
	_ = l
	if m.IrisInfo != nil {
		l = m.IrisInfo.Size()
...
func (m *L2SegmentStatus_GftInfo) Size() (n int) {
	var l int
	_ = l
	if m.GftInfo != nil {
		l = m.GftInfo.Size()
...
func (m *L2SegmentStatusIris) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: L2segmentStatusIris: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: L2segmentStatusIris: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 3:
			if wireType != 0 {
...
func (m *L2SegmentStatusGFT) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: L2segmentStatusGFT: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: L2segmentStatusGFT: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *L2SegmentStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			v := &L2SegmentStatusIris{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.L2SegInfo = &L2SegmentStatus_IrisInfo{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			v := &L2SegmentStatusGFT{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.L2SegInfo = &L2SegmentStatus_GftInfo{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipL2Segment(dAtA[iNdEx:])
...
var fileDescriptorL2Segment = []byte{
	...
	,
}
