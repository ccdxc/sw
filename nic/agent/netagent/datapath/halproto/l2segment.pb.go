...
func (m *L2SegmentStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BcastLst != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.BcastLst.Size()))
		n15, err := m.BcastLst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.McastLst != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.McastLst.Size()))
		n16, err := m.McastLst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.PromLst != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.PromLst.Size()))
		n17, err := m.PromLst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	}
	if m.SharedBcastLst != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.SharedBcastLst.Size()))
		n18, err := m.SharedBcastLst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	}
	if m.SharedMcastLst != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.SharedMcastLst.Size()))
		n19, err := m.SharedMcastLst.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.L2SegStatus != nil {
		nn20, err := m.L2SegStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn20
...
func (m *L2SegmentStatus_EpdInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EpdInfo != nil {
		...
		n21, err := m.EpdInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *L2SegmentStatus_CpdInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CpdInfo != nil {
		...
		n22, err := m.CpdInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *L2SegmentResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L2SegmentStatus != nil {
		...
		n23, err := m.L2SegmentStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *L2SegmentGetRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VrfKeyHandle != nil {
		...
		i++
		i = encodeVarintL2Segment(dAtA, i, uint64(m.VrfKeyHandle.Size()))
		n27, err := m.VrfKeyHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *L2SegmentStatus) Size() (n int) {
	...
	if m.SharedBcastLst != nil {
		l = m.SharedBcastLst.Size()
		n += 1 + l + sovL2Segment(uint64(l))
	}
	if m.SharedMcastLst != nil {
		l = m.SharedMcastLst.Size()
		n += 1 + l + sovL2Segment(uint64(l))
	}
	if len(m.AttachedL2Segs) > 0 {
...
func (m *L2SegmentStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BcastLst", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BcastLst.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field McastLst", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.McastLst.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PromLst", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PromLst.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SharedBcastLst", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SharedBcastLst == nil {
				m.SharedBcastLst = &OifList{}
			}
			if err := m.SharedBcastLst.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SharedMcastLst", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SharedMcastLst == nil {
				m.SharedMcastLst = &OifList{}
			}
			if err := m.SharedMcastLst.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
...
var fileDescriptorL2Segment = []byte{
	...
	,
}
