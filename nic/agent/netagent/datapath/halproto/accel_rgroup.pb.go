...
type AccelRGroupRingIndicesSpec struct {
	...
	Endx       uint32 `protobuf:"varint,5,opt,name=endx,proto3" json:"endx,omitempty"`
}
...
func (*AccelRGroupMiscGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorAccelRgroup, []int{43}
}
...
func (*AccelRGroupMiscGetRequestMsg) Descriptor() ([]byte, []int) {
	return fileDescriptorAccelRgroup, []int{44}
}
...
func (*AccelRGroupMiscRegVal) Descriptor() ([]byte, []int) {
	return fileDescriptorAccelRgroup, []int{45}
}
...
type AccelRGroupRingMiscSpec struct {
	RingHandle uint32                   `protobuf:"varint,1,opt,name=ring_handle,json=ringHandle,proto3" json:"ring_handle,omitempty"`
	SubRing    uint32                   `protobuf:"varint,2,opt,name=sub_ring,json=subRing,proto3" json:"sub_ring,omitempty"`
	NumRegVals uint32                   `protobuf:"varint,3,opt,name=num_reg_vals,json=numRegVals,proto3" json:"num_reg_vals,omitempty"`
...
func (*AccelRGroupRingMiscSpec) Descriptor() ([]byte, []int) {
	return fileDescriptorAccelRgroup, []int{46}
}
...
func (*AccelRGroupMiscGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorAccelRgroup, []int{47}
}
...
func (*AccelRGroupMiscGetResponseMsg) Descriptor() ([]byte, []int) {
	return fileDescriptorAccelRgroup, []int{48}
}
...
func init() {
	...
	proto.RegisterType((*AccelRGroupMiscGetRequest)(nil), "accelRGroup.AccelRGroupMiscGetRequest")
	proto.RegisterType((*AccelRGroupMiscGetRequestMsg)(nil), "accelRGroup.AccelRGroupMiscGetRequestMsg")
	proto.RegisterType((*AccelRGroupMiscRegVal)(nil), "accelRGroup.AccelRGroupMiscRegVal")
	proto.RegisterType((*AccelRGroupRingMiscSpec)(nil), "accelRGroup.AccelRGroupRingMiscSpec")
	proto.RegisterType((*AccelRGroupMiscGetResponse)(nil), "accelRGroup.AccelRGroupMiscGetResponse")
	proto.RegisterType((*AccelRGroupMiscGetResponseMsg)(nil), "accelRGroup.AccelRGroupMiscGetResponseMsg")
}
...
type AccelRGroupClient interface {
	...
	AccelRGroupMiscGet(ctx context.Context, in *AccelRGroupMiscGetRequestMsg, opts ...grpc.CallOption) (*AccelRGroupMiscGetResponseMsg, error)
}
...
func (c *accelRGroupClient) AccelRGroupMiscGet(ctx context.Context, in *AccelRGroupMiscGetRequestMsg, opts ...grpc.CallOption) (*AccelRGroupMiscGetResponseMsg, error) {
	out := new(AccelRGroupMiscGetResponseMsg)
	err := grpc.Invoke(ctx, "/accelRGroup.AccelRGroup/AccelRGroupMiscGet", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccelRGroupServer interface {
	...
	AccelRGroupMiscGet(context.Context, *AccelRGroupMiscGetRequestMsg) (*AccelRGroupMiscGetResponseMsg, error)
}
...
func _AccelRGroup_AccelRGroupMiscGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccelRGroupMiscGetRequestMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccelRGroupServer).AccelRGroupMiscGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accelRGroup.AccelRGroup/AccelRGroupMiscGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccelRGroupServer).AccelRGroupMiscGet(ctx, req.(*AccelRGroupMiscGetRequestMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AccelRGroup_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AccelRGroupMiscGet",
			Handler:    _AccelRGroup_AccelRGroupMiscGet_Handler,
		},
	},
...
func (m *AccelRGroupRingIndicesSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Endx != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintAccelRgroup(dAtA, i, uint64(m.Endx))
	}
	return i, nil
}
...
func (m *AccelRGroupMiscGetRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AccelRGroupMiscGetRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AccelRGroupMiscGetRequestMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AccelRGroupMiscGetRequestMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AccelRGroupMiscRegVal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AccelRGroupMiscRegVal) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Name) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAccelRgroup(dAtA, i, uint64(len(m.Name)))
...
func (m *AccelRGroupRingMiscSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AccelRGroupRingMiscSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.NumRegVals != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintAccelRgroup(dAtA, i, uint64(m.NumRegVals))
	}
	if len(m.RegVal) > 0 {
		for _, msg := range m.RegVal {
			dAtA[i] = 0x22
			i++
			i = encodeVarintAccelRgroup(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *AccelRGroupMiscGetResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AccelRGroupMiscGetResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.RingMiscSpec) > 0 {
		for _, msg := range m.RingMiscSpec {
			dAtA[i] = 0x12
			i++
			i = encodeVarintAccelRgroup(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *AccelRGroupMiscGetResponseMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AccelRGroupMiscGetResponseMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AccelRGroupRingIndicesSpec) Size() (n int) {
	...
	if m.Endx != 0 {
		n += 1 + sovAccelRgroup(uint64(m.Endx))
	}
	return n
}
...
func (m *AccelRGroupMiscGetRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.RgroupName)
	if l > 0 {
...
func (m *AccelRGroupMiscGetRequestMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Request) > 0 {
		for _, e := range m.Request {
...
func (m *AccelRGroupMiscRegVal) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	if l > 0 {
...
func (m *AccelRGroupRingMiscSpec) Size() (n int) {
	var l int
	_ = l
	if m.RingHandle != 0 {
		n += 1 + sovAccelRgroup(uint64(m.RingHandle))
	...
	if m.NumRegVals != 0 {
		n += 1 + sovAccelRgroup(uint64(m.NumRegVals))
	}
	if len(m.RegVal) > 0 {
		for _, e := range m.RegVal {
			l = e.Size()
			n += 1 + l + sovAccelRgroup(uint64(l))
		}
	}
...
func (m *AccelRGroupMiscGetResponse) Size() (n int) {
	var l int
	_ = l
	if m.ApiStatus != 0 {
		n += 1 + sovAccelRgroup(uint64(m.ApiStatus))
...
func (m *AccelRGroupMiscGetResponseMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Response) > 0 {
		for _, e := range m.Response {
...
func (m *AccelRGroupMiscGetRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccelRGroupMiscGetRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccelRGroupMiscGetRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AccelRGroupMiscGetRequestMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccelRGroupMiscGetRequestMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccelRGroupMiscGetRequestMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Request = append(m.Request, &AccelRGroupMiscGetRequest{})
			if err := m.Request[len(m.Request)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *AccelRGroupMiscRegVal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccelRGroupMiscRegVal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccelRGroupMiscRegVal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AccelRGroupRingMiscSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccelRGroupRingMiscSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccelRGroupRingMiscSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumRegVals", wireType)
			}
			m.NumRegVals = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumRegVals |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RegVal", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RegVal = append(m.RegVal, &AccelRGroupMiscRegVal{})
			if err := m.RegVal[len(m.RegVal)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AccelRGroupMiscGetResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccelRGroupMiscGetResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccelRGroupMiscGetResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RingMiscSpec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RingMiscSpec = append(m.RingMiscSpec, &AccelRGroupRingMiscSpec{})
			if err := m.RingMiscSpec[len(m.RingMiscSpec)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AccelRGroupMiscGetResponseMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AccelRGroupMiscGetResponseMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AccelRGroupMiscGetResponseMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Response = append(m.Response, &AccelRGroupMiscGetResponse{})
			if err := m.Response[len(m.Response)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorAccelRgroup = []byte{
	...
	,
}
