...
func (*TlsProxyECDSAKeys) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{15} }
...
func (*TlsProxyRSAKeys) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{16} }
...
type TlsProxyFlowConfig struct {
	CertId      uint32            `protobuf:"varint,1,opt,name=cert_id,json=certId,proto3" json:"cert_id,omitempty"`
	TrustRootId uint32            `protobuf:"varint,2,opt,name=trust_root_id,json=trustRootId,proto3" json:"trust_root_id,omitempty"`
	Ciphers     string            `protobuf:"bytes,3,opt,name=ciphers,proto3" json:"ciphers,omitempty"`
	KeyType     CryptoAsymKeyType `protobuf:"varint,4,opt,name=key_type,json=keyType,proto3,enum=types.CryptoAsymKeyType" json:"key_type,omitempty"`
...
func (*TlsProxyFlowConfig) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{17} }

type isTlsProxyFlowConfig_Keys interface {
	isTlsProxyFlowConfig_Keys()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type ProxyFlowConfigRequest struct {
	...
	ProxyEn        bool                `protobuf:"varint,3,opt,name=proxy_en,json=proxyEn,proto3" json:"proxy_en,omitempty"`
	FlowData       *FlowData           `protobuf:"bytes,4,opt,name=flow_data,json=flowData" json:"flow_data,omitempty"`
	AllocQid       bool                `protobuf:"varint,5,opt,name=alloc_qid,json=allocQid,proto3" json:"alloc_qid,omitempty"`
...
func (*ProxyFlowConfigRequest) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{18} }
...
func (*ProxyFlowConfigRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{19} }
...
func (*ProxyGetFlowInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{20} }
...
func (*ProxyGetFlowInfoRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{21} }
...
type ProxyGetFlowInfoResponse struct {
	...
	LifId     uint32    `protobuf:"varint,4,opt,name=lif_id,json=lifId,proto3" json:"lif_id,omitempty"`
	Qtype     uint32    `protobuf:"varint,5,opt,name=qtype,proto3" json:"qtype,omitempty"`
	Qid1      uint32    `protobuf:"varint,6,opt,name=qid1,proto3" json:"qid1,omitempty"`
	Qid2      uint32    `protobuf:"varint,7,opt,name=qid2,proto3" json:"qid2,omitempty"`
}
...
func (*ProxyGetFlowInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{22} }
...
func (*ProxyGetFlowInfoResponseMsg) Descriptor() ([]byte, []int) {
	return fileDescriptorProxy, []int{23}
}
...
func (*ProxyGlobalCfgRequest) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{24} }
...
func (*ProxyGlobalCfgRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{25} }
...
func (*ProxyGlobalCfgResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{26} }
...
func init() {
	...
	proto.RegisterType((*TlsProxyECDSAKeys)(nil), "proxy.TlsProxyECDSAKeys")
	proto.RegisterType((*TlsProxyRSAKeys)(nil), "proxy.TlsProxyRSAKeys")
	proto.RegisterType((*TlsProxyFlowConfig)(nil), "proxy.TlsProxyFlowConfig")
...
func (m *ProxySpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VrfKeyHandle != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.VrfKeyHandle.Size()))
...
func (m *IpsecFlowConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EspFlowKey != nil {
		...
		n12, err := m.EspFlowKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *TlsProxyECDSAKeys) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TlsProxyECDSAKeys) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.SignKeyIdx != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.SignKeyIdx))
	}
	return i, nil
}

func (m *TlsProxyRSAKeys) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TlsProxyRSAKeys) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.DecryptKeyIdx != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.DecryptKeyIdx))
	}
	return i, nil
}

func (m *TlsProxyFlowConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TlsProxyFlowConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.CertId != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.CertId))
	}
	if m.TrustRootId != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.TrustRootId))
	}
	if len(m.Ciphers) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintProxy(dAtA, i, uint64(len(m.Ciphers)))
		i += copy(dAtA[i:], m.Ciphers)
	}
	if m.KeyType != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.KeyType))
	}
	if m.Keys != nil {
		nn13, err := m.Keys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn13
...
func (m *TlsProxyFlowConfig_EcdsaKeys) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.EcdsaKeys != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.EcdsaKeys.Size()))
		n14, err := m.EcdsaKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *TlsProxyFlowConfig_RsaKeys) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RsaKeys != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.RsaKeys.Size()))
		n15, err := m.RsaKeys.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *ProxyFlowConfigRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TlsProxyConfig != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.TlsProxyConfig.Size()))
		n20, err := m.TlsProxyConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *ProxyGetFlowInfoResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FlowKey != nil {
		...
		i++
		i = encodeVarintProxy(dAtA, i, uint64(m.FlowKey.Size()))
		n24, err := m.FlowKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *ProxyGlobalCfgResponseMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.ApiStatus) > 0 {
		dAtA26 := make([]byte, len(m.ApiStatus)*10)
		var j25 int
		for _, num := range m.ApiStatus {
			for num >= 1<<7 {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintProxy(dAtA, i, uint64(j25))
...
func (m *TlsProxyECDSAKeys) Size() (n int) {
	var l int
	_ = l
	if m.SignKeyIdx != 0 {
		n += 1 + sovProxy(uint64(m.SignKeyIdx))
	}
	return n
}

func (m *TlsProxyRSAKeys) Size() (n int) {
	var l int
	_ = l
	if m.SignKeyIdx != 0 {
		n += 1 + sovProxy(uint64(m.SignKeyIdx))
	...
	if m.DecryptKeyIdx != 0 {
		n += 1 + sovProxy(uint64(m.DecryptKeyIdx))
	}
	return n
}

func (m *TlsProxyFlowConfig) Size() (n int) {
	var l int
	_ = l
	if m.CertId != 0 {
		n += 1 + sovProxy(uint64(m.CertId))
	}
	if m.TrustRootId != 0 {
		n += 1 + sovProxy(uint64(m.TrustRootId))
	}
	l = len(m.Ciphers)
	if l > 0 {
		n += 1 + l + sovProxy(uint64(l))
...
func (m *TlsProxyFlowConfig_EcdsaKeys) Size() (n int) {
	var l int
	_ = l
	if m.EcdsaKeys != nil {
		l = m.EcdsaKeys.Size()
...
func (m *TlsProxyFlowConfig_RsaKeys) Size() (n int) {
	var l int
	_ = l
	if m.RsaKeys != nil {
		l = m.RsaKeys.Size()
...
func (m *TlsProxyECDSAKeys) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TlsProxyECDSAKeys: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TlsProxyECDSAKeys: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *TlsProxyRSAKeys) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TlsProxyRSAKeys: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TlsProxyRSAKeys: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *TlsProxyFlowConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TlsProxyFlowConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TlsProxyFlowConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EcdsaKeys", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Keys = &TlsProxyFlowConfig_EcdsaKeys{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RsaKeys", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Keys = &TlsProxyFlowConfig_RsaKeys{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
...
func (m *ProxyFlowConfigRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TlsProxyConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TlsProxyConfig == nil {
				m.TlsProxyConfig = &TlsProxyFlowConfig{}
			}
			if err := m.TlsProxyConfig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorProxy = []byte{
	...
	,
}
