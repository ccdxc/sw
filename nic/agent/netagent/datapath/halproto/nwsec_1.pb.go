...
func (m *SecurityRuleStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SecurityRuleHandle != 0 {
		dAtA[i] = 0x9
		i++
		i = encodeFixed64Nwsec_1(dAtA, i, uint64(m.SecurityRuleHandle))
	}
	return i, nil
}
...
func encodeFixed64Nwsec_1(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32Nwsec_1(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
func (m *SecurityRuleStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			iNdEx += 8
			m.SecurityRuleHandle = uint64(dAtA[iNdEx-8])
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-7]) << 8
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-6]) << 16
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-5]) << 24
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-4]) << 32
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-3]) << 40
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-2]) << 48
			m.SecurityRuleHandle |= uint64(dAtA[iNdEx-1]) << 56
		default:
			iNdEx = preIndex
			skippy, err := skipNwsec_1(dAtA[iNdEx:])
			if err != nil {
