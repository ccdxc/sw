...
type RdmaQpSpec struct {
	...
	SqTableIndex uint32 `protobuf:"varint,26,opt,name=sq_table_index,json=sqTableIndex,proto3" json:"sq_table_index,omitempty"`
	RqTableIndex uint32 `protobuf:"varint,27,opt,name=rq_table_index,json=rqTableIndex,proto3" json:"rq_table_index,omitempty"`
}
...
type RdmaQpUpdateSpec struct {
	...
	RsqDepth       uint32           `protobuf:"varint,12,opt,name=rsq_depth,json=rsqDepth,proto3" json:"rsq_depth,omitempty"`
	RrqDepth       uint32           `protobuf:"varint,13,opt,name=rrq_depth,json=rrqDepth,proto3" json:"rrq_depth,omitempty"`
	RsqIndex       uint32           `protobuf:"varint,14,opt,name=rsq_index,json=rsqIndex,proto3" json:"rsq_index,omitempty"`
	RrqIndex       uint32           `protobuf:"varint,15,opt,name=rrq_index,json=rrqIndex,proto3" json:"rrq_index,omitempty"`
}
...
type RdmaCqSpec struct {
	...
	TableIndex       uint32   `protobuf:"varint,14,opt,name=table_index,json=tableIndex,proto3" json:"table_index,omitempty"`
...
type RdmaMemRegSpec struct {
	...
	TableIndex     uint32   `protobuf:"varint,15,opt,name=table_index,json=tableIndex,proto3" json:"table_index,omitempty"`
...
type RdmaAllocLkeySpec struct {
	...
	TableIndex       uint32 `protobuf:"varint,8,opt,name=table_index,json=tableIndex,proto3" json:"table_index,omitempty"`
}
...
type RdmaAqResponse struct {
	ApiStatus         ApiStatus `protobuf:"varint,1,opt,name=api_status,json=apiStatus,proto3,enum=types.ApiStatus" json:"api_status,omitempty"`
	RdmaAtomicResAddr uint64    `protobuf:"varint,2,opt,name=rdma_atomic_res_addr,json=rdmaAtomicResAddr,proto3" json:"rdma_atomic_res_addr,omitempty"`
}
...
func (m *RdmaQpSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SqTableIndex != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.SqTableIndex))
	}
	if m.RqTableIndex != 0 {
		dAtA[i] = 0xd8
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.RqTableIndex))
	}
	return i, nil
}
...
func (m *RdmaQpUpdateSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RsqDepth != 0 {
		dAtA[i] = 0x60
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.RsqDepth))
	}
	if m.RrqDepth != 0 {
		dAtA[i] = 0x68
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.RrqDepth))
	}
	if m.RsqIndex != 0 {
		dAtA[i] = 0x70
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.RsqIndex))
	}
	if m.RrqIndex != 0 {
		dAtA[i] = 0x78
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.RrqIndex))
	}
	return i, nil
}
...
func (m *RdmaCqSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TableIndex != 0 {
		dAtA[i] = 0x70
		i++
		i = encodeVarintRdma(dAtA, i, uint64(m.TableIndex))
	}
...
func (m *RdmaQpSpec) Size() (n int) {
	...
	if m.SqTableIndex != 0 {
		n += 2 + sovRdma(uint64(m.SqTableIndex))
	}
	if m.RqTableIndex != 0 {
		n += 2 + sovRdma(uint64(m.RqTableIndex))
	}
	return n
}
...
func (m *RdmaQpUpdateSpec) Size() (n int) {
	...
	if m.RsqDepth != 0 {
		n += 1 + sovRdma(uint64(m.RsqDepth))
	}
	if m.RrqDepth != 0 {
		n += 1 + sovRdma(uint64(m.RrqDepth))
	}
	if m.RsqIndex != 0 {
		n += 1 + sovRdma(uint64(m.RsqIndex))
	}
	if m.RrqIndex != 0 {
		n += 1 + sovRdma(uint64(m.RrqIndex))
	}
	return n
}
...
func (m *RdmaCqSpec) Size() (n int) {
	...
	if m.TableIndex != 0 {
		n += 1 + sovRdma(uint64(m.TableIndex))
	}
	if len(m.CqVaPagesPhyAddr) > 0 {
		l = 0
...
func (m *RdmaQpSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SqTableIndex", wireType)
			}
			m.SqTableIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SqTableIndex |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 27:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RqTableIndex", wireType)
			}
			m.RqTableIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RqTableIndex |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *RdmaQpUpdateSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RsqDepth", wireType)
			}
			m.RsqDepth = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RsqDepth |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RrqDepth", wireType)
			}
			m.RrqDepth = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RrqDepth |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RsqIndex", wireType)
			}
			m.RsqIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RsqIndex |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RrqIndex", wireType)
			}
			m.RrqIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RrqIndex |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 14:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TableIndex |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorRdma = []byte{
	...
	,
}
