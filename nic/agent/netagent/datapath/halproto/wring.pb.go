...
type WRingSpec struct {
	...
	Pi          uint32          `protobuf:"varint,4,opt,name=pi,proto3" json:"pi,omitempty"`
	Ci          uint32          `protobuf:"varint,5,opt,name=ci,proto3" json:"ci,omitempty"`
}
...
func (*WRingSetMetaResponse) Descriptor() ([]byte, []int) { return fileDescriptorWring, []int{17} }
...
func (*WRingSetMetaResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptorWring, []int{18} }
...
func init() {
	...
	proto.RegisterType((*WRingSetMetaResponse)(nil), "wring.WRingSetMetaResponse")
	proto.RegisterType((*WRingSetMetaResponseMsg)(nil), "wring.WRingSetMetaResponseMsg")
}
...
func (c *wRingClient) WRingSetMeta(ctx context.Context, in *WRingRequestMsg, opts ...grpc.CallOption) (*WRingSetMetaResponseMsg, error) {
	out := new(WRingSetMetaResponseMsg)
	err := grpc.Invoke(ctx, "/wring.WRing/WRingSetMeta", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WRing_WRingSetMeta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WRingRequestMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WRingServer).WRingSetMeta(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wring.WRing/WRingSetMeta",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WRingServer).WRingSetMeta(ctx, req.(*WRingRequestMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _WRing_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _WRing_WRingSetMeta_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "wring.proto",
}
...
func init() { proto.RegisterFile("wring.proto", fileDescriptorWring) }
...
var fileDescriptorWring = []byte{
	...
	,
}
