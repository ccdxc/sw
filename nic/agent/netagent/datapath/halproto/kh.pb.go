...
func (CoppType) EnumDescriptor() ([]byte, []int) { return fileDescriptorKh, []int{1} }
...
func (*NetworkKey) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{2} }
...
func (*NetworkKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{3} }
...
func (*NexthopKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{4} }
...
type NexthopKeyHandle_NexthopId struct {
	NexthopId uint32 `protobuf:"varint,1,opt,name=nexthop_id,json=nexthopId,proto3,oneof"`
}
...
func (m *NexthopKeyHandle) GetNexthopId() uint32 {
...
func _NexthopKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // key_or_handle.nexthop_id
		...
		x, err := b.DecodeVarint()
		m.KeyOrHandle = &NexthopKeyHandle_NexthopId{uint32(x)}
		return true, err
...
func (*RouteKey) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{5} }
...
func (*RouteKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{6} }
...
func (*L2SegmentKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{7} }
...
type NatPoolKey struct {
	VrfIdOrHandle *VrfKeyHandle `protobuf:"bytes,1,opt,name=vrf_id_or_handle,json=vrfIdOrHandle" json:"vrf_id_or_handle,omitempty"`
...
func (*NatPoolKey) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{28} }

func (m *NatPoolKey) GetVrfIdOrHandle() *VrfKeyHandle {
	if m != nil {
		return m.VrfIdOrHandle
	}
	return nil
...
func (m *NatPoolKey) GetPoolId() uint32 {
	if m != nil {
		return m.PoolId
	}
	return 0
...
func (*NatPoolKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{29} }
...
func (*NATPolicyKey) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{30} }
...
func (*NatPolicyKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{31} }
...
type Svc struct {
	...
	VrfKh  *VrfKeyHandle `protobuf:"bytes,2,opt,name=vrf_kh,json=vrfKh" json:"vrf_kh,omitempty"`
	IpAddr *IPAddress    `protobuf:"bytes,3,opt,name=ip_addr,json=ipAddr" json:"ip_addr,omitempty"`
}

func (m *Svc) Reset()                    { *m = Svc{} }
func (m *Svc) String() string            { return proto.CompactTextString(m) }
func (*Svc) ProtoMessage()               {}
func (*Svc) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{32} }
...
func (*NatVpnMappingKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{33} }
...
type NatVpnMappingKeyHandle_SvcKey struct {
	SvcKey *Svc `protobuf:"bytes,1,opt,name=svc_key,json=svcKey,oneof"`
}
...
func (*NatVpnMappingKeyHandle_SvcKey) isNatVpnMappingKeyHandle_KeyOrHandle()        {}
...
func (m *NatVpnMappingKeyHandle) GetSvcKey() *Svc {
	if x, ok := m.GetKeyOrHandle().(*NatVpnMappingKeyHandle_SvcKey); ok {
		return x.SvcKey
	}
	return nil
}
...
func (*NatVpnMappingKeyHandle) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _NatVpnMappingKeyHandle_OneofMarshaler, _NatVpnMappingKeyHandle_OneofUnmarshaler, _NatVpnMappingKeyHandle_OneofSizer, []interface{}{
		(*NatVpnMappingKeyHandle_SvcKey)(nil),
...
func _NatVpnMappingKeyHandle_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// key_or_handle
	switch x := m.KeyOrHandle.(type) {
	case *NatVpnMappingKeyHandle_SvcKey:
		_ = b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.SvcKey); err != nil {
			return err
		}
...
func _NatVpnMappingKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*NatVpnMappingKeyHandle)
	switch tag {
	case 1: // key_or_handle.svc_key
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Svc)
		err := b.DecodeMessage(msg)
		m.KeyOrHandle = &NatVpnMappingKeyHandle_SvcKey{msg}
		return true, err
...
func (*IpsecRuleKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{34} }
...
func (*QosClassKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{35} }
...
func (*CoppKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{36} }
...
func (m *NetworkKeyHandle_NwKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NwKey != nil {
		...
		n6, err := m.NwKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *RouteKeyHandle_RouteKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RouteKey != nil {
		...
		n11, err := m.RouteKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *NatPoolKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VrfIdOrHandle != nil {
		...
		i++
		i = encodeVarintKh(dAtA, i, uint64(m.VrfIdOrHandle.Size()))
		n41, err := m.VrfIdOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *NatPoolKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.KeyOrHandle != nil {
		nn42, err := m.KeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn42
...
func (m *NatPoolKeyHandle_PoolKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PoolKey != nil {
		...
		n43, err := m.PoolKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *NATPolicyKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VrfKeyOrHandle != nil {
		...
		n44, err := m.VrfKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *NatPolicyKeyHandle_PolicyKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PolicyKey != nil {
		...
		n46, err := m.PolicyKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *Svc) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VrfKh != nil {
		...
		n47, err := m.VrfKh.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.IpAddr != nil {
		...
		n48, err := m.IpAddr.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *NatVpnMappingKeyHandle_SvcKey) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.SvcKey != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintKh(dAtA, i, uint64(m.SvcKey.Size()))
		n50, err := m.SvcKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *CoppKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.KeyOrHandle != nil {
		nn53, err := m.KeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn53
...
func (m *NatVpnMappingKeyHandle_SvcKey) Size() (n int) {
	var l int
	_ = l
	if m.SvcKey != nil {
		l = m.SvcKey.Size()
...
func (m *NatVpnMappingKeyHandle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SvcKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KeyOrHandle = &NatVpnMappingKeyHandle_SvcKey{v}
			iNdEx = postIndex
		case 2:
			if wireType != 1 {
...
var fileDescriptorKh = []byte{
	...
	,
}
