...
type VrfKeyHandle_VrfId struct {
	VrfId uint32 `protobuf:"varint,1,opt,name=vrf_id,json=vrfId,proto3,oneof"`
}
...
func (m *VrfKeyHandle) GetVrfId() uint32 {
...
func _VrfKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // key_or_handle.vrf_id
		...
		x, err := b.DecodeVarint()
		m.KeyOrHandle = &VrfKeyHandle_VrfId{uint32(x)}
		return true, err
...
type SecurityGroupPolicyId struct {
	SecurityGroupId     uint32 `protobuf:"varint,1,opt,name=security_group_id,json=securityGroupId,proto3" json:"security_group_id,omitempty"`
	PeerSecurityGroupId uint32 `protobuf:"varint,2,opt,name=peer_security_group_id,json=peerSecurityGroupId,proto3" json:"peer_security_group_id,omitempty"`
}
...
func (*SecurityGroupPolicyId) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{4} }

func (m *SecurityGroupPolicyId) GetSecurityGroupId() uint32 {
	if m != nil {
...
func (m *SecurityGroupPolicyId) GetPeerSecurityGroupId() uint32 {
	if m != nil {
...
func (*SecurityGroupPolicyKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{5} }
...
func (*SecurityGroupKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{6} }
...
func (*PortKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{7} }
...
func (*LifKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{8} }
...
func (*InterfaceKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{9} }
...
type EndpointL2Key struct {
	...
	L2SegmentKeyHandle *L2SegmentKeyHandle `protobuf:"bytes,3,opt,name=l2segment_key_handle,json=l2segmentKeyHandle" json:"ref"`
}
...
func (*EndpointL2Key) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{10} }
...
func (*EndpointL3Key) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{11} }
...
func (*EndpointKey) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{12} }
...
func (*EndpointKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{13} }
...
func (m *SecurityGroupPolicyKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PolicyKeyOrHandle != nil {
		nn6, err := m.PolicyKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn6
...
func (m *SecurityGroupPolicyKeyHandle_SecurityGroupPolicyId) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SecurityGroupPolicyId != nil {
		...
		n7, err := m.SecurityGroupPolicyId.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *EndpointL2Key) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L2SegmentKeyHandle != nil {
		...
		n12, err := m.L2SegmentKeyHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *EndpointL3Key) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IpAddress != nil {
		...
		n13, err := m.IpAddress.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *EndpointKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EndpointL2L3Key != nil {
		nn14, err := m.EndpointL2L3Key.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn14
...
func (m *EndpointKey_L2Key) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L2Key != nil {
		...
		n15, err := m.L2Key.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *EndpointKey_L3Key) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L3Key != nil {
		...
		n16, err := m.L3Key.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *EndpointKeyHandle_EndpointKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EndpointKey != nil {
		...
		n18, err := m.EndpointKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PeerSecurityGroupId |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorKh = []byte{
	...
	,
}
