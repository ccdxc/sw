...
type NatRuleKeyHandle struct {
	// Types that are valid to be assigned to RuleKeyOrHandle:
	//	*NatRuleKeyHandle_NatRuleId
	//	*NatRuleKeyHandle_NatRuleHandle
...
type NatRuleKeyHandle_NatRuleId struct {
	NatRuleId uint64 `protobuf:"varint,1,opt,name=nat_rule_id,json=natRuleId,proto3,oneof"`
}
type NatRuleKeyHandle_NatRuleHandle struct {
	NatRuleHandle uint64 `protobuf:"fixed64,2,opt,name=nat_rule_handle,json=natRuleHandle,proto3,oneof"`
}

func (*NatRuleKeyHandle_NatRuleId) isNatRuleKeyHandle_RuleKeyOrHandle()     {}
func (*NatRuleKeyHandle_NatRuleHandle) isNatRuleKeyHandle_RuleKeyOrHandle() {}
...
func (m *NatRuleKeyHandle) GetNatRuleId() uint64 {
	if x, ok := m.GetRuleKeyOrHandle().(*NatRuleKeyHandle_NatRuleId); ok {
		return x.NatRuleId
	}
	return 0
}

func (m *NatRuleKeyHandle) GetNatRuleHandle() uint64 {
	if x, ok := m.GetRuleKeyOrHandle().(*NatRuleKeyHandle_NatRuleHandle); ok {
		return x.NatRuleHandle
	}
	return 0
}
...
func (*NatRuleKeyHandle) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _NatRuleKeyHandle_OneofMarshaler, _NatRuleKeyHandle_OneofUnmarshaler, _NatRuleKeyHandle_OneofSizer, []interface{}{
		(*NatRuleKeyHandle_NatRuleId)(nil),
		(*NatRuleKeyHandle_NatRuleHandle)(nil),
	}
}
...
func _NatRuleKeyHandle_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// rule_key_or_handle
	switch x := m.RuleKeyOrHandle.(type) {
	case *NatRuleKeyHandle_NatRuleId:
		_ = b.EncodeVarint(1<<3 | proto.WireVarint)
		_ = b.EncodeVarint(uint64(x.NatRuleId))
	case *NatRuleKeyHandle_NatRuleHandle:
		_ = b.EncodeVarint(2<<3 | proto.WireFixed64)
		_ = b.EncodeFixed64(uint64(x.NatRuleHandle))
	case nil:
	default:
...
func _NatRuleKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*NatRuleKeyHandle)
	switch tag {
	case 1: // rule_key_or_handle.nat_rule_id
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.RuleKeyOrHandle = &NatRuleKeyHandle_NatRuleId{x}
		return true, err
	case 2: // rule_key_or_handle.nat_rule_handle
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed64()
		m.RuleKeyOrHandle = &NatRuleKeyHandle_NatRuleHandle{x}
		return true, err
	default:
		return false, nil
	}
...
func _NatRuleKeyHandle_OneofSizer(msg proto.Message) (n int) {
	...
	case *NatRuleKeyHandle_NatRuleId:
		n += proto.SizeVarint(1<<3 | proto.WireVarint)
		n += proto.SizeVarint(uint64(x.NatRuleId))
	case *NatRuleKeyHandle_NatRuleHandle:
		n += proto.SizeVarint(2<<3 | proto.WireFixed64)
		n += 8
	case nil:
...
func (m *NatRuleKeyHandle_NatRuleId) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x8
	i++
	i = encodeVarintKh(dAtA, i, uint64(m.NatRuleId))
	return i, nil
}
func (m *NatRuleKeyHandle_NatRuleHandle) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x11
	i++
	encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.NatRuleHandle))
	i += 8
	return i, nil
}
...
func (m *NatRuleKeyHandle_NatRuleId) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovKh(uint64(m.NatRuleId))
	return n
}
func (m *NatRuleKeyHandle_NatRuleHandle) Size() (n int) {
	var l int
	_ = l
	n += 9
	return n
...
func (m *NatRuleKeyHandle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NatRuleId", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RuleKeyOrHandle = &NatRuleKeyHandle_NatRuleId{v}
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field NatRuleHandle", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.RuleKeyOrHandle = &NatRuleKeyHandle_NatRuleHandle{v}
		default:
			iNdEx = preIndex
			skippy, err := skipKh(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorKh = []byte{
	...
	,
}
