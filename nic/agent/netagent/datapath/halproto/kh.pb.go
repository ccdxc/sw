...
func (*NatMappingKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{33} }
...
// IpsecSAKeyHandle uniquely identifies a IPSec CB and is used
// to create/update/delete/get IPSec CBs
type IpsecSAKeyHandle struct {
	// Types that are valid to be assigned to KeyOrHandle:
	//	*IpsecSAKeyHandle_CbId
	//	*IpsecSAKeyHandle_CbHandle
	KeyOrHandle isIpsecSAKeyHandle_KeyOrHandle `protobuf_oneof:"key_or_handle"`
}

func (m *IpsecSAKeyHandle) Reset()                    { *m = IpsecSAKeyHandle{} }
func (m *IpsecSAKeyHandle) String() string            { return proto.CompactTextString(m) }
func (*IpsecSAKeyHandle) ProtoMessage()               {}
func (*IpsecSAKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{35} }

type isIpsecSAKeyHandle_KeyOrHandle interface {
	isIpsecSAKeyHandle_KeyOrHandle()
	MarshalTo([]byte) (int, error)
	Size() int
}

type IpsecSAKeyHandle_CbId struct {
	CbId uint64 `protobuf:"varint,1,opt,name=cb_id,json=cbId,proto3,oneof"`
}
type IpsecSAKeyHandle_CbHandle struct {
	CbHandle uint64 `protobuf:"fixed64,2,opt,name=cb_handle,json=cbHandle,proto3,oneof"`
}

func (*IpsecSAKeyHandle_CbId) isIpsecSAKeyHandle_KeyOrHandle()     {}
func (*IpsecSAKeyHandle_CbHandle) isIpsecSAKeyHandle_KeyOrHandle() {}

func (m *IpsecSAKeyHandle) GetKeyOrHandle() isIpsecSAKeyHandle_KeyOrHandle {
	if m != nil {
		return m.KeyOrHandle
	}
	return nil
...
func (m *IpsecSAKeyHandle) GetCbId() uint64 {
	if x, ok := m.GetKeyOrHandle().(*IpsecSAKeyHandle_CbId); ok {
		return x.CbId
	}
	return 0
}

func (m *IpsecSAKeyHandle) GetCbHandle() uint64 {
	if x, ok := m.GetKeyOrHandle().(*IpsecSAKeyHandle_CbHandle); ok {
		return x.CbHandle
	}
	return 0
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*IpsecSAKeyHandle) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _IpsecSAKeyHandle_OneofMarshaler, _IpsecSAKeyHandle_OneofUnmarshaler, _IpsecSAKeyHandle_OneofSizer, []interface{}{
		(*IpsecSAKeyHandle_CbId)(nil),
		(*IpsecSAKeyHandle_CbHandle)(nil),
	}
}

func _IpsecSAKeyHandle_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*IpsecSAKeyHandle)
	// key_or_handle
	switch x := m.KeyOrHandle.(type) {
	case *IpsecSAKeyHandle_CbId:
		_ = b.EncodeVarint(1<<3 | proto.WireVarint)
		_ = b.EncodeVarint(uint64(x.CbId))
	case *IpsecSAKeyHandle_CbHandle:
		_ = b.EncodeVarint(2<<3 | proto.WireFixed64)
		_ = b.EncodeFixed64(uint64(x.CbHandle))
	case nil:
	default:
		return fmt.Errorf("IpsecSAKeyHandle.KeyOrHandle has unexpected type %T", x)
	}
	return nil
}

func _IpsecSAKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*IpsecSAKeyHandle)
	switch tag {
	case 1: // key_or_handle.cb_id
		...
		x, err := b.DecodeVarint()
		m.KeyOrHandle = &IpsecSAKeyHandle_CbId{x}
		return true, err
	case 2: // key_or_handle.cb_handle
		...
		x, err := b.DecodeFixed64()
		m.KeyOrHandle = &IpsecSAKeyHandle_CbHandle{x}
		return true, err
	default:
		return false, nil
	}
...
func _IpsecSAKeyHandle_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*IpsecSAKeyHandle)
	// key_or_handle
	switch x := m.KeyOrHandle.(type) {
	case *IpsecSAKeyHandle_CbId:
...
func (*QosClassKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{36} }
...
func (*CoppKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{37} }
...
func init() {
	...
	proto.RegisterType((*IpsecSAKeyHandle)(nil), "kh.IpsecSAKeyHandle")
...
func (m *NatMappingKeyHandle_Svc) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Svc != nil {
		...
		n51, err := m.Svc.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *IpsecSAKeyHandle) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IpsecSAKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *IpsecSAKeyHandle_CbId) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x8
	i++
...
func (m *IpsecSAKeyHandle_CbHandle) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x11
	i++
...
func (m *CoppKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.KeyOrHandle != nil {
		nn55, err := m.KeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn55
...
func (m *IpsecSAKeyHandle) Size() (n int) {
	var l int
	_ = l
	if m.KeyOrHandle != nil {
		n += m.KeyOrHandle.Size()
...
func (m *IpsecSAKeyHandle_CbId) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovKh(uint64(m.CbId))
	return n
}
func (m *IpsecSAKeyHandle_CbHandle) Size() (n int) {
	var l int
	_ = l
	n += 9
	return n
...
func (m *IpsecSAKeyHandle) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IpsecSAKeyHandle: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IpsecSAKeyHandle: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			m.KeyOrHandle = &IpsecSAKeyHandle_CbId{v}
		case 2:
			if wireType != 1 {
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.KeyOrHandle = &IpsecSAKeyHandle_CbHandle{v}
		default:
			iNdEx = preIndex
			skippy, err := skipKh(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorKh = []byte{
	...
	,
}
