...
type NatRuleKeyHandle struct {
	...
	RuleKeyOrHandle isNatRuleKeyHandle_RuleKeyOrHandle `protobuf_oneof:"rule_key_or_handle"`
}
...
type isNatRuleKeyHandle_RuleKeyOrHandle interface {
	isNatRuleKeyHandle_RuleKeyOrHandle()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*NatRuleKeyHandle_RuleId) isNatRuleKeyHandle_RuleKeyOrHandle()     {}
func (*NatRuleKeyHandle_RuleHandle) isNatRuleKeyHandle_RuleKeyOrHandle() {}

func (m *NatRuleKeyHandle) GetRuleKeyOrHandle() isNatRuleKeyHandle_RuleKeyOrHandle {
	if m != nil {
		return m.RuleKeyOrHandle
	}
	return nil
...
func (m *NatRuleKeyHandle) GetRuleId() uint64 {
	if x, ok := m.GetRuleKeyOrHandle().(*NatRuleKeyHandle_RuleId); ok {
		return x.RuleId
	}
	return 0
}
...
func (m *NatRuleKeyHandle) GetRuleHandle() uint64 {
	if x, ok := m.GetRuleKeyOrHandle().(*NatRuleKeyHandle_RuleHandle); ok {
		return x.RuleHandle
	}
	return 0
}
...
func _NatRuleKeyHandle_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("NatRuleKeyHandle.RuleKeyOrHandle has unexpected type %T", x)
	}
	return nil
}
...
func _NatRuleKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*NatRuleKeyHandle)
	switch tag {
	case 1: // rule_key_or_handle.rule_id
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.RuleKeyOrHandle = &NatRuleKeyHandle_RuleId{x}
		return true, err
	case 2: // rule_key_or_handle.rule_handle
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed64()
		m.RuleKeyOrHandle = &NatRuleKeyHandle_RuleHandle{x}
		return true, err
	default:
		return false, nil
	}
...
type IpsecRuleKeyHandle struct {
	...
	RuleKeyOrHandle isIpsecRuleKeyHandle_RuleKeyOrHandle `protobuf_oneof:"rule_key_or_handle"`
}
...
func (*IpsecRuleKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptorKh, []int{24} }

type isIpsecRuleKeyHandle_RuleKeyOrHandle interface {
	isIpsecRuleKeyHandle_RuleKeyOrHandle()
	MarshalTo([]byte) (int, error)
	Size() int
}
...
func (*IpsecRuleKeyHandle_RuleId) isIpsecRuleKeyHandle_RuleKeyOrHandle()     {}
func (*IpsecRuleKeyHandle_RuleHandle) isIpsecRuleKeyHandle_RuleKeyOrHandle() {}

func (m *IpsecRuleKeyHandle) GetRuleKeyOrHandle() isIpsecRuleKeyHandle_RuleKeyOrHandle {
	if m != nil {
		return m.RuleKeyOrHandle
	}
	return nil
...
func (m *IpsecRuleKeyHandle) GetRuleId() uint64 {
	if x, ok := m.GetRuleKeyOrHandle().(*IpsecRuleKeyHandle_RuleId); ok {
		return x.RuleId
	}
	return 0
}
...
func (m *IpsecRuleKeyHandle) GetRuleHandle() uint64 {
	if x, ok := m.GetRuleKeyOrHandle().(*IpsecRuleKeyHandle_RuleHandle); ok {
		return x.RuleHandle
	}
	return 0
}
...
func _IpsecRuleKeyHandle_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case nil:
	default:
		return fmt.Errorf("IpsecRuleKeyHandle.RuleKeyOrHandle has unexpected type %T", x)
	}
	return nil
}
...
func _IpsecRuleKeyHandle_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // rule_key_or_handle.rule_id
		...
		x, err := b.DecodeVarint()
		m.RuleKeyOrHandle = &IpsecRuleKeyHandle_RuleId{x}
		return true, err
	case 2: // rule_key_or_handle.rule_handle
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		...
		x, err := b.DecodeFixed64()
		m.RuleKeyOrHandle = &IpsecRuleKeyHandle_RuleHandle{x}
		return true, err
	default:
		return false, nil
	}
...
func (m *NatRuleKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RuleKeyOrHandle != nil {
		nn32, err := m.RuleKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn32
...
func (m *IpsecRuleKeyHandle) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RuleKeyOrHandle != nil {
		nn33, err := m.RuleKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn33
...
func (m *NatRuleKeyHandle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.RuleKeyOrHandle = &NatRuleKeyHandle_RuleId{v}
		case 2:
			if wireType != 1 {
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.RuleKeyOrHandle = &NatRuleKeyHandle_RuleHandle{v}
		default:
			iNdEx = preIndex
			skippy, err := skipKh(dAtA[iNdEx:])
			if err != nil {
...
func (m *IpsecRuleKeyHandle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.RuleKeyOrHandle = &IpsecRuleKeyHandle_RuleId{v}
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field RuleHandle", wireType)
			}
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.RuleKeyOrHandle = &IpsecRuleKeyHandle_RuleHandle{v}
		default:
			iNdEx = preIndex
			skippy, err := skipKh(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorKh = []byte{
	...
	,
}
