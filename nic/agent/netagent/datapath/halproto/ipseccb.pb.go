...
func (m *IpsecCbSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RxPkts != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintIpseccb(dAtA, i, uint64(m.RxPkts))
	}
	if m.RxBytes != 0 {
		dAtA[i] = 0xf1
		i++
...
func (m *IpsecCbSpec) Size() (n int) {
	...
	if m.RxPkts != 0 {
		n += 2 + sovIpseccb(uint64(m.RxPkts))
	}
	if m.RxBytes != 0 {
		n += 10
	}
...
var fileDescriptorIpseccb = []byte{
	...
	,
}
