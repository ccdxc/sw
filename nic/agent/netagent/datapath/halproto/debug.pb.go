...
const (
	...
	CapriBlock_CAPRI_BLOCK_RXDMA CapriBlock = 1
	CapriBlock_CAPRI_BLOCK_TXDMA CapriBlock = 2
...
func (m *HbmBwRequest) Reset()                    { *m = HbmBwRequest{} }
func (m *HbmBwRequest) String() string            { return proto.CompactTextString(m) }
func (*HbmBwRequest) ProtoMessage()               {}
func (*HbmBwRequest) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{66} }

func (m *HbmBwRequest) GetNumSamples() uint32 {
	if m != nil {
		return m.NumSamples
	}
	return 0
...
func (m *HbmBwRequest) GetSleepInterval() uint32 {
	if m != nil {
...
type HbmBwRequestMsg struct {
	Request []*HbmBwRequest `protobuf:"bytes,1,rep,name=request" json:"request,omitempty"`
}

func (m *HbmBwRequestMsg) Reset()                    { *m = HbmBwRequestMsg{} }
func (m *HbmBwRequestMsg) String() string            { return proto.CompactTextString(m) }
func (*HbmBwRequestMsg) ProtoMessage()               {}
func (*HbmBwRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{67} }

func (m *HbmBwRequestMsg) GetRequest() []*HbmBwRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *HbmBwResponse) Reset()                    { *m = HbmBwResponse{} }
func (m *HbmBwResponse) String() string            { return proto.CompactTextString(m) }
func (*HbmBwResponse) ProtoMessage()               {}
func (*HbmBwResponse) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{68} }

func (m *HbmBwResponse) GetType() CapriBlock {
	if m != nil {
		return m.Type
	}
...
func (m *HbmBwResponse) GetAverage() *Bandwidth {
	if m != nil {
		return m.Average
	}
	return nil
...
func (m *HbmBwResponse) GetMaximum() *Bandwidth {
	if m != nil {
		return m.Maximum
	}
	return nil
...
func (m *HbmBwResponse) GetClkDiff() uint64 {
	if m != nil {
		return m.ClkDiff
	}
	return 0
...
type HbmBwResponseMsg struct {
	Response []*HbmBwResponse `protobuf:"bytes,1,rep,name=response" json:"response,omitempty"`
}

func (m *HbmBwResponseMsg) Reset()                    { *m = HbmBwResponseMsg{} }
func (m *HbmBwResponseMsg) String() string            { return proto.CompactTextString(m) }
func (*HbmBwResponseMsg) ProtoMessage()               {}
func (*HbmBwResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptorDebug, []int{69} }

func (m *HbmBwResponseMsg) GetResponse() []*HbmBwResponse {
	if m != nil {
		return m.Response
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HbmBwRequest)(nil), "debug.HbmBwRequest")
	proto.RegisterType((*HbmBwRequestMsg)(nil), "debug.HbmBwRequestMsg")
	proto.RegisterType((*HbmBwResponse)(nil), "debug.HbmBwResponse")
	proto.RegisterType((*HbmBwResponseMsg)(nil), "debug.HbmBwResponseMsg")
...
func (m *HbmBwRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HbmBwRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HbmBwRequestMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HbmBwRequestMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HbmBwResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HbmBwResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HbmBwResponseMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HbmBwResponseMsg) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HbmBwRequest) Size() (n int) {
	var l int
	_ = l
	if m.NumSamples != 0 {
...
func (m *HbmBwRequestMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Request) > 0 {
		for _, e := range m.Request {
...
func (m *HbmBwResponse) Size() (n int) {
	var l int
	_ = l
	if m.Type != 0 {
...
func (m *HbmBwResponseMsg) Size() (n int) {
	var l int
	_ = l
	if len(m.Response) > 0 {
		for _, e := range m.Response {
...
func (m *HbmBwRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HbmBwRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HbmBwRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *HbmBwRequestMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HbmBwRequestMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HbmBwRequestMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Request = append(m.Request, &HbmBwRequest{})
			if err := m.Request[len(m.Request)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *HbmBwResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HbmBwResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HbmBwResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *HbmBwResponseMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HbmBwResponseMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HbmBwResponseMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Response = append(m.Response, &HbmBwResponse{})
			if err := m.Response[len(m.Response)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorDebug = []byte{
	...
	,
}
