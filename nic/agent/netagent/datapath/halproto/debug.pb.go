...
const (
	DebugMemoryType_DEBUG_MEM_TYPE_TABLE DebugMemoryType = 0
	DebugMemoryType_DEBUG_MEM_TYPE_REG   DebugMemoryType = 1
)

var DebugMemoryType_name = map[int32]string{
	0: "DEBUG_MEM_TYPE_TABLE",
	1: "DEBUG_MEM_TYPE_REG",
}
var DebugMemoryType_value = map[string]int32{
	"DEBUG_MEM_TYPE_TABLE": 0,
	"DEBUG_MEM_TYPE_REG":   1,
}
...
func (m *DebugSpec) GetMemType() DebugMemoryType {
	...
	return DebugMemoryType_DEBUG_MEM_TYPE_TABLE
}
...
var fileDescriptorDebug = []byte{
	...
	,
}
