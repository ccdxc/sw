...
func (m *Bandwidth) GetRead() uint64 {
	if m != nil {
		return m.Read
	}
	return 0
...
func (m *Bandwidth) GetWrite() uint64 {
	if m != nil {
		return m.Write
	}
	return 0
...
func (m *Bandwidth) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Read != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintDebug(dAtA, i, uint64(m.Read))
	}
	if m.Write != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintDebug(dAtA, i, uint64(m.Write))
	}
	return i, nil
}
...
func (m *Bandwidth) Size() (n int) {
	...
	_ = l
	if m.Read != 0 {
		n += 1 + sovDebug(uint64(m.Read))
	}
	if m.Write != 0 {
		n += 1 + sovDebug(uint64(m.Write))
	}
	return n
}
...
var fileDescriptorDebug = []byte{
	...
	,
}
