...
type SecurityProfileSpec struct {
	...
	// Firewall knobs
	PolicyEnforceEn bool `protobuf:"varint,102,opt,name=policy_enforce_en,json=policyEnforceEn,proto3" json:"policy_enforce_en,omitempty" venice:default=false`
...
type SecurityProfileStats struct {
	TcpHalfOpenSessionCount uint32 `protobuf:"varint,1,opt,name=tcp_half_open_session_count,json=tcpHalfOpenSessionCount,proto3" json:"tcp_half_open_session_count,omitempty"`
	UdpActiveSessionCount   uint32 `protobuf:"varint,2,opt,name=udp_active_session_count,json=udpActiveSessionCount,proto3" json:"udp_active_session_count,omitempty"`
	IcmpActiveSessionCount  uint32 `protobuf:"varint,3,opt,name=icmp_active_session_count,json=icmpActiveSessionCount,proto3" json:"icmp_active_session_count,omitempty"`
	OtherActiveSessionCount uint32 `protobuf:"varint,4,opt,name=other_active_session_count,json=otherActiveSessionCount,proto3" json:"other_active_session_count,omitempty"`
	TcpSessionDropCount     uint32 `protobuf:"varint,5,opt,name=tcp_session_drop_count,json=tcpSessionDropCount,proto3" json:"tcp_session_drop_count,omitempty"`
	UdpSessionDropCount     uint32 `protobuf:"varint,6,opt,name=udp_session_drop_count,json=udpSessionDropCount,proto3" json:"udp_session_drop_count,omitempty"`
	IcmpSessionDropCount    uint32 `protobuf:"varint,7,opt,name=icmp_session_drop_count,json=icmpSessionDropCount,proto3" json:"icmp_session_drop_count,omitempty"`
	OtherSessionDropCount   uint32 `protobuf:"varint,8,opt,name=other_session_drop_count,json=otherSessionDropCount,proto3" json:"other_session_drop_count,omitempty"`
}
...
func (m *SecurityProfileStats) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TcpHalfOpenSessionCount != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.TcpHalfOpenSessionCount))
	}
	if m.UdpActiveSessionCount != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.UdpActiveSessionCount))
	}
	if m.IcmpActiveSessionCount != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.IcmpActiveSessionCount))
	}
	if m.OtherActiveSessionCount != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.OtherActiveSessionCount))
	}
	if m.TcpSessionDropCount != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.TcpSessionDropCount))
	}
	if m.UdpSessionDropCount != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.UdpSessionDropCount))
	}
	if m.IcmpSessionDropCount != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.IcmpSessionDropCount))
	}
	if m.OtherSessionDropCount != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintNwsec(dAtA, i, uint64(m.OtherSessionDropCount))
	}
	return i, nil
}
...
func (m *SecurityProfileStats) Size() (n int) {
	...
	_ = l
	if m.TcpHalfOpenSessionCount != 0 {
		n += 1 + sovNwsec(uint64(m.TcpHalfOpenSessionCount))
	}
	if m.UdpActiveSessionCount != 0 {
		n += 1 + sovNwsec(uint64(m.UdpActiveSessionCount))
	}
	if m.IcmpActiveSessionCount != 0 {
		n += 1 + sovNwsec(uint64(m.IcmpActiveSessionCount))
	}
	if m.OtherActiveSessionCount != 0 {
		n += 1 + sovNwsec(uint64(m.OtherActiveSessionCount))
	}
	if m.TcpSessionDropCount != 0 {
		n += 1 + sovNwsec(uint64(m.TcpSessionDropCount))
	}
	if m.UdpSessionDropCount != 0 {
		n += 1 + sovNwsec(uint64(m.UdpSessionDropCount))
	}
	if m.IcmpSessionDropCount != 0 {
		n += 1 + sovNwsec(uint64(m.IcmpSessionDropCount))
	}
	if m.OtherSessionDropCount != 0 {
		n += 1 + sovNwsec(uint64(m.OtherSessionDropCount))
	}
	return n
}
...
func (m *SecurityProfileStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TcpHalfOpenSessionCount", wireType)
			}
			m.TcpHalfOpenSessionCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNwsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TcpHalfOpenSessionCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UdpActiveSessionCount", wireType)
			}
			m.UdpActiveSessionCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNwsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UdpActiveSessionCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IcmpActiveSessionCount", wireType)
			}
			m.IcmpActiveSessionCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNwsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IcmpActiveSessionCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OtherActiveSessionCount", wireType)
			}
			m.OtherActiveSessionCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNwsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OtherActiveSessionCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TcpSessionDropCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UdpSessionDropCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IcmpSessionDropCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OtherSessionDropCount |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorNwsec = []byte{
	...
	,
}
