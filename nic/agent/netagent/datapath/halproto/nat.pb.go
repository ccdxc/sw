...
type NatRuleAction struct {
	SrcNatAction NatAction         `protobuf:"varint,1,opt,name=src_nat_action,json=srcNatAction,proto3,enum=nat.NatAction" json:"src_nat_action,omitempty" venice:immutable`
	DstNatAction NatAction         `protobuf:"varint,2,opt,name=dst_nat_action,json=dstNatAction,proto3,enum=nat.NatAction" json:"dst_nat_action,omitempty" venice:immutable`
...
type NatPolicySpec struct {
	...
	Rules       []*NatRuleSpec      `protobuf:"bytes,3,rep,name=rules" json:"rules,omitempty" venice:ref`
}
...
type NatMappingSpec struct {
	...
	NatPool     *NatPoolKeyHandle    `protobuf:"bytes,3,opt,name=nat_pool,json=natPool" json:"nat_pool,omitempty" venice:mandatory, venice:ref`
	Bidir       bool                 `protobuf:"varint,4,opt,name=bidir,proto3" json:"bidir,omitempty"`
}
...
var fileDescriptorNat = []byte{
	...
	,
}
