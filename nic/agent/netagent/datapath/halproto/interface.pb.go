...
type LifSpec struct {
	...
	HwLifId                 uint32               `protobuf:"varint,11,opt,name=hw_lif_id,json=hwLifId,proto3" json:"hw_lif_id,omitempty"`
	RdmaMaxKeys             uint32               `protobuf:"varint,12,opt,name=rdma_max_keys,json=rdmaMaxKeys,proto3" json:"rdma_max_keys,omitempty"`
	RdmaMaxAhs              uint32               `protobuf:"varint,13,opt,name=rdma_max_ahs,json=rdmaMaxAhs,proto3" json:"rdma_max_ahs,omitempty"`
	RdmaMaxPtEntries        uint32               `protobuf:"varint,14,opt,name=rdma_max_pt_entries,json=rdmaMaxPtEntries,proto3" json:"rdma_max_pt_entries,omitempty"`
	LifQstate               []*QStateSetReq      `protobuf:"bytes,15,rep,name=lif_qstate,json=lifQstate" json:"lif_qstate,omitempty"`
	Rss                     *LifRssSpec          `protobuf:"bytes,16,opt,name=rss" json:"rss,omitempty"`
	TxPolicer               *PolicerSpec         `protobuf:"bytes,17,opt,name=tx_policer,json=txPolicer" json:"tx_policer,omitempty"`
	RxPolicer               *PolicerSpec         `protobuf:"bytes,18,opt,name=rx_policer,json=rxPolicer" json:"rx_policer,omitempty"`
	RxQosClass              *QosClassKeyHandle   `protobuf:"bytes,19,opt,name=rx_qos_class,json=rxQosClass" json:"rx_qos_class,omitempty"`
	TxQosClass              *QosClassKeyHandle   `protobuf:"bytes,20,opt,name=tx_qos_class,json=txQosClass" json:"tx_qos_class,omitempty"`
}
...
func (m *IfEnicInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PinnedUplinkIfKeyHandle != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.PinnedUplinkIfKeyHandle.Size()))
		n26, err := m.PinnedUplinkIfKeyHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.EnicTypeInfo != nil {
		nn27, err := m.EnicTypeInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn27
...
func (m *IfEnicInfo_EnicInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EnicInfo != nil {
		...
		n28, err := m.EnicInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *IfEnicInfo_ClassicEnicInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClassicEnicInfo != nil {
		...
		n29, err := m.ClassicEnicInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *IfTunnelVxlanInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LocalTep != nil {
		...
		n30, err := m.LocalTep.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.RemoteTep != nil {
		...
		n31, err := m.RemoteTep.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *IfTunnelInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EncapInfo != nil {
		nn34, err := m.EncapInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn34
...
func (m *IfTunnelInfo_VxlanInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VxlanInfo != nil {
		...
		n36, err := m.VxlanInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *IfTunnelInfo_GreInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GreInfo != nil {
		...
		n37, err := m.GreInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *IfAppRedirInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LifKeyOrHandle != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.LifKeyOrHandle.Size()))
		n39, err := m.LifKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *InterfaceSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfInfo != nil {
		nn42, err := m.IfInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn42
...
func (m *InterfaceSpec_IfEnicInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfEnicInfo != nil {
		...
		n43, err := m.IfEnicInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *InterfaceSpec_IfUplinkInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfUplinkInfo != nil {
		...
		n44, err := m.IfUplinkInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *InterfaceSpec_IfUplinkPcInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfUplinkPcInfo != nil {
		...
		n45, err := m.IfUplinkPcInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *InterfaceSpec_IfTunnelInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfTunnelInfo != nil {
		...
		n46, err := m.IfTunnelInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *InterfaceSpec_IfCpuInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfCpuInfo != nil {
		...
		n47, err := m.IfCpuInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *InterfaceSpec_IfAppRedirInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfAppRedirInfo != nil {
		...
		n48, err := m.IfAppRedirInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *EnicL2SegInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L2SegmentKeyOrHandle != nil {
		...
		n49, err := m.L2SegmentKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *TunnelIfResponseInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.InpMapNatIdx) > 0 {
		dAtA51 := make([]byte, len(m.InpMapNatIdx)*10)
		var j50 int
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintInterface(dAtA, i, uint64(j50))
		i += copy(dAtA[i:], dAtA51[:j50])
	}
	if len(m.InpMapTnlIdx) > 0 {
		dAtA53 := make([]byte, len(m.InpMapTnlIdx)*10)
		var j52 int
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintInterface(dAtA, i, uint64(j52))
...
func (m *InterfaceStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IfResponseInfo != nil {
		nn54, err := m.IfResponseInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn54
...
func (m *InterfaceStatus_UplinkInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UplinkInfo != nil {
		...
		n55, err := m.UplinkInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n55
...
func (m *InterfaceStatus_EnicInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EnicInfo != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.EnicInfo.Size()))
		n56, err := m.EnicInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *InterfaceStatus_CpuInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CpuInfo != nil {
		...
		n57, err := m.CpuInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
...
func (m *InterfaceStatus_TunnelInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TunnelInfo != nil {
		...
		n58, err := m.TunnelInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n58
...
func (m *InterfaceStatus_AppRedirInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AppRedirInfo != nil {
		...
		n59, err := m.AppRedirInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n59
...
func (m *InterfaceDeleteRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Meta != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.Meta.Size()))
		n61, err := m.Meta.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n61
	...
	if m.KeyOrHandle != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.KeyOrHandle.Size()))
		n62, err := m.KeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n62
...
func (m *InterfaceGetRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.KeyOrHandle != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.KeyOrHandle.Size()))
		n64, err := m.KeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *InterfaceGetResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Stats != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.Stats.Size()))
		n67, err := m.Stats.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n67
...
func (m *InterfaceL2SegmentSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.L2SegmentKeyOrHandle != nil {
		...
		i++
		i = encodeVarintInterface(dAtA, i, uint64(m.L2SegmentKeyOrHandle.Size()))
		n69, err := m.L2SegmentKeyOrHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n69
	...
	if m.IfKeyHandle != nil {
		...
		n70, err := m.IfKeyHandle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n70
...
var fileDescriptorInterface = []byte{
	...
	,
}
