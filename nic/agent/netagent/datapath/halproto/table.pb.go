...
type TableFlowEntry struct {
	PrimaryIndexValid   bool   `protobuf:"varint,1,opt,name=primary_index_valid,json=primaryIndexValid,proto3" json:"primary_index_valid,omitempty"`
	PrimaryIndex        uint32 `protobuf:"varint,2,opt,name=primary_index,json=primaryIndex,proto3" json:"primary_index,omitempty"`
	SecondaryIndexValid bool   `protobuf:"varint,3,opt,name=secondary_index_valid,json=secondaryIndexValid,proto3" json:"secondary_index_valid,omitempty"`
	SecondaryIndex      uint32 `protobuf:"varint,4,opt,name=secondary_index,json=secondaryIndex,proto3" json:"secondary_index,omitempty"`
...
func (m *TableFlowEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PrimaryIndex != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintTable(dAtA, i, uint64(m.PrimaryIndex))
	}
	...
	if m.SecondaryIndex != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintTable(dAtA, i, uint64(m.SecondaryIndex))
	}
	if len(m.Key) > 0 {
		dAtA[i] = 0x2a
		i++
...
func (m *TableFlowEntry) Size() (n int) {
	...
	if m.PrimaryIndex != 0 {
		n += 1 + sovTable(uint64(m.PrimaryIndex))
	}
	if m.SecondaryIndexValid {
		n += 2
	}
	if m.SecondaryIndex != 0 {
		n += 1 + sovTable(uint64(m.SecondaryIndex))
	}
	l = len(m.Key)
	if l > 0 {
		n += 1 + l + sovTable(uint64(l))
...
var fileDescriptorTable = []byte{
	...
	,
}
