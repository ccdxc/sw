...
type IPSecGlobalStatisticsGetSpec struct {
	...
	DecryptBarcoBadIndescErrors       uint64 `protobuf:"varint,49,opt,name=decrypt_barco_bad_indesc_errors,json=decryptBarcoBadIndescErrors,proto3" json:"decrypt_barco_bad_indesc_errors,omitempty"`
	DecryptBarcoBadOutdescErrors      uint64 `protobuf:"varint,50,opt,name=decrypt_barco_bad_outdesc_errors,json=decryptBarcoBadOutdescErrors,proto3" json:"decrypt_barco_bad_outdesc_errors,omitempty"`
	DecryptBadIndescFreeErrors        uint64 `protobuf:"varint,51,opt,name=decrypt_bad_indesc_free_errors,json=decryptBadIndescFreeErrors,proto3" json:"decrypt_bad_indesc_free_errors,omitempty"`
	DecryptBadOutdescFreeErrors       uint64 `protobuf:"varint,52,opt,name=decrypt_bad_outdesc_free_errors,json=decryptBadOutdescFreeErrors,proto3" json:"decrypt_bad_outdesc_free_errors,omitempty"`
	RnmdprSemPindex                   uint32 `protobuf:"varint,53,opt,name=rnmdpr_sem_pindex,json=rnmdprSemPindex,proto3" json:"rnmdpr_sem_pindex,omitempty"`
	RnmdprSemCindex                   uint32 `protobuf:"varint,54,opt,name=rnmdpr_sem_cindex,json=rnmdprSemCindex,proto3" json:"rnmdpr_sem_cindex,omitempty"`
	Gcm0BarcoFullErrors               uint32 `protobuf:"varint,55,opt,name=gcm0_barco_full_errors,json=gcm0BarcoFullErrors,proto3" json:"gcm0_barco_full_errors,omitempty"`
	Gcm1BarcoFullErrors               uint32 `protobuf:"varint,56,opt,name=gcm1_barco_full_errors,json=gcm1BarcoFullErrors,proto3" json:"gcm1_barco_full_errors,omitempty"`
}
...
func (m *IPSecGlobalStatisticsGetSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DecryptBarcoBadIndescErrors != 0 {
		dAtA[i] = 0x88
		i++
		dAtA[i] = 0x3
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(m.DecryptBarcoBadIndescErrors))
	}
	if m.DecryptBarcoBadOutdescErrors != 0 {
		dAtA[i] = 0x90
		i++
		dAtA[i] = 0x3
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(m.DecryptBarcoBadOutdescErrors))
	}
	if m.DecryptBadIndescFreeErrors != 0 {
		dAtA[i] = 0x98
		i++
		dAtA[i] = 0x3
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(m.DecryptBadIndescFreeErrors))
	}
	if m.DecryptBadOutdescFreeErrors != 0 {
		dAtA[i] = 0xa0
		i++
		dAtA[i] = 0x3
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(m.DecryptBadOutdescFreeErrors))
	}
...
func (m *IPSecGlobalStatisticsGetSpec) Size() (n int) {
	...
	if m.DecryptBarcoBadIndescErrors != 0 {
		n += 2 + sovIpsec(uint64(m.DecryptBarcoBadIndescErrors))
	}
	if m.DecryptBarcoBadOutdescErrors != 0 {
		n += 2 + sovIpsec(uint64(m.DecryptBarcoBadOutdescErrors))
	}
	if m.DecryptBadIndescFreeErrors != 0 {
		n += 2 + sovIpsec(uint64(m.DecryptBadIndescFreeErrors))
	}
	if m.DecryptBadOutdescFreeErrors != 0 {
		n += 2 + sovIpsec(uint64(m.DecryptBadOutdescFreeErrors))
	}
	if m.RnmdprSemPindex != 0 {
...
func (m *IPSecGlobalStatisticsGetSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 49:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecryptBarcoBadIndescErrors", wireType)
			}
			m.DecryptBarcoBadIndescErrors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowIpsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DecryptBarcoBadIndescErrors |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 50:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecryptBarcoBadOutdescErrors", wireType)
			}
			m.DecryptBarcoBadOutdescErrors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowIpsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DecryptBarcoBadOutdescErrors |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 51:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecryptBadIndescFreeErrors", wireType)
			}
			m.DecryptBadIndescFreeErrors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowIpsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DecryptBadIndescFreeErrors |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 52:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecryptBadOutdescFreeErrors", wireType)
			}
			m.DecryptBadOutdescFreeErrors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowIpsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DecryptBadOutdescFreeErrors |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorIpsec = []byte{
	...
	,
}
