...
type IPSecGlobalStatisticsGetSpec struct {
	...
	EncryptBadIndescFreeErrors   uint64 `protobuf:"varint,25,opt,name=encrypt_bad_indesc_free_errors,json=encryptBadIndescFreeErrors,proto3" json:"encrypt_bad_indesc_free_errors,omitempty"`
	EncryptBadOutdescFreeErrors  uint64 `protobuf:"varint,26,opt,name=encrypt_bad_outdesc_free_errors,json=encryptBadOutdescFreeErrors,proto3" json:"encrypt_bad_outdesc_free_errors,omitempty"`
	DecryptInputDescErrors       uint64 `protobuf:"varint,27,opt,name=decrypt_input_desc_errors,json=decryptInputDescErrors,proto3" json:"decrypt_input_desc_errors,omitempty"`
	DecryptOutputDescErrors      uint64 `protobuf:"varint,28,opt,name=decrypt_output_desc_errors,json=decryptOutputDescErrors,proto3" json:"decrypt_output_desc_errors,omitempty"`
	DecryptCbRingBaseErrors      uint64 `protobuf:"varint,29,opt,name=decrypt_cb_ring_base_errors,json=decryptCbRingBaseErrors,proto3" json:"decrypt_cb_ring_base_errors,omitempty"`
	DecryptInputPageErrors       uint64 `protobuf:"varint,30,opt,name=decrypt_input_page_errors,json=decryptInputPageErrors,proto3" json:"decrypt_input_page_errors,omitempty"`
	DecryptBarcoReqAddrErrors    uint64 `protobuf:"varint,31,opt,name=decrypt_barco_req_addr_errors,json=decryptBarcoReqAddrErrors,proto3" json:"decrypt_barco_req_addr_errors,omitempty"`
	DecryptBarcoCbAddrErrors     uint64 `protobuf:"varint,32,opt,name=decrypt_barco_cb_addr_errors,json=decryptBarcoCbAddrErrors,proto3" json:"decrypt_barco_cb_addr_errors,omitempty"`
	DecryptStage4InpageErrors    uint64 `protobuf:"varint,33,opt,name=decrypt_stage4_inpage_errors,json=decryptStage4InpageErrors,proto3" json:"decrypt_stage4_inpage_errors,omitempty"`
	DecryptOutputPageErrors      uint64 `protobuf:"varint,34,opt,name=decrypt_output_page_errors,json=decryptOutputPageErrors,proto3" json:"decrypt_output_page_errors,omitempty"`
	DecryptTxdma1EnterCounters   uint64 `protobuf:"varint,35,opt,name=decrypt_txdma1_enter_counters,json=decryptTxdma1EnterCounters,proto3" json:"decrypt_txdma1_enter_counters,omitempty"`
	DecryptTxdma2EnterCounters   uint64 `protobuf:"varint,36,opt,name=decrypt_txdma2_enter_counters,json=decryptTxdma2EnterCounters,proto3" json:"decrypt_txdma2_enter_counters,omitempty"`
	DecryptTxdma1DropCounters    uint64 `protobuf:"varint,37,opt,name=decrypt_txdma1_drop_counters,json=decryptTxdma1DropCounters,proto3" json:"decrypt_txdma1_drop_counters,omitempty"`
	DecryptDescExhaustErrors     uint64 `protobuf:"varint,38,opt,name=decrypt_desc_exhaust_errors,json=decryptDescExhaustErrors,proto3" json:"decrypt_desc_exhaust_errors,omitempty"`
	DecryptLoadIpsecIntErrors    uint64 `protobuf:"varint,39,opt,name=decrypt_load_ipsec_int_errors,json=decryptLoadIpsecIntErrors,proto3" json:"decrypt_load_ipsec_int_errors,omitempty"`
	DecryptTxdma1DummyErrors     uint64 `protobuf:"varint,40,opt,name=decrypt_txdma1_dummy_errors,json=decryptTxdma1DummyErrors,proto3" json:"decrypt_txdma1_dummy_errors,omitempty"`
	DecryptTxdma2DummyFree       uint64 `protobuf:"varint,41,opt,name=decrypt_txdma2_dummy_free,json=decryptTxdma2DummyFree,proto3" json:"decrypt_txdma2_dummy_free,omitempty"`
	DecryptRxdmaDummyDescErrors  uint64 `protobuf:"varint,42,opt,name=decrypt_rxdma_dummy_desc_errors,json=decryptRxdmaDummyDescErrors,proto3" json:"decrypt_rxdma_dummy_desc_errors,omitempty"`
	DecryptRxdmaEnterCounters    uint64 `protobuf:"varint,43,opt,name=decrypt_rxdma_enter_counters,json=decryptRxdmaEnterCounters,proto3" json:"decrypt_rxdma_enter_counters,omitempty"`
	DecryptBarcoBadIndescErrors  uint64 `protobuf:"varint,44,opt,name=decrypt_barco_bad_indesc_errors,json=decryptBarcoBadIndescErrors,proto3" json:"decrypt_barco_bad_indesc_errors,omitempty"`
	DecryptBarcoBadOutdescErrors uint64 `protobuf:"varint,45,opt,name=decrypt_barco_bad_outdesc_errors,json=decryptBarcoBadOutdescErrors,proto3" json:"decrypt_barco_bad_outdesc_errors,omitempty"`
	DecryptBadIndescFreeErrors   uint64 `protobuf:"varint,46,opt,name=decrypt_bad_indesc_free_errors,json=decryptBadIndescFreeErrors,proto3" json:"decrypt_bad_indesc_free_errors,omitempty"`
	DecryptBadOutdescFreeErrors  uint64 `protobuf:"varint,47,opt,name=decrypt_bad_outdesc_free_errors,json=decryptBadOutdescFreeErrors,proto3" json:"decrypt_bad_outdesc_free_errors,omitempty"`
}
...
func (m *IPSecGlobalStatisticsGetSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EncryptBadIndescFreeErrors != 0 {
		dAtA[i] = 0xc8
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(m.EncryptBadIndescFreeErrors))
	}
	if m.EncryptBadOutdescFreeErrors != 0 {
		dAtA[i] = 0xd0
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintIpsec(dAtA, i, uint64(m.EncryptBadOutdescFreeErrors))
	}
...
func (m *IPSecGlobalStatisticsGetSpec) Size() (n int) {
	...
	if m.EncryptBadIndescFreeErrors != 0 {
		n += 2 + sovIpsec(uint64(m.EncryptBadIndescFreeErrors))
	}
	if m.EncryptBadOutdescFreeErrors != 0 {
		n += 2 + sovIpsec(uint64(m.EncryptBadOutdescFreeErrors))
	}
	if m.DecryptInputDescErrors != 0 {
...
func (m *IPSecGlobalStatisticsGetSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptBadIndescFreeErrors", wireType)
			}
			m.EncryptBadIndescFreeErrors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowIpsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EncryptBadIndescFreeErrors |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncryptBadOutdescFreeErrors", wireType)
			}
			m.EncryptBadOutdescFreeErrors = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowIpsec
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EncryptBadOutdescFreeErrors |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorIpsec = []byte{
	...
	,
}
