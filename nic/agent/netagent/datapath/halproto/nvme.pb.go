...
type NvmeEnableResponse struct {
	...
	ResourcecbAddr       uint64    `protobuf:"varint,4,opt,name=resourcecb_addr,json=resourcecbAddr,proto3" json:"resourcecb_addr,omitempty"`
	TxPduContextRingBase uint64    `protobuf:"varint,5,opt,name=tx_pdu_context_ring_base,json=txPduContextRingBase,proto3" json:"tx_pdu_context_ring_base,omitempty"`
	TxPduContextPageBase uint64    `protobuf:"varint,6,opt,name=tx_pdu_context_page_base,json=txPduContextPageBase,proto3" json:"tx_pdu_context_page_base,omitempty"`
	RxPduContextRingBase uint64    `protobuf:"varint,7,opt,name=rx_pdu_context_ring_base,json=rxPduContextRingBase,proto3" json:"rx_pdu_context_ring_base,omitempty"`
	RxPduContextPageBase uint64    `protobuf:"varint,8,opt,name=rx_pdu_context_page_base,json=rxPduContextPageBase,proto3" json:"rx_pdu_context_page_base,omitempty"`
	TxHwxtscbAddr        uint64    `protobuf:"varint,9,opt,name=tx_hwxtscb_addr,json=txHwxtscbAddr,proto3" json:"tx_hwxtscb_addr,omitempty"`
	TxHwdgstcbAddr       uint64    `protobuf:"varint,10,opt,name=tx_hwdgstcb_addr,json=txHwdgstcbAddr,proto3" json:"tx_hwdgstcb_addr,omitempty"`
	RxHwxtscbAddr        uint64    `protobuf:"varint,11,opt,name=rx_hwxtscb_addr,json=rxHwxtscbAddr,proto3" json:"rx_hwxtscb_addr,omitempty"`
	RxHwdgstcbAddr       uint64    `protobuf:"varint,12,opt,name=rx_hwdgstcb_addr,json=rxHwdgstcbAddr,proto3" json:"rx_hwdgstcb_addr,omitempty"`
}
...
func (m *NvmeEnableResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResourcecbAddr != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.ResourcecbAddr))
	}
	if m.TxPduContextRingBase != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.TxPduContextRingBase))
	}
	if m.TxPduContextPageBase != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.TxPduContextPageBase))
	}
	if m.RxPduContextRingBase != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.RxPduContextRingBase))
	}
	if m.RxPduContextPageBase != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.RxPduContextPageBase))
	}
	if m.TxHwxtscbAddr != 0 {
		dAtA[i] = 0x48
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.TxHwxtscbAddr))
	}
	if m.TxHwdgstcbAddr != 0 {
		dAtA[i] = 0x50
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.TxHwdgstcbAddr))
	}
	if m.RxHwxtscbAddr != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.RxHwxtscbAddr))
	}
	if m.RxHwdgstcbAddr != 0 {
		dAtA[i] = 0x60
		i++
		i = encodeVarintNvme(dAtA, i, uint64(m.RxHwdgstcbAddr))
	}
	return i, nil
}
...
func (m *NvmeEnableResponse) Size() (n int) {
	...
	if m.ResourcecbAddr != 0 {
		n += 1 + sovNvme(uint64(m.ResourcecbAddr))
	}
	if m.TxPduContextRingBase != 0 {
		n += 1 + sovNvme(uint64(m.TxPduContextRingBase))
	}
	if m.TxPduContextPageBase != 0 {
		n += 1 + sovNvme(uint64(m.TxPduContextPageBase))
	}
	if m.RxPduContextRingBase != 0 {
		n += 1 + sovNvme(uint64(m.RxPduContextRingBase))
	}
	if m.RxPduContextPageBase != 0 {
		n += 1 + sovNvme(uint64(m.RxPduContextPageBase))
	}
	if m.TxHwxtscbAddr != 0 {
		n += 1 + sovNvme(uint64(m.TxHwxtscbAddr))
	}
	if m.TxHwdgstcbAddr != 0 {
		n += 1 + sovNvme(uint64(m.TxHwdgstcbAddr))
	}
	if m.RxHwxtscbAddr != 0 {
		n += 1 + sovNvme(uint64(m.RxHwxtscbAddr))
	}
	if m.RxHwdgstcbAddr != 0 {
		n += 1 + sovNvme(uint64(m.RxHwdgstcbAddr))
	}
	return n
}
...
func (m *NvmeEnableResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourcecbAddr", wireType)
			}
			m.ResourcecbAddr = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResourcecbAddr |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxPduContextRingBase", wireType)
			}
			m.TxPduContextRingBase = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNvme
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxPduContextRingBase |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxPduContextPageBase", wireType)
			}
			m.TxPduContextPageBase = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNvme
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxPduContextPageBase |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RxPduContextRingBase", wireType)
			}
			m.RxPduContextRingBase = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNvme
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RxPduContextRingBase |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RxPduContextPageBase", wireType)
			}
			m.RxPduContextPageBase = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNvme
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RxPduContextPageBase |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxHwxtscbAddr", wireType)
			}
			m.TxHwxtscbAddr = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxHwxtscbAddr |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxHwdgstcbAddr", wireType)
			}
			m.TxHwdgstcbAddr = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxHwdgstcbAddr |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RxHwxtscbAddr", wireType)
			}
			m.RxHwxtscbAddr = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RxHwxtscbAddr |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RxHwdgstcbAddr", wireType)
			}
			m.RxHwdgstcbAddr = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RxHwdgstcbAddr |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorNvme = []byte{
	...
	,
}
