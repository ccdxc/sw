...
func (*ICMPMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*DoSService) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*DoSSessionLimits) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*DoSPolicer) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func (*DoSFloodLimits) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4} }
...
func (*DoSFloodLimits_ProtectLimits) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4, 1} }
...
func (*DoSProtectionSpec) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{5} }
...
func (*IngressDoSPolicy) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{6} }
...
func (*EgressDoSPolicy) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{7} }
...
func (*DoSPolicySpec) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{8} }
...
func (*DoSPolicyRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{9} }
...
func (*DoSPolicyStatus) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{10} }
...
func (*DoSPolicyResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{11} }
...
func (*DoSPolicyResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{12} }
...
func (*DoSPolicyDeleteRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{13} }
...
func (*DoSPolicyDeleteRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{14} }
...
func (*DoSPolicyDeleteResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{15} }
...
func (*DoSPolicyDeleteResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{16} }
...
func (*DoSPolicyGetRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{17} }
...
func (*DoSPolicyGetRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{18} }
...
func (*DoSPolicyStats) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{19} }
...
func (*DoSPolicyGetResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{20} }
...
func (*DoSPolicyGetResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{21} }
...
func init() { proto.RegisterFile("dos.proto", fileDescriptor4) }
