...
type TcpProxyGlobalStats struct {
	...
	TcpDebug1            uint64 `protobuf:"varint,12,opt,name=tcp_debug1,json=tcpDebug1" json:"tcp_debug1,omitempty"`
	TcpDebug2            uint64 `protobuf:"varint,13,opt,name=tcp_debug2,json=tcpDebug2" json:"tcp_debug2,omitempty"`
	TcpDebug3            uint64 `protobuf:"varint,14,opt,name=tcp_debug3,json=tcpDebug3" json:"tcp_debug3,omitempty"`
	TcpDebug4            uint64 `protobuf:"varint,15,opt,name=tcp_debug4,json=tcpDebug4" json:"tcp_debug4,omitempty"`
	TcpDebug5            uint64 `protobuf:"varint,16,opt,name=tcp_debug5,json=tcpDebug5" json:"tcp_debug5,omitempty"`
	TcpDebug6            uint64 `protobuf:"varint,17,opt,name=tcp_debug6,json=tcpDebug6" json:"tcp_debug6,omitempty"`
	TcpDebug7            uint64 `protobuf:"varint,18,opt,name=tcp_debug7,json=tcpDebug7" json:"tcp_debug7,omitempty"`
	TcpDebug8            uint64 `protobuf:"varint,19,opt,name=tcp_debug8,json=tcpDebug8" json:"tcp_debug8,omitempty"`
	TcpDebug9            uint64 `protobuf:"varint,20,opt,name=tcp_debug9,json=tcpDebug9" json:"tcp_debug9,omitempty"`
	TcpDebug10           uint64 `protobuf:"varint,21,opt,name=tcp_debug10,json=tcpDebug10" json:"tcp_debug10,omitempty"`
}
...
var fileDescriptor30 = []byte{
	...
	,
}
