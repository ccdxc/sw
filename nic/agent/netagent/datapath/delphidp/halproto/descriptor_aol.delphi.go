...
func (*DescrAolRequest) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{0} }
...
func (*DescrAolRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{1} }
...
func (*DescrAolSpec) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{2} }
...
func (*DescrAolResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{3} }
...
func init() { proto.RegisterFile("descriptor_aol.proto", fileDescriptor27) }
