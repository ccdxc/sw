...
type IPSecGlobalStatisticsGetSpec struct {
	...
	DecryptInputDescErrors      uint64 `protobuf:"varint,22,opt,name=decrypt_input_desc_errors,json=decryptInputDescErrors" json:"decrypt_input_desc_errors,omitempty"`
	DecryptOutputDescErrors     uint64 `protobuf:"varint,23,opt,name=decrypt_output_desc_errors,json=decryptOutputDescErrors" json:"decrypt_output_desc_errors,omitempty"`
	DecryptCbRingBaseErrors     uint64 `protobuf:"varint,24,opt,name=decrypt_cb_ring_base_errors,json=decryptCbRingBaseErrors" json:"decrypt_cb_ring_base_errors,omitempty"`
	DecryptInputPageErrors      uint64 `protobuf:"varint,25,opt,name=decrypt_input_page_errors,json=decryptInputPageErrors" json:"decrypt_input_page_errors,omitempty"`
	DecryptBarcoReqAddrErrors   uint64 `protobuf:"varint,26,opt,name=decrypt_barco_req_addr_errors,json=decryptBarcoReqAddrErrors" json:"decrypt_barco_req_addr_errors,omitempty"`
	DecryptBarcoCbAddrErrors    uint64 `protobuf:"varint,27,opt,name=decrypt_barco_cb_addr_errors,json=decryptBarcoCbAddrErrors" json:"decrypt_barco_cb_addr_errors,omitempty"`
	DecryptStage4InpageErrors   uint64 `protobuf:"varint,28,opt,name=decrypt_stage4_inpage_errors,json=decryptStage4InpageErrors" json:"decrypt_stage4_inpage_errors,omitempty"`
	DecryptOutputPageErrors     uint64 `protobuf:"varint,29,opt,name=decrypt_output_page_errors,json=decryptOutputPageErrors" json:"decrypt_output_page_errors,omitempty"`
	DecryptTxdma1EnterCounters  uint64 `protobuf:"varint,30,opt,name=decrypt_txdma1_enter_counters,json=decryptTxdma1EnterCounters" json:"decrypt_txdma1_enter_counters,omitempty"`
	DecryptTxdma2EnterCounters  uint64 `protobuf:"varint,31,opt,name=decrypt_txdma2_enter_counters,json=decryptTxdma2EnterCounters" json:"decrypt_txdma2_enter_counters,omitempty"`
	DecryptTxdma1DropCounters   uint64 `protobuf:"varint,32,opt,name=decrypt_txdma1_drop_counters,json=decryptTxdma1DropCounters" json:"decrypt_txdma1_drop_counters,omitempty"`
	DecryptDescExhaustErrors    uint64 `protobuf:"varint,33,opt,name=decrypt_desc_exhaust_errors,json=decryptDescExhaustErrors" json:"decrypt_desc_exhaust_errors,omitempty"`
	DecryptLoadIpsecIntErrors   uint64 `protobuf:"varint,34,opt,name=decrypt_load_ipsec_int_errors,json=decryptLoadIpsecIntErrors" json:"decrypt_load_ipsec_int_errors,omitempty"`
	DecryptTxdma1DummyErrors    uint64 `protobuf:"varint,35,opt,name=decrypt_txdma1_dummy_errors,json=decryptTxdma1DummyErrors" json:"decrypt_txdma1_dummy_errors,omitempty"`
	DecryptTxdma2DummyFree      uint64 `protobuf:"varint,36,opt,name=decrypt_txdma2_dummy_free,json=decryptTxdma2DummyFree" json:"decrypt_txdma2_dummy_free,omitempty"`
	DecryptRxdmaDummyDescErrors uint64 `protobuf:"varint,37,opt,name=decrypt_rxdma_dummy_desc_errors,json=decryptRxdmaDummyDescErrors" json:"decrypt_rxdma_dummy_desc_errors,omitempty"`
}
...
var fileDescriptor13 = []byte{
	...
	,
}
