...
func (EpLearnType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (DhcpTransactionState) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*EplearnDhcpCfg) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*EplearnArpCfg) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*EplearnDataPacketCfg) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*EplearnCfg) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (*ArpStats) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{4} }
...
func (*DhcpStats) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{5} }
...
func (*L2EplearnStats) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{6} }
...
func (*DhcpStatus) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{7} }
...
func (*ArpStatus) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{8} }
...
func (*EplearnStats) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{9} }
...
func (*EplearnStatus) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{10} }
...
func init() { proto.RegisterFile("eplearn.proto", fileDescriptor6) }
