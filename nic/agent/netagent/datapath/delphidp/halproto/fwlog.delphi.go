...
func (FlowLogEventType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*FWEvent) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func init() { proto.RegisterFile("fwlog.proto", fileDescriptor1) }
