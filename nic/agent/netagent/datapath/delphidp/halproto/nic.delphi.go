...
func (DeviceMode) EnumDescriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*DeviceSpec) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*DeviceRequest) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{1} }
...
func (*DeviceRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2} }
...
func (*DeviceResponse) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{3} }
...
func (*DeviceResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{4} }
...
func (*DeviceGetRequest) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{5} }
...
func (*DeviceGetRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{6} }
...
func (*DeviceGetResponse) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{7} }
...
func (*DeviceGetResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{8} }
