...
func (*TlsProxyCbKeyHandle) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{0} }
...
func (*TlsProxyCbSpec) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{1} }
...
func (*TlsProxyCbRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{2} }
...
func (*TlsProxyCbStatus) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{3} }
...
func (*TlsProxyCbResponse) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{4} }
...
func (*TlsProxyCbResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{5} }
...
func (*TlsProxyCbDeleteRequest) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{6} }
...
func (*TlsProxyCbDeleteRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{7} }
...
func (*TlsProxyCbDeleteResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{8} }
...
func (*TlsProxyCbGetRequest) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{9} }
...
func (*TlsProxyCbGetRequestMsg) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{10} }
...
func (*TlsProxyCbStats) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{11} }
...
func (*TlsProxyCbGetResponse) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{12} }
...
func (*TlsProxyCbGetResponseMsg) Descriptor() ([]byte, []int) { return fileDescriptor30, []int{13} }
...
func init() { proto.RegisterFile("tls_proxy_cb2.proto", fileDescriptor30) }
