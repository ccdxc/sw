...
func showIpsecGlobalStatistics(resp *halproto.IpsecGlobalStatisticsGetResponse) {
	...
	fmt.Printf("%-40s : %-6d\n", "encrypt_barco_bad_indesc_errors", spec.EncryptBarcoBadIndescErrors)
	fmt.Printf("%-40s : %-6d\n", "encrypt_barco_bad_outdesc_errors", spec.EncryptBarcoBadOutdescErrors)
	fmt.Printf("%-40s : %-6d\n", "encrypt_bad_indesc_free_errors", spec.EncryptBadIndescFreeErrors)
	fmt.Printf("%-40s : %-6d\n", "encrypt_bad_outdesc_free_errors", spec.EncryptBadOutdescFreeErrors)
	...
	fmt.Printf("%-40s : %-6d\n", "decrypt_barco_bad_indesc_errors", spec.DecryptBarcoBadIndescErrors)
	fmt.Printf("%-40s : %-6d\n", "decrypt_barco_bad_outdesc_errors", spec.DecryptBarcoBadOutdescErrors)
	fmt.Printf("%-40s : %-6d\n", "decrypt_bad_indesc_free_errors", spec.DecryptBadIndescFreeErrors)
	fmt.Printf("%-40s : %-6d\n", "decrypt_bad_outdesc_free_errors", spec.DecryptBadOutdescFreeErrors)
}
