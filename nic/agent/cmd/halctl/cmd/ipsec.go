...
func showIpsecGlobalStatistics(resp *halproto.IpsecGlobalStatisticsGetResponse) {
	...
	fmt.Printf("\n%-40s : %-6d\n", "rnmdpr_sem_pindex", spec.RnmdprSemPindex)
	fmt.Printf("%-40s : %-6d\n", "rnmdpr_sem_cindex", spec.RnmdprSemCindex)
	fmt.Printf("%-40s : %-6d\n", "gcm0_barco_full_errors", spec.Gcm0BarcoFullErrors)
	fmt.Printf("%-40s : %-6d\n", "gcm1_barco_full_errors", spec.Gcm1BarcoFullErrors)
}
