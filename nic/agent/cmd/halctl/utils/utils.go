...
// CmdSend function to send commands over unix domain sockets
// param[in] unix domain socket path
// param[in] []byte cmd to be sent over socket
// param[in] fds
// return    []byte response read back from socket
