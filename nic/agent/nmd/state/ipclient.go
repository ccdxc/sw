...
// UpdateDelphiNaplesObject updates the delphi object
...
// UpdateTransitionPhase updates nmd transition state
func (c *IPClient) UpdateTransitionPhase() {
