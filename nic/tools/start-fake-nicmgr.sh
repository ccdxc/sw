...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$NIC_DIR/../bazel-bin/nic/model_sim/:$SNORT_EXPORT_DIR/x86_64/lib/:$NIC_DIR/sdk/obj/lib:$NIC_DIR/sdk/obj/lib/external:$NIC_DIR/hal/obj
