...
metadata scratch_meta_t scratch_meta;
...
action nop() {
    // dummy instr to avoid frame_size getting removed by hlir
    modify_field(scratch_meta.frame_size, capri_p4_intrinsic.frame_size);
}
