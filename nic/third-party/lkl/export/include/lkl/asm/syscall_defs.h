...
#endif
#ifdef __lkl__NR_pause
LKL_SYSCALL_DEFINE0(_pause,)
#endif
...
#endif
#ifdef __lkl__NR_getpgrp
LKL_SYSCALL_DEFINE0(_getpgrp,)
#endif
...
#endif
#ifdef __lkl__NR_alarm
LKL_SYSCALL_DEFINE1(_alarm,unsigned int,seconds)
#endif
...
#endif
#ifdef __lkl__NR_pipe
LKL_SYSCALL_DEFINE1(_pipe,int *,fildes)
#endif
#ifdef __lkl__NR_mknodat
LKL_SYSCALL_DEFINE4(_mknodat,int,dfd,const char *,filename,lkl_umode_t,mode,unsigned,dev)
#endif
...
LKL_SYSCALL_DEFINE1(_oldumount,char *,name)
#endif
