...
#define LKL_NLM_F_REQUEST		1	/* It is request message. 	*/
#define LKL_NLM_F_MULTI		2	/* Multipart message, terminated by LKL_NLMSG_DONE */
#define LKL_NLM_F_ACK		4	/* Reply with ack, with zero or error code */
#define LKL_NLM_F_ECHO		8	/* Echo this request 		*/
#define LKL_NLM_F_DUMP_INTR		16	/* Dump was inconsistent due to sequence change */
#define LKL_NLM_F_DUMP_FILTERED	32	/* Dump was filtered as requested */
