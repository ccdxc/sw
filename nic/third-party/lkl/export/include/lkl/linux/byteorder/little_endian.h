...
{
	return (__lkl__be64)__swab64p(p);
}
...
{
	return (__lkl__be32)__swab32p(p);
}
...
{
	return (__lkl__be16)__swab16p(p);
}
...
#define __lkl__cpu_to_be64s(x) __swab64s((x))
#define __lkl__be64_to_cpus(x) __swab64s((x))
#define __lkl__cpu_to_be32s(x) __swab32s((x))
#define __lkl__be32_to_cpus(x) __swab32s((x))
