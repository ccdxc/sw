...
# define pen_BIO_get_flags(b) pen_BIO_test_flags(b, ~(0x0))
...
# define BIO_get_retry_flags(b) \
                pen_BIO_test_flags(b, (BIO_FLAGS_RWS|BIO_FLAGS_SHOULD_RETRY))

/* These should be used by the application to tell why we should retry */
# define pen_BIO_should_read(a)              pen_BIO_test_flags(a, BIO_FLAGS_READ)
# define pen_BIO_should_write(a)             pen_BIO_test_flags(a, BIO_FLAGS_WRITE)
# define pen_BIO_should_io_special(a)        pen_BIO_test_flags(a, BIO_FLAGS_IO_SPECIAL)
# define pen_BIO_retry_type(a)               pen_BIO_test_flags(a, BIO_FLAGS_RWS)
# define pen_BIO_should_retry(a)             pen_BIO_test_flags(a, BIO_FLAGS_SHOULD_RETRY)
