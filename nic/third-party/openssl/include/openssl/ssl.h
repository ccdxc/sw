...
# define OpenSSL_add_ssl_algorithms()    pen_SSL_library_init()
# if OPENSSL_API_COMPAT < 0x10100000L
#  define SSLeay_add_ssl_algorithms()    pen_SSL_library_init()
# endif
...
#if OPENSSL_API_COMPAT < 0x10100000L
# define pen_SSL_load_error_strings() \
    pen_OPENSSL_init_ssl(OPENSSL_INIT_LOAD_SSL_STRINGS \
...
#define SSLv23_method           pen_TLS_method
#define SSLv23_server_method    pen_TLS_server_method
#define SSLv23_client_method    pen_TLS_client_method
...
#if OPENSSL_API_COMPAT < 0x10100000L
# define pen_SSL_library_init() pen_OPENSSL_init_ssl(0, NULL)
#endif
