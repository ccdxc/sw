...
l4_profile:
    ...
    phvwr           p.{l4_metadata_ip_rsvd_flags_action, \
                        ...
                        d.{u.l4_profile_d.ip_rsvd_flags_action, \
                        u.l4_profile_d.ip_df_action, \
    ...
    phvwr.c1        p.l4_metadata_icmp_normalization_en, \
                        d.u.l4_profile_d.icmp_normalization_en

    ASSERT_PHVWR(p, l4_metadata_icmp_deprecated_msgs_drop, l4_metadata_tcp_flags_nonsyn_noack_drop,
                 d, u.l4_profile_d.icmp_deprecated_msgs_drop, u.l4_profile_d.tcp_flags_nonsyn_noack_drop)
    ...
    or              r1, d.u.l4_profile_d.ip_bm_mc_policy_enf_cfg_en, \
