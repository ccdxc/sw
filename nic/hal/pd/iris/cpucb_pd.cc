...
p4pd_add_or_del_cpucb_rx_qidxr_entry(pd_cpucb_t* cpucb_pd, cpucb_hw_id_t addr)
{
    ...
    HAL_TRACE_DEBUG(" Programming qidxr pi0 : {:#x}", data.u.write_arqrx_d.pi_0);
    HAL_TRACE_DEBUG(" Programming qidxr pi1 : {:#x}", data.u.write_arqrx_d.pi_1);
    HAL_TRACE_DEBUG(" Programming qidxr pi2 : {:#x}", data.u.write_arqrx_d.pi_2);
...
hal_ret_t
pd_cpucb_create (pd_cpucb_args_t *args)
{
    hal_ret_t               ret;
    pd_cpucb_s              *cpucb_pd;
...
hal_ret_t
pd_cpucb_get (pd_cpucb_args_t *args)
{
    hal_ret_t               ret;
    pd_cpucb_t              cpucb_pd;
