...
static uint8_t p4pluspd_txdma_get_tableid_from_tablename(const char *tablename)
{
...
static p4pd_table_dir_en p4pluspd_txdma_get_table_direction(const char *direction)
{
...
static p4pd_table_type_en p4pluspd_txdma_get_table_type(const char *match_type)
{
...
#else
     full_path =  std::string(P4PLUSPD_TXDMA_TBL_PACKING_JSON);
#endif
