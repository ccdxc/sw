...
#define nvme_sessxtsrxcb_t s3_t0_nvme_sessprexts_rx_cb_writeback_process_bitfield_t
#define nvme_sessdgstrxcb_t s4_t0_nvme_sesspredgst_rx_cb_writeback_process_bitfield_t
#define nvme_rxhwxtscb_t s2_t1_nvme_sessprexts_rx_xtscb_process_bitfield_t
#define nvme_rxhwdgstcb_t s3_t0_nvme_sesspredgst_rx_dgstcb_process_bitfield_t
#define nvme_sqcb_t s6_t0_nvme_req_tx_sqcb_writeback_process_bitfield_t
#define nvme_rqcb_t s5_t0_nvme_req_rx_rqcb_writeback_process_bitfield_t
