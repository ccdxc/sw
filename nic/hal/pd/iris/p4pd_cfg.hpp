...
pipeline_cfg_init (p4pd_cfg_t *p4pd_cfg, p4pd_cfg_t *p4pd_rxdma_cfg, 
 ...
 {
     if (p4pd_cfg) {
         p4pd_cfg->table_map_cfg_file  = "iris/capri_p4_table_map.json";
     ...
     if (p4pd_rxdma_cfg) {
         p4pd_rxdma_cfg->table_map_cfg_file  = "iris/capri_p4_rxdma_table_map.json";
     ...
     if (p4pd_txdma_cfg) {
         p4pd_txdma_cfg->table_map_cfg_file  = "iris/capri_p4_txdma_table_map.json";
