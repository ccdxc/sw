...
common_p4plus_symbols_init (void **p4plus_symbols, platform_type_t platform_type)
{
    ...
    *p4plus_symbols = (sdk::p4::p4_prog_param_info_t *)
    ...
    symbols[i].name = "tcp_ooq_txdma_free_queue.bin";
    symbols[i].num_params = 1;
    symbols[i].params[0].name = TCP_OOQ_TABLE_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_TCP_OOO_QBASE_RING);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_BRQ);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_PAD_TABLE);
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS);
    i++;
    ...
    symbols[i].name = "esp_ipv4_tunnel_n2h_txdma2_ipsec_free_resources.bin";
    symbols[i].num_params = 2;
    ...
    symbols[i].params[1].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS) + IPSEC_N2H_GLOBAL_STATS_OFFSET;
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS) + IPSEC_N2H_GLOBAL_STATS_OFFSET;
    i++;
    ...
    symbols[i].params[1].val = get_mem_addr(CAPRI_HBM_REG_TLS_PROXY_PAD_TABLE) +
                                BARCO_GCM1_PI_HBM_TABLE_OFFSET;
    symbols[i].params[2].name = IPSEC_GLOBAL_BAD_DMA_COUNTER_BASE_N2H;
    symbols[i].params[2].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS) + IPSEC_N2H_GLOBAL_STATS_OFFSET;
    i++;
    ...
    symbols[i].params[1].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_NMPR_RX);
    symbols[i].params[2].name = IPSEC_TNMDR_TABLE_BASE;
    symbols[i].params[2].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_NMDR_TX);
    ...
    symbols[i].params[4].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS);
    i++;
    ...
    symbols[i].params[4].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS) + IPSEC_N2H_GLOBAL_STATS_OFFSET;
    i++;
    ...
    symbols[i].params[2].val = get_mem_addr(CAPRI_HBM_REG_IPSEC_GLOBAL_DROP_STATS);
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_ARQRX);
    i++;
    ...
    if ((offset = get_mem_addr("flow_stats")) != INVALID_MEM_ADDRESS) {
        ...
        symbols[i].params[1].val = get_mem_addr(CAPRI_HBM_REG_P4_ATOMIC_STATS);
        i++;
    }
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_NMDR_RX_GC);
    symbols[i].params[1].name = TNMDR_GC_TABLE_BASE;
    symbols[i].params[1].val = get_mem_addr(CAPRI_HBM_REG_NMDR_TX_GC);
    symbols[i].params[2].name = TCP_PROXY_STATS;
    symbols[i].params[2].val = get_mem_addr(CAPRI_HBM_REG_TCP_PROXY_STATS);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_TLS_PROXY_PAD_TABLE) +
    ...
    symbols[i].num_params = 1;
    symbols[i].params[0].name = BRQ_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_BARCO_RING_MPP1);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_RDMA_EQ_INTR_TABLE);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_RDMA_ATOMIC_RESOURCE_ADDR);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_P4PT_TCB_MEM);
    i++;

    symbols[i].name = "p4pt_update_tcb.bin";
    symbols[i].num_params = 1;
    symbols[i].params[0].name = P4PT_TCB_ISCSI_REC_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_P4PT_TCB_ISCSI_REC_MEM);
    i++;

    symbols[i].name = "p4pt_update_tcb_rec.bin";
    symbols[i].num_params = 1;
    symbols[i].params[0].name = P4PT_TCB_ISCSI_STATS_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_P4PT_TCB_ISCSI_STATS_MEM);
    i++;

    symbols[i].name = "p4pt_update_tcb_stats.bin";
    symbols[i].num_params = 1;
    symbols[i].params[0].name = P4PT_TCB_ISCSI_READ_LATENCY_DISTRIBUTION_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_P4PT_TCB_ISCSI_READ_LATENCY_DISTRIBUTION_MEM);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_P4PT_TCB_ISCSI_WRITE_LATENCY_DISTRIBUTION_MEM);
    i++;
    ...
    symbols[i].num_params = 1;
    symbols[i].params[0].name = BRQ_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_BARCO_RING_MPP2);
    i++;

    symbols[i].name = "tls-mac-queue-enc-brq.bin";
    symbols[i].num_params = 1;
    symbols[i].params[0].name = BRQ_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_BARCO_RING_MPP3);
    i++;
    ...
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_LIF_STATS);
    i++;
    ...
    symbols[i].name = "rdma_aq_tx_wqe_process.bin";
    symbols[i].num_params = 1;
    symbols[i].params[0].name = LIF_STATS_BASE;
    symbols[i].params[0].val = get_mem_addr(CAPRI_HBM_REG_LIF_STATS);
    i++;
