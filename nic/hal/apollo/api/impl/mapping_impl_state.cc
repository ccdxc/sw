...
typedef struct local_ip_mapping_tbl_data_s {
} __PACK__ local_ip_mapping_tbl_data_t;

typedef struct remote_vnic_mapping_rx_tbl_data_s {
} __PACK__ remote_vnic_mapping_rx_tbl_data_t;

typedef struct remote_vnic_mapping_tx_tbl_data_s {
} __PACK__ remote_vnic_mapping_tx_tbl_data_t;
...
mapping_impl_state::mapping_impl_state() {
    ...
    local_ip_mapping_tbl_ =
        HbmHash::factory(tinfo.tablename, P4TBL_ID_LOCAL_IP_MAPPING,
                         ...
                         sizeof(local_ip_mapping_tbl_data_t),
    ...
    remote_vnic_mapping_rx_tbl_ =
        HbmHash::factory(tinfo.tablename, P4TBL_ID_REMOTE_VNIC_MAPPING_RX,
                         tinfo.oflow_table_id, tinfo.tabledepth,
                         ctinfo.tabledepth, tinfo.key_struct_size,
                         sizeof(remote_vnic_mapping_rx_tbl_data_t),
