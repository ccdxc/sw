...
hal_ret_t hal_linkmgr_init(hal_cfg_t *hal_cfg);
// signal handler type
...
int hal_thread_priority(sdk::lib::thread_role_t role);
int hal_thread_sched_policy(sdk::lib::thread_role_t thread_role);
