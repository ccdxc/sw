...
void tcp_transmit_pkt(unsigned char* pkt, unsigned int len, bool is_connect_req, uint16_t dst_lif, uint16_t src_lif, hal::flow_direction_t dir, uint16_t hw_vlan_id, uint16_t rencap_vlan);
hal_ret_t
