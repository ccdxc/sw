...
const std::string FTE_FEATURE_TCP_PROXY_TRIGGER_FLOW("pensando.io/proxy:tcp-trigger-flow");
...
extern "C" hal_ret_t proxy_plugin_init() {
    ...
    fte::register_feature(FTE_FEATURE_TCP_PROXY_TRIGGER_FLOW, tcp_exec_trigger_flow);
