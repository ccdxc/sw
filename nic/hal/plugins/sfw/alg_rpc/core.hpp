...
using session::RPCALGInfo;
using session::SUNRPCInfo;
using session::MSRPCInfo;
using session::EXPECTEDFlow;
...
void insert_rpc_expflow_from_proto(fte::ctx_t &ctx, l4_alg_status_t *l4_sess, rpc_cb_t cb,
...
void rpc_ctrl_session_info_from_proto(l4_alg_status_t *l4_sess, const RPCALGInfo &rpc_alg_info);
}  // namespace alg_rpc
}  // namespace plugins
}  // namespace hal
