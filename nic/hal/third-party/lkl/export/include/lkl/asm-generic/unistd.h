 ...
 * enable by default?
 */
#ifdef __LKL__ARCH_WANT_SYSCALL_NO_AT
#define __lkl__NR_open 1024
__LKL__SYSCALL(__lkl__NR_open, sys_open)
#define __lkl__NR_link 1025
__LKL__SYSCALL(__lkl__NR_link, sys_link)
#define __lkl__NR_unlink 1026
__LKL__SYSCALL(__lkl__NR_unlink, sys_unlink)
#define __lkl__NR_mknod 1027
__LKL__SYSCALL(__lkl__NR_mknod, sys_mknod)
#define __lkl__NR_chmod 1028
__LKL__SYSCALL(__lkl__NR_chmod, sys_chmod)
#define __lkl__NR_chown 1029
__LKL__SYSCALL(__lkl__NR_chown, sys_chown)
#define __lkl__NR_mkdir 1030
__LKL__SYSCALL(__lkl__NR_mkdir, sys_mkdir)
#define __lkl__NR_rmdir 1031
__LKL__SYSCALL(__lkl__NR_rmdir, sys_rmdir)
#define __lkl__NR_lchown 1032
__LKL__SYSCALL(__lkl__NR_lchown, sys_lchown)
#define __lkl__NR_access 1033
__LKL__SYSCALL(__lkl__NR_access, sys_access)
#define __lkl__NR_rename 1034
__LKL__SYSCALL(__lkl__NR_rename, sys_rename)
#define __lkl__NR_readlink 1035
__LKL__SYSCALL(__lkl__NR_readlink, sys_readlink)
#define __lkl__NR_symlink 1036
__LKL__SYSCALL(__lkl__NR_symlink, sys_symlink)
#define __lkl__NR_utimes 1037
__LKL__SYSCALL(__lkl__NR_utimes, sys_utimes)
#define __lkl__NR3264_stat 1038
__LKL__SC_3264(__lkl__NR3264_stat, sys_stat64, sys_newstat)
#define __lkl__NR3264_lstat 1039
__LKL__SC_3264(__lkl__NR3264_lstat, sys_lstat64, sys_newlstat)

#undef __lkl__NR_syscalls
#define __lkl__NR_syscalls (__lkl__NR3264_lstat+1)
#endif /* __LKL__ARCH_WANT_SYSCALL_NO_AT */

#ifdef __LKL__ARCH_WANT_SYSCALL_NO_FLAGS
#define __lkl__NR_pipe 1040
__LKL__SYSCALL(__lkl__NR_pipe, sys_pipe)
#define __lkl__NR_dup2 1041
__LKL__SYSCALL(__lkl__NR_dup2, sys_dup2)
#define __lkl__NR_epoll_create 1042
__LKL__SYSCALL(__lkl__NR_epoll_create, sys_epoll_create)
#define __lkl__NR_inotify_init 1043
__LKL__SYSCALL(__lkl__NR_inotify_init, sys_inotify_init)
#define __lkl__NR_eventfd 1044
__LKL__SYSCALL(__lkl__NR_eventfd, sys_eventfd)
#define __lkl__NR_signalfd 1045
__LKL__SYSCALL(__lkl__NR_signalfd, sys_signalfd)

#undef __lkl__NR_syscalls
#define __lkl__NR_syscalls (__lkl__NR_signalfd+1)
#endif /* __LKL__ARCH_WANT_SYSCALL_NO_FLAGS */

#if (__LKL__BITS_PER_LONG == 32 || defined(__SYSCALL_COMPAT)) && \
     defined(__ARCH_WANT_SYSCALL_OFF_T)
#define __lkl__NR_sendfile 1046
__LKL__SYSCALL(__lkl__NR_sendfile, sys_sendfile)
#define __lkl__NR_ftruncate 1047
__LKL__SYSCALL(__lkl__NR_ftruncate, sys_ftruncate)
#define __lkl__NR_truncate 1048
__LKL__SYSCALL(__lkl__NR_truncate, sys_truncate)
#define __lkl__NR_stat 1049
__LKL__SYSCALL(__lkl__NR_stat, sys_newstat)
#define __lkl__NR_lstat 1050
__LKL__SYSCALL(__lkl__NR_lstat, sys_newlstat)
#define __lkl__NR_fstat 1051
__LKL__SYSCALL(__lkl__NR_fstat, sys_newfstat)
#define __lkl__NR_fcntl 1052
__LKL__SYSCALL(__lkl__NR_fcntl, sys_fcntl)
#define __lkl__NR_fadvise64 1053
#define __LKL__ARCH_WANT_SYS_FADVISE64
__LKL__SYSCALL(__lkl__NR_fadvise64, sys_fadvise64)
#define __lkl__NR_newfstatat 1054
#define __LKL__ARCH_WANT_SYS_NEWFSTATAT
__LKL__SYSCALL(__lkl__NR_newfstatat, sys_newfstatat)
#define __lkl__NR_fstatfs 1055
__LKL__SYSCALL(__lkl__NR_fstatfs, sys_fstatfs)
#define __lkl__NR_statfs 1056
__LKL__SYSCALL(__lkl__NR_statfs, sys_statfs)
#define __lkl__NR_lseek 1057
__LKL__SYSCALL(__lkl__NR_lseek, sys_lseek)
#define __lkl__NR_mmap 1058
__LKL__SYSCALL(__lkl__NR_mmap, sys_mmap)

#undef __lkl__NR_syscalls
#define __lkl__NR_syscalls (__lkl__NR_mmap+1)
#endif /* 32 bit lkl_off_t syscalls */

#ifdef __LKL__ARCH_WANT_SYSCALL_DEPRECATED
#define __lkl__NR_alarm 1059
#define __LKL__ARCH_WANT_SYS_ALARM
__LKL__SYSCALL(__lkl__NR_alarm, sys_alarm)
#define __lkl__NR_getpgrp 1060
#define __LKL__ARCH_WANT_SYS_GETPGRP
__LKL__SYSCALL(__lkl__NR_getpgrp, sys_getpgrp)
#define __lkl__NR_pause 1061
#define __LKL__ARCH_WANT_SYS_PAUSE
__LKL__SYSCALL(__lkl__NR_pause, sys_pause)
#define __lkl__NR_time 1062
#define __LKL__ARCH_WANT_SYS_TIME
#define __LKL__ARCH_WANT_COMPAT_SYS_TIME
__LKL__SYSCALL(__lkl__NR_time, sys_time)
#define __lkl__NR_utime 1063
#define __LKL__ARCH_WANT_SYS_UTIME
__LKL__SYSCALL(__lkl__NR_utime, sys_utime)

#define __lkl__NR_creat 1064
__LKL__SYSCALL(__lkl__NR_creat, sys_creat)
#define __lkl__NR_getdents 1065
#define __LKL__ARCH_WANT_SYS_GETDENTS
__LKL__SYSCALL(__lkl__NR_getdents, sys_getdents)
#define __lkl__NR_futimesat 1066
__LKL__SYSCALL(__lkl__NR_futimesat, sys_futimesat)
#define __lkl__NR_select 1067
#define __LKL__ARCH_WANT_SYS_SELECT
__LKL__SYSCALL(__lkl__NR_select, sys_select)
#define __lkl__NR_poll 1068
__LKL__SYSCALL(__lkl__NR_poll, sys_poll)
#define __lkl__NR_epoll_wait 1069
__LKL__SYSCALL(__lkl__NR_epoll_wait, sys_epoll_wait)
#define __lkl__NR_ustat 1070
__LKL__SYSCALL(__lkl__NR_ustat, sys_ustat)
#define __lkl__NR_vfork 1071
__LKL__SYSCALL(__lkl__NR_vfork, sys_vfork)
#define __lkl__NR_oldwait4 1072
__LKL__SYSCALL(__lkl__NR_oldwait4, sys_wait4)
#define __lkl__NR_recv 1073
__LKL__SYSCALL(__lkl__NR_recv, sys_recv)
#define __lkl__NR_send 1074
__LKL__SYSCALL(__lkl__NR_send, sys_send)
#define __lkl__NR_bdflush 1075
__LKL__SYSCALL(__lkl__NR_bdflush, sys_bdflush)
#define __lkl__NR_umount 1076
__LKL__SYSCALL(__lkl__NR_umount, sys_oldumount)
#define __LKL__ARCH_WANT_SYS_OLDUMOUNT
#define __lkl__NR_uselib 1077
__LKL__SYSCALL(__lkl__NR_uselib, sys_uselib)
#define __lkl__NR__sysctl 1078
__LKL__SYSCALL(__lkl__NR__sysctl, sys_sysctl)

#define __lkl__NR_fork 1079
#ifdef CONFIG_MMU
__LKL__SYSCALL(__lkl__NR_fork, sys_fork)
#else
__LKL__SYSCALL(__lkl__NR_fork, sys_ni_syscall)
#endif /* CONFIG_MMU */

#undef __lkl__NR_syscalls
#define __lkl__NR_syscalls (__lkl__NR_fork+1)

#endif /* __LKL__ARCH_WANT_SYSCALL_DEPRECATED */
...
#ifdef __lkl__NR3264_stat
#define __lkl__NR_stat __lkl__NR3264_stat
#define __lkl__NR_lstat __lkl__NR3264_lstat
#endif
#else
...
#ifdef __lkl__NR3264_stat
#define __lkl__NR_stat64 __lkl__NR3264_stat
#define __lkl__NR_lstat64 __lkl__NR3264_lstat
#endif
#endif
