...
api_stats_fill_entry(ApiStatsEntry *entry, ApiCounter type)
{
    ...
    case sys::API_COUNTER_VRF_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_VRF_CREATE_CALL));
    ...
    case sys::API_COUNTER_VRF_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_VRF_UPDATE_CALL));
    ...
    case sys::API_COUNTER_VRF_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_VRF_DELETE_CALL));
    ...
    case sys::API_COUNTER_VRF_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_VRF_GET_CALL));
    ...
    case sys::API_COUNTER_ACL_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ACL_CREATE_CALL));
    ...
    case sys::API_COUNTER_ACL_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ACL_UPDATE_CALL));
    ...
    case sys::API_COUNTER_ACL_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ACL_DELETE_CALL));
    ...
    case sys::API_COUNTER_ACL_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ACL_GET_CALL));
    ...
    case sys::API_COUNTER_CPUCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CPUCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_CPUCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CPUCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_CPUCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CPUCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_CPUCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CPUCB_GET_CALL));
    ...
    case sys::API_COUNTER_CRYPTOAPI_INVOKE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CRYPTOAPI_INVOKE_CALL));
    ...
    case sys::API_COUNTER_CRYPTOKEY_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CRYPTOKEY_CREATE_CALL));
    ...
    case sys::API_COUNTER_CRYPTOKEY_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CRYPTOKEY_UPDATE_CALL));
    ...
    case sys::API_COUNTER_CRYPTOKEY_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CRYPTOKEY_DELETE_CALL));
    ...
    case sys::API_COUNTER_CRYPTOKEY_READ:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CRYPTOKEY_READ_CALL));
    ...
    case sys::API_COUNTER_DESCRAOL_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_DESCRAOL_GET_CALL));
    ...
    case sys::API_COUNTER_ENDPOINT_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ENDPOINT_CREATE_CALL));
    ...
    case sys::API_COUNTER_ENDPOINT_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ENDPOINT_UPDATE_CALL));
    ...
    case sys::API_COUNTER_ENDPOINT_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ENDPOINT_DELETE_CALL));
    ...
    case sys::API_COUNTER_ENDPOINT_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ENDPOINT_GET_CALL));
    ...
    case sys::API_COUNTER_GFT_EXACT_MATCH_PROFILE_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_GFT_EXACT_MATCH_PROFILE_CREATE_CALL));
    ...
    case sys::API_COUNTER_GFT_HEADER_TRANSPOSITION_PROFILE_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_GFT_HEADER_TRANSPOSITION_PROFILE_CREATE_CALL));
    ...
    case sys::API_COUNTER_GFT_EXACT_MATCH_FLOW_ENTRY_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_GFT_EXACT_MATCH_FLOW_ENTRY_CREATE_CALL));
    ...
    case sys::API_COUNTER_GETPROGRAM_ADDRESS:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_GETPROGRAM_ADDRESS_CALL));
    ...
    case sys::API_COUNTER_ALLOCHBM_ADDRESS:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_ALLOCHBM_ADDRESS_CALL));
    ...
    case sys::API_COUNTER_CONFIGURELIF_BDF:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_CONFIGURELIF_BDF_CALL));
    ...
    case sys::API_COUNTER_IPSECCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_IPSECCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_IPSECCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_IPSECCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_IPSECCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_IPSECCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_IPSECCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_IPSECCB_GET_CALL));
    ...
    case sys::API_COUNTER_L2SEGMENT_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_L2SEGMENT_CREATE_CALL));
    ...
    case sys::API_COUNTER_L2SEGMENT_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_L2SEGMENT_UPDATE_CALL));
    ...
    case sys::API_COUNTER_L2SEGMENT_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_L2SEGMENT_DELETE_CALL));
    ...
    case sys::API_COUNTER_L2SEGMENT_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_L2SEGMENT_GET_CALL));
    ...
    case sys::API_COUNTER_L4LBSERVICE_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_L4LBSERVICE_CREATE_CALL));
    ...
    case sys::API_COUNTER_MULTICASTENTRY_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_MULTICASTENTRY_CREATE_CALL));
    ...
    case sys::API_COUNTER_MULTICASTENTRY_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_MULTICASTENTRY_UPDATE_CALL));
    ...
    case sys::API_COUNTER_MULTICASTENTRY_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_MULTICASTENTRY_DELETE_CALL));
    ...
    case sys::API_COUNTER_MULTICASTENTRY_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_MULTICASTENTRY_GET_CALL));
    ...
    case sys::API_COUNTER_SECURITYPROFILE_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYPROFILE_CREATE_CALL));
    ...
    case sys::API_COUNTER_SECURITYPROFILE_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYPROFILE_UPDATE_CALL));
    ...
    case sys::API_COUNTER_SECURITYPROFILE_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYPROFILE_DELETE_CALL));
    ...
    case sys::API_COUNTER_SECURITYPROFILE_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYPROFILE_GET_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUPPOLICY_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUPPOLICY_CREATE_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUPPOLICY_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUPPOLICY_UPDATE_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUPPOLICY_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUPPOLICY_DELETE_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUPPOLICY_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUPPOLICY_GET_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUP_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUP_CREATE_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUP_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUP_UPDATE_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUP_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUP_DELETE_CALL));
    ...
    case sys::API_COUNTER_SECURITYGROUP_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_SECURITYGROUP_GET_CALL));
    ...
    case sys::API_COUNTER_DOSPOLICY_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_DOSPOLICY_CREATE_CALL));
    ...
    case sys::API_COUNTER_DOSPOLICY_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_DOSPOLICY_UPDATE_CALL));
    ...
    case sys::API_COUNTER_DOSPOLICY_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_DOSPOLICY_DELETE_CALL));
    ...
    case sys::API_COUNTER_DOSPOLICY_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_DOSPOLICY_GET_CALL));
    ...
    case sys::API_COUNTER_PROXYCCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYCCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_PROXYCCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYCCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_PROXYCCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYCCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_PROXYCCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYCCB_GET_CALL));
    ...
    case sys::API_COUNTER_PROXYRCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYRCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_PROXYRCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYRCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_PROXYRCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYRCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_PROXYRCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_PROXYRCB_GET_CALL));
    ...
    case sys::API_COUNTER_QOSCLASS_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_QOSCLASS_CREATE_CALL));
    ...
    case sys::API_COUNTER_QOSCLASS_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_QOSCLASS_UPDATE_CALL));
    ...
    case sys::API_COUNTER_QOSCLASS_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_QOSCLASS_DELETE_CALL));
    ...
    case sys::API_COUNTER_QOSCLASS_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_QOSCLASS_GET_CALL));
    ...
    case sys::API_COUNTER_COPP_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_COPP_UPDATE_CALL));
    ...
    case sys::API_COUNTER_COPP_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_COPP_GET_CALL));
    ...
    case sys::API_COUNTER_RAWCCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_RAWCCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_RAWCCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_RAWCCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_RAWCCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_RAWCCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_RAWCCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_RAWCCB_GET_CALL));
    ...
    case sys::API_COUNTER_TCPCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TCPCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_TCPCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TCPCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_TCPCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TCPCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_TCPCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TCPCB_GET_CALL));
    ...
    case sys::API_COUNTER_TLSCB_CREATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TLSCB_CREATE_CALL));
    ...
    case sys::API_COUNTER_TLSCB_UPDATE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TLSCB_UPDATE_CALL));
    ...
    case sys::API_COUNTER_TLSCB_DELETE:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TLSCB_DELETE_CALL));
    ...
    case sys::API_COUNTER_TLSCB_GET:
        entry->set_num_api_call(g_hal_state->api_stats(HAL_API_TLSCB_GET_CALL));
