...
gft_exact_match_profile_add_to_db (gft_exact_match_profile_t *profile,
                                   hal_handle_t handle)
{
    hal_ret_t                   ret;
    sdk_ret_t                   sdk_ret;
...
//------------------------------------------------------------------------------
static inline hal_ret_t
gft_exact_match_profile_del_from_db (gft_exact_match_profile_t *profile)
{
    hal_handle_id_ht_entry_t    *entry;
...
static hal_ret_t
validate_gft_exact_match_profile_create (GftExactMatchProfileSpec& spec,
...
static inline void
gft_exact_match_profile_init_from_spec (gft_exact_match_profile_t *profile,
...
gft_exact_match_profile_lookup_key_or_handle (const GftExactMatchProfileKeyHandle& kh)
{
    gft_exact_match_profile_t    *profile = NULL;
...
//------------------------------------------------------------------------------
static hal_ret_t
gft_exact_match_profile_create_add_cb (cfg_op_ctxt_t *cfg_ctxt)
{
...
//------------------------------------------------------------------------------
// update PI databases as gft_exact_match_profile_create_add_cb was a success
//------------------------------------------------------------------------------
static hal_ret_t
gft_exact_match_profile_create_commit_cb (cfg_op_ctxt_t *cfg_ctxt)
{
    return HAL_RET_OK;
}

//------------------------------------------------------------------------------
// gft_exact_match_profile_create_add_cb was a failure, do the cleanup
//------------------------------------------------------------------------------
hal_ret_t
gft_exact_match_profile_create_abort_cb (cfg_op_ctxt_t *cfg_ctxt)
{
    return HAL_RET_OK;
}
...
//-----------------------------------------------------------------------------
static hal_ret_t
gft_exact_match_profile_create_cleanup_cb (cfg_op_ctxt_t *cfg_ctxt)
{
    hal_ret_t   ret = HAL_RET_OK;
...
//------------------------------------------------------------------------------
static hal_ret_t
gft_exact_match_profile_prepare_rsp (GftExactMatchProfileResponse *rsp,
                                    hal_ret_t ret,
                                ...
                                GftExactMatchProfileResponse *rsp)
{
    hal_ret_t                                    ret;
    gft_exact_match_profile_t                    *profile;
    gft_exact_match_profile_create_app_ctxt_t    app_ctxt; // = { 0 };
    cfg_op_ctxt_t                                cfg_ctxt = { 0 };
    dhl_entry_t                                  dhl_entry = { 0 };

    HAL_TRACE_DEBUG("GFT exact match profile create");
    // validate the request message
    ret = validate_gft_exact_match_profile_create(spec, rsp);
    if (ret != HAL_RET_OK) {
    ...
    profile = gft_exact_match_profile_lookup_key_or_handle(spec.key_or_handle());
    if (profile) {
        HAL_TRACE_ERR("Failed to create GFT exact match profile, "
    ...
    // consume the config
    gft_exact_match_profile_init_from_spec(profile, spec);
    ...
    ret = hal_handle_add_obj(profile->hal_handle, &cfg_ctxt,
                             gft_exact_match_profile_create_add_cb,
                             gft_exact_match_profile_create_commit_cb,
                             gft_exact_match_profile_create_abort_cb,
                             gft_exact_match_profile_create_cleanup_cb);
    ...
    gft_exact_match_profile_prepare_rsp(rsp, ret, profile);
