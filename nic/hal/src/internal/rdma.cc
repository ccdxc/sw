...
rdma_rx_sram_lif_entry_get (uint16_t lif, sram_lif_entry_t *entry_p)
{
    ...
    entry_p->sqcb_base_addr_hi = data.rx_stage0_rdma_params_table_action_u.rx_stage0_rdma_params_table_rx_stage0_load_rdma_params.sqcb_base_addr_hi;
    entry_p->rqcb_base_addr_hi = data.rx_stage0_rdma_params_table_action_u.rx_stage0_rdma_params_table_rx_stage0_load_rdma_params.rqcb_base_addr_hi;    
...
rdma_tx_sram_lif_entry_get (uint16_t lif, sram_lif_entry_t *entry_p)
{
    ...
    entry_p->sqcb_base_addr_hi = data.tx_stage0_rdma_params_table_action_u.tx_stage0_rdma_params_table_tx_stage0_load_rdma_params.sqcb_base_addr_hi;
    entry_p->rqcb_base_addr_hi = data.tx_stage0_rdma_params_table_action_u.tx_stage0_rdma_params_table_tx_stage0_load_rdma_params.rqcb_base_addr_hi;
...
rdma_qp_create (RdmaQpSpec& spec, RdmaQpResponse *rsp)
{
    ...
    sqcb_p->sqcb1.credits = 0x1F;
    sqcb_p->sqcb1.msn = 0;
    sqcb_p->sqcb1.sqd_async_notify_enable = 1;
    sqcb_p->sqcb2.lsn_rx = 0;
    sqcb_p->sqcb2.lsn_tx = sqcb_p->sqcb2.lsn_rx;
    sqcb_p->sqcb2.lsn = sqcb_p->sqcb2.lsn_rx;
    sqcb_p->sqcb2.disable_credits = 1;
    sqcb_p->sqcb2.ssn = 1;
    ...
    HAL_TRACE_DEBUG("{}: QstateAddr = {:#x}\n", __FUNCTION__, lif_manager()->GetLIFQStateAddr(lif, Q_TYPE_RDMA_SQ, spec.qp_num()));
...
rdma_qp_update (RdmaQpUpdateSpec& spec, RdmaQpUpdateResponse *rsp)
{
    ...
    // Read sqcb from HW
    memset(sqcb_p, 0, sizeof(sqcb_t));
    lif_manager()->ReadQState(lif, Q_TYPE_RDMA_SQ, qp_num, (uint8_t *)sqcb_p, sizeof(sqcb_t));
    memrev((uint8_t*)&sqcb_p->sqcb0, sizeof(sqcb0_t));
    memrev((uint8_t*)&sqcb_p->sqcb1, sizeof(sqcb1_t));
    memrev((uint8_t*)&sqcb_p->sqcb2, sizeof(sqcb2_t));
    ...
    // Read rqcb from HW
    memset(rqcb_p, 0, sizeof(rqcb_t));
    lif_manager()->ReadQState(lif, Q_TYPE_RDMA_RQ, qp_num, (uint8_t *)rqcb_p, sizeof(rqcb_t));
