...
class ep_vmotion_server_test : public hal_base_test {
protected:
  ep_vmotion_server_test() {
  }

  virtual ~ep_vmotion_server_test() {
  }
...
TEST_F(ep_vmotion_server_test, test1)
{
    hal_ret_t                   ret;
    VrfSpec                     vrf_spec;
    VrfResponse                 vrf_rsp;
    ...
    sess_spec.mutable_initiator_flow()->mutable_flow_key()->
        mutable_v4_key()->set_ip_proto(types::IPPROTO_TCP);
    sess_spec.mutable_initiator_flow()->mutable_flow_key()->
        mutable_v4_key()->mutable_tcp_udp()->set_sport(1100);
    sess_spec.mutable_initiator_flow()->mutable_flow_key()->
        mutable_v4_key()->mutable_tcp_udp()->set_dport(2100);
    sess_spec.mutable_initiator_flow()->mutable_flow_data()->
        mutable_flow_info()->set_flow_action(session::FLOW_ACTION_ALLOW);
    ...
    sess_spec.mutable_responder_flow()->mutable_flow_key()->
        mutable_v4_key()->set_ip_proto(types::IPPROTO_TCP);
    sess_spec.mutable_responder_flow()->mutable_flow_key()->
        mutable_v4_key()->mutable_tcp_udp()->set_sport(2100);
    sess_spec.mutable_responder_flow()->mutable_flow_key()->
        mutable_v4_key()->mutable_tcp_udp()->set_dport(1100);
    sess_spec.mutable_responder_flow()->mutable_flow_data()->
        mutable_flow_info()->set_flow_action(session::FLOW_ACTION_ALLOW);
...
TEST_F(ep_vmotion_server_test, DISABLED_test2)
{
    hal_ret_t                   ret;
    VrfSpec                     vrf_spec;
    VrfResponse                 vrf_rsp;
