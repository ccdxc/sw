...
TEST_F(ep_mgmt_merge_test, test1)
{
    ...
    ifid_count = 1;
    ASSERT_EQ(create_l2seg(vrf_id_cl_up1, l2seg_id_cl_up1, 8192, up_ifid, ifid_count, 
                           l2segment::MulticastFwdPolicy::MULTICAST_FWD_POLICY_FLOOD,
                           l2segment::BroadcastFwdPolicy::BROADCAST_FWD_POLICY_FLOOD), HAL_RET_OK);
    up_ifid[0] = uplinkif_id2;
    ifid_count = 1;
    ASSERT_EQ(create_l2seg(vrf_id_cl_up2, l2seg_id_cl_up2, 8192, up_ifid, ifid_count, 
                           l2segment::MulticastFwdPolicy::MULTICAST_FWD_POLICY_FLOOD,
                           l2segment::BroadcastFwdPolicy::BROADCAST_FWD_POLICY_FLOOD), HAL_RET_OK);
    ...
    ifid_count = 2;
    ASSERT_EQ(create_l2seg(vrf_id_hp1, l2seg_id_hp1, 8192, up_ifid, ifid_count,
                           l2segment::MulticastFwdPolicy::MULTICAST_FWD_POLICY_FLOOD,
                           l2segment::BroadcastFwdPolicy::BROADCAST_FWD_POLICY_FLOOD), HAL_RET_OK);
    // Create Enic
