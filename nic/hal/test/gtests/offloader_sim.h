...
int algo_encrypt_xts(void* scratch, uint8_t* key, uint8_t* input, uint32_t input_sz,
                     uint8_t* output, uint32_t *output_sz);
int algo_decrypt_xts(void* scratch, uint8_t* key, uint8_t* input, uint32_t input_sz,
                     uint8_t* output, uint32_t *output_sz);
