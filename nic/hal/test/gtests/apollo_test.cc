...
TEST_F(apollo_test, test1) {
    ...
    ret = capri_load_config((char *)"obj/apollo_p4/pgm_bin");
    ASSERT_NE(ret, -1);
    ret = capri_load_config((char *)"obj/apollo_rxdma/pgm_bin");
    ASSERT_NE(ret, -1);
    ret = capri_load_config((char *)"obj/apollo_txdma/pgm_bin");
    ASSERT_NE(ret, -1);
