...
#define tx_table_s2_t0_action eth_tx_cq_create_desc
#define tx_table_s3_t0_action eth_tx_cq_post_desc
        ...
        enable, ring_base, ring_size, cq_qstate_addr)
{
    ...
    modify_field(eth_tx_qstate.cq_qstate_addr, cq_qstate_addr);
}
...
action eth_tx_cq_create_desc()
{
}

action eth_tx_cq_post_desc()
{
}
