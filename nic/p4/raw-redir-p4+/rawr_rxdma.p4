...
#define rx_table_s6_t1		rawr_chain_sem
...
#define rx_table_s6_t1_action 	chain_sem_pindex_post_update
...
#define GENERATE_GLOBAL_K \
    modify_field(common_global_scratch.chain_rxq_base, common_phv.chain_rxq_base); \
    modify_field(common_global_scratch.packet_len, common_phv.packet_len); \
    modify_field(common_global_scratch.flow_id, common_phv.flow_id); \
    ...
    modify_field(common_global_scratch.chain_rxq_ring_size_shift, common_phv.chain_rxq_ring_size_shift); \
    modify_field(common_global_scratch.chain_rxq_entry_size_shift, common_phv.chain_rxq_entry_size_shift); \
    modify_field(common_global_scratch.chain_qidxr_pi, common_phv.chain_qidxr_pi); \
...
header_type rawrcb_t {
	...
	/*
	 * Next service chain RxQ ring info
	 */	
        chain_rxq_base			: HBM_ADDRESS_WIDTH;
        chain_rxq_sem_alloc_idx		: HBM_ADDRESS_WIDTH;
	 ...
	 */	
        chain_rxq_qidxr_base		: HBM_ADDRESS_WIDTH;
        chain_qidxr_entry_size_shift	: 5;
        chain_rxq_ring_size_shift	: 5;
        chain_rxq_entry_size_shift	: 5;
...
@pragma scratch_metadata
metadata sem_chain_d_t 			sem_chain_d;
...
@pragma dont_trim
metadata dma_phv_pad_448_t  		dma_pad_448;
 ...
 */
action rawr_rx_start(pc, rsvd, cosA, cosB, cos_sel, 
		     eval_last, host, total, pid,
		     chain_rxq_base, chain_rxq_sem_alloc_idx,
		     chain_rxq_qidxr_base, chain_qidxr_entry_size_shift,
		     chain_rxq_ring_size_shift, chain_rxq_entry_size_shift,
		     desc_valid_bit_req, chain_qidxr_pi) {
    // k + i for stage 0
    ...
    modify_field(rawrcb_d.chain_rxq_sem_alloc_idx, chain_rxq_sem_alloc_idx);
    modify_field(rawrcb_d.chain_rxq_qidxr_base, chain_rxq_qidxr_base);
    modify_field(rawrcb_d.chain_qidxr_entry_size_shift, chain_qidxr_entry_size_shift);
    ...
    modify_field(rawrcb_d.chain_qidxr_pi, chain_qidxr_pi);
...
action chain_pindex_pre_alloc(void) {
    ...
    // from to_stage 5
    modify_field(to_s5_scratch.chain_rxq_sem_alloc_idx, to_s5.chain_rxq_sem_alloc_idx);
    modify_field(to_s5_scratch.chain_rxq_qidxr_base, to_s5.chain_rxq_qidxr_base);
 ...
 */
action chain_sem_pindex_post_update(pindex, pindex_full) {
    ...
    modify_field(sem_chain_d.pindex, pindex);
    modify_field(sem_chain_d.pindex_full, pindex_full);
}
