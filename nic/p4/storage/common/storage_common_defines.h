...
#define R2N_BUF_IO_CTX_OFFSET			0
#define R2N_BUF_SEQ_DESC_OFFSET			64
#define R2N_BUF_PRP_LIST_OFFSET			704
#define R2N_BUF_STATUS_BUF_OFFSET		832
#define R2N_BUF_BUF_POST_OFFSET			896
#define R2N_BUF_STATUS_REQ_OFFSET		960
#define R2N_BUF_PAD_OFFSET			1024 // Pad size = 3072 - 128 - 64 - 8 = 2872 bytes
...
#define R2N_BUF_WRITE_REQ_SGE0_OFFSET		(R2N_BUF_WRITE_REQ_OFFSET + 256)
