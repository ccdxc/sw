...
action pkt_dma() {
    ...
    modify_field(capri_intrinsic.tm_iport, TM_PORT_DMA);
    ...
    modify_field(scratch_metadata.cindex, txdma_control.cindex);
    modify_field(scratch_metadata.qid, capri_txdma_intrinsic.qid);
}
