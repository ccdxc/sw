...
#define tx_table_s1_t0_action ipsec_encap_txdma_deque_head_desc
#define tx_table_s1_t1_action ipsec_encap_txdma_load_head_desc_int_header 
#define tx_table_s1_t2_action allocate_barco_req_pindex 
#define tx_table_s1_t3_action ipsec_txdma_dummy 

#define tx_table_s2_t0_action ipsec_write_barco_req 
...
#define tx_table_s3_t0_action ipsec_txdma_dummy
                             ...
                             block_size, head_desc_addr, tail_desc_addr)
{
    ...
    DMA_COMMAND_PHV2MEM_FILL(brq_req_write, ipsec_to_stage2.barco_req_addr, IPSEC_TXDMA1_BARCO_REQ_PHV_OFFSET_START, IPSEC_TXDMA1_BARCO_REQ_PHV_OFFSET_END, 0, 0, 0, 0) 
                                                   ...
                                                   payload_size)
{
    ...
    modify_field(common_te0_phv.table_addr, (txdma1_global.ipsec_cb_index * IPSEC_CB_SIZE)+IPSEC_CB_BASE);
}
                              ...
                              nextptr, rsvd)
{
    ...
    DMA_COMMAND_PHV2MEM_FILL(head_desc_addr_update, (txdma1_global.ipsec_cb_index * IPSEC_CB_SIZE)+IPSEC_CB_BASE+IPSEC_CB_HEAD_DESC_ADDR_OFFSET, IPSEC_TXDMA1_HEAD_DESC_PHV_OFFSET_START, IPSEC_TXDMA1_HEAD_DESC_PHV_OFFSET_END, 0, 0, 0, 0) 
...
{
    modify_field(ipsec_to_stage2.barco_req_addr, BRQ_REQ_RING_BASE_ADDR + (BRQ_REQ_ENTRY_SIZE * barco_pindex));
    modify_field(p4plus2p4_hdr.table0_valid, 1);
    modify_field(common_te0_phv.table_pc, 0);
    modify_field(common_te0_phv.table_raw_table_size, 6);
    modify_field(common_te0_phv.table_lock_en, 0);
    modify_field(common_te0_phv.table_addr, BRQ_REQ_RING_BASE_ADDR + (BRQ_REQ_ENTRY_SIZE * barco_pindex));
...
action ipsec_encap_txdma_initial_table(pid, cosb, cosa, pc_offset,
                                       ...
                                       block_size, head_desc_addr, tail_desc_addr)
{
    modify_field(txdma1_global.ipsec_cb_index, ipsec_cb_index);
