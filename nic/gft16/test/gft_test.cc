...
#include "gen/p4gen/gft16/include/p4pd.h"
...
rx_key1_init(int index) {
    ...
    key.hdr_ip_1_ipv4_valid           = 0xFF;
    key.hdr_l4_1_udp_valid            = 0xFF;
    key.metadata_tunnel_tunnel_type_1 = INGRESS_TUNNEL_TYPE_VXLAN;
    key.hdr_ethernet_2_ethernet_valid  = 0xFF;
    key.hdr_ip_2_ipv4_valid           = 0xFF;
    key.hdr_l4_2_udp_valid            = 0xFF;
    key.metadata_tunnel_tunnel_type_2 = INGRESS_TUNNEL_TYPE_VXLAN;
    key.hdr_ethernet_3_ethernet_valid = 0xFF;
    key.hdr_ip_3_ipv4_valid           = 0xFF;
    key.hdr_l4_3_tcp_valid            = 0xFF;
    memset(&mask, 0xFF, sizeof(mask));
    // data
    data.action_u.rx_key1_rx_key1_action.match_fields =
...
rx_key3_init(int index) {
    ...
    // data
    data.action_u.rx_key3_rx_key3_action.match_fields =
        (MATCH_ETHERNET_SRC | MATCH_ETHERNET_DST |
         MATCH_IP_SRC | MATCH_IP_DST | MATCH_IP_PROTO);
...
rx_create_vport_entry() {
    ...
    // data
    data.action_u.rx_vport_rx_vport_action.vport = 0x55;
    data.action_u.rx_vport_rx_vport_action.tm_oport = TM_PORT_UPLINK_0;
    data.action_u.rx_vport_rx_vport_action.rdma_enabled = 1;
...
rx_create_gft_entry1() {
    ...
    // key
    memcpy(key.metadata_flow_lkp_ethernet_dst_1, &g_layer1_dmac, 6);
    memcpy(key.metadata_flow_lkp_ethernet_src_1, &g_layer1_smac, 6);
    memcpy(key.metadata_flow_lkp_ip_dst_1, &g_layer1_dip, 4);
    memcpy(key.metadata_flow_lkp_ip_src_1, &g_layer1_sip, 4);
    key.metadata_flow_lkp_ip_proto_1 = g_layer1_proto;
    memcpy(key.metadata_flow_lkp_ethernet_dst_2, &g_layer2_dmac, 6);
    memcpy(key.metadata_flow_lkp_ethernet_src_2, &g_layer2_smac, 6);
    memcpy(key.metadata_flow_lkp_ip_dst_2, &g_layer2_dip, 4);
    memcpy(key.metadata_flow_lkp_ip_src_2, &g_layer2_sip, 4);
    key.metadata_flow_lkp_ip_proto_2 = g_layer2_proto;
    memcpy(key.metadata_flow_lkp_ethernet_dst_3, &g_layer3_dmac, 6);
    memcpy(key.metadata_flow_lkp_ethernet_src_3, &g_layer3_smac, 6);
    memcpy(key.metadata_flow_lkp_ip_dst_3, &g_layer3_dip, 4);
    memcpy(key.metadata_flow_lkp_ip_src_3, &g_layer3_sip, 4);
    key.metadata_flow_lkp_ip_proto_3 = g_layer3_proto;
    key.metadata_flow_lkp_l4_sport_3 = g_layer31_sport;
    key.metadata_flow_lkp_l4_dport_3 = g_layer31_dport;
...
rx_create_gft_entry2() {
    ...
    memcpy(key.metadata_flow_lkp_ip_src_3, &g_layer3_sip, 4);
    key.metadata_flow_lkp_ip_proto_3 = g_layer3_proto;
    key.metadata_flow_lkp_l4_sport_3 = g_layer32_sport;
    key.metadata_flow_lkp_l4_dport_3 = g_layer32_dport;
...
rx_create_gft_entry3() {
    ...
    memcpy(key.metadata_flow_lkp_ip_src_1, &g_layer1_sip, 4);
    key.metadata_flow_lkp_ip_proto_1 = g_layer1_proto;
    key.metadata_flow_lkp_l4_sport_1 = g_rdma_sport;
    key.metadata_flow_lkp_l4_dport_1 = g_rdma_dport;
...
rx_create_gft_entry4() {
    ...
    memcpy(key.metadata_flow_lkp_ip_src_2, &g_layer2_sip, 4);
    key.metadata_flow_lkp_ip_proto_2 = g_layer2_proto;
    key.metadata_flow_lkp_l4_sport_2 = g_rdma_sport;
    key.metadata_flow_lkp_l4_dport_2 = g_rdma_dport;
...
tx_tcp_key_init(int index) {
    ...
    key.hdr_ethernet_1_ethernet_valid = 0xFF;
    key.hdr_ip_1_ipv4_valid = 0xFF;
    key.hdr_l4_1_tcp_valid = 0xFF;
    memset(&mask, 0xFF, sizeof(mask));

    // data
    data.action_u.tx_key_tx_key_action.match_fields =
        ((MATCH_ETHERNET_SRC | MATCH_ETHERNET_DST |
          MATCH_IP_SRC | MATCH_IP_DST | MATCH_IP_PROTO) |
...
tx_create_gft_entry1() {
    ...
    // key
    memcpy(key.metadata_flow_lkp_ethernet_dst_1, &g_tx_layer1_dmac, 6);
    memcpy(key.metadata_flow_lkp_ethernet_src_1, &g_tx_layer1_smac, 6);
#ifdef ISSUE_1279
    memcpy(key.metadata_flow_lkp_ip_dst_1, &g_tx_layer1_dip, 4);
    memcpy(key.metadata_flow_lkp_ip_src_1, &g_tx_layer1_sip, 4);
    key.metadata_flow_lkp_ip_proto_1 = g_tx_layer1_proto;
    key.metadata_flow_lkp_l4_sport_1 = g_tx_layer1_sport;
    key.metadata_flow_lkp_l4_dport_1 = g_tx_layer1_dport;
#endif
...
tx_create_gft_entry2() {
    ...
    // key
    memcpy(key.metadata_flow_lkp_ethernet_dst_1, &g_tx_rdma1_dmac, 6);
    memcpy(key.metadata_flow_lkp_ethernet_src_1, &g_tx_rdma1_smac, 6);
#if 0
    memcpy(key.metadata_flow_lkp_ip_dst_1, &g_tx_rdma1_dip, 4);
    memcpy(key.metadata_flow_lkp_ip_src_1, &g_tx_rdma1_sip, 4);
    key.metadata_flow_lkp_ip_proto_1 = g_rdma_proto;
    key.metadata_flow_lkp_l4_sport_1 = g_rdma_sport;
    key.metadata_flow_lkp_l4_dport_1 = g_rdma_dport;
#endif
...
tx_create_gft_entry3() {
    ...
    // key
    memcpy(key.metadata_flow_lkp_ethernet_dst_1, &g_tx_rdma2_dmac, 6);
    memcpy(key.metadata_flow_lkp_ethernet_src_1, &g_tx_rdma1_smac, 6);
#if 0
    memcpy(key.metadata_flow_lkp_ip_dst_1, &g_tx_rdma1_dip, 4);
    memcpy(key.metadata_flow_lkp_ip_src_1, &g_tx_rdma1_sip, 4);
...
TEST_F(gft_test, test1) {
    ...
    cfg.asm_cfg[0].name = std::string("gft16_p4");
