...
#include <math.h>
#include "nic/apollo/api/impl/apollo/lpm/lpm_ipv6_acl.hpp"
                               ...
                               lpm_inode_t *lpm_inode)
{
    ...
    switch (idx) {
    case 0:
        sdk::lib::memrev(table->action_u.sacl_ip_match_ipv6.key0,
                         lpm_inode->ipaddr.addr.v6_addr.addr8, IP6_ADDR8_LEN);
        break;
    case 1:
        sdk::lib::memrev(table->action_u.sacl_ip_match_ipv6.key1,
                         lpm_inode->ipaddr.addr.v6_addr.addr8, IP6_ADDR8_LEN);
        break;
    case 2:
        sdk::lib::memrev(table->action_u.sacl_ip_match_ipv6.key2,
                         lpm_inode->ipaddr.addr.v6_addr.addr8, IP6_ADDR8_LEN);
        break;
    default:
        break;
                                    ...
                                    lpm_inode_t *lpm_inode)
{
    ...
    switch (idx) {
    case 0:
        sdk::lib::memrev(table->action_u.sacl_ip_match_ipv6_retrieve.key0,
                         lpm_inode->ipaddr.addr.v6_addr.addr8, IP6_ADDR8_LEN);
        table->action_u.sacl_ip_match_ipv6_retrieve.data0 =
...
{
    auto table = (sacl_ip_actiondata_t *) bytes;
    table->action_u.sacl_ip_match_ipv6_retrieve.data_ =
...
lpm_ipv6_acl_write_last_stage_table (mem_addr_t addr, uint8_t *bytes)
{
    return impl_base::pipeline_impl()->write_to_rxdma_table(addr,
               P4_APOLLO_RXDMA_TBL_ID_SACL_IP,
               SACL_IP_MATCH_IPV6_RETRIEVE_ID, bytes);
}
