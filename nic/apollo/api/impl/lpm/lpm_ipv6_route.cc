 ...
 *
 * @file    lpm_ipv6_route.cc
 *
 * @brief   LPM IPv6 Route implementation
 */
...
/**
 * key size is 4 bytes for IPv6 route
 */
uint32_t
lpm_ipv6_route_key_size ()
{
 ...
 */
uint32_t
lpm_ipv6_route_stages (uint32_t num_intrvls)
{
