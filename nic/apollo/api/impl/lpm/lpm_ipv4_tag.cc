 ...
 *
 * @file    lpm_ipv4_tag.cc
 *
 * @brief   LPM for IPv4 TAG implementation
 */

#include <math.h>
#include "lpm_ipv4_tag.hpp"
#include "gen/p4gen/p4plus_rxdma/include/p4plus_rxdma_p4pd.h"
#include "nic/apollo/framework/impl_base.hpp"
#include "nic/apollo/framework/pipeline_impl_base.hpp"

sdk_ret_t
lpm_ipv4_tag_add_key_to_stage (uint8_t *bytes, uint32_t idx,
...
sdk_ret_t
lpm_ipv4_tag_add_key_to_last_stage (uint8_t *bytes, uint32_t idx,
                                    lpm_inode_t *lpm_inode)
{
    auto table = (rxlpm1_actiondata_t *)bytes;
...
sdk_ret_t
lpm_ipv4_tag_set_default_data (uint8_t *bytes, uint32_t default_data)
{
    auto table = (rxlpm1_actiondata_t *) bytes;
...
sdk_ret_t
lpm_ipv4_tag_write_stage_table (mem_addr_t addr, uint8_t *bytes)
{
...
sdk_ret_t
lpm_ipv4_tag_write_last_stage_table (mem_addr_t addr, uint8_t *bytes)
{
    return impl_base::pipeline_impl()->write_to_rxdma_table(addr,
                                    P4_P4PLUS_RXDMA_TBL_ID_RXLPM1,
 ...
 */
uint32_t
lpm_ipv4_tag_stages (uint32_t num_intrvls)
{
