 ...
 *
 * @file    lpm_ipv4_peer_route.cc
 *
 * @brief   LPM IPv4 Peer Route implementation
 */
...
sdk_ret_t
lpm_ipv4_peer_route_add_key_to_stage (uint8_t *bytes, uint32_t idx,
...
sdk_ret_t
lpm_ipv4_peer_route_add_key_to_last_stage (uint8_t *bytes, uint32_t idx,
                                           lpm_inode_t *lpm_inode)
{
    auto table = (txlpm1_actiondata_t *)bytes;
...
sdk_ret_t
lpm_ipv4_peer_route_write_stage_table (mem_addr_t addr, uint8_t *bytes)
{
    auto table = (txlpm1_actiondata_t *) bytes;
...
sdk_ret_t
lpm_ipv4_peer_route_write_last_stage_table (mem_addr_t addr, uint8_t *bytes)
{
    auto table = (txlpm1_actiondata_t *) bytes;
 ...
 */
uint32_t
lpm_ipv4_peer_route_key_size (void)
{
 ...
 */
uint32_t
lpm_ipv4_peer_route_stages (uint32_t num_intrvls)
{
