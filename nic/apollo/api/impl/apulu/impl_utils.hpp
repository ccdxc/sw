...
///
/// \file
/// apulu pipeline utils implementation
///
//----------------------------------------------------------------------------

#ifndef __APULU_IMPL_UTILS_HPP__
#define __APULU_IMPL_UTILS_HPP__
...
pipeline_p4_hbm_init (p4pd_cfg_t *p4pd_cfg, bool hw_init = true)
{
    ...
    p4pd_cfg->table_map_cfg_file  = "apulu/p4_table_map.json";
...
#endif    //__APULU_IMPL_UTILS_HPP__
