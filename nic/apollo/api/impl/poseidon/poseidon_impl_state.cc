...
/// \defgroup PDS_POSEIDON_IMPL_STATE - poseidon database functionality
/// \ingroup PDS_POSEIDON
/// \@{

// TODO: table_health_monitor_cb is passed as NULL everywhere here
poseidon_impl_state::poseidon_impl_state(pds_state *state) {
...
poseidon_impl_state::~poseidon_impl_state() {
