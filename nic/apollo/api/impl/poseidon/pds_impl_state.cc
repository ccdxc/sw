...
#include "nic/apollo/api/impl/poseidon/pds_impl_state.hpp"
...
pds_impl_state::init(pds_state *state) {
    poseidon_impl_db_ = new poseidon_impl_state(state);
