...
public:
    ...
    // eth APIs
    virtual sdk_ret_t eth_dev_admin_status_update(uint32_t lif_id, lif_state_t state);
    ...
    virtual sdk_ret_t qos_clear_stats(uint32_t port_num, uint8_t qos_group_bitmap);
