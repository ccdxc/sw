...
*/
    ...
    lif_qstate.ring0_size = log2((api::g_oci_state.mempartition()->size(MEM_REGION_RXDMA_TO_TXDMA_BUF_NAME) >> 10) / 10);
    ...
    txdma_qstate.ring_size = log2((api::g_oci_state.mempartition()->size(MEM_REGION_RXDMA_TO_TXDMA_BUF_NAME) >> 10) / 10);
