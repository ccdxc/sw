...
static sdk_ret_t
pds_mirror_session_api_handle (pds_batch_ctxt_t bctxt, api::api_op_t op,
                               ...
                               pds_mirror_session_spec_t *spec)
{
    ...
    api_ctxt = api::api_ctxt_alloc(api::OBJ_ID_MIRROR_SESSION, op);
...
{
    return pds_mirror_session_api_handle(bctxt, api::API_OP_CREATE, NULL, spec);
}
...
pds_mirror_session_update (_In_ pds_mirror_session_spec_t *spec,
                           _In_ pds_batch_ctxt_t bctxt)
{
    return pds_mirror_session_api_handle(bctxt, api::API_OP_UPDATE, NULL, spec);
}
...
pds_mirror_session_delete (_In_ pds_mirror_session_key_t *key,
                           _In_ pds_batch_ctxt_t bctxt)
{
    return pds_mirror_session_api_handle(bctxt, api::API_OP_DELETE, key, NULL);
}
