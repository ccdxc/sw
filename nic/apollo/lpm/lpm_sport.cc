...
{
    auto table = (slacl_sport_lpm_s0_actiondata_t *)bytes;
...
lpm_sport_add_key_to_last_stage (uint8_t *bytes, uint32_t idx,
                                 lpm_inode_t *lpm_inode)
{
    auto table = (slacl_sport_lpm_s1_actiondata_t *)bytes;
...
lpm_sport_write_stage_table (mem_addr_t addr, uint8_t *bytes)
{
    return impl::impl_base::pipeline_impl()->write_to_rxdma_table(addr,
               ...
               SLACL_SPORT_LPM_S0_SLACL_SPORT_LPM_S0_ID, bytes);
}
...
lpm_sport_write_last_stage_table (mem_addr_t addr, uint8_t *bytes)
{
    return impl::impl_base::pipeline_impl()->write_to_rxdma_table(addr,
               ...
               SLACL_SPORT_LPM_S1_SLACL_SPORT_LPM_S1_ID, bytes);
}
