...
enum {
    ...
    PDS_SLAB_ID_ROUTE,
    PDS_SLAB_ID_POLICY_RULE,
    PDS_SLAB_ID_API_OBJ_MAX,

    PDS_SLAB_ID_LEARN_MIN = PDS_SLAB_ID_API_OBJ_MAX + 1,
    PDS_SLAB_ID_MAC_ENTRY = PDS_SLAB_ID_LEARN_MIN,
    PDS_SLAB_ID_IP_ENTRY,
    PDS_SLAB_ID_LEARN_MAX,
...
enum {
    ...
    PDS_MEM_ALLOC_UPG,
    PDS_MEM_ALLOC_ID_UPG_CTXT,
    PDS_MEM_ALLOC_NAT_PORT_BLOCK,
