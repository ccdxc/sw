...
TEST_F(tep_test, tep_invalid_delete) {
    ...
    tep_util tep_obj("10.1.1.1/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_invalid_delete_3) {
    pds_batch_params_t batch_params = {0};
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj1("10.1.1.1/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj2("10.1.1.2/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj3("10.1.1.3/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_invalid_delete_4) {
    ...
    tep_util tep_obj2("10.1.1.2/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj3("10.1.1.3/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj4("10.1.1.4/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj5("10.1.1.5/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_read) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.2/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_delete) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.3/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_double_create) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.4/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_double_create_1) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.5/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_double_delete) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.6/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_double_delete_2) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.7/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_create_delete) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.8/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_delete_create) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.9/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_delete_create_delete) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.10/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_delete_create_delete_1) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj1("10.1.1.11/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj2("10.1.1.12/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj3("10.1.1.13/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, DISABLED_tep_max_create) {
    ...
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.10.5.1", PDS_TEP_TYPE_WORKLOAD, encap);
    ...
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_OK, PDS_MAX_TEP,
        tep_first_ip_str, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
...
TEST_F(tep_test, tep_beyondmax_create) {
    ...
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.20.5.1", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, DISABLED_tep_multi_max_create_1) {
    ...
    // verify all num_teps entries are programmed
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_OK, num_teps,
        tep_first_ip_str_2, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
...
TEST_F(tep_test, tep_multi_max_delete_1) {
    ...
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj(tep_last_ip_str, PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, DISABLED_tep_read_nonexisting_when_single) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj_1("10.1.1.15/8", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj_2("10.1.1.20/8", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_read_nonexisting_when_multiple) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj_1("10.1.1.21", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj_2("10.1.1.22", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj_3("10.1.1.23", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj_4("10.1.1.24", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj_5("10.1.1.25", PDS_TEP_TYPE_WORKLOAD, encap);
    tep_util tep_obj("10.1.1.30", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, tep_read_existing_when_single) {
    ...
    pds_tep_info_t info;
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.31", PDS_TEP_TYPE_WORKLOAD, encap);
...
TEST_F(tep_test, DISABLED_tep_read_existing_when_full) {
    ...
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("10.1.1.1", PDS_TEP_TYPE_WORKLOAD, encap);
...
<<<<<<< HEAD
    ...
    ASSERT_TRUE(tep_util::many_read(
        k_max_tep, tep_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
...
=======
    ...
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_OK, num_teps,
        tep_first_ip_str, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
>>>>>>> tunnel api changes (minus dol changes)
...
<<<<<<< HEAD
    ASSERT_TRUE(tep_util::many_read(
        10, set1_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_ENTRY_NOT_FOUND) == sdk::SDK_RET_OK);
    ASSERT_TRUE(tep_util::many_read(
        20, set2_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_OK) == sdk::SDK_RET_OK);
    ASSERT_TRUE(tep_util::many_read(
        30, set3_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_OK) == sdk::SDK_RET_OK);
=======
    // verify TEPs from set1 are NOT programmed
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_ENTRY_NOT_FOUND, 10,
        set1_first_ip_str, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
    // verify TEPs from set2 are programmed
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_OK, 20,
        set2_first_ip_str, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
    // verify TEPs from set3 are programmed
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_OK, 30,
        set3_first_ip_str, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
>>>>>>> tunnel api changes (minus dol changes)
...
<<<<<<< HEAD
    ...
    ASSERT_TRUE(tep_util::many_read(
        k_max_tep + 1, tep_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_ENTRY_NOT_FOUND) == sdk::SDK_RET_OK);
=======
    ASSERT_TRUE(tep_util::many_create(num_teps, tep_first_ip_str,
        PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
...
<<<<<<< HEAD
    ...
    // trigger
    ASSERT_TRUE(tep_util::many_read(
        k_max_tep, tep_invalid_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_ENTRY_NOT_FOUND) == sdk::SDK_RET_OK);
=======
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("192.168.9.1", PDS_TEP_TYPE_WORKLOAD, encap);
    ...
    ASSERT_TRUE(tep_util::many_read(sdk::SDK_RET_ENTRY_NOT_FOUND, num_teps,
        tep_invalid_ip_str, PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
>>>>>>> tunnel api changes (minus dol changes)
...
=======
    std::string tep_first_ip_str = "50.50.1.1/8";
    pds_encap_t encap = {PDS_ENCAP_TYPE_MPLSoUDP, 0};
    tep_util tep_obj("99.99.99.99", PDS_TEP_TYPE_WORKLOAD, encap);
>>>>>>> tunnel api changes (minus dol changes)
...
<<<<<<< HEAD
    ...
    ASSERT_TRUE(tep_util::many_read(
        num_teps, set1_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_OK) == sdk::SDK_RET_OK);
=======
    ASSERT_TRUE(tep_util::many_create(num_teps, tep_first_ip_str,
        PDS_TEP_TYPE_WORKLOAD, encap) == sdk::SDK_RET_OK);
...
<<<<<<< HEAD
    ...
    ASSERT_TRUE(tep_util::many_read(
        ...
        sdk::SDK_RET_OK) == sdk::SDK_RET_OK);
    ASSERT_TRUE(tep_util::many_read(
        num_teps, set2_first_ip_str, PDS_TEP_ENCAP_TYPE_VNIC,
        sdk::SDK_RET_ENTRY_NOT_FOUND) == sdk::SDK_RET_OK);
