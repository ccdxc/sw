...
$GDB $PDSPKG_TOPDIR/build/x86_64/apulu/bin/cap_model \
    +PLOG_MAX_QUIT_COUNT=0 +plog=info \
    +model_debug=$PDSPKG_TOPDIR/build/x86_64/apulu/gen/p4gen//apulu/dbg_out/combined_model_debug.json 2>&1 > $PDSPKG_TOPDIR/model.log
