...
TEST_F(flow_cache_scale, crurd_1K) {
    ...
    rs = create_entries(1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
    rs = read_entries(1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
    rs = update_entries(1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
    rs = read_entries(1024, sdk::SDK_RET_OK);
...
TEST_F(flow_cache_scale, create2M) {
    sdk_ret_t rs;
    rs = create_entries(2*1024*1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
}
...
TEST_F(flow_cache_scale, delete2M) {
    ...
    rs = create_entries(2*1024*1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
    rs = delete_entries(2*1024*1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
}
...
TEST_F(flow_cache_scale, DISABLED_delete4M) {
    ...
    rs = create_entries(4*1024*1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
    rs = delete_entries(4*1024*1024, sdk::SDK_RET_OK);
    ASSERT_TRUE(rs == sdk::SDK_RET_OK);
}
