...
static uint8_t g_rcv_pkt_h2s[] = {
    ...
    0x19, 0xeb, 0x00, 0x7e, 0x00, 0x00, 0x12, 0x34,
...
athena_gtest_test_flows_tcp(void)
{
    ...
    ret = send_packet("TCP-IPv4: h2s pkt", g_snd_pkt_h2s, sizeof(g_snd_pkt_h2s), g_h_port,
                       g_rcv_pkt_h2s, sizeof(g_rcv_pkt_h2s), g_s_port);
    if (ret != SDK_RET_OK) {
        return ret;
    }
