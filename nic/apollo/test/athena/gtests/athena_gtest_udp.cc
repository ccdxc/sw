...
static uint16_t    g_udp_vnic_id = VNIC_ID_UDP;
static uint32_t    g_h2s_udp_vlan = VLAN_ID_UDP;
...
static uint32_t    mpls2_label = MPLS_LABEL_UDP;

static sdk_ret_t
setup_flow_v4_udp(void)
{
...
static uint8_t g_rcv_pkt_ipv4_udp_h2s[] = {
    ...
    0x02, 0x01, 0x01, 0x02, 0x03, 0x04, 0xbb, 0xf4,
...
static uint8_t g_rcv_pkt_ipv4_udp_h2s[] = {
    ...
    0x08, 0x00, 0x45, 0x00, 0x00, 0x74, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x70, 0x04, 0x03,
    0x02, 0x01, 0x01, 0x02, 0x03, 0x04, 0x35, 0xb1,
    0x19, 0xeb, 0x00, 0x60, 0x00, 0x00, 0x12, 0x34,
    0x50, 0x40, 0x67, 0x89, 0xa1, 0x40, 0x45, 0x00,
    0x00, 0x50, 0x00, 0x01, 0x00, 0x00, 0x40, 0x11,
    0xb6, 0x9a, 0x02, 0x00, 0x00, 0x01, 0xc0, 0x00,
...
static uint8_t g_snd_pkt_ipv4_udp_bad_substrate_ip_csum_s2h[] = {
    ...
    0xBB, 0xCC, 0xDD, 0xEE, 0x08, 0x00, 0x45, 0x00,
    0x00, 0x74, 0x00, 0x00, 0x00, 0x00, 0x40, 0x11,
    0xA2, 0xA1, 0x64, 0x65, 0x66, 0x67, 0x0C, 0x0C,
    0x01, 0x01, 0xE4, 0xE7, 0x19, 0xEB, 0x00, 0x60,
    0x00, 0x00, 0x12, 0x34, 0x50, 0x00, 0x67, 0x89,
    0xA1, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x01,
    0x00, 0x00, 0x40, 0x11, 0xB6, 0x9A, 0xC0, 0x00,
...
static uint8_t g_snd_pkt_ipv4_udp_bad_user_udp_csum_s2h[] = {
    ...
    0x00, 0x00, 0x40, 0x11, 0xB6, 0x9A, 0xC0, 0x00,
    0x02, 0x01, 0x02, 0x00, 0x00, 0x01, 0x27, 0x10,
    0x03, 0xE8, 0x00, 0x3C, 0xF3, 0x45, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
    0x73, 0x74, 0x75, 0x76, 0x77, 0x7A, 0x78, 0x79,
    0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68,
...
static uint8_t g_rcv_pkt_ipv6_udp_h2s[] = {
    ...
    0x02, 0x01, 0x01, 0x02, 0x03, 0x04, 0x65, 0x5c,
...
static uint8_t g_rcv_pkt_ipv6_udp_h2s[] = {
    ...
    0x08, 0x00, 0x45, 0x00, 0x00, 0x88, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x5c, 0x04, 0x03,
    0x02, 0x01, 0x01, 0x02, 0x03, 0x04, 0x24, 0x2a,
    0x19, 0xeb, 0x00, 0x74, 0x00, 0x00, 0x12, 0x34,
    0x50, 0x40, 0x67, 0x89, 0xa1, 0x40, 0x60, 0x00,
    0x00, 0x00, 0x00, 0x3c, 0x11, 0x40, 0x02, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
athena_gtest_test_flows_udp(void)
{
    ...
    ret = send_packet("UDP-IPv4-Bad-IP-CSUM: h2s pkt", g_snd_pkt_ipv4_udp_bad_ip_csum_h2s,
    ...
    ret = send_packet("UDP-IPv4-Bad-UDP-CSUM: h2s pkt", g_snd_pkt_ipv4_udp_bad_udp_csum_h2s,
    ...
    ret = send_packet("UDP-IPv4-Bad-Substrate-IP-CSUM: s2h pkt",
    ...
    ret = send_packet("UDP-IPv4-Bad-User-IP-CSUM: s2h pkt",
    ...
    ret = send_packet("UDP-IPv4-Bad-User-UDP-CSUM: s2h pkt",
