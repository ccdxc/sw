...
*/
static uint16_t    g_icmp_vnic_id = VNIC_ID_L2_ICMP;
static uint32_t    g_h2s_icmp_vlan = VLAN_ID_L2_ICMP;
...
static uint32_t    destination_slot_id = GENEVE_DST_SLOT_ID_ICMP;
...
setup_flow_v4_icmp(void)
{
    ...
    // Setup VNIC Mappings
    ret = vlan_to_vnic_map(g_h2s_icmp_vlan, g_icmp_vnic_id, vnic_type);
    if (ret != SDK_RET_OK) {
        return ret;
    }

    // Setup VNIC Mappings
    ret = mpls_label_to_vnic_map(destination_slot_id, g_icmp_vnic_id, vnic_type);
    if (ret != SDK_RET_OK) {
        return ret;
    }
    ...
    ret = create_s2h_session_rewrite_insert_ctag(s2h_session_rewrite_id, g_h2s_icmp_vlan);
    if (ret != SDK_RET_OK) {
        return ret;
    }
    ...
    ret = create_l2_flow (g_icmp_vnic_id, ep_dmac, s2h_session_rewrite_encap_id);
    if (ret != SDK_RET_OK) {
        return ret;
    }

    ret = create_l2_flow (g_icmp_vnic_id, ep_smac, h2s_session_rewrite_encap_id);
    if (ret != SDK_RET_OK) {
        return ret;
    }
...
static uint8_t g_snd_pkt_ipv4_icmp_h2s[] = {
    ...
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0x09,
...
static uint8_t g_rcv_pkt_ipv4_icmp_h2s[] = {
    ...
    0x22, 0x01, 0x00, 0x01, 0x23, 0x4D, 0x00, 0x00,
...
static uint8_t g_rcv_pkt_ipv4_icmp_s2h[] {
    ...
    0xF1, 0xD0, 0xD1, 0xD0, 0x81, 0x00, 0x00, 0x09,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x00,
...
static uint8_t g_rcv_pkt_ipv6_icmp_h2s[] = {
    ...
    0x02, 0x01, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00,
    0x17, 0xC1, 0x00, 0x96, 0x00, 0x00, 0x04, 0x00,
    0x65, 0x58, 0xAA, 0xBB, 0xCC, 0x00, 0x00, 0x00,
    0x21, 0x01, 0x00, 0x11, 0x22, 0x33, 0x00, 0x00,
    0x22, 0x01, 0x00, 0x01, 0x23, 0x4D, 0x00, 0x00,
    0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00, 0x00, 0x40,
    0x08, 0x01, 0x86, 0xDD, 0x60, 0x00, 0x00, 0x00,
    0x00, 0x40, 0x3A, 0x40, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x0C, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x02, 0x01, 0x80, 0x00, 0x40, 0x18,
...
static uint8_t g_snd_pkt_ipv6_icmp_s2h[] = {
    ...
    0x07, 0x08, 0x09, 0x0A, 0x81, 0x00, 0x00, 0x02,
    0x08, 0x00, 0x45, 0x00, 0x00, 0xAA, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x3A, 0x01, 0x02,
    0x03, 0x04, 0x04, 0x03, 0x02, 0x01, 0x00, 0x00,
    0x17, 0xC1, 0x00, 0x96, 0x00, 0x00, 0x04, 0x00,
    0x65, 0x58, 0xAA, 0xBB, 0xCC, 0x00, 0x00, 0x00,
    0x21, 0x01, 0x00, 0x11, 0x22, 0x33, 0x00, 0x00,
    ...
    0x00, 0x40, 0x3A, 0x40, 0x0C, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x02, 0x01, 0x02, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x80, 0x00, 0x40, 0x18,
    0x12, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68,
    0x69, 0x6A, 0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70,
    0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x7A,
