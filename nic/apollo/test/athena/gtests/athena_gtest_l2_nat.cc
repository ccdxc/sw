...
setup_l2_flow_nat(void)
{
    ...
    ret = create_h2s_session_rewrite_geneve_nat_ipv4(h2s_session_rewrite_id,
    ...
    ret = create_h2s_session_rewrite_geneve_nat_ipv6(h2s_ipv6_session_rewrite_id,
        &substrate_dmac, &substrate_smac,
        substrate_vlan,
        substrate_sip, substrate_dip,
	vni,
...
static uint8_t g_rcv_pkt_ipv4_udp_h2s[] = {
    ...
    0x03, 0x00, 0x00, 0x01, 0xC0, 0x00, 0x02, 0x01,
    0x03, 0xE8, 0x27, 0x10, 0x00, 0x3C, 0xF2, 0x44,
    0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68,
    0x69, 0x6A, 0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70,
    0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x7A,
...
static uint8_t g_snd_pkt_ipv4_udp_s2h[] = {
    ...
    0x27, 0x10, 0x03, 0xE8, 0x00, 0x3C, 0xF2, 0x44,
    0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68,
    0x69, 0x6A, 0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70,
    0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x7A,
    0x78, 0x79, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66,
...
static uint8_t g_rcv_pkt_ipv6_udp_h2s[] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x02, 0x01, 0x03, 0xE8, 0x27, 0x10,
    0x00, 0x3C, 0xA6, 0x45, 0x61, 0x62, 0x63, 0x64,
    0x65, 0x66, 0x67, 0x68, 0x69, 0x6A, 0x6C, 0x6B,
    0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72, 0x73, 0x74,
...
static uint8_t g_snd_pkt_ipv6_udp_s2h[] = {
    ...
    0x07, 0x08, 0x09, 0x0A, 0x81, 0x00, 0x00, 0x02,
    0x08, 0x00, 0x45, 0x00, 0x00, 0xA6, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x3E, 0x01, 0x02,
    0x03, 0x04, 0x04, 0x03, 0x02, 0x01, 0x00, 0x00,
    0x17, 0xC1, 0x00, 0x92, 0x00, 0x00, 0x04, 0x00,
    0x65, 0x58, 0xAA, 0xBB, 0xCC, 0x00, 0x00, 0x00,
    0x21, 0x01, 0x00, 0x11, 0x22, 0x33, 0x00, 0x00,
