...
TEST_F(if_test, if_workflow_6) {
    ...
    feeder1.init(int2pdsobjkey(1), "80.1.1.1");
    feeder1A.init(int2pdsobjkey(1), "80.1.2.1");
    feeder1B.init(int2pdsobjkey(1), "80.1.3.1");
...
TEST_F(if_test, if_workflow_neg_5) {
    ...
    feeder1A.init(int2pdsobjkey(10));
...
TEST_F(if_test, if_workflow_neg_7) {
    ...
    feeder1.init(int2pdsobjkey(1), "80.1.1.1");
    feeder1A.init(int2pdsobjkey(1), "80.1.2.1");
    feeder2.init(int2pdsobjkey(10), "80.1.1.1");
