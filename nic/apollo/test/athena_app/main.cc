...
/*
 * Host to Switch: non-NAT flow on NAT VNIC
 */
uint8_t g_snd_nat_pkt_h2s_1[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0x66,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x01,
    0x00, 0x00, 0x40, 0x11, 0xB4, 0x9A, 0x04, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x03, 0xE8,
    0x27, 0x10, 0x00, 0x3C, 0x00, 0x00, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
 ...
 */
static uint8_t g_snd_pkt_l2_ipv4_udp_h2s[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD1, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x02, 0x81, 0x00, 0x00, 0xC8,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x01,
    0x00, 0x00, 0x40, 0x11, 0xB6, 0x9A, 0x02, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x03, 0xE8,
...
/*
 * Switch to Host UDP L2 flow: Packet to be sent
 */
static uint8_t g_snd_pkt_l2_ipv4_udp_s2h[] = {
    ,
...
static uint8_t g_snd_pkt_l2_ipv4_udp_h2s_1[] = {
    ...
    0x00, 0x40, 0x08, 0x02, 0x81, 0x00, 0x00, 0xC8,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x01,
    0x00, 0x00, 0x40, 0x11, 0xB6, 0x98, 0x02, 0x00,
    0x00, 0x02, 0xC0, 0x00, 0x02, 0x02, 0x03, 0xE8,
    0x27, 0x10, 0x00, 0x3C, 0x00, 0x00, 0x61, 0x62,
    0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A,
    0x6C, 0x6B, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72,
    0x73, 0x74, 0x75, 0x76, 0x77, 0x7A, 0x78, 0x79,
...
/*
 * Host to Switch TCP L2 flow: Packet to be sent
 */
static uint8_t g_snd_pkt_l2_ipv4_tcp_h2s[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD0, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x01, 0x81, 0x00, 0x00, 0xC8,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x5C, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x06, 0xB6, 0x9A, 0x02, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x03, 0xE8,
    0x27, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
/*
 * Switch to Host TCP L2 flow: Packet to be sent
 */
static uint8_t g_snd_pkt_l2_ipv4_tcp_s2h[] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x06,
    0x07, 0x08, 0x09, 0x0A, 0x81, 0x00, 0x00, 0x03,
...
main (int argc, char **argv)
{
    ...
    */
    ...
    sleep(5);
    recv_packet();
    send_packet("h2s non-NAT flow on NAT VNIC:flow-miss", g_snd_nat_pkt_h2s_1, sizeof(g_snd_nat_pkt_h2s_1), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    ...
    sleep(5);
    recv_packet();
    send_packet("L2 h2s pkt:flow-miss", g_snd_pkt_l2_ipv4_udp_h2s, sizeof(g_snd_pkt_l2_ipv4_udp_h2s), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("L2 s2h pkt:flow-miss", g_snd_pkt_l2_ipv4_udp_s2h, sizeof(g_snd_pkt_l2_ipv4_udp_s2h), g_s2h_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("L2 h2s pkt:flow-miss", g_snd_pkt_l2_ipv4_udp_h2s_1, sizeof(g_snd_pkt_l2_ipv4_udp_h2s_1), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("L2 h2s TCP pkt:flow-miss", g_snd_pkt_l2_ipv4_tcp_h2s, sizeof(g_snd_pkt_l2_ipv4_tcp_h2s), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("L2 s2h TCP pkt:flow-miss", g_snd_pkt_l2_ipv4_tcp_s2h, sizeof(g_snd_pkt_l2_ipv4_tcp_s2h), g_s2h_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
#endif /* __x86_64__ */
