...
/*
 * Host to Switch UDP L2 NAT flow: Packet to be sent
 */
static uint8_t g_snd_pkt_l2_nat_h2s[] = {
    0x00, 0x00, 0xF1, 0xD0, 0xD1, 0xD1, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x02, 0x81, 0x00, 0x00, 0xCA,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x50, 0x00, 0x01,
    0x00, 0x00, 0x40, 0x11, 0xB6, 0x9A, 0x02, 0x00,
    0x00, 0x01, 0xC0, 0x00, 0x02, 0x01, 0x03, 0xE8,
    0x27, 0x10, 0x00, 0x3C, 0xF3, 0x44, 0x61, 0x62,
...
/*
 * Switch to Host UDP L2 NAT flow: Packet to be sent
 */
static uint8_t g_snd_pkt_l2_nat_s2h[] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x00, 0x06,
    0x07, 0x08, 0x09, 0x0a, 0x81, 0x00, 0x00, 0x03,
    0x08, 0x00, 0x45, 0x00, 0x00, 0x92, 0x00, 0x00,
    0x00, 0x00, 0x40, 0x11, 0x70, 0x52, 0x01, 0x02,
    ...
    0x17, 0xc1, 0x00, 0x7e, 0x00, 0x00, 0x04, 0x00,
    0x65, 0x58, 0x01, 0x23, 0x45, 0x00, 0x00, 0x00,
    0x21, 0x01, 0x00, 0x00, 0x07, 0xD3, 0x00, 0x00,
    0x22, 0x01, 0x00, 0x00, 0x07, 0xD2, 0x00, 0x00,
    0x00, 0x40, 0x08, 0x02, 0x00, 0x00, 0xF1, 0xD0,
    0xD1, 0xD1, 0x08, 0x00, 0x45, 0x00, 0x00, 0x50,
    0x00, 0x01, 0x00, 0x00, 0x40, 0x11, 0xb5, 0x9a,
    0xC0, 0x00, 0x02, 0x01, 0x03, 0x00, 0x00, 0x01,
    0x27, 0x10, 0x03, 0xE8, 0x00, 0x3c, 0x00, 0x00,
    0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68,
    0x69, 0x6a, 0x6c, 0x6b, 0x6d, 0x6e, 0x6f, 0x70,
    0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x7a,
    0x78, 0x79, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66,
...
main (int argc, char **argv)
{
    ...
    */
    ...
    sleep(5);
    recv_packet();
    send_packet("L2 h2s NAT pkt:flow-miss", g_snd_pkt_l2_nat_h2s, sizeof(g_snd_pkt_l2_nat_h2s), g_h2s_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
    send_packet("L2 s2h NAT pkt:flow-miss", g_snd_pkt_l2_nat_s2h, sizeof(g_snd_pkt_l2_nat_s2h), g_s2h_port, NULL, 0, 0);
    sleep(5);
    recv_packet();
#endif /* __x86_64__ */
