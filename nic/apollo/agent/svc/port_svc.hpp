                          ...
                          const sdk::linkmgr::port_args_t *port_info)
{
    ...
    if (port_info->port_type != port_type_t::PORT_TYPE_MGMT) {
        ...
        xcvr_sprom = port_info->xcvr_event_info.xcvr_sprom;
        xcvr_status->set_port(port_info->xcvr_event_info.phy_port);
        xcvr_status->set_state(pds::PortXcvrState(
                         port_info->xcvr_event_info.state));
        xcvr_status->set_pid(pds::PortXcvrPid(port_info->xcvr_event_info.pid));
        xcvr_status->set_mediatype(pds::MediaType(
                         port_info->xcvr_event_info.cable_type));
        xcvr_status->set_xcvrsprom(&port_info->xcvr_event_info.xcvr_sprom,
                                   XCVR_SPROM_SIZE);
        xcvr_status->set_vendorname(sdk::platform::xcvr_vendor_name(
                                        xcvr_sprom));
        xcvr_status->set_vendoroui(sdk::platform::xcvr_vendor_oui(
                                       xcvr_sprom));
        ...
        xcvr_status->set_revision(
            sdk::platform::xcvr_vendor_revision(
                port_info->xcvr_event_info.phy_port, xcvr_sprom));
    }
}
