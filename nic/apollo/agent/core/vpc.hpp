...
sdk_ret_t vpc_peer_create(pds_vpc_peer_key_t *key, pds_vpc_peer_spec_t *spec,
                          pds_batch_ctxt_t bctxt);
sdk_ret_t vpc_peer_delete(pds_vpc_peer_key_t *key, pds_batch_ctxt_t bctxt);
sdk_ret_t vpc_peer_get(pds_vpc_peer_key_t *key, pds_vpc_peer_info_t *info);
