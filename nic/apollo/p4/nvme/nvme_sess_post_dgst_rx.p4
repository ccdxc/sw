...
#define rx_table_s0_t0 s0_t0_nvme_sesspostdgst_rx
#define rx_table_s0_t1 s0_t1_nvme_sesspostdgst_rx
#define rx_table_s0_t2 s0_t2_nvme_sesspostdgst_rx
#define rx_table_s0_t3 s0_t3_nvme_sesspostdgst_rx

#define rx_table_s1_t0 s1_t0_nvme_sesspostdgst_rx
#define rx_table_s1_t1 s1_t1_nvme_sesspostdgst_rx
#define rx_table_s1_t2 s1_t2_nvme_sesspostdgst_rx
#define rx_table_s1_t3 s1_t3_nvme_sesspostdgst_rx

#define rx_table_s2_t0 s2_t0_nvme_sesspostdgst_rx
#define rx_table_s2_t1 s2_t1_nvme_sesspostdgst_rx
#define rx_table_s2_t2 s2_t2_nvme_sesspostdgst_rx
#define rx_table_s2_t3 s2_t3_nvme_sesspostdgst_rx

#define rx_table_s3_t0 s3_t0_nvme_sesspostdgst_rx
#define rx_table_s3_t1 s3_t1_nvme_sesspostdgst_rx
#define rx_table_s3_t2 s3_t2_nvme_sesspostdgst_rx
#define rx_table_s3_t3 s3_t3_nvme_sesspostdgst_rx

#define rx_table_s4_t0 s4_t0_nvme_sesspostdgst_rx
#define rx_table_s4_t1 s4_t1_nvme_sesspostdgst_rx
#define rx_table_s4_t2 s4_t2_nvme_sesspostdgst_rx
#define rx_table_s4_t3 s4_t3_nvme_sesspostdgst_rx

#define rx_table_s5_t0 s5_t0_nvme_sesspostdgst_rx
#define rx_table_s5_t1 s5_t1_nvme_sesspostdgst_rx
#define rx_table_s5_t2 s5_t2_nvme_sesspostdgst_rx
#define rx_table_s5_t3 s5_t3_nvme_sesspostdgst_rx

#define rx_table_s6_t0 s6_t0_nvme_sesspostdgst_rx
#define rx_table_s6_t1 s6_t1_nvme_sesspostdgst_rx
#define rx_table_s6_t2 s6_t2_nvme_sesspostdgst_rx
#define rx_table_s6_t3 s6_t3_nvme_sesspostdgst_rx

#define rx_table_s7_t0 s7_t0_nvme_sesspostdgst_rx
#define rx_table_s7_t1 s7_t1_nvme_sesspostdgst_rx
#define rx_table_s7_t2 s7_t2_nvme_sesspostdgst_rx
#define rx_table_s7_t3 s7_t3_nvme_sesspostdgst_rx
...
#define rx_table_s2_t0_action pdu_ctxt1_process

//fetches num_pages and other cmd related parameters
#define rx_table_s3_t0_action pdu_ctxt0_process

//enqueues to sessprexts ring0
#define rx_table_s4_t0_action sessprodcb_process

//releases busy lock
#define rx_table_s5_t0_action cb_writeback_process
...
header_type nvme_sesspostdgst_rx_to_stage_sessprodcb_info_t {
    fields {
        pad                              :  128;
    }
}
...
header_type nvme_sesspostdgst_rx_pdu_ctxt_to_sessprodcb_t {
    fields {
        pad                 : 160;
    }
}

header_type nvme_sesspostdgst_rx_sessprodcb_to_writeback_t {
    fields {
        pad                 : 160;
    }
}
...
metadata nvme_sesspostdgst_rx_to_stage_sessprodcb_info_t to_s4_info;
@pragma scratch_metadata
metadata nvme_sesspostdgst_rx_to_stage_sessprodcb_info_t to_s4_info_scr;
...
//Table-0
@pragma pa_header_union ingress common_t0_s2s t0_s2s_cb_to_sess_wqe_info t0_s2s_sess_wqe_to_pdu_ctxt1_info t0_s2s_pdu_ctxt1_to_pdu_ctxt0_info t0_s2s_pdu_ctxt_to_sessprodcb_info t0_s2s_sessprodcb_to_writeback_info
...
metadata nvme_sesspostdgst_rx_pdu_ctxt_to_sessprodcb_t t0_s2s_pdu_ctxt_to_sessprodcb_info;
@pragma scratch_metadata
metadata nvme_sesspostdgst_rx_pdu_ctxt_to_sessprodcb_t t0_s2s_pdu_ctxt_to_sessprodcb_info_scr;

metadata nvme_sesspostdgst_rx_sessprodcb_to_writeback_t t0_s2s_sessprodcb_to_writeback_info;
@pragma scratch_metadata
metadata nvme_sesspostdgst_rx_sessprodcb_to_writeback_t t0_s2s_sessprodcb_to_writeback_info_scr;
