...
struct phv_                 p;
struct sacl_ipv4_lpm_s0_k   k;
struct sacl_ipv4_lpm_s0_d   d;

#define prog_name           sacl_ipv4_lpm_s0
#define keys(a)             d.sacl_ipv4_lpm_s0_d.key ## a
#define key                 k.sacl_metadata_ip
#define next_addr           p.sacl_metadata_ipv4_table_addr
#define s2_offset           p.sacl_metadata_ipv4_lpm_s2_offset
