...
struct sacl_sport_lpm_s1_k  k;
struct sacl_sport_lpm_s1_d  d;
struct phv_                 p;

#define keys(a)             d.sacl_sport_lpm_s1_d.key ## a
#define data(a)             d.sacl_sport_lpm_s1_d.data ## a
...
sacl_sport_lpm_s1:
    ...
    phvwr           p.sacl_metadata_sport_class_id, r7
