...
#define keys32b(a)         d.u.match2_ipv4_d.key ## a
#define keys32b_(a)        d.u.match2_ipv4_retrieve_d.key ## a
#define data32b(a)         d.u.match2_ipv4_retrieve_d.data ## a
#define keys128bhi(a)      d.u.match2_ipv6_d.key ## a[127:64]
#define keys128blo(a)      d.u.match2_ipv6_d.key ## a[63:0]
...
#define curr_addr          k.{sacl_metadata_ip_table_addr_next_sbit0_ebit1,\
                              sacl_metadata_ip_table_addr_next_sbit2_ebit33}
