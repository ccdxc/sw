...
struct phv_                         p;
struct sacl_proto_dport_lpm_s1_k    k;
struct sacl_proto_dport_lpm_s1_d    d;

#define prog_name           sacl_proto_dport_lpm_s1
#define keys(a)             d.sacl_proto_dport_lpm_s1_d.key ## a
#define key                 k.sacl_metadata_proto_dport
#define next_addr           p.sacl_metadata_proto_dport_table_addr
#define s2_offset           k.sacl_metadata_proto_dport_lpm_s2_offset
