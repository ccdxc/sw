...
// intrinsic fields
#define CAPRI_RXDMA_INTRINSIC_QSTATE_ADDR k.p4_rxdma_intr_qstate_addr
#define CAPRI_RXDMA_INTRINSIC_QSTATE_ADDR_WITH_SHIFT(_shift) k.p4_rxdma_intr_qstate_addr[33:_shift]
#define CAPRI_RXDMA_INTRINSIC_LIF k.p4_intr_global_lif
...
#define CAPRI_TXDMA_INTRINSIC_QSTATE_ADDR k.p4_txdma_intr_qstate_addr
#define CAPRI_TXDMA_INTRINSIC_QSTATE_ADDR_WITH_SHIFT(_shift) k.p4_txdma_intr_qstate_addr[33:_shift]
#define CAPRI_TXDMA_INTRINSIC_LIF k.p4_intr_global_lif
...
// length in bytes
#define DMA_HBM_PHV2MEM_START_LEN_SETUP(_base_r, _tmp_r, _start, _len, _addr)         \
    phvwrpi       _base_r, offsetof(DMA_CMD_PHV2MEM_T, cmdtype), CAPRI_SIZEOF_RANGE(DMA_CMD_PHV2MEM_T, phv_start, cmdtype), (PHV_FIELD_START_OFFSET(_start) << PHV2MEM_PHV_START_OFFSET) | (DMA_CMD_TYPE_PHV2MEM << PHV2MEM_CMDTYPE_OFFSET); \
    add          _tmp_r, PHV_FIELD_START_OFFSET(_start)-1, _len; \
    phvwrp       _base_r, offsetof(DMA_CMD_PHV2MEM_T, phv_end), sizeof(DMA_CMD_PHV2MEM_T.phv_end), _tmp_r; \
    phvwrp       _base_r, offsetof(DMA_CMD_PHV2MEM_T, addr), sizeof(DMA_CMD_PHV2MEM_T.addr), _addr; \

#define DMA_HBM_PHV2MEM_START_SLEN_ELEN_SETUP(_base_r, _tmp_r, _start, _slen, _elen, _addr)         \
    phvwrpi      _base_r, offsetof(DMA_CMD_PHV2MEM_T, cmdtype), sizeof(DMA_CMD_PHV2MEM_T.cmdtype), (DMA_CMD_TYPE_PHV2MEM << PHV2MEM_CMDTYPE_OFFSET); \
    add          _tmp_r, PHV_FIELD_START_OFFSET(_start), _slen; \
    phvwrp       _base_r, offsetof(DMA_CMD_PHV2MEM_T, phv_start), sizeof(DMA_CMD_PHV2MEM_T.phv_start), _tmp_r; \
    add          _tmp_r, PHV_FIELD_START_OFFSET(_start)-1, _elen; \
    phvwrp       _base_r, offsetof(DMA_CMD_PHV2MEM_T, phv_end), sizeof(DMA_CMD_PHV2MEM_T.phv_end), _tmp_r; \
    phvwrp       _base_r, offsetof(DMA_CMD_PHV2MEM_T, addr), sizeof(DMA_CMD_PHV2MEM_T.addr), _addr; \
