...
#define T0_CMD_CTXT_P   r1
#define T1_CMD_CTXT_P   r2
...
nvme_sesspostdgst_tx_cb_writeback_process:
    ...
    addui          T0_CMD_CTXT_P, r0, hiword(nvme_cmd_context_base)
    addi           T0_CMD_CTXT_P, T0_CMD_CTXT_P, loword(nvme_cmd_context_base)
    add            T0_CMD_CTXT_P, T0_CMD_CTXT_P, k.to_s4_info_cid, LOG_CMD_CTXT_SIZE
    add            T0_CMD_CTXT_P, T0_CMD_CTXT_P, NVME_CMD_CTXT_PAGE_LIST_OFFSET
...
t1_tso_process:
    ...
    add            T1_CMD_CTXT_P, T0_CMD_CTXT_P, 64
