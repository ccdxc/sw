...
.assert(offsetof(k, key_metadata_ipv4_src) == (512 - 32 - (16 + 16 + 8 + 32)))
.assert(offsetof(k, key_metadata_ipv4_dst) == (512 - 32 - (16 + 16 + 8 + 32 + 32)))
.assert(offsetof(k, vnic_metadata_bd_id)   == (512 - 32 - (16 + 16 + 8 + 32 + 32 + 16)))
