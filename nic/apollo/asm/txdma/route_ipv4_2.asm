...
struct phv_                p;
struct route_ipv4_2_k      k;
struct route_ipv4_2_d      d;

#define action_keys        search_routes32b2_d
#define action_data        search_routes32b2_retrieve
#define keys(a)            d.u.search_routes32b2_d.key ## a
#define keys_(a)           d.u.search_routes32b2_retrieve_d.key ## a
#define data(a)            d.u.search_routes32b2_retrieve_d.data ## a
