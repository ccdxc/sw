...
#define keys32b(a)         d.u.search4_ipv4_d.key ## a
#define keys64b(a)         d.u.search4_ipv6_d.key ## a
#define keys32b_(a)        d.u.search4_ipv4_retrieve_d.key ## a
#define keys64b_(a)        d.u.search4_ipv6_retrieve_d.key ## a
#define data32b(a)         d.u.search4_ipv4_retrieve_d.data ## a
#define data64b(a)         d.u.search4_ipv6_retrieve_d.data ## a
