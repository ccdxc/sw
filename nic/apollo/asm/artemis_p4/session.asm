...
session_info_common:
    phvwrpair       p.rewrite_metadata_nexthop_idx, d.session_info_d.nexthop_idx, \
                        p.rewrite_metadata_meter_idx, d.session_info_d.meter_idx
    bbeq            k.control_metadata_direction, TX_FROM_HOST, session_tx
    phvwr           p.{rewrite_metadata_ip,rewrite_metadata_l4port}, \
                        d.{session_info_d.tx_dst_ip,session_info_d.tx_dst_l4port}
session_rx:
