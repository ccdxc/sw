...
#define keys32b(a)         d.u.match1_6_32b_d.key ## a
#define keys128bhi(a)      d.u.match1_6_128b_d.key ## a[127:64]
#define keys128blo(a)      d.u.match1_6_128b_d.key ## a[63:0]
#define keys32b_(a)        d.u.match1_6_32b_retrieve_d.key ## a
#define data32b(a)         d.u.match1_6_32b_retrieve_d.data ## a
#define keys128bhi_(a)     d.u.match1_6_128b_retrieve_d.key ## a[127:64]
#define keys128blo_(a)     d.u.match1_6_128b_retrieve_d.key ## a[63:0]
#define data128b(a)        d.u.match1_6_128b_retrieve_d.data ## a
