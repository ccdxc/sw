...
vnic_info:
    ...
    phvwr.c1     p.lpm_metadata_sacl_base_addr, d.vnic_info_d.lpm_base1
    phvwr.c1     p.lpm_metadata_meter_base_addr, d.vnic_info_d.lpm_base3
    add.c1       r1, r1, d.vnic_info_d.lpm_base1
    phvwr.!c1    p.lpm_metadata_sacl_base_addr, d.vnic_info_d.lpm_base2
    phvwr.!c1    p.lpm_metadata_meter_base_addr, d.vnic_info_d.lpm_base4
    add.!c1      r1, r1, d.vnic_info_d.lpm_base2
    ...
    phvwr        p.lpm_metadata_lpm2_key[15:8], k.p4_to_rxdma_flow_dport_sbit0_ebit7
    phvwr.e      p.lpm_metadata_lpm2_key[7:0], k.p4_to_rxdma_flow_dport_sbit8_ebit15
    // Enable LPM2
