...
update_l2_ipv4_checksum:
    add             r1, r0, k.ipv4_2_ihl, 2
    phvwr.e         p.capri_deparser_len_ipv4_2_hdr_len, r1
    phvwr           p.ipv4_2_csum, TRUE

.align
update_l2_ipv4_udp_checksum:
    add             r1, r0, k.ipv4_2_ihl, 2
    phvwr           p.capri_deparser_len_ipv4_2_hdr_len, r1
    phvwr           p.capri_deparser_len_l4_payload_len, k.udp_2_len
    phvwrpair.e     p.udp_2_csum, TRUE, p.ipv4_2_udp_csum, TRUE
    phvwr           p.ipv4_2_csum, TRUE
...
update_l2_ipv4_tcp_checksum:
    add             r1, r0, k.ipv4_2_ihl, 2
    phvwr           p.capri_deparser_len_ipv4_2_hdr_len, r1
    sub             r1, k.ipv4_2_totalLen, r1
    phvwr           p.capri_deparser_len_l4_payload_len, r1
    phvwrpair.e     p.tcp_csum, TRUE, p.ipv4_2_tcp_csum, TRUE
    phvwr           p.ipv4_2_csum, TRUE
...
update_l2_ipv6_udp_checksum:
    phvwr.e         p.capri_deparser_len_l4_payload_len, k.udp_2_len
    phvwrpair       p.udp_2_csum, TRUE, p.ipv6_2_udp_csum, TRUE

.align
update_l2_ipv6_tcp_checksum:
    add             r1, r0, k.ipv6_2_payloadLen
    phvwr.e         p.capri_deparser_len_l4_payload_len, r1
    phvwrpair       p.tcp_csum, TRUE, p.ipv6_2_tcp_csum, TRUE

.align
update_l2_ipv6_icmp_checksum:
    add             r1, r0, k.ipv6_2_payloadLen
    phvwr.e         p.capri_deparser_len_l4_payload_len, r1
    phvwrpair       p.icmp_csum, TRUE, p.ipv6_2_icmp_csum, TRUE
