...
func (fw FirewallReject) Run(srcEp *Infra.Endpoint, dstEp *Infra.Endpoint) error {
	cmd := []string{"nc", "-l", "80"}
...
func (FirewallReject) FilterEpPairs(epPairs []TestApi.EpPair, agentCfg *Pkg.AgentConfig) []TestApi.EpPair {
