...
public:
  ...
  void block_write(uint32_t chip, uint64_t addr, int size, const vector<uint32_t>& data, cpu_access_type_e do_backdoor=front_door_e, uint32_t flags=secure_acc_e) {}
