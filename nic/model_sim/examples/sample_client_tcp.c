...
#endif
            //pkt2 = Ether(dst="00:22:22:22:22:22",src="00:33:33:33:33:33")/Dot1Q(vlan=2)/IP(src="64.2.0.4",dst="64.2.0.5")/TCP(dport=80,sport=47273,seq=0xbabababa,ack=0xefefefef)/Raw("hello world!")
