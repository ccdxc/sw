...
func (*ForeignKey) Descriptor() ([]byte, []int) { return fileDescriptorDelphi, []int{5} }

func (m *ForeignKey) GetMessageName() string {
	if m != nil {
...
func (m *ForeignKey) GetFilePath() string {
	if m != nil {
		return m.FilePath
	}
	return ""
...
var E_Persist = &proto.ExtensionDesc{
	ExtendedType:  (*google_protobuf.MessageOptions)(nil),
	ExtensionType: (*bool)(nil),
	Field:         70004,
	Name:          "delphi.persist",
	Tag:           "varint,70004,opt,name=persist",
	Filename:      "delphi.proto",
}
...
var E_ForeignKey = &proto.ExtensionDesc{
	ExtendedType:  (*google_protobuf.FieldOptions)(nil),
	ExtensionType: (*ForeignKey)(nil),
	Field:         70001,
	Name:          "delphi.foreign_key",
	Tag:           "bytes,70001,opt,name=foreign_key,json=foreignKey",
	Filename:      "delphi.proto",
}
...
func init() {
	...
	proto.RegisterType((*ForeignKey)(nil), "delphi.ForeignKey")
	...
	proto.RegisterExtension(E_Persist)
...
func (m *ForeignKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.MessageName) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintDelphi(dAtA, i, uint64(len(m.MessageName)))
		i += copy(dAtA[i:], m.MessageName)
	}
	if len(m.FilePath) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDelphi(dAtA, i, uint64(len(m.FilePath)))
...
var fileDescriptorDelphi = []byte{
	...
	,
}
