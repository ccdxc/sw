...
func TestDelphicMetricsBasic(t *testing.T) {
	...
	checkForString(t, ret, ".delphi.hpp", "InterfaceMetrics(int32_t key, char *valptr);")
	checkForString(t, ret, ".delphi.hpp", "InterfaceMetrics(char *kptr, char *valptr) : InterfaceMetrics(*(int32_t *)kptr, valptr){ };")
...
func TestDelphicMetricsKeyType(t *testing.T) {
	...
	checkForString(t, ret, ".delphi.hpp", "delphi::metrics::CounterPtr   PktCounter_;")
	checkForString(t, ret, ".delphi.hpp", "delphi::metrics::GaugePtr     PktRate_;")
	checkForString(t, ret, ".delphi.hpp", "InterfaceMetrics(test::InterfaceIdx key, char *valptr);")
	checkForString(t, ret, ".delphi.hpp", "InterfaceMetrics(char *kptr, char *valptr) : InterfaceMetrics(getInterfaceIdxFromPtr(kptr), valptr){ };")
