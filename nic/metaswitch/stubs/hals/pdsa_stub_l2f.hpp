...
#ifndef __PDSA_STUB_L2F_HPP__
#define __PDSA_STUB_L2F_HPP__

// This is to avoid including the Metaswitch definition of TestIntegSubcomp class 
// that is supposed to implement the L2F IntegrationSubcomponent interface 
...
class L2fIntegSubcomp: public l2f::IntegrationSubcomponent {
    public:
...
namespace l2f {
using TestIntegSubcomp = pdsa_stub::L2fIntegSubcomp ;
}
