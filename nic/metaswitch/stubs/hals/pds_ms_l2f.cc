...
void l2f_integ_subcomp_t::delete_vrf_arp_entry(const ATG_MAI_MAC_IP_ID *mac_ip_id,
                                               const char *vrf_name)
{
    SDK_TRACE_INFO("L2F VRF MAC IP DEL");
}
