...
// PDS-MS SMI HW ports, MAC description
//---------------------------------------------------------------
...
namespace pds_ms
{
// PDS-MS implementation of the SMI Hardware Description class.
class pds_ms_smi_hw_desc_t : public smi::HwDesc
{
public:
    //-------------------------------------------------------------------------
    // Constructor.
    //-------------------------------------------------------------------------
    pds_ms_smi_hw_desc_t (NBB_BYTE (&)[ATG_L2_MAC_ADDR_LEN], NBB_ULONG);
    ~pds_ms_smi_hw_desc_t () {};
    void verify(void) {};
