...
parse_json_config (test_config_t *conf, uint8_t node) {
    ...
    conf->local_lo_ip_addr  = inet_network (value.c_str());
    value                   = pt.get <std::string>("local.gwip");
    conf->local_gwip_addr[0] = inet_network (value.c_str());
    value                    = pt.get <std::string>("local.gwip1");
    conf->local_gwip_addr[1] = inet_network (value.c_str());
    value                   = pt.get <std::string>("local.ac-ip");
    conf->local_mai_ip[0][0]   = inet_network (value.c_str());
    value                   = pt.get <std::string>("local.ac-ip1");
    conf->local_mai_ip[0][1]   = inet_network (value.c_str());
    ...
    conf->local_mai_ip[1][1]   = inet_network (value.c_str());
    ...
    conf->remote_ip_addr_2    = inet_network (value.c_str());
    value                   = pt.get <std::string>("remote.lo-ip");
    conf->remote_lo_ip_addr = inet_network (value.c_str());
    value                   = pt.get <std::string>("remote.lo-ip2");
    conf->remote_lo_ip_addr_2 = inet_network (value.c_str());
