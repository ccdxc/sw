...
#define PDSA_START_TXN(correlator) \
...
#define PDSA_END_TXN(correlator) \
    pdsa_ctm_send_transaction_end (correlator); \
    NBS_RELEASE_SHARED_DATA(); \
    NBS_EXIT_SHARED_CONTEXT(); \
    NBB_DESTROY_THREAD_CONTEXT

#define PDSA_GET_SHARED_START() \
    NBB_CREATE_THREAD_CONTEXT \
    NBS_ENTER_SHARED_CONTEXT(sms_our_pid); \
    NBS_GET_SHARED_DATA(); \
    NBB_TRC_FLOW ((NBB_FORMAT "Start PDSA_GET_SHARED_START"));

#define PDSA_GET_SHARED_END() \
    NBS_RELEASE_SHARED_DATA(); \
    NBS_EXIT_SHARED_CONTEXT(); \
    NBB_DESTROY_THREAD_CONTEXT
