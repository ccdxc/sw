...
export TARGET_DIR=/sw/nic/buildroot/output/target

HOSTPATH=PATH="/sw/nic/buildroot/output/host/bin:/sw/nic/buildroot/output/host/sbin:/opt/coreutils/bin:/opt/rh/devtoolset-7/root/usr/bin:$(PATH)"
...
build-rootfs: copy-overlay
	...
	$(HOSTPATH) /sw/nic/buildroot/output/host/bin/fakeroot -- /sw/nic/buildroot/output/build/buildroot-fs/fakeroot.fs
...
build-squashfs: build-rootfs
	...
	printf '   \n' >> /sw/nic/buildroot/output/build/buildroot-fs/squashfs/fakeroot
	printf '        /sw/nic/buildroot/output/host/bin/mksquashfs /sw/nic/buildroot/output/build/buildroot-fs/squashfs/target /sw/nic/buildroot/output/images/rootfs.squashfs -noappend -processors 8 -comp gzip\n' >> /sw/nic/buildroot/output/build/buildroot-fs/squashfs/fakeroot
