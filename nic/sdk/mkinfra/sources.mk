...
$${${1}_BLD_OUT_DIR}/${2}/%.o: ${2}/%${3} $${${1}_DEPS}
	...
	${AT}$(strip $${${1}_CMD_GXX} -c -o $$@ ${${1}_FLAGS} ${${1}_GPP_FLAGS} ${${1}_INCS} ${${1}_DEFS} -D__FILENAME__=\"$$(notdir $$<)\" $$<)

$${${1}_BLD_OUT_DIR}/${2}/%.o: ${2}/%.c $${${1}_DEPS}
	${AT}mkdir -p $$(dir $$@)
	${NAT}${AT}echo ${NAME_GCC} $$<
	${AT}$(strip $${${1}_CMD_GCC} -c -o $$@ ${${1}_FLAGS} ${${1}_GXX_FLAGS} ${${1}_INCS} ${${1}_DEFS} -D__FILENAME__=\"$$(notdir $$<)\" $$<)
endef
