...
$${${1}_BLD_OUT_DIR}/${2}/%.proto_ccobj: ${2}/%.proto $${${1}_DEPS}
	...
	${AT}$(strip ${CMD_PROTOC} ${CMD_PROTOC_CPP_OPTS} ${${1}_INCS} ${${1}_DEFS} $$<)
	${AT}touch $$@
endef
...
$${${1}_BLD_OUT_DIR}/${2}/%.proto_pyobj: ${2}/%.proto $${${1}_DEPS}
	...
	${AT}$(strip ${CMD_PROTOC} ${CMD_PROTOC_PY_OPTS} ${${1}_INCS} ${${1}_DEFS} $$<)
	${AT}touch $$@
endef
...
$${${1}_BLD_OUT_DIR}/${2}/%.proto_cobj: ${2}/%.proto $${${1}_DEPS}
	...
	${AT}$(strip ${CMD_PROTOC_C} ${CMD_PROTOC_C_OPTS} ${${1}_INCS} ${${1}_DEFS} $$<)
	${AT}touch $$@
endef
...
$${${1}_BLD_OUT_DIR}/${2}/%.proto_gobj: ${2}/%.proto $${${1}_DEPS}
	...
	${AT}$(strip ${CMD_PROTOC} ${${1}_INCS} ${${1}_PROTOC_GOFAST_OPTS} ${${1}_DEFS} $$(notdir $$<))
	${AT}touch $$@
endef
