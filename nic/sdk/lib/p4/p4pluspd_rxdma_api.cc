...
p4pluspd_rxdma_get_table_direction (const char *direction)
{
...
p4pluspd_rxdma_get_table_type (const char *match_type)
{
...
void
p4pluspd_rxdma_cleanup (void)
{
    P4PD_FREE(_p4plus_rxdma_tbls);
    _p4plus_rxdma_tbls = NULL;
}
...
//----------------------------------------------------------------------------
void
p4pd_rxdma_hbm_table_address_set (uint32_t tableid, mem_addr_t pa,
 ...
 */
p4pd_error_t
p4pluspd_rxdma_table_properties_get (uint32_t tableid,
 ...
 */
p4pd_error_t
p4pluspd_rxdma_table_properties_optimal_get (uint32_t tableid,
                                             p4pd_table_properties_t **tbl_ctx)

{
    ...
    *tbl_ctx = (p4pd_table_properties_t *) (_p4plus_rxdma_tbls + tableid);
