...
#define DEV_FEATURE_PROFILE(ENTRY)                                                           \
    ...
    ENTRY(FEATURE_PROFILE_CLASSIC_DEFAULT,       2, "FEATURE_PROFILE_CLASSIC_DEFAULT")       \
    ENTRY(FEATURE_PROFILE_CLASSIC_ETH_DEV_SCALE, 3, "FEATURE_PROFILE_CLASSIC_ETH_DEV_SCALE")
