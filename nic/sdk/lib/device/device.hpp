...
#define DEV_FEATURE_PROFILE(ENTRY)                                                           \
    ...
    ENTRY(FEATURE_PROFILE_BASE,                  1, "FEATURE_PROFILE_BASE")                  \
    ENTRY(FEATURE_PROFILE_STORAGE,               2, "FEATURE_PROFILE_STORAGE")               \
    ENTRY(FEATURE_PROFILE_SRIOV,                 3, "FEATURE_PROFILE_SRIOV")                 \
    ENTRY(FEATURE_PROFILE_VIRTUALIZED,           4, "FEATURE_PROFILE_VIRTUALIZED")           \
    ENTRY(FEATURE_PROFILE_PROXY,                 5, "FEATURE_PROFILE_PROXY")                 \
    ENTRY(FEATURE_PROFILE_DEVELOPER,             6, "FEATURE_PROFILE_DEVELOPER")             
