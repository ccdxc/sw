...
public:
    ...
    sdk_ret_t subscribe(event_id_t event_id, void *lctxt);
    sdk_ret_t unsubscribe(event_id_t event_id, void *lctxt);
    sdk_ret_t unsubscribe_listener(void *lctxt);
    ...
    sdk_ret_t walk_listeners(event_id_t event_id, void *event_ctxt,
                             event_walk_cb_t walk_cb);
    sdk_ret_t notify_event(event_id_t event_id, void *event_ctxt,
                             event_walk_cb_t walk_cb);
...
private:
    ...
    sdk_ret_t del_event_listener_(event_listener_state_t *event_lstate);
    sdk_ret_t add_eventmap_entry_(event_state_t *event_state);
    sdk_ret_t del_eventmap_entry_(event_state_t *event_state);
    sdk_ret_t add_listener_map_entry_(listener_state_t *lstate);
    sdk_ret_t unsubscribe_(event_state_t *event_state,
                           listener_state_t *listener_state);
};
