...
extern float cap_get_temp(uint32_t sbus_addr=51, uint32_t sensor_num=0);
extern float cap_read_temp(uint32_t sbus_addr=51, uint32_t sensor_num=0);
extern void cap_temperature_en(uint32_t sbus_addr=51, uint32_t tsense_mode=0);
extern float cap_get_voltage(uint32_t sbus_addr=51, uint32_t sensor_num=0);
extern float cap_read_voltage(uint32_t sbus_addr=51, uint32_t sensor_num=0);
extern void cap_voltage_en(uint32_t sbus_addr=51, uint32_t vsense_mode=0);

extern uint32_t cap_read_sensor_val(uint32_t sbus_addr=51, uint32_t mode=0, uint32_t v_or_t=0);
