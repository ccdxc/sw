...
int capri_table_entry_read(uint32_t tableid, uint32_t index,
                           uint8_t  *hwentry, uint16_t *hwentry_bit_len,
                           p4_table_mem_layout_t &tbl_info, int gress,
                           bool is_oflow_table, uint32_t ofl_parent_tbl_depth);

int capri_table_hw_entry_read(uint32_t tableid, uint32_t index,
                              uint8_t  *hwentry, uint16_t *hwentry_bit_len,
                              p4_table_mem_layout_t &tbl_info, int gress,
                              bool is_oflow_table, bool ingress,
                              uint32_t ofl_parent_tbl_depth);
...
int capri_hbm_table_entry_write(uint32_t tableid, uint32_t index,
...
int capri_hbm_table_entry_read(uint32_t tableid, uint32_t index,
                               uint8_t *hwentry, uint16_t *entry_size,
                               p4pd_table_properties_t *tbl_info);
...
void capri_program_table_mpu_pc(int tableid, bool gress, int stage,
                                int stage_tableid,
