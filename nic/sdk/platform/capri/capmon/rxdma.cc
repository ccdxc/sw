...
static inline void
capmon_pipeline_rx_data_store1(int type, uint64_t hostq_xoff_cnt,
...
prd_read_counters(int verbose)
{
    ...
    capmon_pipeline_data_store1(RXDMA, ma_cnt, ps_cnt, phv_drop, phv_err,
                                phv_recirc, resub_cnt, num_phv, polls);
    capmon_pipeline_data_store2(RXDMA, pend_rd / polls, pend_wr / polls,
...
psp_read_counters(int verbose)
{
    ...
    capmon_pipeline_data_store3(RXDMA, ma_cnt, sw_cnt, pb_pbus_cnt, pr_pbus_cnt,
