...
sha3_validate_digest_len (unsigned short digest_len)
{
    if ((digest_len != 28) &&
            (digest_len != 32) &&
            (digest_len != 48) &&
...
sdk_ret_t
sha3_pad_gen (int data_len, int digest_len, char *sha3_pad, int *sha3_pad_len)
{
    int         r = 0, q = 0;
...
sdk_ret_t
capri_barco_sym_hash_process_request (CryptoApiHashType hash_type,
                                      bool generate, unsigned char *key,
                                      int key_len, unsigned char *data,
                                      ...
                                      int digest_len)
{
    ...
    uint64_t                    ilist_mem_addr = 0,
                                auth_tag_mem_addr = 0, curr_ptr = 0;
...
#define     SHA3_PAD_MAX_SZ 144
    ...
    if (key_len) {
        CAPRI_BARCO_API_PARAM_HEXDUMP((char *)"Input HMAC Key:",
                                      (char *)key, key_len);
    }
    ...
    case CRYPTOAPI_HASHTYPE_SHA1:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA1_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA1_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA224:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA224_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA224_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA256:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA256_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA256_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA384:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA384_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA384_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA512:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA512_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA512_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_HMAC_SHA1:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA1_Generate_HMAC :
          CAPRI_BARCO_SYM_COMMAND_SHA1_Verify_HMAC;
      break;
    case CRYPTOAPI_HASHTYPE_HMAC_SHA224:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA224_Generate_HMAC :
          CAPRI_BARCO_SYM_COMMAND_SHA224_Verify_HMAC;
      break;
    case CRYPTOAPI_HASHTYPE_HMAC_SHA256:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA256_Generate_HMAC :
          CAPRI_BARCO_SYM_COMMAND_SHA256_Verify_HMAC;
      break;
    case CRYPTOAPI_HASHTYPE_HMAC_SHA384:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA384_Generate_HMAC :
          CAPRI_BARCO_SYM_COMMAND_SHA384_Verify_HMAC;
      break;
    case CRYPTOAPI_HASHTYPE_HMAC_SHA512:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA512_Generate_HMAC :
          CAPRI_BARCO_SYM_COMMAND_SHA512_Verify_HMAC;
      break;
    case CRYPTOAPI_HASHTYPE_SHA3_224:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA3_224_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA3_224_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA3_256:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA3_256_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA3_256_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA3_384:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA3_384_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA3_384_Verify_Hash;
      break;
    case CRYPTOAPI_HASHTYPE_SHA3_512:
      sym_req_descr.command = generate ?
          CAPRI_BARCO_SYM_COMMAND_SHA3_512_Generate_Hash :
          CAPRI_BARCO_SYM_COMMAND_SHA3_512_Verify_Hash;
      break;
    ...
    ret = capri_barco_ring_queue_request(BARCO_RING_MPP0,
                                         (void *)&sym_req_descr,
                                         &req_tag, true);
    if (ret != SDK_RET_OK) {
...
sdk_ret_t
capri_barco_sym_aes_encrypt_process_request (capri_barco_symm_enctype_e enc_type,
                                             bool encrypt,
                                             ...
                                             bool schedule_barco)
{
    ...
    if (key_len) {
        CAPRI_BARCO_API_PARAM_HEXDUMP(key_len == 16 ?
                                      ((char *)"Input AES-128 Key") :
                                      ((char *)"Input AES-256 Key:"),
                                      (char *)key, key_len);
    }
    ...
    if (enc_type == CAPRI_SYMM_ENCTYPE_AES_CCM) {
        ...
        *ptr++ = TLS_AES_CCM_HDR_B0_FLAGS;
        ...
        ptr += iv_len;
        ptr++;
        *(uint16_t *)ptr = encrypt ? htons((uint16_t)plaintext_len) :
            htons((uint16_t)ciphertext_len);
        ptr += 2;
    ...
    if (enc_type == CAPRI_SYMM_ENCTYPE_AES_GCM) {
        ret = capri_barco_ring_queue_request(BARCO_RING_GCM0,
                                             (void *)&sym_req_descr,
    ...
    if (!schedule_barco) {
        SDK_TRACE_DEBUG("SYMM Encrypt %s-%s: Request at slot %d, Barco PI not updated",
                        capri_barco_symm_enctype_name(enc_type),
                        encrypt ? "encrypt" : "decrypt", req_tag);
        ret = SDK_RET_OK;
        return(ret);
    }
...
static inline void
cap_drbg_set_ctl_isr (int chip_id, int value, bool refresh)
{
    DRBG_SET(isr);
}

static inline void
cap_drbg_set_ctl_msk (int chip_id, int value, bool refresh)
{
    DRBG_SET(msk);
}

static inline void
cap_drbg_set_ctl_icr (int chip_id, int value, bool refresh)
{
    DRBG_SET(icr);
}

static inline void
cap_drbg_set_ctl_ver (int chip_id, int value, bool refresh)
{
    DRBG_SET(ver);
}

static inline void
cap_drbg_set_ctl_gct (int chip_id, int value, bool refresh)
{
    DRBG_SET(gct);
}

static inline void
cap_drbg_set_ctl_gs (int chip_id, int value, bool refresh)
{
    DRBG_SET(gs);
}

static inline void
cap_drbg_set_ctl_rng (int chip_id, int value, bool refresh)
{
    DRBG_SET(rng);
}

static inline void
cap_drbg_set_ctl_drnge(int chip_id, int value, bool refresh)
{
    DRBG_SET(drnge);
}

static inline int
cap_drbg_get_ctl_isr(int chip_id, bool refresh)
{
    DRBG_GET(isr);
}

static inline int
cap_drbg_get_ctl_msk(int chip_id, bool refresh)
{
    DRBG_GET(msk);
}

static inline int
cap_drbg_get_ctl_icr(int chip_id, bool refresh)
{
    DRBG_GET(icr);
}

static inline int
cap_drbg_get_ctl_ver(int chip_id, bool refresh)
{
    DRBG_GET(ver);
}

static inline int
cap_drbg_get_ctl_gct(int chip_id, bool refresh)
{
    DRBG_GET(gct);
}

static inline int
cap_drbg_get_ctl_gs(int chip_id,  bool refresh)
{
    DRBG_GET(gs);
}

static inline int
cap_drbg_get_ctl_rng(int chip_id, bool refresh)
{
    DRBG_GET(rng);
}

static inline int
cap_drbg_get_ctl_drnge(int chip_id, bool refresh)
{
    DRBG_GET(drnge);
}
...
static inline void
cap_drbg_write_ram_rand_num0(int chip_id, const unsigned char* value,
...
static inline void
cap_drbg_write_ram_rand_num1(int chip_id, const unsigned char* value,
                             int len, bool refresh)
{
...
static inline void
cap_drbg_read_ram_rand_num0(int chip_id, unsigned char* value,
                            int len, bool refresh)
{
...
static inline void
cap_drbg_read_ram_rand_num1 (int chip_id, unsigned char* value, int len,
                             bool refresh)
{
...
static inline void
cap_drbg_write_ram_psnl_str_p (int chip_id, const unsigned char* value,
                               int len, bool refresh)
{
...
static inline void
cap_trng_set_ctl_reg (int chip_id, int value, bool refresh)
{
    TRNG_SET(controlreg);
}

static inline void
cap_trng_set_fifo_level (int chip_id, int value, bool refresh)
{
    TRNG_SET(fifolevel);
}

static inline void
cap_trng_set_fifo_thresh (int chip_id, int value, bool refresh)
{
    TRNG_SET(fifothresh);
}

static inline void
cap_trng_set_fifo_depth (int chip_id, int value, bool refresh)
{
    TRNG_SET(fifodepth);
}

static inline void
cap_trng_set_key0 (int chip_id, int value, bool refresh)
{
    TRNG_SET(key0);
}

static inline void
cap_trng_set_key1 (int chip_id, int value, bool refresh)
{
    TRNG_SET(key1);
}

static inline void
cap_trng_set_key2 (int chip_id, int value, bool refresh)
{
    TRNG_SET(key2);
}

static inline void
cap_trng_set_key3 (int chip_id, int value, bool refresh)
{
    TRNG_SET(key3);
}
...
static inline void
cap_trng_set_rep_thresh (int chip_id, int value, bool refresh)
{
    TRNG_SET(repthresh);
}

static inline void
cap_trng_set_prop1 (int chip_id, int value, bool refresh)
{
    TRNG_SET(prop1);
}

static inline void
cap_trng_set_prop2 (int chip_id, int value, bool refresh)
{
    TRNG_SET(prop2);
}

static inline void
cap_trng_set_status (int chip_id, int value, bool refresh)
{
    TRNG_SET(status);
}

static inline void
cap_trng_set_init_wait_val (int chip_id, int value, bool refresh)
{
    TRNG_SET(initwaitval);
}

static inline void
cap_trng_set_disable_osc0 (int chip_id, int value, bool refresh)
{
    TRNG_SET(disableosc0);
}

static inline void
cap_trng_set_disable_osc1 (int chip_id, int value, bool refresh)
{
    TRNG_SET(disableosc1);
}

static inline void
cap_trng_set_swoff_tmrval (int chip_id, int value, bool refresh)
{
    TRNG_SET(swofftmrval);
}

static inline void
cap_trng_set_clk_div (int chip_id, int value, bool refresh)
{
    TRNG_SET(clkdiv);
}

static inline void
cap_trng_set_ais31_conf0 (int chip_id, int value, bool refresh)
{
    TRNG_SET(ais31conf0);
}

static inline void
cap_trng_set_ais31_conf1 (int chip_id, int value, bool refresh)
{
    TRNG_SET(ais31conf1);
}

static inline void
cap_trng_set_ais31_conf2 (int chip_id, int value, bool refresh)
{
    TRNG_SET(ais31conf2);
}

static inline void
cap_trng_set_ais31_status (int chip_id, int value, bool refresh)
{
    TRNG_SET(ais31status);
}

static inline int
cap_trng_get_ctl_reg(int chip_id, bool refresh)
{
    TRNG_GET(controlreg);
}

static inline int
cap_trng_get_fifo_level (int chip_id, bool refresh)
{
    TRNG_GET(fifolevel);
}

static inline int
cap_trng_get_fifo_thresh (int chip_id, bool refresh)
{
    TRNG_GET(fifothresh);
}

static inline int
cap_trng_get_fifo_depth (int chip_id, bool refresh)
{
    TRNG_GET(fifodepth);
}

static inline int
cap_trng_get_key0 (int chip_id, bool refresh)
{
    TRNG_GET(key0);
}

static inline int
cap_trng_get_key1 (int chip_id, bool refresh)
{
    TRNG_GET(key1);
}

static inline int
cap_trng_get_key2 (int chip_id, bool refresh)
{
    TRNG_GET(key2);
}

static inline int
cap_trng_get_key3 (int chip_id, bool refresh)
{
    TRNG_GET(key3);
}

static inline int
cap_trng_get_test_data (int chip_id, bool refresh)
{
    TRNG_GET(testdata);
}

static inline int
cap_trng_get_rep_thresh (int chip_id, bool refresh)
{
    TRNG_GET(repthresh);
}

static inline int
cap_trng_get_prop1 (int chip_id, bool refresh)
{
    TRNG_GET(prop1);
}

static inline int
cap_trng_get_prop2 (int chip_id, bool refresh)
{
    TRNG_GET(prop2);
}

static inline int
cap_trng_get_status (int chip_id, bool refresh)
{
    TRNG_GET(status);
}

static inline int
cap_trng_get_init_wait_val (int chip_id, bool refresh)
{
    TRNG_GET(initwaitval);
}

static inline int
cap_trng_get_disable_osc0 (int chip_id, bool refresh)
{
    TRNG_GET(disableosc0);
}

static inline int
cap_trng_get_disable_osc1 (int chip_id, bool refresh)
{
    TRNG_GET(disableosc1);
}

static inline int
cap_trng_get_swoff_tmrval (int chip_id, bool refresh)
{
    TRNG_GET(swofftmrval);
}

static inline int
cap_trng_get_clk_div (int chip_id, bool refresh)
{
    TRNG_GET(clkdiv);
}

static inline int
cap_trng_get_ais31_conf0 (int chip_id, bool refresh)
{
    TRNG_GET(ais31conf0);
}

static inline int
cap_trng_get_ais31_conf1 (int chip_id, bool refresh)
{
    TRNG_GET(ais31conf1);
}

static inline int
cap_trng_get_ais31_conf2 (int chip_id, bool refresh)
{
    TRNG_GET(ais31conf2);
}

static inline int
cap_trng_get_ais31_status (int chip_id, bool refresh)
{
...
capri_barco_init_drbg (void)
{
    ...
    SDK_TRACE_DEBUG("generated personalized string P -- %s len %d",
    ...
    CAPRI_BARCO_API_PARAM_HEXDUMP((char *)"Random number set 0:",
                                  (char *)num0, 512);
}
...
sdk_ret_t
capri_barco_setup_dummy_gcm1_req (uint32_t key_idx)
{
    sdk_ret_t                   ret = SDK_RET_OK;
