...
sdk_ret_t elba_barco_sym_hash_run_tests (void)
{
    sdk_ret_t       ret = SDK_RET_OK;

    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA1, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA224, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA256, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA384, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA512, true);

    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA1, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA224, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA256, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA384, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_SHA512, false);

    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA224, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA256, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA384, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA512, true);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA1, true);

    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA224, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA256, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA384, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA512, false);
    ret = elba_barco_sym_hash_sha_test(CRYPTOAPI_HASHTYPE_HMAC_SHA1, false);

    uint8_t auth_tag[64], ciphertext[128];

#if 0
    ret = elba_barco_sym_aes_encrypt_process_request(ELBA_SYMM_ENCTYPE_AES_CCM, true,
    ...
    if (ret != SDK_RET_OK) {
        ...
        ELBA_BARCO_API_PARAM_HEXDUMP((char *)"Received cipher-text:",
                      (char *)ciphertext, aes_enc[1].ciphertext_len);
        ELBA_BARCO_API_PARAM_HEXDUMP((char *)"Expected cipher-text:",
       ...
       SDK_TRACE_DEBUG("AES-CCM Encrypt test PASSED: ciphertexts match");
        ...
        ELBA_BARCO_API_PARAM_HEXDUMP((char *)"Received auth-tag:",
                      (char *)auth_tag, aes_enc[1].auth_tag_len);
        ELBA_BARCO_API_PARAM_HEXDUMP((char *)"Expected auth-tag:",
    ...
    ret = elba_barco_sym_aes_encrypt_process_request(ELBA_SYMM_ENCTYPE_AES_CCM, false,
                              aes_enc[1].key, aes_enc[1].key_len,
                              aes_enc[1].aad, aes_enc[1].aad_len,
...
sdk_ret_t elba_barco_sym_run_aes_gcm_1K_test (void)
{
    sdk_ret_t       ret = SDK_RET_OK;
    ...
    for (int i = 0; i < 1000; i++) {
        ret = elba_barco_sym_aes_encrypt_process_request(ELBA_SYMM_ENCTYPE_AES_GCM, true,
                              aes_enc[1].key, aes_enc[1].key_len,
                              aes_enc[1].aad, aes_enc[1].aad_len,
                              aes_enc[1].plaintext, aes_enc[1].plaintext_len,
                              aes_enc[1].iv, aes_enc[1].iv_len,
    ...
    ret = elba_barco_sym_aes_encrypt_process_request(ELBA_SYMM_ENCTYPE_AES_GCM, false,
                              aes_enc[1].key, aes_enc[1].key_len,
                              aes_enc[1].aad, aes_enc[1].aad_len,
                              plaintext, aes_enc[1].plaintext_len,
                              aes_enc[1].iv, aes_enc[1].iv_len,
