...
parser_read_counters(int type, int verbose, uint32_t base_addr)
{
    ...
    pkt_to_dp =
        ((uint64_t)CAP_PPA_CSR_CNT_PPA_DP_CNT_PPA_DP_0_4_SOP_31_0_GET(cnt[0]) +
         ((uint64_t)CAP_PPA_CSR_CNT_PPA_DP_CNT_PPA_DP_1_4_SOP_39_32_GET(cnt[1])
          << 32));

    pal_reg_rd32w(base_addr + CAP_PPA_CSR_CNT_PPA_MA_BYTE_ADDRESS, cnt, 4);
    phv_to_s0 =
        ((uint64_t)CAP_PPA_CSR_CNT_PPA_MA_CNT_PPA_MA_0_4_SOP_31_0_GET(cnt[0]) +
         ((uint64_t)CAP_PPA_CSR_CNT_PPA_MA_CNT_PPA_MA_1_4_SOP_39_32_GET(cnt[1])
          << 32));
