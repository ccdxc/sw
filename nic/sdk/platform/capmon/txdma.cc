...
void
capmon_pipeline_data_store1(uint8_t type, uint64_t ma_cnt, uint64_t pb_cnt,
...
void
capmon_pipeline_data_store2(uint8_t type, uint64_t pend_rd, uint64_t pend_wr,
...
ptd_read_counters(int verbose)
{
    ...
    capmon_pipeline_data_store1(TXDMA, ma_cnt, pb_cnt, phv_drop, phv_err,
                                phv_recirc, resub_cnt, num_phv, polls);
    capmon_pipeline_data_store2(
...
void
capmon_pipeline_data_store3(uint8_t type, uint64_t ma_cnt, uint64_t pb_pbus_cnt,
...
npv_read_counters(int verbose)
{
    ...
    capmon_pipeline_data_store3(TXDMA, ma_cnt, pb_pbus_cnt, pr_pbus_cnt, sw_cnt,
