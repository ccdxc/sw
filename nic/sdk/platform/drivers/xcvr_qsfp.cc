...
qsfp_sprom_parse (int port, uint8_t *data)
{
    ...
    default:
        SDK_TRACE_DEBUG("Xcvr port %u QSFP eth spec code %u checking ext compliance",
    ...
    case 0x0:
        SDK_TRACE_DEBUG("Xcvr port %d QSFP ext spec unspecified compliance code 0x0", port);
        break;
    case 0x1:
        // 100G AOC
