...
yaml_emitter_open(yaml_emitter_t *emitter)
{
    ...
    OSAL_ASSERT(emitter);            /* Non-NULL emitter object is required. */
    OSAL_ASSERT(!emitter->opened);   /* Emitter should not be opened yet. */
...
yaml_emitter_close(yaml_emitter_t *emitter)
{
    ...
    OSAL_ASSERT(emitter);            /* Non-NULL emitter object is required. */
    OSAL_ASSERT(emitter->opened);    /* Emitter should be opened. */
...
yaml_emitter_dump(yaml_emitter_t *emitter, yaml_document_t *document)
{
    ...
    OSAL_ASSERT(emitter);            /* Non-NULL emitter object is required. */
    OSAL_ASSERT(document);           /* Non-NULL emitter object is expected. */
