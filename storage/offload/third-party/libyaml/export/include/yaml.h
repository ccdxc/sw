...
typedef void *(*yaml_alloc_fn_t)(size_t sz);
typedef void (*yaml_dealloc_fn_t)(void *ptr);
typedef void *(*yaml_realloc_fn_t)(void *ptr, size_t size);

YAML_DECLARE(void)
yaml_init_allocators(yaml_alloc_fn_t alloc, yaml_dealloc_fn_t dealloc,
                     yaml_realloc_fn_t realloc);
