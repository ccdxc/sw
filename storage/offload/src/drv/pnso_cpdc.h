 ...
 *
 */
#define CPDC_CHKSUM_ADLER32		0
#define CPDC_CHKSUM_CRC32C		1
#define CPDC_CHKSUM_TYPE_DFLT		CPDC_CHKSUM_ADLER32

#define CPDC_INTEGRITY_M_CRC64		0
#define CPDC_INTEGRITY_CRC32C		1
#define CPDC_INTEGRITY_ADLER32		2
#define CPDC_INTEGRITY_M_ADLER32		3
#define CPDC_INTEGRITY_TYPE_DFLT	CPDC_INTEGRITY_ADLER32

#define CPDC_INTEGRITY_SRC_COMP_DATA	0
#define CPDC_INTEGRITY_SRC_UNCOMP_DATA	1
#define CPDC_INTEGRITY_SRC_DFLT		CPDC_INTEGRITY_SRC_UNCOMP_DATA
