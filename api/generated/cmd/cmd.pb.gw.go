...
func request_CmdV1_AutoAddSmartNIC_0(ctx context.Context, marshaler runtime.Marshaler, client CmdV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &SmartNIC{}
	var smetadata runtime.ServerMetadata
...
func RegisterCmdV1HandlerWithClient(ctx context.Context, mux *runtime.ServeMux, client CmdV1Client) error {
	...
	mux.Handle("POST", pattern_CmdV1_AutoAddSmartNIC_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_CmdV1_AutoAddSmartNIC_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_CmdV1_AutoAddSmartNIC_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_CmdV1_AutoAddSmartNIC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"smartnics"}, ""))
...
var (
	...
	forward_CmdV1_AutoAddSmartNIC_0 = runtime.ForwardResponseMessage
