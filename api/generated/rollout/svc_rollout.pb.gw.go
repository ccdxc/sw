...
func request_RolloutV1_RemoveRollout_0(ctx context.Context, marshaler runtime.Marshaler, client RolloutV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &Rollout{}
	var smetadata runtime.ServerMetadata
	...
	msg, err := client.RemoveRollout(ctx, protoReq, grpc.Header(&smetadata.HeaderMD), grpc.Trailer(&smetadata.TrailerMD))
	return msg, smetadata, err
...
func RegisterRolloutV1HandlerWithClient(ctx context.Context, mux *runtime.ServeMux, client RolloutV1Client) error {
	...
	mux.Handle("POST", pattern_RolloutV1_RemoveRollout_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_RolloutV1_RemoveRollout_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_RolloutV1_RemoveRollout_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_RolloutV1_RemoveRollout_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"rollout", "RemoveRollout"}, ""))
...
var (
	...
	forward_RolloutV1_RemoveRollout_0 = runtime.ForwardResponseMessage
