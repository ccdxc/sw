...
var typesMapRollout = map[string]*api.Struct{
	...
	"rollout.Rollout": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.RolloutSpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.RolloutStatus"},
	...
	"rollout.RolloutPhase": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Phase": api.Field{Name: "Phase", CLITag: api.CLIInfo{ID: "phase", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "phase", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
			...
			"Reason": api.Field{Name: "Reason", CLITag: api.CLIInfo{ID: "reason", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "reason", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
	...
	"rollout.RolloutSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"Version": api.Field{Name: "Version", CLITag: api.CLIInfo{ID: "version", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "version", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"ScheduledStartTime": api.Field{Name: "ScheduledStartTime", CLITag: api.CLIInfo{ID: "scheduled-start-time", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "scheduled-start-time", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "api.Timestamp"},

			"Duration": api.Field{Name: "Duration", CLITag: api.CLIInfo{ID: "duration", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "duration", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"Strategy": api.Field{Name: "Strategy", CLITag: api.CLIInfo{ID: "strategy", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "strategy", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"MaxParallel": api.Field{Name: "MaxParallel", CLITag: api.CLIInfo{ID: "max-parallel", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "max-parallel", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_UINT32"},

			"MaxNICFailuresBeforeAbort": api.Field{Name: "MaxNICFailuresBeforeAbort", CLITag: api.CLIInfo{ID: "max-nic-failures-before-abort", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "max-nic-failures-before-abort", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_UINT32"},

			"OrderConstraints": api.Field{Name: "OrderConstraints", CLITag: api.CLIInfo{ID: "order-constraints", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "order-constraints", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "labels.Selector"},

			"Suspend": api.Field{Name: "Suspend", CLITag: api.CLIInfo{ID: "suspend", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "suspend", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_BOOL"},

			"SmartNICsOnly": api.Field{Name: "SmartNICsOnly", CLITag: api.CLIInfo{ID: "smartnics-only", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "smartnics-only", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_BOOL"},

			"SmartNICMustMatchConstraint": api.Field{Name: "SmartNICMustMatchConstraint", CLITag: api.CLIInfo{ID: "smartnic-must-match-constraint", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "smartnic-must-match-constraint", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_BOOL"},

			"UpgradeType": api.Field{Name: "UpgradeType", CLITag: api.CLIInfo{ID: "upgrade-type", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "upgrade-type", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	"rollout.RolloutStatus": &api.Struct{
		...
		Fields: map[string]api.Field{
			"ControllerNodesStatus": api.Field{Name: "ControllerNodesStatus", CLITag: api.CLIInfo{ID: "controller-nodes-status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "controller-nodes-status", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.RolloutPhase"},

			"ControllerServicesStatus": api.Field{Name: "ControllerServicesStatus", CLITag: api.CLIInfo{ID: "controller-services-status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "controller-services-status", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.RolloutPhase"},

			"SmartNICsStatus": api.Field{Name: "SmartNICsStatus", CLITag: api.CLIInfo{ID: "smartnics-status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "smartnics-status", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.RolloutPhase"},

			"OperationalState": api.Field{Name: "OperationalState", CLITag: api.CLIInfo{ID: "state", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "state", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"CompletionPercentage": api.Field{Name: "CompletionPercentage", CLITag: api.CLIInfo{ID: "completion-percent", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "completion-percent", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_UINT32"},

			"StartTime": api.Field{Name: "StartTime", CLITag: api.CLIInfo{ID: "start-time", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "start-time", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "api.Timestamp"},

			"EndTime": api.Field{Name: "EndTime", CLITag: api.CLIInfo{ID: "end-time", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "end-time", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "api.Timestamp"},

			"PreviousVersion": api.Field{Name: "PreviousVersion", CLITag: api.CLIInfo{ID: "prev-version", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "prev-version", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
}
