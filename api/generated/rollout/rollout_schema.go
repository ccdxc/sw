...
var typesMapRollout = map[string]*api.Struct{
	...
	"rollout.Rollout": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"message":                       api.CLIInfo{Path: "Status.ControllerNodesStatus[].Message", Skip: false, Insert: "", Help: ""},
			"name":                          api.CLIInfo{Path: "Status.ControllerNodesStatus[].Name", Skip: false, Insert: "", Help: ""},
			"namespace":                     api.CLIInfo{Path: "Namespace", Skip: false, Insert: "", Help: ""},
			"num-retries":                   api.CLIInfo{Path: "Status.ControllerNodesStatus[].NumberOfRetries", Skip: false, Insert: "", Help: ""},
			"phase":                         api.CLIInfo{Path: "Status.ControllerNodesStatus[].Phase", Skip: false, Insert: "", Help: ""},
			"prev-version":                  api.CLIInfo{Path: "Status.PreviousVersion", Skip: false, Insert: "", Help: ""},
			"reason":                        api.CLIInfo{Path: "Status.ControllerNodesStatus[].Reason", Skip: false, Insert: "", Help: ""},
