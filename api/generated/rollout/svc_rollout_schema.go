...
var typesMapSvc_rollout = map[string]*api.Struct{
	...
	"rollout.AutoMsgRolloutWatchHelper": &api.Struct{
		...
		Fields: map[string]api.Field{
			"Events": api.Field{Name: "Events", CLITag: api.CLIInfo{ID: "events", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "events", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.AutoMsgRolloutWatchHelper.WatchEvent"},
		},
	},
	"rollout.AutoMsgRolloutWatchHelper.WatchEvent": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Object": api.Field{Name: "Object", CLITag: api.CLIInfo{ID: "object", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "object", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.Rollout"},
		},
	},
	"rollout.RolloutList": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Items": api.Field{Name: "Items", CLITag: api.CLIInfo{ID: "items", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "items", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "rollout.Rollout"},
