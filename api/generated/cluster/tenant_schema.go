...
var typesMapTenant = map[string]*api.Struct{
	...
	"cluster.Tenant": &api.Struct{
		Kind: "Tenant", APIGroup: "cluster", Scopes: []string{"Cluster"}, GetTypeFn: func() reflect.Type { return reflect.TypeOf(Tenant{}) },
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "cluster.TenantSpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "cluster.TenantStatus"},
	...
	"cluster.TenantSpec": &api.Struct{
		Kind: "", APIGroup: "", Scopes: []string{}, GetTypeFn: func() reflect.Type { return reflect.TypeOf(TenantSpec{}) },
		Fields: map[string]api.Field{
			"AdminUser": api.Field{Name: "AdminUser", CLITag: api.CLIInfo{ID: "admin-user", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "admin-user", Pointer: true, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	"cluster.TenantStatus": &api.Struct{
		Kind: "", APIGroup: "", Scopes: []string{}, GetTypeFn: func() reflect.Type { return reflect.TypeOf(TenantStatus{}) },
		Fields: map[string]api.Field{},
	},
}
