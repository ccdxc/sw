...
type sclusterSnapshotBackend struct {
...
func (s *sclusterSnapshotBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for sclusterSnapshotBackend")
	s.Messages = map[string]apiserver.Message{

		"cluster.ConfigurationSnapshot": apisrvpkg.NewMessage("cluster.ConfigurationSnapshot").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := cluster.ConfigurationSnapshot{}
				return r.MakeKey(prefix)
			}
			r := i.(cluster.ConfigurationSnapshot)
			return r.MakeKey(prefix)
		}).WithObjectVersionWriter(func(i interface{}, version string) interface{} {
			r := i.(cluster.ConfigurationSnapshot)
			r.Kind = "ConfigurationSnapshot"
			...
			if create {
				if updateFn != nil {
					upd := &cluster.ConfigurationSnapshot{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*cluster.ConfigurationSnapshot)
				...
				if updateFn != nil {
					into := &cluster.ConfigurationSnapshot{}
					...
					var cur cluster.ConfigurationSnapshot
			...
			if create {
				...
				if updatefn != nil {
					...
					r = *robj.(*cluster.ConfigurationSnapshot)
			...
			var n *cluster.ConfigurationSnapshot
			if v, ok := i.(cluster.ConfigurationSnapshot); ok {
				n = &v
			} else if v, ok := i.(*cluster.ConfigurationSnapshot); ok {
				n = v
			} else {
				return nil
			}
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*cluster.ConfigurationSnapshot)
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				if oldObj == nil {
					rete := &cluster.ConfigurationSnapshot{}
		...
		"cluster.ConfigurationSnapshotRequest": apisrvpkg.NewMessage("cluster.ConfigurationSnapshotRequest").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := cluster.ConfigurationSnapshotRequest{}
				return r.MakeKey(prefix)
			}
			r := i.(cluster.ConfigurationSnapshotRequest)
			return r.MakeKey(prefix)
		}).WithObjectVersionWriter(func(i interface{}, version string) interface{} {
			r := i.(cluster.ConfigurationSnapshotRequest)
			r.Kind = "ConfigurationSnapshotRequest"
			r.APIVersion = version
			return r
		}).WithKvUpdater(func(ctx context.Context, kvs kvstore.Interface, i interface{}, prefix string, create bool, updateFn kvstore.UpdateFunc) (interface{}, error) {
			r := i.(cluster.ConfigurationSnapshotRequest)
			...
			if create {
				if updateFn != nil {
					upd := &cluster.ConfigurationSnapshotRequest{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*cluster.ConfigurationSnapshotRequest)
					new.TypeMeta = r.TypeMeta
					new.GenerationID = "1"
					new.UUID = r.UUID
					new.CreationTime = r.CreationTime
				...
				var cur cluster.ConfigurationSnapshotRequest
				err = kvs.Get(ctx, key, &cur)
				if err != nil {
					l.ErrorLog("msg", "trying to update an object that does not exist", "key", key, "err", err)
					return nil, err
			...
			if create {
				...
				if updatefn != nil {
					...
					r = *robj.(*cluster.ConfigurationSnapshotRequest)
					txn.AddComparator(kvstore.Compare(kvstore.WithVersion(key), "=", r.ResourceVersion))
				} else {
					var cur cluster.ConfigurationSnapshotRequest
					err = kvs.Get(ctx, key, &cur)
		...
		"cluster.ConfigurationSnapshotSpec":   apisrvpkg.NewMessage("cluster.ConfigurationSnapshotSpec"),
		"cluster.ConfigurationSnapshotStatus": apisrvpkg.NewMessage("cluster.ConfigurationSnapshotStatus"),
		"cluster.SnapshotDestination":         apisrvpkg.NewMessage("cluster.SnapshotDestination"),
		"cluster.SnapshotRestore": apisrvpkg.NewMessage("cluster.SnapshotRestore").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := cluster.SnapshotRestore{}
				return r.MakeKey(prefix)
			}
			r := i.(cluster.SnapshotRestore)
			return r.MakeKey(prefix)
		}).WithObjectVersionWriter(func(i interface{}, version string) interface{} {
			r := i.(cluster.SnapshotRestore)
			r.Kind = "SnapshotRestore"
			r.APIVersion = version
			return r
		}).WithKvUpdater(func(ctx context.Context, kvs kvstore.Interface, i interface{}, prefix string, create bool, updateFn kvstore.UpdateFunc) (interface{}, error) {
			r := i.(cluster.SnapshotRestore)
			...
			if create {
				if updateFn != nil {
					upd := &cluster.SnapshotRestore{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*cluster.SnapshotRestore)
					new.TypeMeta = r.TypeMeta
					new.GenerationID = "1"
					new.UUID = r.UUID
					new.CreationTime = r.CreationTime
				...
				if updateFn != nil {
					...
					var cur cluster.SnapshotRestore
					err = kvs.Get(ctx, key, &cur)
					if err != nil {
						l.ErrorLog("msg", "trying to update an object that does not exist", "key", key, "err", err)
						return nil, err
			...
			if create {
				...
				if updatefn != nil {
					...
					r = *robj.(*cluster.SnapshotRestore)
					txn.AddComparator(kvstore.Compare(kvstore.WithVersion(key), "=", r.ResourceVersion))
				} else {
					var cur cluster.SnapshotRestore
					err = kvs.Get(ctx, key, &cur)
			...
			var n *cluster.SnapshotRestore
			if v, ok := i.(cluster.SnapshotRestore); ok {
				n = &v
			} else if v, ok := i.(*cluster.SnapshotRestore); ok {
				n = v
			} else {
				return nil
			}
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*cluster.SnapshotRestore)
				n.UUID, n.CreationTime, n.Namespace, n.GenerationID = o.UUID, o.CreationTime, o.Namespace, o.GenerationID
				ts, err := types.TimestampProto(time.Now())
				if err != nil {
					return nil, err
		...
		"cluster.SnapshotRestoreSpec":   apisrvpkg.NewMessage("cluster.SnapshotRestoreSpec"),
		"cluster.SnapshotRestoreStatus": apisrvpkg.NewMessage("cluster.SnapshotRestoreStatus"),
...
func (s *sclusterSnapshotBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sclusterSnapshotBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sclusterSnapshotBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *sclusterSnapshotBackend) Reset() {
	cleanupRegistration()
}
