...
type sclusterLicenseBackend struct {
...
func (s *sclusterLicenseBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for sclusterLicenseBackend")
	s.Messages = map[string]apiserver.Message{

		"cluster.Feature":       apisrvpkg.NewMessage("cluster.Feature"),
		"cluster.FeatureStatus": apisrvpkg.NewMessage("cluster.FeatureStatus"),
		"cluster.License": apisrvpkg.NewMessage("cluster.License").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := cluster.License{}
			...
			var n *cluster.License
			if v, ok := i.(cluster.License); ok {
				n = &v
			} else if v, ok := i.(*cluster.License); ok {
				n = v
			} else {
				return nil
			}
		...
		"cluster.LicenseSpec":   apisrvpkg.NewMessage("cluster.LicenseSpec"),
...
func (s *sclusterLicenseBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sclusterLicenseBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sclusterLicenseBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *sclusterLicenseBackend) Reset() {
	cleanupRegistration()
}
