...
type sclusterDscprofileBackend struct {
...
func (s *sclusterDscprofileBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for sclusterDscprofileBackend")
	s.Messages = map[string]apiserver.Message{

		"cluster.DSCProfile": apisrvpkg.NewMessage("cluster.DSCProfile").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := cluster.DSCProfile{}
				return r.MakeKey(prefix)
			}
			r := i.(cluster.DSCProfile)
			return r.MakeKey(prefix)
			...
			var n *cluster.DSCProfile
			if v, ok := i.(cluster.DSCProfile); ok {
				n = &v
			} else if v, ok := i.(*cluster.DSCProfile); ok {
				n = v
			} else {
				return nil
			}
...
func (s *sclusterDscprofileBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sclusterDscprofileBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sclusterDscprofileBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *sclusterDscprofileBackend) Reset() {
	cleanupRegistration()
}
