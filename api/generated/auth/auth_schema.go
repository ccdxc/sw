...
var typesMapAuth = map[string]*api.Struct{
	...
	"auth.AuthenticationPolicy": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"auth-method":                   api.CLIInfo{Path: "Spec.Authenticators.Radius.Domains[].Servers[].AuthMethod", Skip: false, Insert: "", Help: ""},
			"authenticator-order":           api.CLIInfo{Path: "Spec.Authenticators.AuthenticatorOrder", Skip: false, Insert: "", Help: ""},
			"base-dn":                       api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].BaseDN", Skip: false, Insert: "", Help: ""},
			"bind-dn":                       api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].BindDN", Skip: false, Insert: "", Help: ""},
			"bind-password":                 api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].BindPassword", Skip: false, Insert: "", Help: ""},
			...
			"message":                       api.CLIInfo{Path: "Status.LdapServers[].Message", Skip: false, Insert: "", Help: ""},
			"name":                          api.CLIInfo{Path: "Name", Skip: false, Insert: "", Help: ""},
			"namespace":                     api.CLIInfo{Path: "Namespace", Skip: false, Insert: "", Help: ""},
			"nas-id":                        api.CLIInfo{Path: "Spec.Authenticators.Radius.Domains[].NasID", Skip: false, Insert: "", Help: ""},
			"resource-version":              api.CLIInfo{Path: "ResourceVersion", Skip: false, Insert: "", Help: ""},
			"result":                        api.CLIInfo{Path: "Status.LdapServers[].Result", Skip: false, Insert: "", Help: ""},
			"secret":                        api.CLIInfo{Path: "Spec.Authenticators.Radius.Domains[].Servers[].Secret", Skip: false, Insert: "", Help: ""},
			"self-link":                     api.CLIInfo{Path: "SelfLink", Skip: false, Insert: "", Help: ""},
			"server-name":                   api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].Servers[].TLSOptions.ServerName", Skip: false, Insert: "", Help: ""},
			"skip-server-cert-verification": api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].Servers[].TLSOptions.SkipServerCertVerification", Skip: false, Insert: "", Help: ""},
			"start-tls":                     api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].Servers[].TLSOptions.StartTLS", Skip: false, Insert: "", Help: ""},
			"tag":                           api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].Tag", Skip: false, Insert: "", Help: ""},
			"tenant":                        api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].AttributeMapping.Tenant", Skip: false, Insert: "", Help: ""},
			"token-expiry":                  api.CLIInfo{Path: "Spec.TokenExpiry", Skip: false, Insert: "", Help: ""},
			"trusted-certs":                 api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].Servers[].TLSOptions.TrustedCerts", Skip: false, Insert: "", Help: ""},
			"url":                           api.CLIInfo{Path: "Spec.Authenticators.Ldap.Domains[].Servers[].Url", Skip: false, Insert: "", Help: ""},
	...
	"auth.User": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"kind":             api.CLIInfo{Path: "Status.AccessReview[].Operation.Resource.Kind", Skip: false, Insert: "", Help: ""},
			"labels":           api.CLIInfo{Path: "Labels", Skip: false, Insert: "", Help: ""},
			"message":          api.CLIInfo{Path: "Status.AccessReview[].Message", Skip: false, Insert: "", Help: ""},
			"name":             api.CLIInfo{Path: "Status.AccessReview[].Operation.Resource.Name", Skip: false, Insert: "", Help: ""},
			"namespace":        api.CLIInfo{Path: "Status.AccessReview[].Operation.Resource.Namespace", Skip: false, Insert: "", Help: ""},
			"password":         api.CLIInfo{Path: "Spec.Password", Skip: false, Insert: "", Help: ""},
			"resource-version": api.CLIInfo{Path: "ResourceVersion", Skip: false, Insert: "", Help: ""},
			"roles":            api.CLIInfo{Path: "Status.Roles", Skip: false, Insert: "", Help: ""},
			"self-link":        api.CLIInfo{Path: "SelfLink", Skip: false, Insert: "", Help: ""},
			"tenant":           api.CLIInfo{Path: "Status.AccessReview[].Operation.Resource.Tenant", Skip: false, Insert: "", Help: ""},
