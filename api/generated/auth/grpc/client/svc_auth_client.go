...
func (a *crudClientAuthV1) Watch(ctx context.Context, options *api.AggWatchOptions) (kvstore.Watcher, error) {
...
func (a *crudRestClientAuthV1) Watch(ctx context.Context, options *api.AggWatchOptions) (kvstore.Watcher, error) {
