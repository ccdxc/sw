...
var typesMapNetworkencryption = map[string]*api.Struct{
	...
	"security.IPsecProtocolSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"EncryptionTransform": api.Field{Name: "EncryptionTransform", CLITag: api.CLIInfo{ID: "encryption-transform", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "encryption-transform", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"IntegrityTransform": api.Field{Name: "IntegrityTransform", CLITag: api.CLIInfo{ID: "integrity-transform", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "integrity-transform", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	"security.TLSProtocolSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"CipherSuite": api.Field{Name: "CipherSuite", CLITag: api.CLIInfo{ID: "cipher-suite", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "cipher-suite", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	"security.TrafficEncryptionPolicy": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "security.TrafficEncryptionPolicySpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "security.TrafficEncryptionPolicyStatus"},
	...
	"security.TrafficEncryptionPolicySpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Tls": api.Field{Name: "Tls", CLITag: api.CLIInfo{ID: "tls", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "security.TLSProtocolSpec"},

			"IPsec": api.Field{Name: "IPsec", CLITag: api.CLIInfo{ID: "ipsec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "ipsec", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "security.IPsecProtocolSpec"},

			"KeyRotationIntervalSecs": api.Field{Name: "KeyRotationIntervalSecs", CLITag: api.CLIInfo{ID: "key-rotation-interval-secs", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "key-rotation-interval-secs", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_UINT32"},
		},
	},
