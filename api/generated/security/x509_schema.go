...
var typesMapX509 = map[string]*api.Struct{
	...
	"security.Certificate": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "security.CertificateSpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "security.CertificateStatus"},
	...
	"security.CertificateSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Usages": api.Field{Name: "Usages", CLITag: api.CLIInfo{ID: "usages", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "usages", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"Body": api.Field{Name: "Body", CLITag: api.CLIInfo{ID: "body", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "body", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"TrustChain": api.Field{Name: "TrustChain", CLITag: api.CLIInfo{ID: "trust-chain", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "trust-chain", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	"security.CertificateStatus": &api.Struct{
		...
		Fields: map[string]api.Field{
			"Validity": api.Field{Name: "Validity", CLITag: api.CLIInfo{ID: "validity", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "validity", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
