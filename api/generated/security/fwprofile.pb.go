...
// FirewallProfilePropagationStatus - status part of FirewallProfileStatus
type FirewallProfilePropagationStatus struct {
...
func (m *FirewallProfilePropagationStatus) Reset()         { *m = FirewallProfilePropagationStatus{} }
func (m *FirewallProfilePropagationStatus) String() string { return proto.CompactTextString(m) }
func (*FirewallProfilePropagationStatus) ProtoMessage()    {}
func (*FirewallProfilePropagationStatus) Descriptor() ([]byte, []int) {
	return fileDescriptorFwprofile, []int{1}
}

func (m *FirewallProfilePropagationStatus) GetGenerationID() string {
	if m != nil {
...
func (m *FirewallProfilePropagationStatus) GetUpdated() int32 {
	if m != nil {
		return m.Updated
	}
	return 0
...
func (m *FirewallProfilePropagationStatus) GetPending() int32 {
	if m != nil {
		return m.Pending
	}
	return 0
...
func (m *FirewallProfilePropagationStatus) GetMinVersion() string {
	if m != nil {
		return m.MinVersion
	}
	return ""
...
func (*FirewallProfileSpec) Descriptor() ([]byte, []int) { return fileDescriptorFwprofile, []int{2} }
...
type FirewallProfileStatus struct {
	...
	PropagationStatus FirewallProfilePropagationStatus `protobuf:"bytes,1,opt,name=PropagationStatus,json=propagation-status" json:"propagation-status"`
}
...
func (*FirewallProfileStatus) Descriptor() ([]byte, []int) { return fileDescriptorFwprofile, []int{3} }

func (m *FirewallProfileStatus) GetPropagationStatus() FirewallProfilePropagationStatus {
	if m != nil {
		return m.PropagationStatus
	}
	return FirewallProfilePropagationStatus{}
}

func init() {
	proto.RegisterType((*FirewallProfile)(nil), "security.FirewallProfile")
	proto.RegisterType((*FirewallProfilePropagationStatus)(nil), "security.FirewallProfilePropagationStatus")
...
func (m *FirewallProfilePropagationStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *FirewallProfilePropagationStatus) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.GenerationID) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintFwprofile(dAtA, i, uint64(len(m.GenerationID)))
		i += copy(dAtA[i:], m.GenerationID)
	}
	if m.Updated != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintFwprofile(dAtA, i, uint64(m.Updated))
	}
	if m.Pending != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintFwprofile(dAtA, i, uint64(m.Pending))
	}
	if len(m.MinVersion) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintFwprofile(dAtA, i, uint64(len(m.MinVersion)))
...
func (m *FirewallProfilePropagationStatus) Size() (n int) {
	var l int
	_ = l
	...
	if m.Updated != 0 {
		n += 1 + sovFwprofile(uint64(m.Updated))
	}
	if m.Pending != 0 {
		n += 1 + sovFwprofile(uint64(m.Pending))
	}
	l = len(m.MinVersion)
	if l > 0 {
		n += 1 + l + sovFwprofile(uint64(l))
...
func (m *FirewallProfilePropagationStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FirewallProfilePropagationStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FirewallProfilePropagationStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorFwprofile = []byte{
	...
	,
}
