...
func request_WorkloadV1_AutoLabelWorkload_0(ctx context.Context, marshaler runtime.Marshaler, client WorkloadV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &api.Label{}
	var smetadata runtime.ServerMetadata
	...
	msg, err := client.AutoLabelWorkload(ctx, protoReq, grpc.Header(&smetadata.HeaderMD), grpc.Trailer(&smetadata.TrailerMD))
	return msg, smetadata, err

}

func request_WorkloadV1_AutoLabelWorkload_1(ctx context.Context, marshaler runtime.Marshaler, client WorkloadV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &api.Label{}
	var smetadata runtime.ServerMetadata
...
func request_WorkloadV1_FinalSyncMigration_0(ctx context.Context, marshaler runtime.Marshaler, client WorkloadV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &Workload{}
	var smetadata runtime.ServerMetadata
	...
	msg, err := client.FinalSyncMigration(ctx, protoReq, grpc.Header(&smetadata.HeaderMD), grpc.Trailer(&smetadata.TrailerMD))
	return msg, smetadata, err

}

func request_WorkloadV1_FinalSyncMigration_1(ctx context.Context, marshaler runtime.Marshaler, client WorkloadV1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	protoReq := &Workload{}
	var smetadata runtime.ServerMetadata
...
func RegisterWorkloadV1HandlerWithClient(ctx context.Context, mux *runtime.ServeMux, client WorkloadV1Client) error {
	...
	mux.Handle("POST", pattern_WorkloadV1_AutoLabelWorkload_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_WorkloadV1_AutoLabelWorkload_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_WorkloadV1_AutoLabelWorkload_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_WorkloadV1_AutoLabelWorkload_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_WorkloadV1_AutoLabelWorkload_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_WorkloadV1_AutoLabelWorkload_1(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_WorkloadV1_FinalSyncMigration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_WorkloadV1_FinalSyncMigration_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_WorkloadV1_FinalSyncMigration_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_WorkloadV1_FinalSyncMigration_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_WorkloadV1_FinalSyncMigration_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, outboundMarshaler, w, req, err)
			return
		...
		forward_WorkloadV1_FinalSyncMigration_1(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_WorkloadV1_AutoLabelWorkload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"tenant", "O.Tenant", "workloads", "O.Name", "label"}, ""))

	pattern_WorkloadV1_AutoLabelWorkload_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"workloads", "O.Name", "label"}, ""))
	...
	pattern_WorkloadV1_FinalSyncMigration_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"tenant", "O.Tenant", "workloads", "O.Name", "FinalSyncMigration"}, ""))

	pattern_WorkloadV1_FinalSyncMigration_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"workloads", "O.Name", "FinalSyncMigration"}, ""))
...
var (
	...
	forward_WorkloadV1_AutoLabelWorkload_0 = runtime.ForwardResponseMessage

	forward_WorkloadV1_AutoLabelWorkload_1 = runtime.ForwardResponseMessage
	...
	forward_WorkloadV1_FinalSyncMigration_0 = runtime.ForwardResponseMessage

	forward_WorkloadV1_FinalSyncMigration_1 = runtime.ForwardResponseMessage
