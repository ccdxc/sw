...
var typesMapNetwork = map[string]*api.Struct{
	...
	"network.Network": &api.Struct{
		...
		CLITags: map[string]api.CLIInfo{
			...
			"egress-security-policy":  api.CLIInfo{Path: "Spec.EgressSecurityPolicy", Skip: false, Insert: "", Help: ""},
			"generation-id":           api.CLIInfo{Path: "GenerationID", Skip: false, Insert: "", Help: ""},
			"id":                      api.CLIInfo{Path: "Status.Handle", Skip: false, Insert: "", Help: ""},
			"ingress-security-policy": api.CLIInfo{Path: "Spec.IngressSecurityPolicy", Skip: false, Insert: "", Help: ""},
	...
	"network.NetworkSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"IngressSecurityPolicy": api.Field{Name: "IngressSecurityPolicy", CLITag: api.CLIInfo{ID: "ingress-security-policy", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "ingress-security-policy", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"EgressSecurityPolicy": api.Field{Name: "EgressSecurityPolicy", CLITag: api.CLIInfo{ID: "egress-security-policy", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "egress-security-policy", Pointer: false, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
