...
var typesMapIpam = map[string]*api.Struct{
	...
	"network.DHCPRelayPolicy": &api.Struct{
		Kind: "", APIGroup: "", Scopes: []string{}, GetTypeFn: func() reflect.Type { return reflect.TypeOf(DHCPRelayPolicy{}) },
		Fields: map[string]api.Field{
			"Servers": api.Field{Name: "Servers", CLITag: api.CLIInfo{ID: "relay-servers", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "relay-servers", Pointer: true, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.DHCPServer"},
		},
	},
	"network.DHCPServer": &api.Struct{
	...
	"network.IPAMPolicy": &api.Struct{
		Kind: "IPAMPolicy", APIGroup: "network", Scopes: []string{"Tenant"}, GetTypeFn: func() reflect.Type { return reflect.TypeOf(IPAMPolicy{}) },
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.IPAMPolicySpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.IPAMPolicyStatus"},
	...
	"network.IPAMPolicySpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"DHCPRelay": api.Field{Name: "DHCPRelay", CLITag: api.CLIInfo{ID: "dhcp-relay", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "dhcp-relay", Pointer: true, Slice: false, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.DHCPRelayPolicy"},
		},
	},
	"network.IPAMPolicyStatus": &api.Struct{
