...
var typesMapService = map[string]*api.Struct{
	...
	"network.Service": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.ServiceSpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.ServiceStatus"},
	...
	"network.ServiceSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"WorkloadSelector": api.Field{Name: "WorkloadSelector", CLITag: api.CLIInfo{ID: "workload-labels", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "workload-labels", Pointer: true, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"VirtualIp": api.Field{Name: "VirtualIp", CLITag: api.CLIInfo{ID: "virtual-ip", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "virtual-ip", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"Ports": api.Field{Name: "Ports", CLITag: api.CLIInfo{ID: "ports", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "ports", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"LBPolicy": api.Field{Name: "LBPolicy", CLITag: api.CLIInfo{ID: "lb-policy", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "lb-policy", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"TLSServerPolicy": api.Field{Name: "TLSServerPolicy", CLITag: api.CLIInfo{ID: "tls-server-policy", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-server-policy", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.TLSServerPolicySpec"},

			"TLSClientPolicy": api.Field{Name: "TLSClientPolicy", CLITag: api.CLIInfo{ID: "tls-client-policy", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-client-policy", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "network.TLSClientPolicySpec"},
		},
	},
	...
	"network.TLSClientPolicySpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"CertificatesSelector": api.Field{Name: "CertificatesSelector", CLITag: api.CLIInfo{ID: "tls-client-certificates-selector", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-client-certificates-selector", Pointer: true, Slice: false, Map: true, Inline: false, FromInline: false, KeyType: "TYPE_STRING", Type: "TYPE_STRING"},

			"TrustRoots": api.Field{Name: "TrustRoots", CLITag: api.CLIInfo{ID: "tls-client-trust-roots", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-client-trust-roots", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"AllowedPeerId": api.Field{Name: "AllowedPeerId", CLITag: api.CLIInfo{ID: "tls-client-allowed-peer-id", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-client-allowed-peer-id", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	...
	"network.TLSServerPolicySpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"Certificates": api.Field{Name: "Certificates", CLITag: api.CLIInfo{ID: "tls-server-certificates", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-server-certificates", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"ClientAuthentication": api.Field{Name: "ClientAuthentication", CLITag: api.CLIInfo{ID: "client-authentication", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "client-authentication", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"TrustRoots": api.Field{Name: "TrustRoots", CLITag: api.CLIInfo{ID: "tls-server-trust-roots", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-server-trust-roots", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},

			"AllowedPeerId": api.Field{Name: "AllowedPeerId", CLITag: api.CLIInfo{ID: "tls-server-allowed-peer-id", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "tls-server-allowed-peer-id", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
}
