...
type snetworkIpamBackend struct {
...
func (s *snetworkIpamBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for snetworkIpamBackend")
	s.Messages = map[string]apiserver.Message{

		"network.DHCPRelayPolicy": apisrvpkg.NewMessage("network.DHCPRelayPolicy"),
		"network.DHCPServer":      apisrvpkg.NewMessage("network.DHCPServer"),
		"network.IPAMPolicy": apisrvpkg.NewMessage("network.IPAMPolicy").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := network.IPAMPolicy{}
				return r.MakeKey(prefix)
			}
			r := i.(network.IPAMPolicy)
			return r.MakeKey(prefix)
			...
			var n *network.IPAMPolicy
			if v, ok := i.(network.IPAMPolicy); ok {
				n = &v
			} else if v, ok := i.(*network.IPAMPolicy); ok {
				n = v
			} else {
				return nil
			}
		...
		"network.IPAMPolicySpec":   apisrvpkg.NewMessage("network.IPAMPolicySpec"),
		"network.IPAMPolicyStatus": apisrvpkg.NewMessage("network.IPAMPolicyStatus"),
...
func (s *snetworkIpamBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *snetworkIpamBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *snetworkIpamBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *snetworkIpamBackend) Reset() {
	cleanupRegistration()
}
