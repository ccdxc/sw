...
type sroutingRoutingBackend struct {
...
func (s *sroutingRoutingBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for sroutingRoutingBackend")
	s.Messages = map[string]apiserver.Message{

		"routing.Neighbor": apisrvpkg.NewMessage("routing.Neighbor").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := routing.Neighbor{}
				return r.MakeKey(prefix)
			}
			r := i.(routing.Neighbor)
			return r.MakeKey(prefix)
			...
			var n *routing.Neighbor
			if v, ok := i.(routing.Neighbor); ok {
				n = &v
			} else if v, ok := i.(*routing.Neighbor); ok {
				n = v
			} else {
				return nil
			}
		...
		}).WithStorageTransformer(&routing.StorageNeighborTransformer),
	...
	apisrv.RegisterMessages("routing", s.Messages)
...
func (s *sroutingRoutingBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sroutingRoutingBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sroutingRoutingBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *sroutingRoutingBackend) Reset() {
	cleanupRegistration()
}
