...
func (s *smonitoringTroubleshootingBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	...
	s.Messages = map[string]apiserver.Message{
		...
		"monitoring.TroubleshootingSession": apisrvpkg.NewMessage("monitoring.TroubleshootingSession").WithKeyGenerator(func(i interface{}, prefix string) string {
			...
			if create {
				if updateFn != nil {
					upd := &monitoring.TroubleshootingSession{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*monitoring.TroubleshootingSession)
				...
				if updateFn != nil {
					...
					var cur monitoring.TroubleshootingSession
			...
			if create {
				...
				if updatefn != nil {
					...
					r = *robj.(*monitoring.TroubleshootingSession)
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.TroubleshootingSession)
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				if oldObj == nil {
					rete := &monitoring.TroubleshootingSession{}
