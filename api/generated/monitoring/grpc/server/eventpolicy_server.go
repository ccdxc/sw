...
func (s *smonitoringEventpolicyBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	...
	s.Messages = map[string]apiserver.Message{
		...
		"monitoring.EventPolicy": apisrvpkg.NewMessage("monitoring.EventPolicy").WithKeyGenerator(func(i interface{}, prefix string) string {
			...
			if create {
				if updateFn != nil {
					upd := &monitoring.EventPolicy{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*monitoring.EventPolicy)
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.EventPolicy)
		...
		}).WithStorageTransformer(&monitoring.StorageEventPolicyTransformer),
