		...
		"monitoring.FlowExportPolicy": apisrvpkg.NewMessage("monitoring.FlowExportPolicy").WithKeyGenerator(func(i interface{}, prefix string) string {
			...
			if create {
				...
				if updateFn != nil {
					...
					var cur monitoring.FlowExportPolicy
			...
			if create {
				...
				if updatefn != nil {
					...
					r = *robj.(*monitoring.FlowExportPolicy)
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.FlowExportPolicy)
		...
		"monitoring.FwlogPolicy": apisrvpkg.NewMessage("monitoring.FwlogPolicy").WithKeyGenerator(func(i interface{}, prefix string) string {
			...
			if create {
				...
				if updateFn != nil {
					...
					var cur monitoring.FwlogPolicy
					err = kvs.Get(ctx, key, &cur)
					if err != nil {
						l.ErrorLog("msg", "trying to update an object that does not exist", "key", key, "err", err)
						return nil, err
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.FwlogPolicy)
				n.UUID, n.CreationTime, n.Namespace, n.GenerationID = o.UUID, o.CreationTime, o.Namespace, o.GenerationID
				ts, err := types.TimestampProto(time.Now())
				if err != nil {
					return nil, err
		...
		"monitoring.StatsPolicy": apisrvpkg.NewMessage("monitoring.StatsPolicy").WithKeyGenerator(func(i interface{}, prefix string) string {
			...
			if create {
				...
				if updateFn != nil {
					...
					var cur monitoring.StatsPolicy
					err = kvs.Get(ctx, key, &cur)
					if err != nil {
						l.ErrorLog("msg", "trying to update an object that does not exist", "key", key, "err", err)
						return nil, err
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.StatsPolicy)
				n.UUID, n.CreationTime, n.Namespace, n.GenerationID = o.UUID, o.CreationTime, o.Namespace, o.GenerationID
				ts, err := types.TimestampProto(time.Now())
				if err != nil {
					return nil, err
