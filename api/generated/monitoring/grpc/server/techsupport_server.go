...
type smonitoringTechsupportBackend struct {
...
func (s *smonitoringTechsupportBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for smonitoringTechsupportBackend")
	s.Messages = map[string]apiserver.Message{

		"monitoring.TechSupportNodeResult": apisrvpkg.NewMessage("monitoring.TechSupportNodeResult"),
		"monitoring.TechSupportRequest": apisrvpkg.NewMessage("monitoring.TechSupportRequest").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
			...
			if create {
				if updateFn != nil {
					upd := &monitoring.TechSupportRequest{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*monitoring.TechSupportRequest)
				...
				if updateFn != nil {
					into := &monitoring.TechSupportRequest{}
					...
					var cur monitoring.TechSupportRequest
			...
			if create {
				...
				if updatefn != nil {
					...
					r = *robj.(*monitoring.TechSupportRequest)
			...
			var n *monitoring.TechSupportRequest
			if v, ok := i.(monitoring.TechSupportRequest); ok {
				n = &v
			} else if v, ok := i.(*monitoring.TechSupportRequest); ok {
				n = v
			} else {
				return nil
			}
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.TechSupportRequest)
			...
			return func(oldObj runtime.Object) (runtime.Object, error) {
				if oldObj == nil {
					rete := &monitoring.TechSupportRequest{}
					rete.TypeMeta, rete.ObjectMeta, rete.Spec = n.TypeMeta, n.ObjectMeta, n.Spec
					rete.GenerationID = "1"
					return rete, nil
				}
				if ret, ok := oldObj.(*monitoring.TechSupportRequest); ok {
		...
		"monitoring.TechSupportRequestSpec":   apisrvpkg.NewMessage("monitoring.TechSupportRequestSpec"),
		"monitoring.TechSupportRequestStatus": apisrvpkg.NewMessage("monitoring.TechSupportRequestStatus"),
...
func (s *smonitoringTechsupportBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *smonitoringTechsupportBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *smonitoringTechsupportBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *smonitoringTechsupportBackend) Reset() {
	cleanupRegistration()
}
