...
type smonitoringAuditpolicyBackend struct {
...
func (s *smonitoringAuditpolicyBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for smonitoringAuditpolicyBackend")
	s.Messages = map[string]apiserver.Message{

		"monitoring.AuditPolicy": apisrvpkg.NewMessage("monitoring.AuditPolicy").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := monitoring.AuditPolicy{}
				return r.MakeKey(prefix)
			}
			r := i.(monitoring.AuditPolicy)
			return r.MakeKey(prefix)
			...
			if create {
				if updateFn != nil {
					upd := &monitoring.AuditPolicy{}
					n, err := updateFn(upd)
					if err != nil {
						l.ErrorLog("msg", "could not create new object", "err", err)
						return nil, err
					}
					new := n.(*monitoring.AuditPolicy)
				...
				if updateFn != nil {
					...
					var cur monitoring.AuditPolicy
			...
			var n *monitoring.AuditPolicy
			if v, ok := i.(monitoring.AuditPolicy); ok {
				n = &v
			} else if v, ok := i.(*monitoring.AuditPolicy); ok {
				n = v
			} else {
				return nil
			}
			return func(oldObj runtime.Object) (runtime.Object, error) {
				...
				o := oldObj.(*monitoring.AuditPolicy)
		...
		"monitoring.SyslogAuditor":     apisrvpkg.NewMessage("monitoring.SyslogAuditor"),
...
func (s *smonitoringAuditpolicyBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *smonitoringAuditpolicyBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *smonitoringAuditpolicyBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *smonitoringAuditpolicyBackend) Reset() {
	cleanupRegistration()
}
