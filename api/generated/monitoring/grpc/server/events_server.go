...
type smonitoringEventsBackend struct {
...
func (s *smonitoringEventsBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for smonitoringEventsBackend")
	s.Messages = map[string]apiserver.Message{

		"monitoring.Event": apisrvpkg.NewMessage("monitoring.Event").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := monitoring.Event{}
		...
		"monitoring.EventSource":       apisrvpkg.NewMessage("monitoring.EventSource"),
		"monitoring.EventsList":        apisrvpkg.NewMessage("monitoring.EventsList"),
...
func (s *smonitoringEventsBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *smonitoringEventsBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *smonitoringEventsBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *smonitoringEventsBackend) Reset() {
	cleanupRegistration()
}
