...
type ServiceMonitoringV1Client interface {
	...
	AutoAddStatsAlertPolicy(ctx context.Context, t *StatsAlertPolicy) (*StatsAlertPolicy, error)
	...
	AutoDeleteStatsAlertPolicy(ctx context.Context, t *StatsAlertPolicy) (*StatsAlertPolicy, error)
	...
	AutoGetStatsAlertPolicy(ctx context.Context, t *StatsAlertPolicy) (*StatsAlertPolicy, error)
	...
	AutoLabelStatsAlertPolicy(ctx context.Context, t *api.Label) (*StatsAlertPolicy, error)
	...
	AutoListStatsAlertPolicy(ctx context.Context, t *api.ListWatchOptions) (*StatsAlertPolicyList, error)
	...
	AutoUpdateStatsAlertPolicy(ctx context.Context, t *StatsAlertPolicy) (*StatsAlertPolicy, error)
	...
	AutoWatchStatsAlertPolicy(ctx context.Context, in *api.ListWatchOptions) (MonitoringV1_AutoWatchStatsAlertPolicyClient, error)
...
type ServiceMonitoringV1Server interface {
	...
	AutoWatchStatsAlertPolicy(in *api.ListWatchOptions, stream MonitoringV1_AutoWatchStatsAlertPolicyServer) error
