...
var typesMapTechsupport = map[string]*api.Struct{
	...
	"monitoring.TechSupportNodeResult": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"URI": api.Field{Name: "URI", CLITag: api.CLIInfo{ID: "uri", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "uri", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
		},
	},
	"monitoring.TechSupportRequest": &api.Struct{
		...
		Fields: map[string]api.Field{
			...
			"Spec": api.Field{Name: "Spec", CLITag: api.CLIInfo{ID: "spec", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "spec", Pointer: false, Slice: false, Map: false, Inline: true, FromInline: false, KeyType: "", Type: "monitoring.TechSupportRequestSpec"},

			"Status": api.Field{Name: "Status", CLITag: api.CLIInfo{ID: "status", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "status", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "monitoring.TechSupportRequestStatus"},
	...
	"monitoring.TechSupportRequestSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"CollectionSelector": api.Field{Name: "CollectionSelector", CLITag: api.CLIInfo{ID: "collection-selector", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "collection-selector", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "labels.Selector"},

			"NodeSelector": api.Field{Name: "NodeSelector", CLITag: api.CLIInfo{ID: "node-selector", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "node-selector", Pointer: true, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "monitoring.TechSupportRequestSpec.NodeSelectorSpec"},

			"Verbosity": api.Field{Name: "Verbosity", CLITag: api.CLIInfo{ID: "verbosity", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "verbosity", Pointer: false, Slice: false, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_INT32"},
		},
	},
	"monitoring.TechSupportRequestSpec.NodeSelectorSpec": &api.Struct{
		...
		Fields: map[string]api.Field{
			"Names": api.Field{Name: "Names", CLITag: api.CLIInfo{ID: "names", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "names", Pointer: false, Slice: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "TYPE_STRING"},
