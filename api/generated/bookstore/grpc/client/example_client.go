...
func (a *crudClientBookstoreV1) Watch(ctx context.Context, options *api.AggWatchOptions) (kvstore.Watcher, error) {
...
func (a *crudRestClientBookstoreV1) Watch(ctx context.Context, options *api.AggWatchOptions) (kvstore.Watcher, error) {
