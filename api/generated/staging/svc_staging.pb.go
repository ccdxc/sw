...
type StagingV1Client interface {
	...
	AutoWatchSvcStagingV1(ctx context.Context, in *api.AggWatchOptions, opts ...grpc.CallOption) (StagingV1_AutoWatchSvcStagingV1Client, error)
...
func (c *stagingV1Client) AutoWatchSvcStagingV1(ctx context.Context, in *api.AggWatchOptions, opts ...grpc.CallOption) (StagingV1_AutoWatchSvcStagingV1Client, error) {
...
type StagingV1Server interface {
	...
	AutoWatchSvcStagingV1(*api.AggWatchOptions, StagingV1_AutoWatchSvcStagingV1Server) error
	// Create/Update/Delete multiple objects as part of a single request
...
var fileDescriptorSvcStaging = []byte{
	...
	,
}
