...
type sdiagnosticsModuleBackend struct {
...
func (s *sdiagnosticsModuleBackend) regMsgsFunc(l log.Logger, scheme *runtime.Scheme) {
	l.Infof("registering message for sdiagnosticsModuleBackend")
	s.Messages = map[string]apiserver.Message{

		"diagnostics.DiagnosticsRequest": apisrvpkg.NewMessage("diagnostics.DiagnosticsRequest").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := diagnostics.DiagnosticsRequest{}
				return r.MakeKey(prefix)
			}
			r := i.(diagnostics.DiagnosticsRequest)
			return r.MakeKey(prefix)
		}).WithObjectVersionWriter(func(i interface{}, version string) interface{} {
			r := i.(diagnostics.DiagnosticsRequest)
			r.Kind = "DiagnosticsRequest"
		...
		"diagnostics.DiagnosticsResponse": apisrvpkg.NewMessage("diagnostics.DiagnosticsResponse"),
		"diagnostics.Module": apisrvpkg.NewMessage("diagnostics.Module").WithKeyGenerator(func(i interface{}, prefix string) string {
			if i == nil {
				r := diagnostics.Module{}
				return r.MakeKey(prefix)
			}
			r := i.(diagnostics.Module)
			return r.MakeKey(prefix)
		}).WithObjectVersionWriter(func(i interface{}, version string) interface{} {
			r := i.(diagnostics.Module)
			r.Kind = "Module"
			...
			var n *diagnostics.Module
			if v, ok := i.(diagnostics.Module); ok {
				n = &v
			} else if v, ok := i.(*diagnostics.Module); ok {
				n = v
			} else {
				return nil
			}
...
func (s *sdiagnosticsModuleBackend) regSvcsFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sdiagnosticsModuleBackend) regWatchersFunc(ctx context.Context, logger log.Logger, grpcserver *rpckit.RPCServer, scheme *runtime.Scheme) {

}

func (s *sdiagnosticsModuleBackend) CompleteRegistration(ctx context.Context, logger log.Logger,
...
func (s *sdiagnosticsModuleBackend) Reset() {
	cleanupRegistration()
}
