...
type DiagnosticsV1Client interface {
	...
	AutoWatchSvcDiagnosticsV1(ctx context.Context, in *api.AggWatchOptions, opts ...grpc.CallOption) (DiagnosticsV1_AutoWatchSvcDiagnosticsV1Client, error)
...
func (c *diagnosticsV1Client) AutoWatchSvcDiagnosticsV1(ctx context.Context, in *api.AggWatchOptions, opts ...grpc.CallOption) (DiagnosticsV1_AutoWatchSvcDiagnosticsV1Client, error) {
...
type DiagnosticsV1Server interface {
	...
	AutoWatchSvcDiagnosticsV1(*api.AggWatchOptions, DiagnosticsV1_AutoWatchSvcDiagnosticsV1Server) error
	// Request Diagnostics information for a module
...
var fileDescriptorSvcDiagnostics = []byte{
	...
	,
}
