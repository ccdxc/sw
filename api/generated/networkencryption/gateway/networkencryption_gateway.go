...
func (e *sTrafficEncryptionPolicyV1GwService) newClient(ctx context.Context, grpcAddr string, rslvr resolver.Interface) (networkencryption.TrafficEncryptionPolicyV1Client, error) {
