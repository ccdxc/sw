...
var typesMapSelector = map[string]*api.Struct{
	...
	"labels.Selector": &api.Struct{
		...
		Fields: map[string]api.Field{
			"Requirements": api.Field{Name: "Requirements", CLITag: api.CLIInfo{ID: "requirements", Path: "", Skip: false, Insert: "", Help: ""}, JSONTag: "requirements", Pointer: true, Slice: true, Mutable: true, Map: false, Inline: false, FromInline: false, KeyType: "", Type: "labels.Requirement"},
		},
	},
}
