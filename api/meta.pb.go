...
func (*ListWatchOptions) Descriptor() ([]byte, []int) { return fileDescriptorMeta, []int{2} }
...
func (*Timestamp) Descriptor() ([]byte, []int) { return fileDescriptorMeta, []int{7} }
...
func (*TypeMeta) Descriptor() ([]byte, []int) { return fileDescriptorMeta, []int{8} }
...
func (*WatchEvent) Descriptor() ([]byte, []int) { return fileDescriptorMeta, []int{9} }
...
func (*WatchEventList) Descriptor() ([]byte, []int) { return fileDescriptorMeta, []int{10} }
...
func (m *ObjectMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	n3, err := m.CreationTime.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	...
	n4, err := m.ModTime.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
var fileDescriptorMeta = []byte{
	...
	,
}
