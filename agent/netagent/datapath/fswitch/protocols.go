...
var (
	...
	// addresses are passed to NewArpPacket.
...
// ArpPacket is a raw ARP packet, as described in RFC 826.
...
// NewArpPacket creates a new ArpPacket from an input Operation and hardware/IPv4
...
func NewArpPacket(op Operation, srcHW net.HardwareAddr, srcIP net.IP, dstHW net.HardwareAddr, dstIP net.IP) (*ArpPacket, error) {
...
// UnmarshalBinary unmarshals a raw byte slice into a ArpPacket.
