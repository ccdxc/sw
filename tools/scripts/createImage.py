...
static_images = {
    ...
    'pen-filebeat' : 'registry.test.pensando.io:5000/pen-filebeat:v0.1',
    'pen-ntp' : 'registry.test.pensando.io:5000/pens-ntp:v0.5',
    'pen-elastic'  : 'registry.test.pensando.io:5000/elasticsearch-cluster:v0.11',
    'pen-pause' : 'gcr.io/google_containers/pause-amd64:3.0',
}

# images which are compiled every time
dynamic_images = [
    "cmd", "apiserver", "apigw",  "npm",  "tpm", "spyglass", "evtsmgr", "tsm", "evtsproxy", "vos", "citadel", "rollout", "vtsa"
]
...
imageConfig['upgradeOrder'] = ['pen-cmd', 'pen-apiserver', 'pen-apigw',  'pen-npm', 'pen-tpm', 'pen-spyglass', 'pen-evtsmgr', 'pen-tsm', 'pen-evtsproxy',
                               'pen-kube-controller-manager', 'pen-kube-scheduler', 'pen-kube-apiserver', 'pen-etcd', 'pen-filebeat', 'pen-ntp',  'pen-elastic', "pen-vos", "pen-citadel", "pen-vtsa", "pen-rollout"]
