...
# create License
#curl -k --header "Content-Type: application/json"   --request POST --data ' { "kind": "License", "api-version": "v1", "meta": { "name": "def-license" }, "spec": { "features": [ {"feature-key": "OverlayRouting" } ] } } ' https://$IPADDR/configs/cluster/v1/licenses
