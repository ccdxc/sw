...
class Node:
    ...
    def startCluster(self):
        ...
        self.runCmd("docker run --rm --name pen-cmd -v /usr/pensando/bin:/host/usr/pensando/bin -v /usr/lib/systemd/system:/host/usr/lib/systemd/system -v /etc/pensando:/host/etc/pensando -v /var/lib/pensando:/host/var/lib/pensando pen-install -c /initscript")
    ...
    def stopCluster(self):
        ...
        penSrvs = ["pen-cmd", "pen-apiserver", "pen-apigw", "pen-etcd", "pen-kube-controller-manager", "pen-kube-scheduler", "pen-kube-apiserver", "pen-elastic",  "pen-npm", "pen-tpm", "pen-evtsmgr", "pen-tsm", "pen-evtsproxy", "pen-vtsa"]
        for srv in penSrvs:
        ...
        self.runCmd("sudo rm -fr /var/run/pensando/* /etc/pensando/* /etc/kubernetes/* /usr/pensando/bin/* /var/lib/pensando/* /var/log/pensando/*  /var/lib/cni/ /var/lib/kubelet/* /etc/cni/ /tmp/tlsprovider-*")
