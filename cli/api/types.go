...
var Objs = map[string]ObjectInfo{
	...
	"network":       {Name: "network", Package: "network", GrpcService: "network", URL: "/v1/networks//networks", Perms: "rw"},
	"securityGroup": {Name: "securityGroup", Package: "network", GrpcService: "securityGroup", URL: "/v1/security-groups//security-groups", Perms: "rw"},
	"sgpolicy": {Name: "sgpolicy", Package: "network", GrpcService: "sgpolicy", URL: "/v1/sgpolicy//sgpolicy", Perms: "rw",
		Structs: []GenObjStruct{{Name: "SGRule"}}},
	"service": {Name: "service", Package: "network", GrpcService: "service", URL: "/v1/services//services", Perms: "rw"},
	"lbPolicy": {Name: "lbPolicy", Package: "network", GrpcService: "lbPolicy", URL: "/v1/lb-policy//lb-policy", Perms: "rw",
		Structs: []GenObjStruct{{Name: "HealthCheckSpec"}}},
	"endpoint": {Name: "endpoint", Package: "network", GrpcService: "endpoint", URL: "/v1/endpoints//endpoints", Perms: "rw"},
