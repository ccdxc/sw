...
func (act *ActionCtx) VerifyTechsupportStatus(techsupportName string) error {
	var numRetries int
...
func (act *ActionCtx) PerformTechsupport(techsupport *monitoring.TechSupportRequest) error {
