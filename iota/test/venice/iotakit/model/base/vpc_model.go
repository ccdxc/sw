...
func (sm *SysModel) NewVPC(tenant string, name string, rmac string, vni uint32) *objects.VpcObjCollection {
	return objects.NewVPC(tenant, name, rmac, vni, sm.ObjClient(), sm.Tb)
}
