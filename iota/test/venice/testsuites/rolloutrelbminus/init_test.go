...
func TestIotaRolloutrelbminusTest(t *testing.T) {
	// set log level
	...
	RunSpecsWithCustomReporters(t, "Iota Rollout BIMINUS2B Tests E2E Suite", []Reporter{model})
