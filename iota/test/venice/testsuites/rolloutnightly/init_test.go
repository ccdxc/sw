...
func TestIotaRolloutNIghtlyTest(t *testing.T) {
	// set log level
	...
	RunSpecsWithCustomReporters(t, "Iota Rollout Nightly Tests E2E Suite", []Reporter{model})
}
