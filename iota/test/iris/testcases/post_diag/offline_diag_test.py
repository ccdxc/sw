...
def Trigger(tc):
    ...
    cmd2 = "! grep FAIL /var/log/offline_diags_report.txt | grep -v Local | grep -v RTC"
    cmd3 = "grep PASS /var/log/offline_diags_report.txt"
    cmd4 = "cat /var/log/offline-diags.*.log"
