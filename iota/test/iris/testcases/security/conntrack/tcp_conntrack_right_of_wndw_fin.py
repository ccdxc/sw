...
def Trigger(tc):
    ...
    if tc.resp_flow:
        ...
        cmd_cookie = "hping3 -c 1 -s 1237 -p 52255 -M {}  -L {} --fin  --ack --tcp-timestamp {} -d 10".format(new_seq_num, tc.pre_ctrckinf.r_tcpacknum, tc.client.ip_address)    
        ...
        cmd_cookie = "hping3 -c 1 -s 52255 -p 1237 -M {}  -L {} --fin --ack --tcp-timestamp {} -d 10".format(new_seq_num, tc.pre_ctrckinf.i_tcpacknum, tc.server.ip_address)    
