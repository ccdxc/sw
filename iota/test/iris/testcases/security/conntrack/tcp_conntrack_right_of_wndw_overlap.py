...
def Trigger(tc):
    ...
    cmd_cookie = "nc {} 1239 -p 52257".format(server.ip_address)
    ...
    cmd_cookie = "/nic/bin/halctl show session --dstport 1239 --dstip {} --yaml".format(server.ip_address)
    ...
    cmd_cookie = "hping3 -c 1 -s 52257 -p 1239 -M {}  -L {} --ack --tcp-timestamp {} -d {}".format(iseq_num + rwindo_size - 200, iack_num, server.ip_address, 500)    
