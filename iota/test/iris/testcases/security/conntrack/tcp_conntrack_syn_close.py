...
def Trigger(tc):
    ...
    if resp_flow:
        ...
        cmd_cookie = "hping3 -c 1 -s 1237 -p 52255 -M {}  -L {} --ack --syn --tcp-timestamp {} ".format(wrap_around(rseq_num+1, 0), rack_num, client.ip_address)    
        ...
        cmd_cookie = "hping3 -c 1 -s 52255 -p 1237 -M {}  -L {} --ack --tcp-timestamp {} --syn".format(wrap_around(iseq_num+1, 0), iack_num, server.ip_address)   
