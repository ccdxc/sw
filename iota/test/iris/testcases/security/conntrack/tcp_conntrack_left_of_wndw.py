...
def Trigger(tc):
    ...
    if tc.resp_flow:
        ...
        cmd_cookie = "hping3 -c 1 -s {} -p {} -M {}  -L {} --ack --tcp-timestamp {} -d 10".format(server_port, client_port, wrap_around(tc.pre_ctrckinf.r_tcpseqnum, -200), tc.pre_ctrckinf.r_tcpacknum, tc.client.ip_address)    
