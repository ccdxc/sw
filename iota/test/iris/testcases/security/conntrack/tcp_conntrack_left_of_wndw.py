...
def Trigger(tc):
    ...
    cmd_cookie = "nc {} 1237 -p 52255".format(server.ip_address)
    ...
    cmd_cookie = "hping3 -c 1 -s 52255 -p 1237 -M {}  -L {} --ack --tcp-timestamp {} -d 10".format(iseq_num - 200, iack_num, server.ip_address)    
