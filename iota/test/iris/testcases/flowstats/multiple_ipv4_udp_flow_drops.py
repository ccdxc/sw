...
def Setup(tc):
    ...
    # Set-up UDP-timeout per testcase specification
    #
    tc.udp_timeout_val = get_timeout_val('udp-timeout')
    update_timeout('udp-timeout', tc.iterators.timeout)
...
def Teardown(tc):
    ...
    #
    update_timeout('udp-timeout', tc.udp_timeout_val)
