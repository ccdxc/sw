...
def Trigger(tc):
    ...
    SetupFTPServer(server.node_name, server.workload_name, promiscous=True, restart=True)
    SetupFTPServer(client.node_name, client.workload_name, promiscous=True, restart=True)
