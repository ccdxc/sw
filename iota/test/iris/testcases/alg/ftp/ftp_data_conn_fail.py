...
def Trigger(tc):
    ...
    SetupFTPServer(server.node_name, server.workload_name, promiscous=True, bind_fail=True, restart=True)
    SetupFTPServer(client.node_name, client.workload_name, promiscous=True, bind_fail=True, restart=True)
    ...
    api.Trigger_AddNaplesCommand(req, naples.node_name,
                           "/nic/bin/halctl show security flow-gate")
