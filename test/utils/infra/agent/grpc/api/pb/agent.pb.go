...
type NaplesSimConfig struct {
	...
	DataIntfs       []string `protobuf:"bytes,4,rep,name=dataIntfs" json:"dataIntfs,omitempty"`
	WithQemu        bool     `protobuf:"varint,5,opt,name=withQemu" json:"withQemu,omitempty"`
	PassThroughMode bool     `protobuf:"varint,6,opt,name=PassThroughMode" json:"PassThroughMode,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
