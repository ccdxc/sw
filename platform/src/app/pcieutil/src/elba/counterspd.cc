...
#include "platform/src/app/pcieutil/src/counters.hpp"
...
static void
show_pp_sat_pp_pipe(const int port)
{
...
void
counterspd_show_global_counters(const int flags)
{
    global_flags = flags;
...
void
counterspd_show_port_counters(const int port, const int flags)
{
    global_flags = flags;
