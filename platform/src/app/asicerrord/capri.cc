...
CAPRI_INTR_KIND_BEGIN(dppintcredit, 9, DppintcreditMetrics)
    CAPRI_INTR_KIND_FIELD(ptr_credit_ovflow, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(ptr_credit_undflow, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(pkt_credit_ovflow, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(pkt_credit_undflow, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(framer_credit_ovflow, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(framer_credit_undflow, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(framer_hdrfld_vld_ovfl, 6, ERROR)
    CAPRI_INTR_KIND_FIELD(framer_hdrfld_offset_ovfl, 7, ERROR)
    CAPRI_INTR_KIND_FIELD(err_framer_hdrsize_zero_ovfl, 8, ERROR)
CAPRI_INTR_KIND_END(DppintcreditMetrics)

CAPRI_INTR_KIND_BEGIN(dppintfifo, 6, DppintfifoMetrics)
    CAPRI_INTR_KIND_FIELD(phv_ff_overflow, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(ohi_ff_overflow, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(pkt_size_ff_ovflow, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(pkt_size_ff_undflow, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(csum_phv_ff_ovflow, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(csum_phv_ff_undflow, 5, ERROR)
...
CAPRI_INTR_KIND_BEGIN(dppintreg2, 2, Dppintreg2Metrics)
    CAPRI_INTR_KIND_FIELD(fieldC, 0, INFO)
    CAPRI_INTR_KIND_FIELD(fieldD, 1, INFO)
...
CAPRI_INTR_KIND_BEGIN(dppintsramsecc, 4, DppintsramseccMetrics)
    CAPRI_INTR_KIND_FIELD(dpp_phv_fifo_uncorrectable, 0, FATAL)
    CAPRI_INTR_KIND_FIELD(dpp_phv_fifo_correctable, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(dpp_ohi_fifo_uncorrectable, 2, FATAL)
...
CAPRI_INTR_KIND_BEGIN(dprintcredit, 4, DprintcreditMetrics)
    CAPRI_INTR_KIND_FIELD(egress_credit_ovflow, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(egress_credit_undflow, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(pktout_credit_ovflow, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(pktout_credit_undflow, 3, ERROR)
CAPRI_INTR_KIND_END(DprintcreditMetrics)

CAPRI_INTR_KIND_BEGIN(dprintfifo, 6, DprintfifoMetrics)
    CAPRI_INTR_KIND_FIELD(phv_ff_ovflow, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(ohi_ff_ovflow, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(pktin_ff_ovflow, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(pktout_ff_undflow, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(csum_ff_ovflow, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(ptr_ff_ovflow, 5, ERROR)
CAPRI_INTR_KIND_END(DprintfifoMetrics)

CAPRI_INTR_KIND_BEGIN(dprintflopfifo, 20, DprintflopfifoMetrics)
    CAPRI_INTR_KIND_FIELD(data_mux_force_bypass_crc_flop_ff_ovflow, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_crc_info_flop_ff_ovflow, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_crc_update_info_flop_ff_ovflow, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_csum_info_flop_ff_ovflow, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(data_mux_force_bypass_csum_flop_ff_ovflow, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_csum_update_info_flop_ff_ovflow, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(ptr_early_pkt_eop_info_flop_ff_ovflow, 6, ERROR)
    CAPRI_INTR_KIND_FIELD(data_mux_eop_err_flop_ff_ovflow, 7, ERROR)
    CAPRI_INTR_KIND_FIELD(pktin_eop_err_flop_ff_ovflow, 8, ERROR)
    CAPRI_INTR_KIND_FIELD(csum_err_flop_ff_ovflow, 9, ERROR)
    CAPRI_INTR_KIND_FIELD(crc_err_flop_ff_ovflow, 10, ERROR)
    CAPRI_INTR_KIND_FIELD(data_mux_drop_flop_ff_ovflow, 11, ERROR)
    CAPRI_INTR_KIND_FIELD(phv_pkt_data_flop_ff_ovflow, 12, ERROR)
    CAPRI_INTR_KIND_FIELD(pktout_len_cell_flop_ff_ovflow, 13, ERROR)
    CAPRI_INTR_KIND_FIELD(padding_size_flop_ff_ovflow, 14, ERROR)
    CAPRI_INTR_KIND_FIELD(pktin_err_flop_ff_ovflow, 15, ERROR)
    CAPRI_INTR_KIND_FIELD(phv_no_data_flop_ff_ovflow, 16, ERROR)
    CAPRI_INTR_KIND_FIELD(ptr_lookahaed_flop_ff_ovflow, 17, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_vld_flop_ff_ovflow, 18, ERROR)
    CAPRI_INTR_KIND_FIELD(csum_cal_vld_flop_ff_ovflow, 19, ERROR)
...
//    CAPRI_INTR_KIND_FIELD(err_crc_mask_offset_gt_pkt_size, 23, INFO)
    CAPRI_INTR_KIND_FIELD(err_pkt_eop_early, 24, INFO)
    ...
    CAPRI_INTR_KIND_FIELD(err_ptr_from_cfg_overflow, 28, INFO)
...
CAPRI_INTR_KIND_BEGIN(dprintsramsecc, 12, DprintsramseccMetrics)
    CAPRI_INTR_KIND_FIELD(dpr_pktin_fifo_uncorrectable, 0, FATAL)
    CAPRI_INTR_KIND_FIELD(dpr_pktin_fifo_correctable, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_csum_fifo_uncorrectable, 2, FATAL)
    CAPRI_INTR_KIND_FIELD(dpr_csum_fifo_correctable, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_phv_fifo_uncorrectable, 4, FATAL)
    CAPRI_INTR_KIND_FIELD(dpr_phv_fifo_correctable, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_ohi_fifo_uncorrectable, 6, FATAL)
    CAPRI_INTR_KIND_FIELD(dpr_ohi_fifo_correctable, 7, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_ptr_fifo_uncorrectable, 8, FATAL)
    CAPRI_INTR_KIND_FIELD(dpr_ptr_fifo_correctable, 9, ERROR)
    CAPRI_INTR_KIND_FIELD(dpr_pktout_fifo_uncorrectable, 10, FATAL)
...
CAPRI_INTR_KIND_BEGIN(ssepicsintbadaddr, 18, SsepicsintbadaddrMetrics)
    CAPRI_INTR_KIND_FIELD(rdreq0_bad_addr, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq0_bad_addr, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq1_bad_addr, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq1_bad_addr, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq2_bad_addr, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq2_bad_addr, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq3_bad_addr, 6, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq3_bad_addr, 7, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq4_bad_addr, 8, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq4_bad_addr, 9, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq5_bad_addr, 10, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq5_bad_addr, 11, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq6_bad_addr, 12, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq6_bad_addr, 13, ERROR)
    CAPRI_INTR_KIND_FIELD(rdreq7_bad_addr, 14, ERROR)
    CAPRI_INTR_KIND_FIELD(wrreq7_bad_addr, 15, ERROR)
    CAPRI_INTR_KIND_FIELD(cpu_bad_addr, 16, ERROR)
    CAPRI_INTR_KIND_FIELD(bg_bad_addr, 17, ERROR)
...
CAPRI_INTR_KIND_BEGIN(ssepicsintpics, 3, SsepicsintpicsMetrics)
    CAPRI_INTR_KIND_FIELD(uncorrectable_ecc, 0, FATAL)
...
CAPRI_INTR_KIND_BEGIN(dbwaintdb, 7, DbwaintdbMetrics)
    CAPRI_INTR_KIND_FIELD(db_cam_conflict, 0, INFO)
...
CAPRI_INTR_KIND_BEGIN(dbwaintlifqstatemap, 3, DbwaintlifqstatemapMetrics)
    CAPRI_INTR_KIND_FIELD(ecc_uncorrectable, 0, FATAL)
...
CAPRI_INTR_KIND_BEGIN(sgeteinterr, 20, SgeteinterrMetrics)
    CAPRI_INTR_KIND_FIELD(miss_sop, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(miss_eop, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(phv_max_size, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(spurious_axi_rsp, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(spurious_tcam_rsp, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(te2mpu_timeout, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(axi_rdrsp_err, 6, ERROR)
    CAPRI_INTR_KIND_FIELD(axi_bad_read, 7, ERROR)
    CAPRI_INTR_KIND_FIELD(tcam_req_idx_fifo, 8, ERROR)
    CAPRI_INTR_KIND_FIELD(tcam_rsp_idx_fifo, 9, ERROR)
    CAPRI_INTR_KIND_FIELD(mpu_req_idx_fifo, 10, ERROR)
    CAPRI_INTR_KIND_FIELD(axi_req_idx_fifo, 11, ERROR)
    CAPRI_INTR_KIND_FIELD(proc_tbl_vld_wo_proc, 12, ERROR)
    CAPRI_INTR_KIND_FIELD(pend_wo_wb, 13, ERROR)
    CAPRI_INTR_KIND_FIELD(pend1_wo_pend0, 14, ERROR)
    CAPRI_INTR_KIND_FIELD(both_pend_down, 15, ERROR)
    CAPRI_INTR_KIND_FIELD(pend_wo_proc_down, 16, ERROR)
    CAPRI_INTR_KIND_FIELD(both_pend_went_up, 17, ERROR)
    CAPRI_INTR_KIND_FIELD(loaded_but_no_proc, 18, ERROR)
    CAPRI_INTR_KIND_FIELD(loaded_but_no_proc_tbl_vld, 19, ERROR)
...
CAPRI_INTR_KIND_BEGIN(sgempuinterr, 27, SgempuinterrMetrics)
    ...
    CAPRI_INTR_KIND_FIELD(sdp_mem_uncorrectable, 1, FATAL)
...
CAPRI_INTR_KIND_BEGIN(mdhensintaxierr, 2, MdhensintaxierrMetrics)
    CAPRI_INTR_KIND_FIELD(wrsp_err, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(rrsp_err, 1, ERROR)
...
CAPRI_INTR_KIND_BEGIN(mdhensintecc, 2, MdhensinteccMetrics)
    ...
    CAPRI_INTR_KIND_FIELD(uncorrectable_err, 1, FATAL)
CAPRI_INTR_KIND_END(MdhensinteccMetrics)

CAPRI_INTR_KIND_BEGIN(mdhensintipcore, 8, MdhensintipcoreMetrics)
    CAPRI_INTR_KIND_FIELD(xts_enc, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(xts, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(gcm0, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(gcm1, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(drbg, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(pk, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(cp, 6, INFO)
    CAPRI_INTR_KIND_FIELD(dc, 7, INFO)
CAPRI_INTR_KIND_END(MdhensintipcoreMetrics)

CAPRI_INTR_KIND_BEGIN(mpmpnsintcrypto, 8, MpmpnsintcryptoMetrics)
    CAPRI_INTR_KIND_FIELD(mpp0, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp1, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp2, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp3, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp4, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp5, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp6, 6, ERROR)
    CAPRI_INTR_KIND_FIELD(mpp7, 7, ERROR)
CAPRI_INTR_KIND_END(MpmpnsintcryptoMetrics)

CAPRI_INTR_KIND_BEGIN(pbpbcintcreditunderflow, 2, PbpbcintcreditunderflowMetrics)
    CAPRI_INTR_KIND_FIELD(port_10, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(port_11, 1, ERROR)
CAPRI_INTR_KIND_END(PbpbcintcreditunderflowMetrics)

CAPRI_INTR_KIND_BEGIN(inteccdesc, 2, InteccdescMetrics)
    CAPRI_INTR_KIND_FIELD(uncorrectable, 0, FATAL)
...
CAPRI_INTR_KIND_BEGIN(pbpbcintpbusviolation, 24, PbpbcintpbusviolationMetrics)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_0, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_1, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_2, 2, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_3, 3, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_4, 4, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_5, 5, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_6, 6, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_7, 7, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_8, 8, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_9, 9, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_10, 10, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_11, 11, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_0, 12, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_1, 13, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_2, 14, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_3, 15, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_4, 16, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_5, 17, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_6, 18, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_7, 19, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_8, 20, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_9, 21, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_10, 22, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_11, 23, ERROR)
CAPRI_INTR_KIND_END(PbpbcintpbusviolationMetrics)

CAPRI_INTR_KIND_BEGIN(pbpbcintrpl, 2, PbpbcintrplMetrics)
    CAPRI_INTR_KIND_FIELD(memory_error, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(zero_last_error, 1, INFO)
CAPRI_INTR_KIND_END(PbpbcintrplMetrics)

CAPRI_INTR_KIND_BEGIN(pbpbcintwrite, 14, PbpbcintwriteMetrics)
    CAPRI_INTR_KIND_FIELD(out_of_cells, 0, INFO)
    CAPRI_INTR_KIND_FIELD(out_of_credit, 1, INFO)
    CAPRI_INTR_KIND_FIELD(port_disabled, 2, INFO)
    CAPRI_INTR_KIND_FIELD(truncation, 3, INFO)
    CAPRI_INTR_KIND_FIELD(intrinsic_drop, 4, INFO)
    CAPRI_INTR_KIND_FIELD(out_of_cells1, 5, INFO)
    CAPRI_INTR_KIND_FIELD(enq_err, 6, INFO)
    CAPRI_INTR_KIND_FIELD(tail_drop_cpu, 7, INFO)
    CAPRI_INTR_KIND_FIELD(tail_drop_span, 8, INFO)
    CAPRI_INTR_KIND_FIELD(min_size_viol, 9, INFO)
    CAPRI_INTR_KIND_FIELD(port_range, 10, INFO)
    CAPRI_INTR_KIND_FIELD(credit_growth_error, 11, ERROR)
    CAPRI_INTR_KIND_FIELD(oq_range, 12, INFO)
    CAPRI_INTR_KIND_FIELD(xoff_timeout, 13, INFO)
CAPRI_INTR_KIND_END(PbpbcintwriteMetrics)

CAPRI_INTR_KIND_BEGIN(pbpbchbmintecchbmrb, 4, PbpbchbmintecchbmrbMetrics)
    CAPRI_INTR_KIND_FIELD(rb_uncorrectable, 0, FATAL)
    CAPRI_INTR_KIND_FIELD(rb_correctable, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(cdt_uncorrectable, 2, FATAL)
...
CAPRI_INTR_KIND_BEGIN(pbpbchbminthbmaxierrrsp, 3, PbpbchbminthbmaxierrrspMetrics)
    CAPRI_INTR_KIND_FIELD(ctrl, 0, ERROR)
    CAPRI_INTR_KIND_FIELD(pyld, 1, ERROR)
    CAPRI_INTR_KIND_FIELD(r2a, 2, ERROR)
...
CAPRI_INTR_KIND_BEGIN(pbpbchbminthbmpbusviolation, 20, PbpbchbminthbmpbusviolationMetrics)
    ...
    CAPRI_INTR_KIND_FIELD(sop_sop_in_8, 8, ERROR)
    CAPRI_INTR_KIND_FIELD(sop_sop_in_9, 9, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_0, 10, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_1, 11, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_2, 12, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_3, 13, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_4, 14, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_5, 15, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_6, 16, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_7, 17, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_8, 18, ERROR)
    CAPRI_INTR_KIND_FIELD(eop_eop_in_9, 19, ERROR)
