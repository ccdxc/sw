...
syms_parser = subparsers.add_parser('gen_syms', help='Create Symbol File')
syms_parser.add_argument('--sym_dir', default='./build/aarch64/iris/out/', help='Symbol root')
...
phv_parser.add_argument('--load', default='capri_loader.conf', help="Loader file")
...
key_parser.add_argument('--load', default='capri_loader.conf', help="Loader file")
...
data_parser.add_argument('--load', default='capri_loader.conf', help="Loader file")
...
file_parser.add_argument('--load', default='capri_loader.conf', help="Loader file")
file_parser.add_argument('--fltr', nargs='+', default=list(), help='Header filters')

args = parser.parse_args()

if args.command == "gen_syms":
    create_symbol_file(sym_dir=args.sym_dir, sym_file=args.sym_file)
