...
class NicLIFManager : public LIFManagerBase {
public:
    static NicLIFManager *factory(sdk::platform::utils::mpartition *mp,
                                  sdk::platform::program_info *pinfo);
    static void destroy(NicLIFManager *lm);
