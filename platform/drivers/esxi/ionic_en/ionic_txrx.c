                      ...
                      struct lif *lif)
{
        ...
        VMK_ASSERT(tx_ring->is_init == VMK_FALSE);
                      ...
                      struct lif *lif)
{
        ...
        VMK_ASSERT(rx_ring->is_init == VMK_FALSE);
                          ...
                          struct lif *lif)
{
        ...
        ionic_err("ionic_en_rx_rss_ring_init() called");

        VMK_ASSERT(rx_rss_ring->is_init == VMK_FALSE);
