...
mocked_modules = ["l2segment_pb2", "types_pb2", "tenant_pb2", "interface_pb2", "endpoint_pb2", "session_pb2", "endpoint_pb2_grpc",
                  ...
                  "telemetry_pb2", "tcp_proxy_cb_pb2", "tls_proxy_cb_pb2", "descriptor_aol_pb2", "wring_pb2", 
                  "tcp_proxy_cb_pb2_grpc", "tls_proxy_cb_pb2_grpc", "descriptor_aol_pb2_grpc", "wring_pb2_grpc",
