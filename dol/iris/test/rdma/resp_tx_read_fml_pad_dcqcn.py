...
def TestCaseVerify(tc):
    ...
    # verify that cur_avail_tokens in dcqcn state is 2780. Since at end of 2 iteration 2*9834=19668 bits will be accumulated 
    # with core-clock running at 833 MHz.
    # 8*2111=16888  bits will be consumed by packet. So 19668-16888=2780 tokens remain.
    if not VerifyFieldAbsolute(tc, tc.pvtdata.dcqcn_post_qstate, 'cur_avail_tokens', 2780):
        return False
    ...
    # It requires 1 iterations to accumulate enough tokens to send 2111B packet at rate 1 Mbps,
