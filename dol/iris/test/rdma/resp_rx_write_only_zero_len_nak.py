...
def TestCaseVerify(tc):
    ...
    #verify that wr_only_zero_len_err is set to 1
    if not VerifyFieldModify(tc, tc.pvtdata.rq_pre_qstate, tc.pvtdata.rq_post_qstate, 'qp_err_dis_wr_only_zero_len_err', 1):
        return False                
