...
def TestCaseStepVerify(tc, step):
    ...
    if step.step_id == 0:
        ...
        # verify qp_err_dis_inv_lkey_qp_mismatch is set
        if not VerifyFieldModify(tc, tc.pvtdata.sq_pre_qstate, tc.pvtdata.sq_post_qstate, 'qp_err_dis_inv_lkey_qp_mismatch', 1):
            return False
