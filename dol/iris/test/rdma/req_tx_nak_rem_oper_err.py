...
def TestCaseStepVerify(tc, step):
    ...
    if step.step_id == 0:
        ...
        # verify qp_err_dis_rrqwqe_remote_oper_err_rcvd is set
        if not VerifyFieldModify(tc, tc.pvtdata.sq_pre_qstate, tc.pvtdata.sq_post_qstate, 'qp_err_dis_rrqwqe_remote_oper_err_rcvd', 1):
            return False
