...
def TestCaseVerify(tc):
    ...
    # verify that cur_avail_tokens in dcqcn state is 78. Since at end of 8 iteration 16974 bits will be accumulated 
    # with core-clock running at 833 MHz.
    # 8*2112=16896  bits will be consumed by packet. So 16974-16896=78tokens remain.
