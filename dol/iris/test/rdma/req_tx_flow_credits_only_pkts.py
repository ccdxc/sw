...
def TestCaseStepVerify(tc, step):
    ...
    if step.step_id == 0:
        ...
        if not VerifyFieldAbsolute(tc, tc.pvtdata.sq_post_qstate, 'lsn', (msn+128)):
            return False

        # verify that lsn_rx is not updated
        ...
        if not VerifyFieldAbsolute(tc, tc.pvtdata.sq_post_qstate, 'lsn_tx', (msn+128)):
            return False
