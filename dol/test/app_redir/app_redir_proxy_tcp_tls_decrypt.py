...
def TestCaseSetup(tc):
    ...
    ProxyrCbHelper.main(id)
    proxyrcbid = "ProxyrCb%04d" % id
    ...
    _proxyccb_id = id + app_redir_shared.app_redir_proxyccb_num_entries_max
    ...
    proxyccb.my_txq_qtype = 0
    proxyccb.my_txq_qid = id
    proxyccb.my_txq_ring = 0
