...
meta:
    id: ICACHE_TENANT_OVERLAY_VLAN

type    : tenant
overlay : vlan

segments:
    - spec  : ref://store/specs/id=ICACHE_SEGMENT_NATIVE
      count : 1
    - spec  : ref://store/specs/id=ICACHE_SEGMENT_DEFAULT
      count : 1
...
sessions:
    unidest:
        ipv4:
            - ref://store/specs/id=ICACHE_SESSION_TCP
            - ref://store/specs/id=ICACHE_SESSION_UDP
